pub(crate) const CRD_V1_SOURCES: &'static [UpstreamSource] = &[
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotect.f5.com_aplogconfs.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotect.f5.com_appolicies.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotect.f5.com_apusersigs.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotectdos.f5.com_apdoslogconfs.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotectdos.f5.com_apdospolicy.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/appprotectdos.f5.com_dosprotectedresources.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/externaldns.nginx.org_dnsendpoints.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/k8s.nginx.org_globalconfigurations.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/k8s.nginx.org_policies.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/k8s.nginx.org_transportservers.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/k8s.nginx.org_virtualserverroutes.yaml",
            "https://github.com/nginxinc/kubernetes-ingress/blob/v3.3.0/deployments/common/crds/k8s.nginx.org_virtualservers.yaml",
        ],
    },
    UpstreamSource {
