...
// kopium command: kopium --docs --filename=./crd-catalog/aws/amazon-cloudwatch-agent-operator/cloudwatch.aws.amazon.com/v1alpha1/instrumentations.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "cloudwatch.aws.amazon.com", version = "v1alpha1", kind = "Instrumentation", plural = "instrumentations")]
#[kube(namespaced)]
