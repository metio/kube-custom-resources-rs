...
// kopium command: kopium --docs --filename=./crd-catalog/aws/amazon-cloudwatch-agent-operator/cloudwatch.aws.amazon.com/v1alpha1/instrumentations.yaml --derive=Default --derive=PartialEq
