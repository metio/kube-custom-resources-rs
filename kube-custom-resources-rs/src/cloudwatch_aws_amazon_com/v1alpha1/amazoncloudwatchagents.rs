...
// kopium command: kopium --docs --filename=./crd-catalog/aws/amazon-cloudwatch-agent-operator/cloudwatch.aws.amazon.com/v1alpha1/amazoncloudwatchagents.yaml --derive=Default --derive=PartialEq --smart-derive-elision
