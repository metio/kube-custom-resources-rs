...
pub struct AmazonCloudWatchAgentVolumeClaimTemplatesStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<AmazonCloudWatchAgentVolumeClaimTemplatesStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AmazonCloudWatchAgentVolumeClaimTemplatesStatusConditions {
