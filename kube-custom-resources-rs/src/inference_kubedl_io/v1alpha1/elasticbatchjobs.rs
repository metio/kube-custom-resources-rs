...
// kopium command: kopium --docs --filename=./crd-catalog/kubedl-io/kubedl/inference.kubedl.io/v1alpha1/elasticbatchjobs.yaml --derive=Default --derive=PartialEq --smart-derive-elision
