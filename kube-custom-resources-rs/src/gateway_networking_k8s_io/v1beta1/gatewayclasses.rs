...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1beta1/gatewayclasses.yaml --derive=Default --derive=PartialEq --smart-derive-elision
