...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1alpha2/tlsroutes.yaml --derive=PartialEq
...
pub struct TLSRouteStatusParents {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TLSRouteStatusParentsConditions>>,
...
pub struct TLSRouteStatusParentsConditions {
    ...
    pub status: TLSRouteStatusParentsConditionsStatus,
