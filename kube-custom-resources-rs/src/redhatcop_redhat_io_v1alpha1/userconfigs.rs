...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/redhat-cop/namespace-configuration-operator/redhatcop.redhat.io/v1alpha1/userconfigs.yaml
