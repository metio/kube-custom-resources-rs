...
// kopium command: kopium --docs --filename=./crd-catalog/cert-manager/cert-manager/acme.cert-manager.io/v1/challenges.yaml --derive=Default --derive=PartialEq --smart-derive-elision
