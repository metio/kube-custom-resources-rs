...
// kopium command: kopium --docs --filename=./crd-catalog/cert-manager/cert-manager/acme.cert-manager.io/v1/orders.yaml --derive=Default --derive=PartialEq --smart-derive-elision
