...
// kopium command: kopium --docs --filename=./crd-catalog/koordinator-sh/koordinator/scheduling.sigs.k8s.io/v1alpha1/elasticquotas.yaml --derive=Default --derive=PartialEq --smart-derive-elision
