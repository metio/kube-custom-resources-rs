...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/hazelcast/hazelcast-platform-operator/hazelcast.com/v1alpha1/wanreplications.yaml
