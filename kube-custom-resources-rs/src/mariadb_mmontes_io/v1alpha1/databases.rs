...
// kopium command: kopium --docs --filename=./crd-catalog/mariadb-operator/mariadb-operator/mariadb.mmontes.io/v1alpha1/databases.yaml --derive=Default --derive=PartialEq --smart-derive-elision
