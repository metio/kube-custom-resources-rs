...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/work-api/multicluster.x-k8s.io/v1alpha1/appliedworks.yaml
