...
// kopium command: kopium --docs --filename=./crd-catalog/apache/rocketmq-operator/rocketmq.apache.org/v1alpha1/nameservices.yaml --derive=Default --derive=PartialEq --smart-derive-elision
