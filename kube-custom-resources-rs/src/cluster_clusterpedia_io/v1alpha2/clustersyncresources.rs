...
// kopium command: kopium --docs --filename=./crd-catalog/clusterpedia-io/clusterpedia/cluster.clusterpedia.io/v1alpha2/clustersyncresources.yaml --derive=Default --derive=PartialEq --smart-derive-elision
