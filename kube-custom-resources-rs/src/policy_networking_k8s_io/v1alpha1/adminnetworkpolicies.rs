...
// kopium command: kopium --docs --filename=./crd-catalog/projectcalico/calico/policy.networking.k8s.io/v1alpha1/adminnetworkpolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
