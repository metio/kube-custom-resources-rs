...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/external-secrets/external-secrets/external-secrets.io/v1alpha1/clustersecretstores.yaml
