...
pub struct NodeModulesConfigModulesConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<NodeModulesConfigModulesConfigTolerations>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NodeModulesConfigModulesConfigTolerations {
...
pub struct NodeModulesConfigStatusModulesConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<NodeModulesConfigStatusModulesConfigTolerations>>,
}
...
/// the triple <key,value,effect> using the matching operator <operator>.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NodeModulesConfigStatusModulesConfigTolerations {
    /// Effect indicates the taint effect to match. Empty means match all taint effects.
    /// When specified, allowed values are NoSchedule, PreferNoSchedule and NoExecute.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub effect: Option<String>,
