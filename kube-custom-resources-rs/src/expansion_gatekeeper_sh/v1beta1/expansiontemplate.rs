...
// kopium command: kopium --docs --filename=./crd-catalog/open-policy-agent/gatekeeper/expansion.gatekeeper.sh/v1beta1/expansiontemplate.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "expansion.gatekeeper.sh", version = "v1beta1", kind = "ExpansionTemplate", plural = "expansiontemplate")]
