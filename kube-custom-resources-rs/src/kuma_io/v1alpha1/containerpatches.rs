...
// kopium command: kopium --docs --filename=./crd-catalog/kumahq/kuma/kuma.io/v1alpha1/containerpatches.yaml --derive=Default --derive=PartialEq --smart-derive-elision
