...
// kopium command: kopium --docs --filename ./crd-catalog/aws-controllers-k8s/elasticache-controller/elasticache.services.k8s.aws/v1alpha1/replicationgroups.yaml
