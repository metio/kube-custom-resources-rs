...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/bpfd-dev/bpfd/bpfd.dev/v1alpha1/tracepointprograms.yaml
...
#[kube(group = "bpfd.dev", version = "v1alpha1", kind = "TracepointProgram", plural = "tracepointprograms")]
...
pub struct TracepointProgramStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TracepointProgramStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TracepointProgramStatusConditions {
    ...
    pub status: TracepointProgramStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TracepointProgramStatusConditionsStatus {
    True,
    False,
    Unknown,
}
