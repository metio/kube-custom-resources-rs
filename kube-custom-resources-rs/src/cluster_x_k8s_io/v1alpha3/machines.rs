...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/cluster-api/cluster.x-k8s.io/v1alpha3/machines.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "cluster.x-k8s.io", version = "v1alpha3", kind = "Machine", plural = "machines")]
#[kube(namespaced)]
