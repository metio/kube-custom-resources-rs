...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/openshift/hive/hive.openshift.io/v1/clusterdeploymentcustomizations.yaml
...
pub struct ClusterDeploymentCustomizationStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ClusterDeploymentCustomizationStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentCustomizationStatusConditions {
