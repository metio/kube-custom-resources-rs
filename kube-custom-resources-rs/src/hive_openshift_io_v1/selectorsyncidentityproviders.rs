...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/openshift/hive/hive.openshift.io/v1/selectorsyncidentityproviders.yaml
