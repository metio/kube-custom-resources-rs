...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/nginxinc/kubernetes-ingress/externaldns.nginx.org/v1/dnsendpoints.yaml
