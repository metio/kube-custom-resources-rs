...
pub struct AccessLogPolicyStatus {
    ...
    ///  * "Accepted" * "Ready"
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<AccessLogPolicyStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct AccessLogPolicyStatusConditions {
    ...
    pub status: AccessLogPolicyStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AccessLogPolicyStatusConditionsStatus {
    True,
    False,
    Unknown,
}
