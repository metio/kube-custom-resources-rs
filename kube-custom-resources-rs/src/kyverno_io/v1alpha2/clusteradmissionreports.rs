...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v1alpha2/clusteradmissionreports.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct ClusterAdmissionReportResults {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<Vec<ClusterAdmissionReportResultsResources>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterAdmissionReportResultsResources {
    /// API version of the referent.
