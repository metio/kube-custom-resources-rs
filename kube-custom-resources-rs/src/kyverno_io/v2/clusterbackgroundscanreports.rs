...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v2/clusterbackgroundscanreports.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "kyverno.io", version = "v2", kind = "ClusterBackgroundScanReport", plural = "clusterbackgroundscanreports")]
...
pub struct ClusterBackgroundScanReportResults {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<Vec<ClusterBackgroundScanReportResultsResources>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterBackgroundScanReportResultsResources {
