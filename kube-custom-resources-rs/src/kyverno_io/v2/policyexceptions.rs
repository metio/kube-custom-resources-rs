...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v2/policyexceptions.yaml --derive=Default --derive=PartialEq --smart-derive-elision
