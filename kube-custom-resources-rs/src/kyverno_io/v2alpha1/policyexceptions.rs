...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v2alpha1/policyexceptions.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "kyverno.io", version = "v2alpha1", kind = "PolicyException", plural = "policyexceptions")]
#[kube(namespaced)]
