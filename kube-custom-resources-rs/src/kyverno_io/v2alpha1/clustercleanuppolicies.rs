...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v2alpha1/clustercleanuppolicies.yaml --derive=PartialEq
...
#[kube(group = "kyverno.io", version = "v2alpha1", kind = "ClusterCleanupPolicy", plural = "clustercleanuppolicies")]
