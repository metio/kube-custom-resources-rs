...
// kopium command: kopium --docs --filename=./crd-catalog/kyverno/kyverno/kyverno.io/v2alpha1/clustercleanuppolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
