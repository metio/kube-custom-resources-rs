...
// kopium command: kopium --docs --filename=./crd-catalog/vmware-tanzu/velero/velero.io/v1/deletebackuprequests.yaml --derive=Default --derive=PartialEq --smart-derive-elision
