...
// kopium command: kopium --docs --filename=./crd-catalog/vmware-tanzu/velero/velero.io/v1/volumesnapshotlocations.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(namespaced)]
#[kube(status = "VolumeSnapshotLocationStatus")]
