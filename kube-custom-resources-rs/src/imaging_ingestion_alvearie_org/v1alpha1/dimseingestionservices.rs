...
// kopium command: kopium --docs --filename=./crd-catalog/Alvearie/imaging-ingestion/imaging-ingestion.alvearie.org/v1alpha1/dimseingestionservices.yaml --derive=Default --derive=PartialEq --smart-derive-elision
