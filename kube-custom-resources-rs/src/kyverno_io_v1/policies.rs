...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kyverno/kyverno/kyverno.io/v1/policies.yaml
...
pub struct PolicyStatusConditions {
    ...
    pub status: PolicyStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PolicyStatusConditionsStatus {
    True,
    False,
    Unknown,
}
