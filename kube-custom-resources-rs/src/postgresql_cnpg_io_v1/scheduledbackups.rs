...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/cloudnative-pg/cloudnative-pg/postgresql.cnpg.io/v1/scheduledbackups.yaml
