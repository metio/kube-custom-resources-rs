...
// kopium command: kopium --docs --filename=./crd-catalog/cloudnative-pg/cloudnative-pg/postgresql.cnpg.io/v1/scheduledbackups.yaml --derive=Default --derive=PartialEq
