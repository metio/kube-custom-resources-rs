...
// kopium command: kopium --docs --filename=./crd-catalog/aws-controllers-k8s/cloudtrail-controller/cloudtrail.services.k8s.aws/v1alpha1/trails.yaml --derive=Default --derive=PartialEq
...
pub struct TrailStatus {
    ...
    /// resource
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TrailStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TrailStatusConditions {
