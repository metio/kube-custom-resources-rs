...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/mittwald/kubernetes-secret-generator/secretgenerator.mittwald.de/v1alpha1/stringsecrets.yaml
