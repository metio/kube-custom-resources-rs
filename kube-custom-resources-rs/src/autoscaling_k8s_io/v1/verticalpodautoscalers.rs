...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes/autoscaler/autoscaling.k8s.io/v1/verticalpodautoscalers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
