...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluxcd/kustomize-controller/kustomize.toolkit.fluxcd.io/v1beta1/kustomizations.yaml
