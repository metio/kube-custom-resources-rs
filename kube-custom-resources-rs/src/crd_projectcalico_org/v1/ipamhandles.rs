...
// kopium command: kopium --docs --filename=./crd-catalog/projectcalico/calico/crd.projectcalico.org/v1/ipamhandles.yaml --derive=Default --derive=PartialEq --smart-derive-elision
