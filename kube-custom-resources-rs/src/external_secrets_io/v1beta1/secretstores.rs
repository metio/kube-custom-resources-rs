...
// kopium command: kopium --docs --filename=./crd-catalog/external-secrets/external-secrets/external-secrets.io/v1beta1/secretstores.yaml --derive=Default --derive=PartialEq --smart-derive-elision
