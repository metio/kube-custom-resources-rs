...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/security.istio.io/v1beta1/peerauthentications.yaml --derive=Default --derive=PartialEq --smart-derive-elision
