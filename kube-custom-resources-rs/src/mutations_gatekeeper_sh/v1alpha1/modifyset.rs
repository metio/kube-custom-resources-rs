...
// kopium command: kopium --docs --filename=./crd-catalog/open-policy-agent/gatekeeper/mutations.gatekeeper.sh/v1alpha1/modifyset.yaml --derive=Default --derive=PartialEq --smart-derive-elision
