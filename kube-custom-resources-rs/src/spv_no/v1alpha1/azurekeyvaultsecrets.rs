...
// kopium command: kopium --docs --filename=./crd-catalog/SparebankenVest/azure-key-vault-to-kubernetes/spv.no/v1alpha1/azurekeyvaultsecrets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
