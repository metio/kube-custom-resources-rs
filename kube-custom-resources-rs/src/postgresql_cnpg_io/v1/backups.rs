...
// kopium command: kopium --docs --filename=./crd-catalog/cloudnative-pg/cloudnative-pg/postgresql.cnpg.io/v1/backups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
