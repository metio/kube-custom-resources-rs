...
// kopium command: kopium --docs --filename=./crd-catalog/kubeedge/kubeedge/operations.kubeedge.io/v1alpha1/nodeupgradejobs.yaml --derive=Default --derive=PartialEq --smart-derive-elision
