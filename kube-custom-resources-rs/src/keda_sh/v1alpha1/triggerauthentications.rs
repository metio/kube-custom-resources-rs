...
// kopium command: kopium --docs --filename=./crd-catalog/kedacore/keda/keda.sh/v1alpha1/triggerauthentications.yaml --derive=Default --derive=PartialEq --smart-derive-elision
