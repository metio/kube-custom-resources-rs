...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubeshop/testkube-operator/tests.testkube.io/v1/testsuiteexecutions.yaml
