...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/azuresqldatabases.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "AzureSqlDatabase", plural = "azuresqldatabases")]
#[kube(namespaced)]
