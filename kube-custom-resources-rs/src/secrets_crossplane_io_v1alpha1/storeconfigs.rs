...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/crossplane/crossplane/secrets.crossplane.io/v1alpha1/storeconfigs.yaml
