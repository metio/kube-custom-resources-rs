...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-policy-agent/gatekeeper/status.gatekeeper.sh/v1beta1/constraintpodstatuses.yaml
