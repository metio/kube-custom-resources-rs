...
// kopium command: kopium --docs --filename=./crd-catalog/aws/aws-app-mesh-controller-for-k8/appmesh.k8s.aws/v1beta2/virtualnodes.yaml --derive=Default --derive=PartialEq --smart-derive-elision
