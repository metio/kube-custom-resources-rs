...
// kopium command: kopium --docs --filename=./crd-catalog/aws/aws-app-mesh-controller-for-k8/appmesh.k8s.aws/v1beta2/virtualgateways.yaml
...
pub struct VirtualGatewayStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<VirtualGatewayStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug)]
pub struct VirtualGatewayStatusConditions {
