...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/node-feature-discovery-operator/nfd.kubernetes.io/v1/nodefeaturediscoveries.yaml
