...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/openshift/hive/hiveinternal.openshift.io/v1alpha1/fakeclusterinstalls.yaml
...
pub struct FakeClusterInstallStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<FakeClusterInstallStatusConditions>>,
}

/// ClusterInstallCondition contains details for the current condition of a cluster install.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FakeClusterInstallStatusConditions {
