...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/mariadb-operator/mariadb-operator/mariadb.mmontes.io/v1alpha1/mariadbs.yaml
