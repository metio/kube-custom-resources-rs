...
// kopium command: kopium --docs --filename=./crd-catalog/bpfman/bpfman/bpfman.io/v1alpha1/fexitprograms.yaml --derive=Default --derive=PartialEq --smart-derive-elision
