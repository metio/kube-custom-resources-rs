...
// kopium command: kopium --docs --filename=./crd-catalog/metal3-io/baremetal-operator/metal3.io/v1alpha1/hostfirmwarecomponents.yaml --derive=Default --derive=PartialEq
...
pub struct HostFirmwareComponentsStatus {
    ...
    pub components: Vec<HostFirmwareComponentsStatusComponents>,
    ...
    pub updates: Vec<HostFirmwareComponentsStatusUpdates>,
}
