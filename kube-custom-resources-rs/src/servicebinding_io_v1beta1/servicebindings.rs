...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/redhat-developer/service-binding-operator/servicebinding.io/v1beta1/servicebindings.yaml
