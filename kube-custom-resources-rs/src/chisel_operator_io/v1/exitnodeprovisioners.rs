...
// kopium command: kopium --docs --filename=./crd-catalog/FyraLabs/chisel-operator/chisel-operator.io/v1/exitnodeprovisioners.yaml --derive=Default --derive=PartialEq --smart-derive-elision
