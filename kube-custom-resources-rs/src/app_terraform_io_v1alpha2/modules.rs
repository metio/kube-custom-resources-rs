...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/hashicorp/terraform-cloud-operator/app.terraform.io/v1alpha2/modules.yaml
