...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes/autoscaler/autoscaling.k8s.io/v1/verticalpodautoscalercheckpoints.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "autoscaling.k8s.io", version = "v1", kind = "VerticalPodAutoscalerCheckpoint", plural = "verticalpodautoscalercheckpoints")]
#[kube(namespaced)]
