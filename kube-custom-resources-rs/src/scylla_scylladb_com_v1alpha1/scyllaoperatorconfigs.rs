...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/scylladb/scylla-operator/scylla.scylladb.com/v1alpha1/scyllaoperatorconfigs.yaml
