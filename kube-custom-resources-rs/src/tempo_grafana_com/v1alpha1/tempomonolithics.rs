...
pub struct TempoMonolithicStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TempoMonolithicStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TempoMonolithicStatusConditions {
    ...
    pub status: TempoMonolithicStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TempoMonolithicStatusConditionsStatus {
    True,
    False,
    Unknown,
}
