...
// kopium command: kopium --docs --filename=./crd-catalog/grafana/tempo-operator/tempo.grafana.com/v1alpha1/tempostacks.yaml --derive=PartialEq
...
pub struct TempoStackStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TempoStackStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TempoStackStatusConditions {
    ...
    pub status: TempoStackStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TempoStackStatusConditionsStatus {
    True,
    False,
    Unknown,
}
