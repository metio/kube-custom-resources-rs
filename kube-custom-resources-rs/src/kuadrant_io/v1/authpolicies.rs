...
// kopium command: kopium --docs --filename=./crd-catalog/Kuadrant/kuadrant-operator/kuadrant.io/v1/authpolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct AuthPolicyDefaultsRulesResponseSuccessFiltersWhen {
    /// A list of pattern expressions to be evaluated as a logical AND.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub all: Option<Vec<AuthPolicyDefaultsRulesResponseSuccessFiltersWhenAll>>,
    /// A list of pattern expressions to be evaluated as a logical OR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub any: Option<Vec<AuthPolicyDefaultsRulesResponseSuccessFiltersWhenAny>>,
    /// The binary operator to be applied to the content fetched from the authorization JSON, for comparison with "value".
    /// Possible values are: "eq" (equal to), "neq" (not equal to), "incl" (includes; for arrays), "excl" (excludes; for arrays), "matches" (regex)
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct AuthPolicyOverridesRulesResponseSuccessFiltersWhen {
    /// A list of pattern expressions to be evaluated as a logical AND.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub all: Option<Vec<AuthPolicyOverridesRulesResponseSuccessFiltersWhenAll>>,
    /// A list of pattern expressions to be evaluated as a logical OR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub any: Option<Vec<AuthPolicyOverridesRulesResponseSuccessFiltersWhenAny>>,
    /// The binary operator to be applied to the content fetched from the authorization JSON, for comparison with "value".
    /// Possible values are: "eq" (equal to), "neq" (not equal to), "incl" (includes; for arrays), "excl" (excludes; for arrays), "matches" (regex)
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct AuthPolicyRulesResponseSuccessFiltersWhen {
    /// A list of pattern expressions to be evaluated as a logical AND.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub all: Option<Vec<AuthPolicyRulesResponseSuccessFiltersWhenAll>>,
    /// A list of pattern expressions to be evaluated as a logical OR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub any: Option<Vec<AuthPolicyRulesResponseSuccessFiltersWhenAny>>,
    /// The binary operator to be applied to the content fetched from the authorization JSON, for comparison with "value".
    /// Possible values are: "eq" (equal to), "neq" (not equal to), "incl" (includes; for arrays), "excl" (excludes; for arrays), "matches" (regex)
    #[serde(default, skip_serializing_if = "Option::is_none")]
