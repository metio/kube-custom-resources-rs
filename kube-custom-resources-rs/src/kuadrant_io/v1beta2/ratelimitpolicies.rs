...
pub struct RateLimitPolicyStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<RateLimitPolicyStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct RateLimitPolicyStatusConditions {
    ...
    pub status: RateLimitPolicyStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum RateLimitPolicyStatusConditionsStatus {
    True,
    False,
    Unknown,
}
