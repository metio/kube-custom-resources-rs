...
// kopium command: kopium --docs --filename=./crd-catalog/ipfs-cluster/ipfs-operator/cluster.ipfs.io/v1alpha1/circuitrelays.yaml --derive=Default --derive=PartialEq --smart-derive-elision
