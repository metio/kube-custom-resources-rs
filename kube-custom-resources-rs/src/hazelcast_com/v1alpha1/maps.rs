...
// kopium command: kopium --docs --filename=./crd-catalog/hazelcast/hazelcast-platform-operator/hazelcast.com/v1alpha1/maps.yaml --derive=Default --derive=PartialEq --smart-derive-elision
