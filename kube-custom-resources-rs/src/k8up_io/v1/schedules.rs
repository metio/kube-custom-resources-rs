...
pub struct ScheduleStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ScheduleStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ScheduleStatusConditions {
    ...
    pub status: ScheduleStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ScheduleStatusConditionsStatus {
    True,
    False,
    Unknown,
}
