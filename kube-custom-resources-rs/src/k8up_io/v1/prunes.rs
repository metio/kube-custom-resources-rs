...
pub struct PruneStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PruneStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct PruneStatusConditions {
    ...
    pub status: PruneStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PruneStatusConditionsStatus {
    True,
    False,
    Unknown,
}
