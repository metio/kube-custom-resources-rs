...
// kopium command: kopium --docs --filename=./crd-catalog/k8up-io/k8up/k8up.io/v1/archives.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct ArchiveResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<ArchiveResourcesClaims>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArchiveResourcesClaims {
