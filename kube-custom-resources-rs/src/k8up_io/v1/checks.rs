...
pub struct CheckStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<CheckStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct CheckStatusConditions {
    ...
    pub status: CheckStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CheckStatusConditionsStatus {
    True,
    False,
    Unknown,
}
