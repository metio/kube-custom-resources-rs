...
// kopium command: kopium --docs --filename=./crd-catalog/CleverCloud/clever-operator/api.clever-cloud.com/v1/elasticsearches.yaml --derive=Default --derive=PartialEq --smart-derive-elision
