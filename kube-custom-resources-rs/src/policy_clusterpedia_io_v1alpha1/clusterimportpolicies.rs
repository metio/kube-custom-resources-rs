...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/clusterpedia-io/clusterpedia/policy.clusterpedia.io/v1alpha1/clusterimportpolicies.yaml
