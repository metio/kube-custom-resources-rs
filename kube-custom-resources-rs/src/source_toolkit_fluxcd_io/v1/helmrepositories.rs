...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/source-controller/source.toolkit.fluxcd.io/v1/helmrepositories.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "source.toolkit.fluxcd.io", version = "v1", kind = "HelmRepository", plural = "helmrepositories")]
#[kube(namespaced)]
