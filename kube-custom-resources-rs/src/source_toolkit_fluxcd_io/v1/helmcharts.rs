...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/source-controller/source.toolkit.fluxcd.io/v1/helmcharts.yaml --derive=Default --derive=PartialEq --smart-derive-elision
