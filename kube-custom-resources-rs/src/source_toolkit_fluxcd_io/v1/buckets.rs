...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/source-controller/source.toolkit.fluxcd.io/v1/buckets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
