...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/aquasecurity/aqua-operator/operator.aquasec.com/v1alpha1/aquakubeenforcers.yaml
