...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/devfile/registry-operator/registry.devfile.io/v1alpha1/clusterdevfileregistrieslists.yaml
