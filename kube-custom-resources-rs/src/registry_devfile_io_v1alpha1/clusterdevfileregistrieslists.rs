...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/devfile/registry-operator/registry.devfile.io/v1alpha1/clusterdevfileregistrieslists.yaml
...
pub struct ClusterDevfileRegistriesListStatus {
    ...
    pub conditions: Option<Vec<ClusterDevfileRegistriesListStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDevfileRegistriesListStatusConditions {
    ...
    pub status: ClusterDevfileRegistriesListStatusConditionsStatus,
...
pub enum ClusterDevfileRegistriesListStatusConditionsStatus {
    True,
    False,
    Unknown,
}
