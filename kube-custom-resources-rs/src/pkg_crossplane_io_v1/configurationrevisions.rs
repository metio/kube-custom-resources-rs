...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1/configurationrevisions.yaml
