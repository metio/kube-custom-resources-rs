...
// kopium command: kopium --docs --filename=./crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1/configurationrevisions.yaml --derive=Default --derive=PartialEq
...
pub struct ConfigurationRevisionStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ConfigurationRevisionStatusConditions>>,
