...
// kopium command: kopium --docs --filename=./crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1alpha1/kafkausers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
