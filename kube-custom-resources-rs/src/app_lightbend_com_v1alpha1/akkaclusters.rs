...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/lightbend/akka-cluster-operator/app.lightbend.com/v1alpha1/akkaclusters.yaml
