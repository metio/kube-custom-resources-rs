...
// kopium command: kopium --docs --filename=./crd-catalog/kubeshop/testkube-operator/executor.testkube.io/v1/executors.yaml --derive=Default --derive=PartialEq --smart-derive-elision
