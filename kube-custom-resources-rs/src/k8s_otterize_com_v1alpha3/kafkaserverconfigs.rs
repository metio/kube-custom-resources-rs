...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/otterize/helm-charts/k8s.otterize.com/v1alpha3/kafkaserverconfigs.yaml
