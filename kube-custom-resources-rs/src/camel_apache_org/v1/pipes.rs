...
// kopium command: kopium --docs --filename=./crd-catalog/apache/camel-k/camel.apache.org/v1/pipes.yaml --derive=Default --derive=PartialEq
...
pub struct PipeIntegration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub flows: Option<Vec<PipeIntegrationFlows>>,
    ...
    pub integration_kit: Option<PipeIntegrationIntegrationKit>,
...
pub struct PipeIntegrationTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecResources {
    ...
    ///  This field is immutable. It can only be set for containers.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<PipeIntegrationTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
    /// Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. Requests cannot exceed Limits. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
...
/// ResourceClaim references one entry in PodSpec.ResourceClaims.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PipeIntegrationTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecResourcesClaims {
    /// Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used. It makes that resource available inside a container.
    pub name: String,
}
...
pub struct PipeIntegrationTraits {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub addons: Option<BTreeMap<String, PipeIntegrationTraitsAddons>>,
...
pub struct PipeSource {
    ...
    /// Ref can be used to declare a Kubernetes resource as source/sink endpoint
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ref")]
    pub r#ref: Option<PipeSourceRef>,
    /// URI can be used to specify the (Camel) endpoint explicitly
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub uri: Option<String>,
}
