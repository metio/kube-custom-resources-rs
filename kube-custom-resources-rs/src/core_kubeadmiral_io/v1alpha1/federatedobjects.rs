...
// kopium command: kopium --docs --filename=./crd-catalog/kubewharf/kubeadmiral/core.kubeadmiral.io/v1alpha1/federatedobjects.yaml --derive=Default --derive=PartialEq --smart-derive-elision
