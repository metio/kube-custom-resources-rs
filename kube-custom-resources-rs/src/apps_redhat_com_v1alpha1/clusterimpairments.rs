...
// kopium command: kopium --auto --filename ./crd-catalog/redhat-performance/cluster-impairment-operator/apps.redhat.com/v1alpha1/clusterimpairments.yaml
...
#[kube(status = "ClusterImpairmentStatus")]
