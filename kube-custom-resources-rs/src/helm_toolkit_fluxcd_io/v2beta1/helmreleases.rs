...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/helm-controller/helm.toolkit.fluxcd.io/v2beta1/helmreleases.yaml --derive=PartialEq
...
pub struct HelmReleaseStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<HelmReleaseStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct HelmReleaseStatusConditions {
    ...
    pub status: HelmReleaseStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum HelmReleaseStatusConditionsStatus {
    True,
    False,
    Unknown,
}
