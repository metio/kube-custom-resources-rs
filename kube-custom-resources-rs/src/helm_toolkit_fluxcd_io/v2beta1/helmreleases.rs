...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/helm-controller/helm.toolkit.fluxcd.io/v2beta1/helmreleases.yaml --derive=Default --derive=PartialEq --smart-derive-elision
