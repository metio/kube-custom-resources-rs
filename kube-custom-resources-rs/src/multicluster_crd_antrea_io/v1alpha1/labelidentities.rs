...
// kopium command: kopium --docs --filename=./crd-catalog/antrea-io/antrea/multicluster.crd.antrea.io/v1alpha1/labelidentities.yaml --derive=Default --derive=PartialEq --smart-derive-elision
