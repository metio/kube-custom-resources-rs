...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1/virtualservices.yaml --derive=Default --derive=PartialEq --smart-derive-elision
