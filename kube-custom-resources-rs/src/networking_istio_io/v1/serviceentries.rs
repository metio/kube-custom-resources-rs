...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1/serviceentries.yaml --derive=Default --derive=PartialEq --smart-derive-elision
