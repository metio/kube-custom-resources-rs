...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1alpha3/gateways.yaml --derive=Default --derive=PartialEq --smart-derive-elision
