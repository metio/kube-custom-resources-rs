...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1alpha3/sidecars.yaml --derive=Default --derive=PartialEq --smart-derive-elision
