...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1beta1/gateways.yaml --derive=Default --derive=PartialEq --smart-derive-elision
