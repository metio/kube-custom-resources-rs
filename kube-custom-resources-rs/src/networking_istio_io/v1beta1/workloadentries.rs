...
// kopium command: kopium --docs --filename=./crd-catalog/istio/istio/networking.istio.io/v1beta1/workloadentries.yaml --derive=Default --derive=PartialEq --smart-derive-elision
