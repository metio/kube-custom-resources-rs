...
// kopium command: kopium --docs --filename=./crd-catalog/argoproj-labs/argocd-operator/argoproj.io/v1beta1/argocds.yaml --derive=Default --derive=PartialEq --smart-derive-elision
