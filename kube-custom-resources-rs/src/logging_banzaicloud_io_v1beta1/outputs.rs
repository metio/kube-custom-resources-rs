...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kube-logging/logging-operator/logging.banzaicloud.io/v1beta1/outputs.yaml
