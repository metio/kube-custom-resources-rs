...
// kopium command: kopium --docs --filename=./crd-catalog/atlasmap/atlasmap-operator/atlasmap.io/v1alpha1/atlasmaps.yaml --derive=Default --derive=PartialEq --smart-derive-elision
