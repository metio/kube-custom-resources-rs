...
// kopium command: kopium --docs --filename=./crd-catalog/kubesphere-sigs/ks-releaser-operator/devops.kubesphere.io/v1alpha1/releasercontrollers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
