...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluxcd/helm-controller/helm.toolkit.fluxcd.io/v2beta1/helmreleases.yaml
