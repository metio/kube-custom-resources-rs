...
// kopium command: kopium --docs --filename=./crd-catalog/kube-logging/logging-operator/logging.banzaicloud.io/v1alpha1/clusterflows.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "logging.banzaicloud.io", version = "v1alpha1", kind = "ClusterFlow", plural = "clusterflows")]
#[kube(namespaced)]
