...
// kopium command: kopium --docs --filename=./crd-catalog/aws-controllers-k8s/route53-controller/route53.services.k8s.aws/v1alpha1/hostedzones.yaml --derive=Default --derive=PartialEq
...
pub struct HostedZoneStatus {
    ...
    /// resource
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<HostedZoneStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct HostedZoneStatusConditions {
