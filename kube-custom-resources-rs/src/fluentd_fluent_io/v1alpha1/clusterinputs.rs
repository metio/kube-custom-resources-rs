...
// kopium command: kopium --docs --filename=./crd-catalog/fluent/fluent-operator/fluentd.fluent.io/v1alpha1/clusterinputs.yaml --derive=PartialEq
...
#[kube(status = "ClusterInputStatus")]
