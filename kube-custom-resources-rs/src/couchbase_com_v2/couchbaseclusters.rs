...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/couchbase-partners/helm-charts/couchbase.com/v2/couchbaseclusters.yaml
...
pub struct CouchbaseClusterStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<CouchbaseClusterStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CouchbaseClusterStatusConditions {
    ...
    #[serde(rename = "type")]
    pub r#type: CouchbaseClusterStatusConditionsType,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CouchbaseClusterStatusConditionsType {
    Available,
    Balanced,
    ManageConfig,
    Scaling,
