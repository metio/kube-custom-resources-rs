...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/couchbase-partners/helm-charts/couchbase.com/v2/couchbaseautoscalers.yaml
