...
// kopium command: kopium --docs --filename=./crd-catalog/Lerentis/bitwarden-crd-operator/lerentis.uploadfilter24.eu/v1beta6/bitwarden-secrets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "lerentis.uploadfilter24.eu", version = "v1beta6", kind = "BitwardenSecret", plural = "bitwarden-secrets")]
#[kube(namespaced)]
