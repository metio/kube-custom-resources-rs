...
// kopium command: kopium --docs --filename=./crd-catalog/wildfly/wildfly-operator/wildfly.org/v1alpha1/wildflyservers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
