...
// kopium command: kopium --docs --filename=./crd-catalog/DopplerHQ/kubernetes-operator/secrets.doppler.com/v1alpha1/dopplersecrets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
