...
// kopium command: kopium --docs --filename=./crd-catalog/traefik/traefik/traefik.io/v1alpha1/tlsstores.yaml --derive=Default --derive=PartialEq --smart-derive-elision
