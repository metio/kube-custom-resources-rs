...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/karmada-io/karmada/networking.karmada.io/v1alpha1/multiclusterservices.yaml
