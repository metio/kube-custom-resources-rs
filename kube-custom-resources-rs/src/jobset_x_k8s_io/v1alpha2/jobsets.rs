...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/jobset/jobset.x-k8s.io/v1alpha2/jobsets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
