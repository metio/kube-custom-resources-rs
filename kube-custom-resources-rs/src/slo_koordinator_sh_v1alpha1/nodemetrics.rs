...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/koordinator-sh/koordinator/slo.koordinator.sh/v1alpha1/nodemetrics.yaml
