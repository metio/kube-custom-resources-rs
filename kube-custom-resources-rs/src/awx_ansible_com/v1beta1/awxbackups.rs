...
// kopium command: kopium --docs --filename=./crd-catalog/ansible/awx-operator/awx.ansible.com/v1beta1/awxbackups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
