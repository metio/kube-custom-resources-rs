...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-csi/external-snapshotter/snapshot.storage.k8s.io/v1/volumesnapshotcontents.yaml --derive=Default --derive=PartialEq --smart-derive-elision
