...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-telemetry/opentelemetry-operator/opentelemetry.io/v1alpha1/instrumentations.yaml
