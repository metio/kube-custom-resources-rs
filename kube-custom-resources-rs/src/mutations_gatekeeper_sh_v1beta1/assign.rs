...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-policy-agent/gatekeeper/mutations.gatekeeper.sh/v1beta1/assign.yaml
