...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/apache/rocketmq-operator/rocketmq.apache.org/v1alpha1/nameservices.yaml
