...
// kopium command: kopium --docs --filename=./crd-catalog/apache/rocketmq-operator/rocketmq.apache.org/v1alpha1/nameservices.yaml --derive=Default --derive=PartialEq
...
pub struct NameServiceVolumeClaimTemplatesStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<NameServiceVolumeClaimTemplatesStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NameServiceVolumeClaimTemplatesStatusConditions {
