...
pub struct TemporalWorkerProcessStatus {
    ...
    pub conditions: Vec<TemporalWorkerProcessStatusConditions>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TemporalWorkerProcessStatusConditions {
    ...
    pub status: TemporalWorkerProcessStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TemporalWorkerProcessStatusConditionsStatus {
    True,
    False,
    Unknown,
}
