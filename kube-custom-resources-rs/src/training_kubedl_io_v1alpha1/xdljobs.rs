...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubedl-io/kubedl/training.kubedl.io/v1alpha1/xdljobs.yaml
...
pub struct XDLJobStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<XDLJobStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct XDLJobStatusConditions {
