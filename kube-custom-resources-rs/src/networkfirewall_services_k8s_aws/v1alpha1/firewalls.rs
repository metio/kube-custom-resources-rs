...
// kopium command: kopium --docs --filename=./crd-catalog/aws-controllers-k8s/networkfirewall-controller/networkfirewall.services.k8s.aws/v1alpha1/firewalls.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct FirewallSpec {
    ...
    pub logging_configuration: Option<FirewallLoggingConfiguration>,
...
/// this setting, Network Firewall disables logging for the firewall.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FirewallLoggingConfiguration {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDestinationConfigs")]
    pub log_destination_configs: Option<Vec<FirewallLoggingConfigurationLogDestinationConfigs>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FirewallLoggingConfigurationLogDestinationConfigs {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDestination")]
    pub log_destination: Option<BTreeMap<String, String>>,
