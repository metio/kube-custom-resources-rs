...
// kopium command: kopium --docs --filename=./crd-catalog/elastic/cloud-on-k8s/elasticsearch.k8s.elastic.co/v1/elasticsearches.yaml --derive=Default --derive=PartialEq
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchNodeSetsVolumeClaimTemplatesStatusConditions {
