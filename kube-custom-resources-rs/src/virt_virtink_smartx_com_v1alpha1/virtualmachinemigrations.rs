...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/smartxworks/virtink/virt.virtink.smartx.com/v1alpha1/virtualmachinemigrations.yaml
