...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/clusternet/clusternet/clusters.clusternet.io/v1beta1/managedclusters.yaml
