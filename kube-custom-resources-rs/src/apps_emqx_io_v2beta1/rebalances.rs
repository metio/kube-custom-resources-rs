...
// kopium command: kopium --docs --filename=./crd-catalog/emqx/emqx-operator/apps.emqx.io/v2beta1/rebalances.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "apps.emqx.io", version = "v2beta1", kind = "Rebalance", plural = "rebalances")]
#[kube(namespaced)]
#[kube(status = "RebalanceStatus")]
#[kube(schema = "disabled")]
pub struct RebalanceSpec {
    #[serde(rename = "instanceKind")]
...
pub struct RebalanceStatus {
    ...
    pub conditions: Option<Vec<RebalanceStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RebalanceStatusConditions {
