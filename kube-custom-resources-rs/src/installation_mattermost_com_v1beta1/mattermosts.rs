...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/mattermost/mattermost-operator/installation.mattermost.com/v1beta1/mattermosts.yaml
