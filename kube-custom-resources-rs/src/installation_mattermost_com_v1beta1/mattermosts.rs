...
// kopium command: kopium --docs --filename=./crd-catalog/mattermost/mattermost-operator/installation.mattermost.com/v1beta1/mattermosts.yaml --derive=Default --derive=PartialEq
