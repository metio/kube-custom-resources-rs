...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/pulp/pulp-operator/repo-manager.pulpproject.org/v1beta2/pulprestores.yaml
