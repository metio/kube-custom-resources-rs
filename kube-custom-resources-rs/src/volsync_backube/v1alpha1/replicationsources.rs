...
pub struct ReplicationSourceStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ReplicationSourceStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ReplicationSourceStatusConditions {
    ...
    pub status: ReplicationSourceStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ReplicationSourceStatusConditionsStatus {
    True,
    False,
    Unknown,
}
