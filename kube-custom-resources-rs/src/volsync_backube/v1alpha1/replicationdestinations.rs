...
pub struct ReplicationDestinationStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ReplicationDestinationStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ReplicationDestinationStatusConditions {
    ...
    pub status: ReplicationDestinationStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ReplicationDestinationStatusConditionsStatus {
    True,
    False,
    Unknown,
}
