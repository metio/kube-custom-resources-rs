...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/elastic/cloud-on-k8s/elasticsearch.k8s.elastic.co/v1beta1/elasticsearches.yaml
