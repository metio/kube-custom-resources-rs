...
// kopium command: kopium --docs --filename=./crd-catalog/IBM/varnish-operator/caching.ibm.com/v1alpha1/varnishclusters.yaml --derive=Default --derive=PartialEq --smart-derive-elision
