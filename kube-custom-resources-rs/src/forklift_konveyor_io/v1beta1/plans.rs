...
// kopium command: kopium --docs --filename=./crd-catalog/kubev2v/forklift/forklift.konveyor.io/v1beta1/plans.yaml --derive=Default --derive=PartialEq
...
pub struct PlanStatusMigrationHistory {
    /// List of conditions.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PlanStatusMigrationHistoryConditions>>,
    /// Map.
...
/// Condition
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PlanStatusMigrationHistoryConditions {
    /// The condition category.
    pub category: String,
    /// The condition is durable - never un-staged.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PlanStatusMigrationVms {
    ...
    /// List of conditions.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PlanStatusMigrationVmsConditions>>,
    /// Errors
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Condition
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PlanStatusMigrationVmsConditions {
    /// The condition category.
    pub category: String,
    /// The condition is durable - never un-staged.
    #[serde(default, skip_serializing_if = "Option::is_none")]
