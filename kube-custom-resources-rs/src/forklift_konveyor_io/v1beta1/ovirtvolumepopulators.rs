...
// kopium command: kopium --docs --filename=./crd-catalog/kubev2v/forklift/forklift.konveyor.io/v1beta1/ovirtvolumepopulators.yaml --derive=Default --derive=PartialEq --smart-derive-elision
