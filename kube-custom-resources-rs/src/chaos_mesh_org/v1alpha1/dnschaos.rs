...
// kopium command: kopium --docs --filename=./crd-catalog/chaos-mesh/chaos-mesh/chaos-mesh.org/v1alpha1/dnschaos.yaml --derive=Default --derive=PartialEq --smart-derive-elision
