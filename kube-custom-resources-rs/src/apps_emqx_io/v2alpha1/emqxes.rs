...
// kopium command: kopium --docs --filename=./crd-catalog/emqx/emqx-operator/apps.emqx.io/v2alpha1/emqxes.yaml --derive=Default --derive=PartialEq --smart-derive-elision
