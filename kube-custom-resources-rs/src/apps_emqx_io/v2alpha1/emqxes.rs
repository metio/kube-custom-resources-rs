...
// kopium command: kopium --docs --filename=./crd-catalog/emqx/emqx-operator/apps.emqx.io/v2alpha1/emqxes.yaml --derive=PartialEq
...
#[kube(group = "apps.emqx.io", version = "v2alpha1", kind = "EMQX", plural = "emqxes")]
#[kube(namespaced)]
...
pub struct EMQXSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bootstrapConfig")]
...
pub struct EMQXDashboardServiceTemplateStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<EMQXDashboardServiceTemplateStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct EMQXDashboardServiceTemplateStatusConditions {
    ...
    pub reason: String,
    pub status: EMQXDashboardServiceTemplateStatusConditionsStatus,
    #[serde(rename = "type")]
    pub r#type: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum EMQXDashboardServiceTemplateStatusConditionsStatus {
    True,
    False,
    Unknown,
}
...
pub struct EMQXListenersServiceTemplateStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<EMQXListenersServiceTemplateStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loadBalancer")]
    pub load_balancer: Option<EMQXListenersServiceTemplateStatusLoadBalancer>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct EMQXListenersServiceTemplateStatusConditions {
    #[serde(rename = "lastTransitionTime")]
    pub last_transition_time: String,
    pub message: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "observedGeneration")]
    pub observed_generation: Option<i64>,
    pub reason: String,
    pub status: EMQXListenersServiceTemplateStatusConditionsStatus,
    #[serde(rename = "type")]
    pub r#type: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum EMQXListenersServiceTemplateStatusConditionsStatus {
    True,
    False,
    Unknown,
}
...
pub struct EMQXStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<EMQXStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreNodeReadyReplicas")]
    pub core_node_ready_replicas: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreNodeReplicas")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicantNodeReadyReplicas")]
    pub replicant_node_ready_replicas: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicantNodeReplicas")]
    pub replicant_node_replicas: Option<i32>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct EMQXStatusConditions {
