...
// kopium command: kopium --docs --filename=./crd-catalog/emqx/emqx-operator/apps.emqx.io/v2beta1/emqxes.yaml --derive=Default --derive=PartialEq --smart-derive-elision
