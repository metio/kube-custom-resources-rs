...
// kopium command: kopium --docs --filename=./crd-catalog/apecloud/kubeblocks/workloads.kubeblocks.io/v1/instancesets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
