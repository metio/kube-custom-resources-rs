...
// kopium command: kopium --docs --filename=./crd-catalog/aws-controllers-k8s/sqs-controller/sqs.services.k8s.aws/v1alpha1/queues.yaml --derive=Default --derive=PartialEq
...
pub struct QueueStatus {
    ...
    /// resource
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<QueueStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QueueStatusConditions {
