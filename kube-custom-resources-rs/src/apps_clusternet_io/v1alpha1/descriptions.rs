...
// kopium command: kopium --docs --filename=./crd-catalog/clusternet/clusternet/apps.clusternet.io/v1alpha1/descriptions.yaml --derive=Default --derive=PartialEq --smart-derive-elision
