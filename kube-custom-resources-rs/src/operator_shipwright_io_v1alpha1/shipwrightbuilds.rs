...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/shipwright-io/operator/operator.shipwright.io/v1alpha1/shipwrightbuilds.yaml
