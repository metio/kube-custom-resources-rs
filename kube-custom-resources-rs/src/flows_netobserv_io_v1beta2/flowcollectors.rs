...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/netobserv/network-observability-operator/flows.netobserv.io/v1beta2/flowcollectors.yaml
