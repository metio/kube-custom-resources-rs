...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/cluster-api-operator/operator.cluster.x-k8s.io/v1alpha1/bootstrapproviders.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.cluster.x-k8s.io", version = "v1alpha1", kind = "BootstrapProvider", plural = "bootstrapproviders")]
#[kube(namespaced)]
...
pub struct BootstrapProviderDeploymentContainers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<BootstrapProviderDeploymentContainersImage>,
...
/// Container Image Name
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BootstrapProviderDeploymentContainersImage {
...
pub struct BootstrapProviderStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<BootstrapProviderStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BootstrapProviderStatusConditions {
