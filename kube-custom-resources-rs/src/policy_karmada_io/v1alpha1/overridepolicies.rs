...
// kopium command: kopium --docs --filename=./crd-catalog/karmada-io/karmada/policy.karmada.io/v1alpha1/overridepolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
