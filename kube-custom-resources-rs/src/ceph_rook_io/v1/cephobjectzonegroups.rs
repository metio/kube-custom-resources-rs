...
// kopium command: kopium --docs --filename=./crd-catalog/rook/rook/ceph.rook.io/v1/cephobjectzonegroups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
