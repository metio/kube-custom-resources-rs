...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1alpha2/grpcroutes.yaml
...
pub struct GRPCRouteStatusParents {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<GRPCRouteStatusParentsConditions>>,
...
pub struct GRPCRouteStatusParentsConditions {
    ...
    pub status: GRPCRouteStatusParentsConditionsStatus,
