...
// kopium command: kopium --docs --filename=./crd-catalog/3scale-ops/marin3r/marin3r.3scale.net/v1alpha1/envoyconfigs.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct EnvoyConfigStatusRevisions {
    ...
    #[serde(rename = "ref")]
    pub r#ref: EnvoyConfigStatusRevisionsRef,
