...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluid-cloudnative/fluid/data.fluid.io/v1alpha1/datasets.yaml
...
pub struct DatasetStatus {
    ...
    pub conditions: Vec<DatasetStatusConditions>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatasetStatusConditions {
