...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluid-cloudnative/fluid/data.fluid.io/v1alpha1/juicefsruntimes.yaml
...
pub struct JuiceFSRuntimeStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<JuiceFSRuntimeStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFSRuntimeStatusConditions {
