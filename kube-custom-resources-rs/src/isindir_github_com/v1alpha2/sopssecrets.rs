...
// kopium command: kopium --docs --filename=./crd-catalog/isindir/sops-secrets-operator/isindir.github.com/v1alpha2/sopssecrets.yaml --derive=Default --derive=PartialEq --smart-derive-elision
