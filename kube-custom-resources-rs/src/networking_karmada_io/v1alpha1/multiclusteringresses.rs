...
// kopium command: kopium --docs --filename=./crd-catalog/karmada-io/karmada/networking.karmada.io/v1alpha1/multiclusteringresses.yaml --derive=Default --derive=PartialEq --smart-derive-elision
