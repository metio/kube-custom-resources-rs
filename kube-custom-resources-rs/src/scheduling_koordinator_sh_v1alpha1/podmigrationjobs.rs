...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/koordinator-sh/koordinator/scheduling.koordinator.sh/v1alpha1/podmigrationjobs.yaml
...
pub struct PodMigrationJobStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PodMigrationJobStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PodMigrationJobStatusConditions {
