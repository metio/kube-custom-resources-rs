...
// kopium command: kopium --docs --filename=./crd-catalog/migtools/crane-operator/crane.konveyor.io/v1alpha1/operatorconfigs.yaml --derive=Default --derive=PartialEq --smart-derive-elision
