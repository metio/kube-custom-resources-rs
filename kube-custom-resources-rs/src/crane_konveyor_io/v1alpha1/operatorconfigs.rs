...
pub struct OperatorConfigStatusConditions {
    ...
    pub status: OperatorConfigStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum OperatorConfigStatusConditionsStatus {
    True,
    False,
    Unknown,
}
