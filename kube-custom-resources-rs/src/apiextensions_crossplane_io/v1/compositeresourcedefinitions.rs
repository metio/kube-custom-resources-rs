...
// kopium command: kopium --docs --filename=./crd-catalog/crossplane/crossplane/apiextensions.crossplane.io/v1/compositeresourcedefinitions.yaml --derive=Default --derive=PartialEq
...
pub struct CompositeResourceDefinitionStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<CompositeResourceDefinitionStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositeResourceDefinitionStatusConditions {
