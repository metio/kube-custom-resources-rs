...
pub struct ImportStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ImportStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ImportStatusConditions {
    ...
    pub status: ImportStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ImportStatusConditionsStatus {
    True,
    False,
    Unknown,
}
