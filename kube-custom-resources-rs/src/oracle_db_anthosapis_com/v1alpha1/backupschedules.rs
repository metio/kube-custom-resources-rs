...
pub struct BackupScheduleStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<BackupScheduleStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct BackupScheduleStatusConditions {
    ...
    pub status: BackupScheduleStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BackupScheduleStatusConditionsStatus {
    True,
    False,
    Unknown,
}
