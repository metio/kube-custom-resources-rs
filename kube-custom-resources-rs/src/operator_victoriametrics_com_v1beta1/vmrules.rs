...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/VictoriaMetrics/operator/operator.victoriametrics.com/v1beta1/vmrules.yaml
