...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/gravitational/teleport/resources.teleport.dev/v1/teleportloginrules.yaml
