...
// kopium command: kopium --docs --filename=./crd-catalog/apecloud/kubeblocks/extensions.kubeblocks.io/v1alpha1/addons.yaml --derive=Default --derive=PartialEq --smart-derive-elision
