...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/quay/container-security-operator/secscan.quay.redhat.com/v1alpha1/imagemanifestvulns.yaml
