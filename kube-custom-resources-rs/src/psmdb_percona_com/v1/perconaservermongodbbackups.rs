...
// kopium command: kopium --docs --filename=./crd-catalog/percona/percona-server-mongodb-operator/psmdb.percona.com/v1/perconaservermongodbbackups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
