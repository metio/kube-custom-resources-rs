...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubeedge/kubeedge/reliablesyncs.kubeedge.io/v1alpha1/clusterobjectsyncs.yaml
