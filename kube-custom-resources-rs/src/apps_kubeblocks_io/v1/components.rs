...
// kopium command: kopium --docs --filename=./crd-catalog/apecloud/kubeblocks/apps.kubeblocks.io/v1/components.yaml --derive=Default --derive=PartialEq --smart-derive-elision
