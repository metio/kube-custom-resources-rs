...
// kopium command: kopium --docs --filename=./crd-catalog/apecloud/kubeblocks/apps.kubeblocks.io/v1/componentdefinitions.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
pub struct ComponentDefinitionSpec {
    ...
    /// This field is immutable.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scripts2: Option<Vec<ComponentDefinitionScripts2>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentDefinitionScripts2 {
    /// The operator attempts to set default file permissions (0444).
    /// 
    /// 
    /// Must be specified as an octal value between 0000 and 0777 (inclusive),
