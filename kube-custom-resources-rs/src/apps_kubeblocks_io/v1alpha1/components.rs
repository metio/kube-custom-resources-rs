...
// kopium command: kopium --docs --filename=./crd-catalog/apecloud/kubeblocks/apps.kubeblocks.io/v1alpha1/components.yaml --derive=Default --derive=PartialEq
...
pub struct ComponentInstances {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<ComponentInstancesTolerations>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentInstancesTolerations {
...
pub struct ComponentInstancesVolumeClaimTemplates {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ComponentInstancesVolumeClaimTemplatesMetadata>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<ComponentInstancesVolumeClaimTemplatesStatus>,
}

/// Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentInstancesVolumeClaimTemplatesMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentInstancesVolumeClaimTemplatesStatus {
...
pub struct ComponentStatus {
    ...
    ///  - Creating: A special `Updating` phase with previous phase `empty`(means "") or `Creating`. - Running: Component replicas > 0 and all pod specs are latest with a Running state. - Updating: Component replicas > 0 and no failed pods. The component is being updated. - Abnormal: Component replicas > 0 but some pods have failed. The component is functional but in a fragile state. - Failed: Component replicas > 0 but some pods have failed. The component is no longer functional. - Stopping: Component replicas = 0 and pods are terminating. - Stopped: Component replicas = 0 and all pods have been deleted. - Deleting: The component is being deleted.
    #[serde(default, skip_serializing_if = "Option::is_none")]
