...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/karmada-io/karmada/policy.karmada.io/v1alpha1/clusterpropagationpolicies.yaml
