...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha2/mysqlservers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
