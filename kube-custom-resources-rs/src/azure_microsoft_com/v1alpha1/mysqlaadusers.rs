...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/mysqlaadusers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "MySQLAADUser", plural = "mysqlaadusers")]
#[kube(namespaced)]
