...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/consumergroups.yaml --derive=Default --derive=PartialEq
