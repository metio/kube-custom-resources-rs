...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/azuresqlfirewallrules.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "AzureSqlFirewallRule", plural = "azuresqlfirewallrules")]
#[kube(namespaced)]
...
pub struct AzureSqlFirewallRuleSpec {
    ...
    pub endipaddress: Option<String>,
    /// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run "make" to regenerate code after modifying this file
    pub resourcegroup: String,
    pub server: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub startipaddress: Option<String>,
}
