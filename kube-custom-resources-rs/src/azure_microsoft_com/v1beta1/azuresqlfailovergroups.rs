...
// kopium command: kopium --docs --filename=./crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1beta1/azuresqlfailovergroups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
