...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-cluster-management-io/registration-operator/operator.open-cluster-management.io/v1/clustermanagers.yaml
