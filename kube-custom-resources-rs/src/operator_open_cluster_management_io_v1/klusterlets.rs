...
// kopium command: kopium --docs --filename ./crd-catalog/open-cluster-management-io/registration-operator/operator.open-cluster-management.io/v1/klusterlets.yaml
