...
// kopium command: kopium --auto --filename ./crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1beta2/kafkamirrormaker2s.yaml
...
pub struct KafkaMirrorMaker2MetricsConfig {
    ...
    #[serde(rename = "valueFrom")]
    pub value_from: KafkaMirrorMaker2MetricsConfigValueFrom,
}
...
pub struct KafkaMirrorMaker2Status {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<KafkaMirrorMaker2StatusConditions>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub connectors: Option<Vec<KafkaMirrorMaker2StatusConnectors>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct KafkaMirrorMaker2StatusConditions {
