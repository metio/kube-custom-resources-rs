...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/projectcalico/calico/crd.projectcalico.org/v1/clusterinformations.yaml
