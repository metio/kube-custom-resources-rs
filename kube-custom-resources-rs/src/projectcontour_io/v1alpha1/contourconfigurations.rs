...
pub struct ContourConfigurationStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ContourConfigurationStatusConditions>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ContourConfigurationStatusConditions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<ContourConfigurationStatusConditionsErrors>>,
    ...
    pub status: ContourConfigurationStatusConditionsStatus,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub warnings: Option<Vec<ContourConfigurationStatusConditionsWarnings>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ContourConfigurationStatusConditionsErrors {
    /// Message is a human readable message indicating details about the transition.
    /// This may be an empty string.
    pub message: String,
    /// Reason contains a programmatic identifier indicating the reason for the condition's last transition.
    ...
    pub reason: String,
    /// Status of the condition, one of True, False, Unknown.
    pub status: ContourConfigurationStatusConditionsErrorsStatus,
    /// Type of condition in `CamelCase` or in `foo.example.com/CamelCase`.
...
/// and should be removed when they are not relevant.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ContourConfigurationStatusConditionsErrorsStatus {
    True,
    False,
    Unknown,
}
...
/// `MultipleReasons` if there is more than one entry.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ContourConfigurationStatusConditionsStatus {
    True,
    False,
    Unknown,
}
...
/// and should be removed when they are not relevant.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ContourConfigurationStatusConditionsWarnings {
    /// Message is a human readable message indicating details about the transition.
    /// This may be an empty string.
    pub message: String,
    /// Reason contains a programmatic identifier indicating the reason for the condition's last transition.
    ...
    pub reason: String,
    /// Status of the condition, one of True, False, Unknown.
    pub status: ContourConfigurationStatusConditionsWarningsStatus,
    /// Type of condition in `CamelCase` or in `foo.example.com/CamelCase`.
    /// This must be in abnormal-true polarity, that is, `ErrorFound` or `controller.io/ErrorFound`.
    /// The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)
    #[serde(rename = "type")]
...
/// and should be removed when they are not relevant.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ContourConfigurationStatusConditionsWarningsStatus {
    True,
    False,
    Unknown,
}
