...
pub struct ContourDeploymentRuntimeSettingsGateway {
    ...
    pub gateway_ref: Option<ContourDeploymentRuntimeSettingsGatewayGatewayRef>,
}
...
pub struct ContourDeploymentStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ContourDeploymentStatusConditions>>,
}
...
/// 	}
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ContourDeploymentStatusConditions {
    ...
    pub status: ContourDeploymentStatusConditionsStatus,
...
/// 	}
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ContourDeploymentStatusConditionsStatus {
    True,
    False,
    Unknown,
}
