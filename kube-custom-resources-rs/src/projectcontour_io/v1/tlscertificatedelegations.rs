...
// kopium command: kopium --docs --filename=./crd-catalog/projectcontour/contour/projectcontour.io/v1/tlscertificatedelegations.yaml --derive=Default --derive=PartialEq --smart-derive-elision
