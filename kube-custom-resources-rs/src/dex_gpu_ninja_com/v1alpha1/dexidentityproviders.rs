...
pub struct DexIdentityProviderVolumeClaimTemplatesStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<DexIdentityProviderVolumeClaimTemplatesStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct DexIdentityProviderVolumeClaimTemplatesStatusConditions {
...
pub struct DexIdentityProviderStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<DexIdentityProviderStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct DexIdentityProviderStatusConditions {
    ...
    pub status: DexIdentityProviderStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum DexIdentityProviderStatusConditionsStatus {
    True,
    False,
    Unknown,
}
