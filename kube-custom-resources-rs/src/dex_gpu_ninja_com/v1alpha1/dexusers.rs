...
// kopium command: kopium --docs --filename=./crd-catalog/gpu-ninja/dex-operator/dex.gpu-ninja.com/v1alpha1/dexusers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
