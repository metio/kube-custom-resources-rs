...
// kopium command: kopium --auto --filename ./crd-catalog/solo-io/gloo/enterprise.gloo.solo.io/v1/authconfigs.yaml
...
pub struct AuthConfigSpec {
    ...
    pub configs: Option<Vec<AuthConfigConfigs>>,
...
pub struct AuthConfigConfigsHmacAuth {
    ...
    pub secret_refs: Option<AuthConfigConfigsHmacAuthSecretRefs>,
}
...
pub struct AuthConfigConfigsHmacAuthSecretRefs {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretRefs")]
    pub secret_refs: Option<Vec<AuthConfigConfigsHmacAuthSecretRefsSecretRefs>>,
}
...
pub struct AuthConfigConfigsOauth {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appUrl")]
...
pub struct AuthConfigConfigsOauth2AccessTokenValidationJwtLocalJwks {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inlineString")]
...
pub struct AuthConfigConfigsOauth2OidcAuthorizationCodeClientAuthenticationPrivateKeyJwt {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "signingKeyRef")]
    pub signing_key_ref: Option<AuthConfigConfigsOauth2OidcAuthorizationCodeClientAuthenticationPrivateKeyJwtSigningKeyRef>,
...
pub struct AuthConfigConfigsOauth2OidcAuthorizationCodeJwksCacheRefreshPolicy {
    ...
    pub max_idp_req_per_polling_interval: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct AuthConfigNamespacedStatuses {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub statuses: Option<BTreeMap<String, AuthConfigNamespacedStatusesStatuses>>,
}
