...
// kopium command: kopium --docs --filename=./crd-catalog/3scale/apicast-operator/apps.3scale.net/v1alpha1/apicasts.yaml --derive=Default --derive=PartialEq --smart-derive-elision
