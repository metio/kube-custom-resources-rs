...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/machineconfigurations.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "MachineConfiguration", plural = "machineconfigurations")]
#[kube(status = "MachineConfigurationStatus")]
#[kube(schema = "disabled")]
pub struct MachineConfigurationSpec {
    ...
    pub log_level: Option<MachineConfigurationLogLevel>,
    ...
    pub operator_log_level: Option<MachineConfigurationOperatorLogLevel>,
...
pub enum MachineConfigurationLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
/// spec is the specification of the desired behavior of the Machine Config Operator
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MachineConfigurationOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct MachineConfigurationStatus {
    /// conditions is a list of conditions and their status
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<MachineConfigurationStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<MachineConfigurationStatusGenerations>>,
    ...
    pub node_statuses: Option<Vec<MachineConfigurationStatusNodeStatuses>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MachineConfigurationStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MachineConfigurationStatusGenerations {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MachineConfigurationStatusNodeStatuses {
