...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/cloudcredentials.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "CloudCredential", plural = "cloudcredentials")]
#[kube(status = "CloudCredentialStatus")]
#[kube(schema = "disabled")]
pub struct CloudCredentialSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsMode")]
    pub credentials_mode: Option<CloudCredentialCredentialsMode>,
    ...
    pub log_level: Option<CloudCredentialLogLevel>,
    ...
    pub operator_log_level: Option<CloudCredentialOperatorLogLevel>,
...
pub enum CloudCredentialCredentialsMode {
    #[serde(rename = "")]
    KopiumEmpty,
    Manual,
    Mint,
...
/// CloudCredentialSpec is the specification of the desired behavior of the cloud-credential-operator.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CloudCredentialLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
/// CloudCredentialSpec is the specification of the desired behavior of the cloud-credential-operator.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CloudCredentialOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct CloudCredentialStatus {
    ...
    pub conditions: Option<Vec<CloudCredentialStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<CloudCredentialStatusGenerations>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CloudCredentialStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CloudCredentialStatusGenerations {
