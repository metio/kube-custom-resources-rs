...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/authentications.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "Authentication", plural = "authentications")]
...
pub struct AuthenticationSpec {
    ...
    pub log_level: Option<AuthenticationLogLevel>,
    ...
    pub operator_log_level: Option<AuthenticationOperatorLogLevel>,
...
pub enum AuthenticationLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AuthenticationOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct AuthenticationStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<AuthenticationStatusGenerations>>,
    /// OAuthAPIServer holds status specific only to oauth-apiserver
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "oauthAPIServer")]
    pub oauth_api_server: Option<AuthenticationStatusOauthApiServer>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthenticationStatusGenerations {
...
/// OAuthAPIServer holds status specific only to oauth-apiserver
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthenticationStatusOauthApiServer {
