...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/kubeschedulers.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "KubeScheduler", plural = "kubeschedulers")]
#[kube(status = "KubeSchedulerStatus")]
#[kube(schema = "disabled")]
pub struct KubeSchedulerSpec {
    ...
    pub log_level: Option<KubeSchedulerLogLevel>,
    ...
    pub operator_log_level: Option<KubeSchedulerOperatorLogLevel>,
...
pub enum KubeSchedulerLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
/// spec is the specification of the desired behavior of the Kubernetes Scheduler
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KubeSchedulerOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct KubeSchedulerStatus {
    /// conditions is a list of conditions and their status
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<KubeSchedulerStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<KubeSchedulerStatusGenerations>>,
    ...
    pub node_statuses: Option<Vec<KubeSchedulerStatusNodeStatuses>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeSchedulerStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeSchedulerStatusGenerations {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeSchedulerStatusNodeStatuses {
