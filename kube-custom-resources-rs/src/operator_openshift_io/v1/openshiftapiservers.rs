...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/openshiftapiservers.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "OpenShiftAPIServer", plural = "openshiftapiservers")]
#[kube(status = "OpenShiftAPIServerStatus")]
#[kube(schema = "disabled")]
pub struct OpenShiftAPIServerSpec {
    ...
    pub log_level: Option<OpenShiftAPIServerLogLevel>,
    ...
    pub operator_log_level: Option<OpenShiftAPIServerOperatorLogLevel>,
...
pub enum OpenShiftAPIServerLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
/// spec is the specification of the desired behavior of the OpenShift API Server.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum OpenShiftAPIServerOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct OpenShiftAPIServerStatus {
    /// conditions is a list of conditions and their status
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<OpenShiftAPIServerStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<OpenShiftAPIServerStatusGenerations>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpenShiftAPIServerStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpenShiftAPIServerStatusGenerations {
