...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/kubeapiservers.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "KubeAPIServer", plural = "kubeapiservers")]
#[kube(status = "KubeAPIServerStatus")]
#[kube(schema = "disabled")]
pub struct KubeAPIServerSpec {
    ...
    pub log_level: Option<KubeAPIServerLogLevel>,
    ...
    pub operator_log_level: Option<KubeAPIServerOperatorLogLevel>,
...
pub enum KubeAPIServerLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
/// spec is the specification of the desired behavior of the Kubernetes API Server
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KubeAPIServerOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct KubeAPIServerStatus {
    /// conditions is a list of conditions and their status
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<KubeAPIServerStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<KubeAPIServerStatusGenerations>>,
    ...
    pub node_statuses: Option<Vec<KubeAPIServerStatusNodeStatuses>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccountIssuers")]
    pub service_account_issuers: Option<Vec<KubeAPIServerStatusServiceAccountIssuers>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeAPIServerStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeAPIServerStatusGenerations {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeAPIServerStatusNodeStatuses {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubeAPIServerStatusServiceAccountIssuers {
