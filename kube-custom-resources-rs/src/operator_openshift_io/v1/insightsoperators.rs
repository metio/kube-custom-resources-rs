...
pub struct InsightsOperatorStatus {
    ...
    pub conditions: Option<Vec<InsightsOperatorStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct InsightsOperatorStatusConditions {
...
pub struct InsightsOperatorStatusGatherStatusGatherers {
    ...
    pub conditions: Vec<InsightsOperatorStatusGatherStatusGatherersConditions>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct InsightsOperatorStatusGatherStatusGatherersConditions {
    ...
    pub status: InsightsOperatorStatusGatherStatusGatherersConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InsightsOperatorStatusGatherStatusGatherersConditionsStatus {
    True,
    False,
    Unknown,
}
