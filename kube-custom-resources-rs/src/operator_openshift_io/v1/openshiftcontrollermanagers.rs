...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/api/operator.openshift.io/v1/openshiftcontrollermanagers.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.openshift.io", version = "v1", kind = "OpenShiftControllerManager", plural = "openshiftcontrollermanagers")]
#[kube(status = "OpenShiftControllerManagerStatus")]
#[kube(schema = "disabled")]
pub struct OpenShiftControllerManagerSpec {
    ...
    pub log_level: Option<OpenShiftControllerManagerLogLevel>,
    ...
    pub operator_log_level: Option<OpenShiftControllerManagerOperatorLogLevel>,
...
pub enum OpenShiftControllerManagerLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum OpenShiftControllerManagerOperatorLogLevel {
    #[serde(rename = "")]
    KopiumEmpty,
    Normal,
    Debug,
...
pub struct OpenShiftControllerManagerStatus {
    /// conditions is a list of conditions and their status
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<OpenShiftControllerManagerStatusConditions>>,
    /// generations are used to determine when an item needs to be reconciled or has changed in a way that needs a reaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generations: Option<Vec<OpenShiftControllerManagerStatusGenerations>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpenShiftControllerManagerStatusConditions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpenShiftControllerManagerStatusGenerations {
