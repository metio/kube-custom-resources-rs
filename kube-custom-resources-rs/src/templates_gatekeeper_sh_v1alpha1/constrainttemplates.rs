...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-policy-agent/gatekeeper/templates.gatekeeper.sh/v1alpha1/constrainttemplates.yaml
