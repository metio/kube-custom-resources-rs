...
// kopium command: kopium --docs --filename=./crd-catalog/kubernetes-sigs/cluster-api-operator/operator.cluster.x-k8s.io/v1alpha1/controlplaneproviders.yaml --derive=Default --derive=PartialEq
...
#[kube(group = "operator.cluster.x-k8s.io", version = "v1alpha1", kind = "ControlPlaneProvider", plural = "controlplaneproviders")]
#[kube(namespaced)]
...
pub struct ControlPlaneProviderDeploymentContainers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<ControlPlaneProviderDeploymentContainersImage>,
...
/// Container Image Name
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ControlPlaneProviderDeploymentContainersImage {
...
pub struct ControlPlaneProviderStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ControlPlaneProviderStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ControlPlaneProviderStatusConditions {
