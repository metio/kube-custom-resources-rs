...
// kopium command: kopium --docs --filename=./crd-catalog/volcano-sh/volcano/nodeinfo.volcano.sh/v1alpha1/numatopologies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
