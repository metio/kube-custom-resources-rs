...
// kopium command: kopium --docs --filename=./crd-catalog/open-cluster-management-io/registration-operator/operator.open-cluster-management.io/v1/clustermanagers.yaml --derive=PartialEq
...
pub struct ClusterManagerStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ClusterManagerStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterManagerStatusConditions {
    ...
    pub status: ClusterManagerStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterManagerStatusConditionsStatus {
    True,
    False,
    Unknown,
}
