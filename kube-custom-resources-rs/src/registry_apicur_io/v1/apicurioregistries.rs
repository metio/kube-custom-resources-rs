...
// kopium command: kopium --docs --filename=./crd-catalog/Apicurio/apicurio-registry-operator/registry.apicur.io/v1/apicurioregistries.yaml --derive=Default --derive=PartialEq --smart-derive-elision
