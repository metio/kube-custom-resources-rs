...
// kopium command: kopium --docs --filename=./crd-catalog/cilium/cilium/cilium.io/v2/ciliumegressgatewaypolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
