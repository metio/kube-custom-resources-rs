...
// kopium command: kopium --docs --filename=./crd-catalog/cilium/cilium/cilium.io/v2/ciliumlocalredirectpolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
