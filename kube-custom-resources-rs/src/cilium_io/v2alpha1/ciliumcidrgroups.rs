...
// kopium command: kopium --docs --filename=./crd-catalog/cilium/cilium/cilium.io/v2alpha1/ciliumcidrgroups.yaml --derive=Default --derive=PartialEq --smart-derive-elision
