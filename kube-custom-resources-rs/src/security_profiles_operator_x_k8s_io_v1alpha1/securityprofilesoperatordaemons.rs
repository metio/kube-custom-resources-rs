...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/security-profiles-operator/security-profiles-operator.x-k8s.io/v1alpha1/securityprofilesoperatordaemons.yaml
...
pub struct SecurityProfilesOperatorDaemonStatusConditions {
    ...
    pub status: SecurityProfilesOperatorDaemonStatusConditionsStatus,
...
pub enum SecurityProfilesOperatorDaemonStatusConditionsStatus {
    True,
    False,
    Unknown,
}
