...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/hive/hiveinternal.openshift.io/v1alpha1/clustersyncs.yaml --derive=Default --derive=PartialEq --smart-derive-elision
