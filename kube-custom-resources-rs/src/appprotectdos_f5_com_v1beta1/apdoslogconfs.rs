...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/nginxinc/kubernetes-ingress/appprotectdos.f5.com/v1beta1/apdoslogconfs.yaml
