...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/karmada-io/karmada/work.karmada.io/v1alpha1/clusterresourcebindings.yaml
