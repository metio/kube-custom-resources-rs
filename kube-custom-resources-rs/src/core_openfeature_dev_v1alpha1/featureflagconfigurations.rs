...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/open-feature/open-feature-operator/core.openfeature.dev/v1alpha1/featureflagconfigurations.yaml
