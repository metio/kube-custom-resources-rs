...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-feature/open-feature-operator/core.openfeature.dev/v1alpha1/featureflagconfigurations.yaml
