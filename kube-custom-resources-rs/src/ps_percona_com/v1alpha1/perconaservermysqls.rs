...
// kopium command: kopium --docs --filename=./crd-catalog/percona/percona-server-mysql-operator/ps.percona.com/v1alpha1/perconaservermysqls.yaml --derive=PartialEq
...
pub struct PerconaServerMySQLStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PerconaServerMySQLStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct PerconaServerMySQLStatusConditions {
    ...
    pub reason: String,
    pub status: PerconaServerMySQLStatusConditionsStatus,
    #[serde(rename = "type")]
    pub r#type: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaServerMySQLStatusConditionsStatus {
    True,
    False,
    Unknown,
}
