...
// kopium command: kopium --docs --filename=./crd-catalog/fluent/fluent-operator/fluentbit.fluent.io/v1alpha2/clusterfilters.yaml --derive=Default --derive=PartialEq
...
pub struct ClusterFilterFiltersLua {
    ...
    pub script: ClusterFilterFiltersLuaScript,
