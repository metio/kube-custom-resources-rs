...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kiegroup/kogito-operator/app.kiegroup.org/v1beta1/kogitosupportingservices.yaml
