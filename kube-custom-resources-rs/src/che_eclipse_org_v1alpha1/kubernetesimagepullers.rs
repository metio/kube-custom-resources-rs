...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/che-incubator/kubernetes-image-puller-operator/che.eclipse.org/v1alpha1/kubernetesimagepullers.yaml
