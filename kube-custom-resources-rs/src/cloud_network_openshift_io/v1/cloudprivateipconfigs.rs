...
pub struct CloudPrivateIPConfigStatus {
    ...
    pub conditions: Vec<CloudPrivateIPConfigStatusConditions>,
    /// node is the node name, as specified by the Kubernetes field: node.metadata.name
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub node: Option<String>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct CloudPrivateIPConfigStatusConditions {
    ...
    pub status: CloudPrivateIPConfigStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CloudPrivateIPConfigStatusConditionsStatus {
    True,
    False,
    Unknown,
}
