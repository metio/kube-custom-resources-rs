...
// kopium command: kopium --docs --filename=./crd-catalog/metacontroller/metacontroller/metacontroller.k8s.io/v1alpha1/compositecontrollers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
