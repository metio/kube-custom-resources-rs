...
// kopium command: kopium --docs --filename=./crd-catalog/metacontroller/metacontroller/metacontroller.k8s.io/v1alpha1/decoratorcontrollers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
