...
// kopium command: kopium --docs --filename=./crd-catalog/GoogleCloudPlatform/gke-networking-recipes/networking.gke.io/v1/lbpolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
