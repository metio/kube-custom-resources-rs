...
// kopium command: kopium --docs --filename=./crd-catalog/tigera/operator/operator.tigera.io/v1/tlsterminatedroutes.yaml --derive=Default --derive=PartialEq --smart-derive-elision
