...
// kopium command: kopium --auto --filename ./crd-catalog/solo-io/gloo/gloo.solo.io/v1/settings.yaml
...
pub struct SettingsSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "graphqlOptions")]
    pub graphql_options: Option<SettingsGraphqlOptions>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SettingsConsoleOptions {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiExplorerEnabled")]
...
pub struct SettingsDiscoveryFdsOptions {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "graphqlEnabled")]
...
pub struct SettingsExtensions {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub configs: Option<BTreeMap<String, SettingsExtensionsConfigs>>,
}
...
pub struct SettingsGlooInvalidConfigPolicy {
    ...
    pub invalid_route_response_code: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replaceInvalidRoutes")]
    pub replace_invalid_routes: Option<bool>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct SettingsGraphqlOptions {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "schemaChangeValidationOptions")]
    pub schema_change_validation_options: Option<SettingsGraphqlOptionsSchemaChangeValidationOptions>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct SettingsGraphqlOptionsSchemaChangeValidationOptions {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "processingRules")]
    pub processing_rules: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rejectBreakingChanges")]
    pub reject_breaking_changes: Option<bool>,
}
...
pub struct SettingsNamespacedStatuses {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub statuses: Option<BTreeMap<String, SettingsNamespacedStatusesStatuses>>,
}
...
pub struct SettingsRatelimit {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub descriptors: Option<Vec<SettingsRatelimitDescriptors>>,
