...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/aws-controllers-k8s/apigatewayv2-controller/apigatewayv2.services.k8s.aws/v1alpha1/stages.yaml
...
pub struct StageStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<StageStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct StageStatusConditions {
