...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/linki/cloudformation-operator/cloudformation.linki.space/v1alpha1/stacks.yaml
