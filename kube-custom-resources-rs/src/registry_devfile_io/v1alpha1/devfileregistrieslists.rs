...
// kopium command: kopium --docs --filename=./crd-catalog/devfile/registry-operator/registry.devfile.io/v1alpha1/devfileregistrieslists.yaml --derive=Default --derive=PartialEq --smart-derive-elision
