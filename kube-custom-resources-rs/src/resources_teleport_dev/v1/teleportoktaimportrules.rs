...
// kopium command: kopium --docs --filename=./crd-catalog/gravitational/teleport/resources.teleport.dev/v1/teleportoktaimportrules.yaml --derive=Default --derive=PartialEq --smart-derive-elision
