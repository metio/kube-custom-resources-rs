...
// kopium command: kopium --docs --filename=./crd-catalog/gravitational/teleport/resources.teleport.dev/v2/teleportusers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
