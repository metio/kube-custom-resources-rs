...
// kopium command: kopium --docs --filename=./crd-catalog/leaksignal/leaksignal-operator/leaksignal.com/v1/cluster-leaksignal-istios.yaml --derive=Default --derive=PartialEq --smart-derive-elision
