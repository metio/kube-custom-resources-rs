...
// kopium command: kopium --auto --filename ./crd-catalog/solo-io/gloo/gateway.solo.io/v1/httpgateways.yaml
...
pub struct MatchableHttpGatewayHttpGatewayOptionsExtensions {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub configs: Option<BTreeMap<String, MatchableHttpGatewayHttpGatewayOptionsExtensionsConfigs>>,
}
...
pub struct MatchableHttpGatewayNamespacedStatuses {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub statuses: Option<BTreeMap<String, MatchableHttpGatewayNamespacedStatusesStatuses>>,
}
