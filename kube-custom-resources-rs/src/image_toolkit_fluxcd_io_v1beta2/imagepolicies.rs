...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluxcd/image-reflector-controller/image.toolkit.fluxcd.io/v1beta2/imagepolicies.yaml
