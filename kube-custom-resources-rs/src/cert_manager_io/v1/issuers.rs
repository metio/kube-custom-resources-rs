...
// kopium command: kopium --docs --filename=./crd-catalog/cert-manager/cert-manager/cert-manager.io/v1/issuers.yaml --derive=PartialEq
...
pub struct IssuerStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<IssuerStatusConditions>>,
}
...
pub struct IssuerStatusConditions {
    ...
    pub status: IssuerStatusConditionsStatus,
