...
// kopium command: kopium --docs --filename=./crd-catalog/cert-manager/cert-manager/cert-manager.io/v1/clusterissuers.yaml --derive=Default --derive=PartialEq --smart-derive-elision
