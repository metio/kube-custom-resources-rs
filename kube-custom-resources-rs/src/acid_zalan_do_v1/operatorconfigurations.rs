...
// kopium command: kopium --auto --filename ./crd-catalog/zalando/postgres-operator/acid.zalan.do/v1/operatorconfigurations.yaml
...
pub struct OperatorConfigurationConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sidecars: Option<Vec<OperatorConfigurationConfigurationSidecars>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
