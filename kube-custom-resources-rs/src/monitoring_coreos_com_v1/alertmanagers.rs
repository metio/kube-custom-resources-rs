...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/prometheus-operator/prometheus-operator/monitoring.coreos.com/v1/alertmanagers.yaml
