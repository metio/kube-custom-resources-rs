...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/prometheus-operator/prometheus-operator/monitoring.coreos.com/v1/prometheuses.yaml
...
pub struct PrometheusRemoteWriteAzureAd {
    ...
    pub managed_identity: PrometheusRemoteWriteAzureAdManagedIdentity,
}
