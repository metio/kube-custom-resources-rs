...
// kopium command: kopium --docs --filename=./crd-catalog/nginxinc/nginx-kubernetes-gateway/gateway.nginx.org/v1alpha2/observabilitypolicies.yaml --derive=Default --derive=PartialEq --smart-derive-elision
