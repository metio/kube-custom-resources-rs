...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/mattermost/mattermost-operator/mattermost.com/v1alpha1/clusterinstallations.yaml
