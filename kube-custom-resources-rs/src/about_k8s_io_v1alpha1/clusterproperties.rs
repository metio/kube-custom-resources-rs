...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/about-api/about.k8s.io/v1alpha1/clusterproperties.yaml
