...
pub struct PerconaXtraDBClusterBackupStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PerconaXtraDBClusterBackupStatusConditions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct PerconaXtraDBClusterBackupStatusConditions {
    ...
    pub reason: String,
    pub status: PerconaXtraDBClusterBackupStatusConditionsStatus,
    #[serde(rename = "type")]
    pub r#type: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaXtraDBClusterBackupStatusConditionsStatus {
    True,
    False,
    Unknown,
}
