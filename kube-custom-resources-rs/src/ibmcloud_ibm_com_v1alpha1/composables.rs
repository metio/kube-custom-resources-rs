...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/composable-operator/composable/ibmcloud.ibm.com/v1alpha1/composables.yaml
