...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/hive/hive.openshift.io/v1/selectorsyncidentityproviders.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "hive.openshift.io", version = "v1", kind = "SelectorSyncIdentityProvider", plural = "selectorsyncidentityproviders")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct SelectorSyncIdentityProviderSpec {
    ...
    pub cluster_deployment_selector: Option<SelectorSyncIdentityProviderClusterDeploymentSelector>,
    /// IdentityProviders is an ordered list of ways for a user to identify themselves
    #[serde(rename = "identityProviders")]
    pub identity_providers: Vec<SelectorSyncIdentityProviderIdentityProviders>,
}

/// ClusterDeploymentSelector is a LabelSelector indicating which clusters the SelectorIdentityProvider applies to in any namespace.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderClusterDeploymentSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<SelectorSyncIdentityProviderClusterDeploymentSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderClusterDeploymentSelectorMatchExpressions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProviders {
    /// basicAuth contains configuration options for the BasicAuth IdP
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "basicAuth")]
    pub basic_auth: Option<SelectorSyncIdentityProviderIdentityProvidersBasicAuth>,
    /// github enables user authentication using GitHub credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub github: Option<SelectorSyncIdentityProviderIdentityProvidersGithub>,
    /// gitlab enables user authentication using GitLab credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gitlab: Option<SelectorSyncIdentityProviderIdentityProvidersGitlab>,
    /// google enables user authentication using Google credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub google: Option<SelectorSyncIdentityProviderIdentityProvidersGoogle>,
    /// htpasswd enables user authentication using an HTPasswd file to validate credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub htpasswd: Option<SelectorSyncIdentityProviderIdentityProvidersHtpasswd>,
    /// keystone enables user authentication using keystone password credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keystone: Option<SelectorSyncIdentityProviderIdentityProvidersKeystone>,
    /// ldap enables user authentication using LDAP credentials
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ldap: Option<SelectorSyncIdentityProviderIdentityProvidersLdap>,
    ...
    pub open_id: Option<SelectorSyncIdentityProviderIdentityProvidersOpenId>,
    ...
    pub request_header: Option<SelectorSyncIdentityProviderIdentityProvidersRequestHeader>,
...
/// basicAuth contains configuration options for the BasicAuth IdP
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersBasicAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersBasicAuthCa>,
    ...
    pub tls_client_cert: Option<SelectorSyncIdentityProviderIdentityProvidersBasicAuthTlsClientCert>,
    ...
    pub tls_client_key: Option<SelectorSyncIdentityProviderIdentityProvidersBasicAuthTlsClientKey>,
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersBasicAuthCa {
...
/// tlsClientCert is an optional reference to a secret by name that contains the PEM-encoded TLS client certificate to present when connecting to the server. The key "tls.crt" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersBasicAuthTlsClientCert {
...
/// tlsClientKey is an optional reference to a secret by name that contains the PEM-encoded TLS private key for the client certificate referenced in tlsClientCert. The key "tls.key" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersBasicAuthTlsClientKey {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// github enables user authentication using GitHub credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGithub {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersGithubCa>,
    ...
    pub client_secret: Option<SelectorSyncIdentityProviderIdentityProvidersGithubClientSecret>,
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. This can only be configured when hostname is set to a non-empty value. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGithubCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
/// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGithubClientSecret {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// gitlab enables user authentication using GitLab credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGitlab {
    /// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersGitlabCa>,
    /// clientID is the oauth client ID
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientID")]
    pub client_id: Option<String>,
    /// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSecret")]
    pub client_secret: Option<SelectorSyncIdentityProviderIdentityProvidersGitlabClientSecret>,
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGitlabCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
/// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGitlabClientSecret {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// google enables user authentication using Google credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGoogle {
    /// clientID is the oauth client ID
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientID")]
    pub client_id: Option<String>,
    /// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSecret")]
    pub client_secret: Option<SelectorSyncIdentityProviderIdentityProvidersGoogleClientSecret>,
...
/// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersGoogleClientSecret {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// htpasswd enables user authentication using an HTPasswd file to validate credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersHtpasswd {
    ...
    pub file_data: Option<SelectorSyncIdentityProviderIdentityProvidersHtpasswdFileData>,
}

/// fileData is a required reference to a secret by name containing the data to use as the htpasswd file. The key "htpasswd" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. If the specified htpasswd data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersHtpasswdFileData {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// keystone enables user authentication using keystone password credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersKeystone {
    /// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersKeystoneCa>,
    /// domainName is required for keystone v3
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainName")]
    pub domain_name: Option<String>,
    /// tlsClientCert is an optional reference to a secret by name that contains the PEM-encoded TLS client certificate to present when connecting to the server. The key "tls.crt" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tlsClientCert")]
    pub tls_client_cert: Option<SelectorSyncIdentityProviderIdentityProvidersKeystoneTlsClientCert>,
    /// tlsClientKey is an optional reference to a secret by name that contains the PEM-encoded TLS private key for the client certificate referenced in tlsClientCert. The key "tls.key" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tlsClientKey")]
    pub tls_client_key: Option<SelectorSyncIdentityProviderIdentityProvidersKeystoneTlsClientKey>,
    /// url is the remote URL to connect to
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersKeystoneCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
/// tlsClientCert is an optional reference to a secret by name that contains the PEM-encoded TLS client certificate to present when connecting to the server. The key "tls.crt" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersKeystoneTlsClientCert {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// tlsClientKey is an optional reference to a secret by name that contains the PEM-encoded TLS private key for the client certificate referenced in tlsClientCert. The key "tls.key" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. If the specified certificate data is not valid, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersKeystoneTlsClientKey {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// ldap enables user authentication using LDAP credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersLdap {
    /// attributes maps LDAP attributes to identities
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attributes: Option<SelectorSyncIdentityProviderIdentityProvidersLdapAttributes>,
    ...
    pub bind_password: Option<SelectorSyncIdentityProviderIdentityProvidersLdapBindPassword>,
    /// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersLdapCa>,
...
/// attributes maps LDAP attributes to identities
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersLdapAttributes {
...
/// bindPassword is an optional reference to a secret by name containing a password to bind with during the search phase. The key "bindPassword" is used to locate the data. If specified and the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersLdapBindPassword {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersLdapCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
/// openID enables user authentication using OpenID credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersOpenId {
    /// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersOpenIdCa>,
    /// claims mappings
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<SelectorSyncIdentityProviderIdentityProvidersOpenIdClaims>,
    /// clientID is the oauth client ID
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientID")]
    pub client_id: Option<String>,
    /// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSecret")]
    pub client_secret: Option<SelectorSyncIdentityProviderIdentityProvidersOpenIdClientSecret>,
...
/// ca is an optional reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. The key "ca.crt" is used to locate the data. If specified and the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. If empty, the default system roots are used. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersOpenIdCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
/// claims mappings
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersOpenIdClaims {
...
/// clientSecret is a required reference to the secret by name containing the oauth client secret. The key "clientSecret" is used to locate the data. If the secret or expected key is not found, the identity provider is not honored. The namespace for this secret is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersOpenIdClientSecret {
    /// name is the metadata.name of the referenced secret
    pub name: String,
}
...
/// requestHeader enables user authentication using request header credentials
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersRequestHeader {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<SelectorSyncIdentityProviderIdentityProvidersRequestHeaderCa>,
...
/// ca is a required reference to a config map by name containing the PEM-encoded CA bundle. It is used as a trust anchor to validate the TLS certificate presented by the remote server. Specifically, it allows verification of incoming requests to prevent header spoofing. The key "ca.crt" is used to locate the data. If the config map or expected key is not found, the identity provider is not honored. If the specified ca data is not valid, the identity provider is not honored. The namespace for this config map is openshift-config.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderIdentityProvidersRequestHeaderCa {
    /// name is the metadata.name of the referenced config map
    pub name: String,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SelectorSyncIdentityProviderStatus {
}
