...
// kopium command: kopium --docs --filename=./crd-catalog/openshift/hive/hive.openshift.io/v1/dnszones.yaml --derive=Default --derive=PartialEq --smart-derive-elision
