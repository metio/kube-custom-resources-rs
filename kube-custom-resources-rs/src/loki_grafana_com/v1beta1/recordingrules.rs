...
// kopium command: kopium --docs --filename=./crd-catalog/grafana/loki/loki.grafana.com/v1beta1/recordingrules.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
#[kube(group = "loki.grafana.com", version = "v1beta1", kind = "RecordingRule", plural = "recordingrules")]
#[kube(namespaced)]
