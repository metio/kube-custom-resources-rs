...
// kopium command: kopium --docs --filename=./crd-catalog/grafana/loki/loki.grafana.com/v1/alertingrules.yaml --derive=Default --derive=PartialEq --smart-derive-elision
