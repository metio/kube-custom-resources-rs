...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes/autoscaler/autoscaling.k8s.io/v1beta2/verticalpodautoscalers.yaml
