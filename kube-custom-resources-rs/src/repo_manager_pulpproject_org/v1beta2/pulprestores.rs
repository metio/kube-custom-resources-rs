...
// kopium command: kopium --docs --filename=./crd-catalog/pulp/pulp-operator/repo-manager.pulpproject.org/v1beta2/pulprestores.yaml --derive=Default --derive=PartialEq --smart-derive-elision
