...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/crossplane/crossplane/apiextensions.crossplane.io/v1/compositeresourcedefinitions.yaml
