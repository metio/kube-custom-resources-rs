...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/change-metrics/monocle-operator/monocle.monocle.change-metrics.io/v1alpha1/monocles.yaml
