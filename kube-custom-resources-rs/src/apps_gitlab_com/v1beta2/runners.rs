...
// kopium command: kopium --docs --filename=./crd-catalog/gitlab-org/gl-openshift/gitlab-runner-operator/apps.gitlab.com/v1beta2/runners.yaml --derive=Default --derive=PartialEq
...
/// KubernetesPodSpec represents the structure expected when adding a custom PodSpec to configure the Pod running the GitLab Runner Manager
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
...
/// Most recently observed status of the GitLab Runner. It is read-only to the user
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
