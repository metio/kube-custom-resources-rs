...
// kopium command: kopium --docs --filename=./crd-catalog/tungstenfabric/tf-operator/tf.tungsten.io/v1alpha1/queryengine.yaml --derive=Default --derive=PartialEq --smart-derive-elision
