...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/clastix/capsule/capsule.clastix.io/v1alpha1/capsuleconfigurations.yaml
