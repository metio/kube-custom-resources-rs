...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/emissary-ingress/emissary/getambassador.io/v3alpha1/ratelimitservices.yaml
