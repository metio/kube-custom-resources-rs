...
// kopium command: kopium --docs --filename=./crd-catalog/rook/rook/objectbucket.io/v1alpha1/objectbucketclaims.yaml --derive=Default --derive=PartialEq --smart-derive-elision
