...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/open-policy-agent/gatekeeper/expansion.gatekeeper.sh/v1beta1/expansiontemplate.yaml
