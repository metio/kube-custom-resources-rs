...
// kopium command: kopium --docs --filename ./crd-catalog/redhat-developer/service-binding-operator/servicebinding.io/v1alpha3/clusterworkloadresourcemappings.yaml
