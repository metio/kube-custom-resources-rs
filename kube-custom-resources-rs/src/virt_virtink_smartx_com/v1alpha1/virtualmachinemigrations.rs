...
// kopium command: kopium --docs --filename=./crd-catalog/smartxworks/virtink/virt.virtink.smartx.com/v1alpha1/virtualmachinemigrations.yaml --derive=Default --derive=PartialEq --smart-derive-elision
