...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/metal3-io/baremetal-operator/metal3.io/v1alpha1/bmceventsubscriptions.yaml
