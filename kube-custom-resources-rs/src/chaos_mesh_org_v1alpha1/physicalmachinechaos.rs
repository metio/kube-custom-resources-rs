...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/chaos-mesh/chaos-mesh/chaos-mesh.org/v1alpha1/physicalmachinechaos.yaml
