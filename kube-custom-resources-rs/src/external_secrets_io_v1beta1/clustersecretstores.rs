...
// kopium command: kopium --derive PartialEq --docs --filename ./crd-catalog/external-secrets/external-secrets/external-secrets.io/v1beta1/clustersecretstores.yaml
