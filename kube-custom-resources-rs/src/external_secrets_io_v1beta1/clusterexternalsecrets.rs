...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/external-secrets/external-secrets/external-secrets.io/v1beta1/clusterexternalsecrets.yaml
