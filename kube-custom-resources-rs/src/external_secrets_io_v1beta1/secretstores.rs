...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/external-secrets/external-secrets/external-secrets.io/v1beta1/secretstores.yaml
...
#[kube(group = "external-secrets.io", version = "v1beta1", kind = "SecretStore", plural = "secretstores")]
#[kube(namespaced)]
...
pub struct SecretStoreStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<SecretStoreStatusConditions>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreStatusConditions {
