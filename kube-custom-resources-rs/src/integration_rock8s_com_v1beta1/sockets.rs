...
// kopium command: kopium --docs --filename=./crd-catalog/clayrisser/integration-operator/integration.rock8s.com/v1beta1/sockets.yaml --derive=Default --derive=PartialEq
