...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/fluxcd/image-automation-controller/image.toolkit.fluxcd.io/v1beta1/imageupdateautomations.yaml
