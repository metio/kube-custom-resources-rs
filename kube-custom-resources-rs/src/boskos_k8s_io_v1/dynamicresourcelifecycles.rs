...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kubernetes-sigs/boskos/boskos.k8s.io/v1/dynamicresourcelifecycles.yaml
