...
pub struct TenantControlPlaneStatusAddonsKonnectivityService {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TenantControlPlaneStatusAddonsKonnectivityServiceConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TenantControlPlaneStatusAddonsKonnectivityServiceConditions {
    ...
    pub status: TenantControlPlaneStatusAddonsKonnectivityServiceConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TenantControlPlaneStatusAddonsKonnectivityServiceConditionsStatus {
    True,
    False,
    Unknown,
}
...
pub struct TenantControlPlaneStatusKubernetesResourcesDeployment {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TenantControlPlaneStatusKubernetesResourcesDeploymentConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TenantControlPlaneStatusKubernetesResourcesDeploymentConditions {
...
pub struct TenantControlPlaneStatusKubernetesResourcesService {
    /// Current service state
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TenantControlPlaneStatusKubernetesResourcesServiceConditions>>,
    /// LoadBalancer contains the current status of the load-balancer, if one is present.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loadBalancer")]
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TenantControlPlaneStatusKubernetesResourcesServiceConditions {
    /// lastTransitionTime is the last time the condition transitioned from one status to another. This should be when the underlying condition changed.  If that is not known, then using the time when the API field changed is acceptable.
    #[serde(rename = "lastTransitionTime")]
    pub last_transition_time: String,
    /// message is a human readable message indicating details about the transition. This may be an empty string.
    ...
    pub reason: String,
    /// status of the condition, one of True, False, Unknown.
    pub status: TenantControlPlaneStatusKubernetesResourcesServiceConditionsStatus,
    /// type of condition in CamelCase or in foo.example.com/CamelCase. --- Many .condition.type values are consistent across resources like Available, but because arbitrary conditions can be useful (see .node.status.conditions), the ability to deconflict is important. The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt)
    #[serde(rename = "type")]
    pub r#type: String,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TenantControlPlaneStatusKubernetesResourcesServiceConditionsStatus {
    True,
    False,
    Unknown,
}
