...
// kopium command: kopium --docs --filename=./crd-catalog/couchbase-partners/helm-charts/couchbase.com/v2/couchbasecollections.yaml --derive=Default --derive=PartialEq
