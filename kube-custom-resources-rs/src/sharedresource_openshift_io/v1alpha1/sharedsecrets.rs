...
pub struct SharedSecretStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<SharedSecretStatusConditions>>,
}
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SharedSecretStatusConditions {
    ...
    pub status: SharedSecretStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SharedSecretStatusConditionsStatus {
    True,
    False,
    Unknown,
}
