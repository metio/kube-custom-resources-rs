...
// kopium command: kopium --docs --filename=./crd-catalog/mittwald/kubernetes-secret-generator/secretgenerator.mittwald.de/v1alpha1/stringsecrets.yaml --derive=Default --derive=PartialEq
...
pub struct StringSecretStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secret: Option<StringSecretStatusSecret>,
}
