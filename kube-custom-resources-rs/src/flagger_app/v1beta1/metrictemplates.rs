...
// kopium command: kopium --docs --filename=./crd-catalog/fluxcd/flagger/flagger.app/v1beta1/metrictemplates.yaml --derive=Default --derive=PartialEq --smart-derive-elision
