...
// kopium command: kopium --docs --filename=./crd-catalog/clastix/capsule/capsule.clastix.io/v1alpha1/tenants.yaml --derive=Default --derive=PartialEq --smart-derive-elision
