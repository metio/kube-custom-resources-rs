...
// kopium command: kopium --docs --filename=./crd-catalog/clastix/capsule/capsule.clastix.io/v1beta2/tenants.yaml --derive=Default --derive=PartialEq --smart-derive-elision
