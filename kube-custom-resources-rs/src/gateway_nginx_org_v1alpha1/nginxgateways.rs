...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/nginxinc/nginx-kubernetes-gateway/gateway.nginx.org/v1alpha1/nginxgateways.yaml
