...
// kopium command: kopium --docs --filename=./crd-catalog/aws-controllers-k8s/route53resolver-controller/route53resolver.services.k8s.aws/v1alpha1/resolverendpoints.yaml --derive=Default --derive=PartialEq
...
pub struct ResolverEndpointStatus {
    ...
    /// resource
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ResolverEndpointStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResolverEndpointStatusConditions {
