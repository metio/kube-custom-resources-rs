...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/RedisLabs/redis-enterprise-k8s-docs/app.redislabs.com/v1/redisenterpriseclusters.yaml
...
pub struct RedisEnterpriseClusterPersistentSpec {
    ...
    /// Storage class for persistent volume in Redis Enterprise pods Leave empty to use the default
