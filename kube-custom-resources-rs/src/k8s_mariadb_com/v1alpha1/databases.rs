...
// kopium command: kopium --docs --filename=./crd-catalog/mariadb-operator/mariadb-operator/k8s.mariadb.com/v1alpha1/databases.yaml --derive=Default --derive=PartialEq --smart-derive-elision
