...
pub struct ClusterResourceBindingSpec {
    ...
    pub schedule_priority: Option<ClusterResourceBindingSchedulePriority>,
...
pub struct ClusterResourceBindingFailoverApplication {
    ...
    pub state_preservation: Option<ClusterResourceBindingFailoverApplicationStatePreservation>,
}
...
/// which is alpha.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterResourceBindingFailoverApplicationStatePreservation {
    ...
    /// to the new cluster.
    pub rules: Vec<ClusterResourceBindingFailoverApplicationStatePreservationRules>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterResourceBindingFailoverApplicationStatePreservationRules {
...
pub struct ClusterResourceBindingGracefulEvictionTasks {
    ...
    /// Valid options are "Immediately", "Graciously" and "Never".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "purgeMode")]
    pub purge_mode: Option<ClusterResourceBindingGracefulEvictionTasksPurgeMode>,
...
/// GracefulEvictionTask represents a graceful eviction task.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterResourceBindingGracefulEvictionTasksPurgeMode {
    Immediately,
    Graciously,
    Never,
}
...
/// SchedulePriority represents the scheduling priority assigned to workloads.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterResourceBindingSchedulePriority {
