...
// kopium command: kopium --docs --filename=./crd-catalog/karmada-io/karmada/work.karmada.io/v1alpha2/resourcebindings.yaml --derive=Default --derive=PartialEq --smart-derive-elision
...
/// be migrated along with the application.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ResourceBindingFailoverApplicationPurgeMode {
    Immediately,
    Graciously,
    Never,
}
...
/// nil means no suspension. no default values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingSuspension {
