...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/nginxinc/kubernetes-ingress/k8s.nginx.org/v1alpha1/globalconfigurations.yaml
