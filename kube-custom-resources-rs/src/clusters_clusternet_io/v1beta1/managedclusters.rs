...
// kopium command: kopium --docs --filename=./crd-catalog/clusternet/clusternet/clusters.clusternet.io/v1beta1/managedclusters.yaml --derive=Default --derive=PartialEq --smart-derive-elision
