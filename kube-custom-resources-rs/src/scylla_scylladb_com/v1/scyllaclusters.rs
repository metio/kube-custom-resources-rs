...
// kopium command: kopium --docs --filename=./crd-catalog/scylladb/scylla-operator/scylla.scylladb.com/v1/scyllaclusters.yaml --derive=Default --derive=PartialEq --smart-derive-elision
