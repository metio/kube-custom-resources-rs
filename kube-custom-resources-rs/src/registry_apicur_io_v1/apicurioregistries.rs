...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/Apicurio/apicurio-registry-operator/registry.apicur.io/v1/apicurioregistries.yaml
...
pub struct ApicurioRegistryStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ApicurioRegistryStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApicurioRegistryStatusConditions {
    ...
    pub status: ApicurioRegistryStatusConditionsStatus,
...
pub enum ApicurioRegistryStatusConditionsStatus {
    True,
    False,
    Unknown,
}
