...
// kopium command: kopium --docs --filename=./crd-catalog/kiegroup/kogito-operator/app.kiegroup.org/v1beta1/kogitobuilds.yaml --derive=Default --derive=PartialEq --smart-derive-elision
