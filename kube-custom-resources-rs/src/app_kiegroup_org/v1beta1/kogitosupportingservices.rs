...
pub struct KogitoSupportingServiceStatus {
    ...
    pub conditions: Vec<KogitoSupportingServiceStatusConditions>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct KogitoSupportingServiceStatusConditions {
    ...
    pub status: KogitoSupportingServiceStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KogitoSupportingServiceStatusConditionsStatus {
    True,
    False,
    Unknown,
}
