...
// kopium command: kopium --docs --filename=./crd-catalog/kiegroup/kogito-operator/app.kiegroup.org/v1beta1/kogitoinfras.yaml --derive=Default --derive=PartialEq --smart-derive-elision
