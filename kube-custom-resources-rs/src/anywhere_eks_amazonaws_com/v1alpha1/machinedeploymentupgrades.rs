...
// kopium command: kopium --docs --filename=./crd-catalog/aws/eks-anywhere/anywhere.eks.amazonaws.com/v1alpha1/machinedeploymentupgrades.yaml --derive=Default --derive=PartialEq
