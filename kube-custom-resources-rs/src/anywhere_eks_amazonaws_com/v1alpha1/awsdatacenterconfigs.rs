...
// kopium command: kopium --docs --filename=./crd-catalog/aws/eks-anywhere/anywhere.eks.amazonaws.com/v1alpha1/awsdatacenterconfigs.yaml --derive=Default --derive=PartialEq
...
#[kube(namespaced)]
#[kube(status = "AWSDatacenterConfigStatus")]
