...
// kopium command: kopium --docs --filename=./crd-catalog/redhat-developer/service-binding-operator/binding.operators.coreos.com/v1alpha1/servicebindings.yaml --derive=Default --derive=PartialEq --smart-derive-elision
