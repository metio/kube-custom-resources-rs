...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/kyverno/kyverno/kyverno.io/v2beta1/clustercleanuppolicies.yaml
...
#[kube(group = "kyverno.io", version = "v2beta1", kind = "ClusterCleanupPolicy", plural = "clustercleanuppolicies")]
...
pub struct ClusterCleanupPolicyStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ClusterCleanupPolicyStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterCleanupPolicyStatusConditions {
    ...
    pub status: ClusterCleanupPolicyStatusConditionsStatus,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterCleanupPolicyStatusConditionsStatus {
    True,
    False,
    Unknown,
}
