...
// kopium command: kopium --derive Default --derive PartialEq --docs --filename ./crd-catalog/flux-framework/flux-operator/flux-framework.org/v1alpha1/miniclusters.yaml
...
pub struct MiniClusterStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<MiniClusterStatusConditions>>,
...
///  // other fields }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MiniClusterStatusConditions {
    ...
    pub status: MiniClusterStatusConditionsStatus,
...
pub enum MiniClusterStatusConditionsStatus {
    True,
    False,
    Unknown,
}
