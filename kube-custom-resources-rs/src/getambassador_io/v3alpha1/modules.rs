...
// kopium command: kopium --docs --filename=./crd-catalog/emissary-ingress/emissary/getambassador.io/v3alpha1/modules.yaml --derive=Default --derive=PartialEq --smart-derive-elision
