...
pub struct SidecarDefinitionConfigs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub variables: Option<Vec<SidecarDefinitionConfigsVariables>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SidecarDefinitionConfigsVariables {
...
pub struct SidecarDefinitionScripts {
    ...
    /// template content directly.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub variables: Option<Vec<SidecarDefinitionScriptsVariables>>,
    /// Refers to the volume name of PodTemplate. The file produced through the template will be mounted to
    /// the corresponding volume. Must be a DNS_LABEL name.
    /// The volume name must be defined in podSpec.containers[*].volumeMounts.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeName")]
...
/// FileTemplateVariable declares a user-configurable variable supported by a file template.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SidecarDefinitionScriptsVariables {
    /// Specifies the default value used.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultValue")]
    pub default_value: Option<String>,
    /// Provides a human-readable explanation of the variable's purpose.
...
pub struct SidecarDefinitionVarsValueFromComponentVarRef {
    ...
    pub service_version: Option<SidecarDefinitionVarsValueFromComponentVarRefServiceVersion>,
...
/// Selects a defined var of a Component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SidecarDefinitionVarsValueFromComponentVarRefServiceVersion {
    Required,
    Optional,
}
