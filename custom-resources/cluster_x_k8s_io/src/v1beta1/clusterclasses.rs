...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api/cluster.x-k8s.io/v1beta1/clusterclasses.yaml
...
pub struct ClusterClassControlPlane {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub taints: Option<Vec<ClusterClassControlPlaneTaints>>,
}
...
pub struct ClusterClassControlPlaneMachineHealthCheck {
    ...
    pub unhealthy_machine_conditions: Option<Vec<ClusterClassControlPlaneMachineHealthCheckUnhealthyMachineConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterClassControlPlaneMachineHealthCheckUnhealthyMachineConditions {
    /// status of the condition, one of True, False, Unknown.
    pub status: ClusterClassControlPlaneMachineHealthCheckUnhealthyMachineConditionsStatus,
...
/// status for at least the timeout value, a machine is considered unhealthy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassControlPlaneMachineHealthCheckUnhealthyMachineConditionsStatus {
    True,
    False,
    Unknown,
}
...
pub struct ClusterClassControlPlaneTaints {
    ...
    pub propagation: ClusterClassControlPlaneTaintsPropagation,
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassControlPlaneTaintsEffect {
    NoSchedule,
    PreferNoSchedule,
    NoExecute,
}
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassControlPlaneTaintsPropagation {
    Always,
    OnInitialization,
}
...
pub struct ClusterClassUpgradeExternal {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "generateUpgradePlanExtension")]
...
pub struct ClusterClassWorkersMachineDeployments {
    ...
    /// NOTE: This list is implemented as a "map" type, meaning that individual elements can be managed by different owners.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub taints: Option<Vec<ClusterClassWorkersMachineDeploymentsTaints>>,
...
pub struct ClusterClassWorkersMachineDeploymentsMachineHealthCheck {
    ...
    /// logical OR, i.e. if any of the conditions is met, the machine is unhealthy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyMachineConditions")]
    pub unhealthy_machine_conditions: Option<Vec<ClusterClassWorkersMachineDeploymentsMachineHealthCheckUnhealthyMachineConditions>>,
    /// unhealthyRange specifies the range of unhealthy machines allowed.
    /// Any further remediation is only allowed if the number of machines selected by "selector" as not healthy
    /// is within the range of "unhealthyRange". Takes precedence over maxUnhealthy.
    /// Eg. "[3-5]" - This means that remediation will be allowed only when:
...
/// status for at least the timeout value, a machine is considered unhealthy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterClassWorkersMachineDeploymentsMachineHealthCheckUnhealthyMachineConditions {
    /// status of the condition, one of True, False, Unknown.
    pub status: ClusterClassWorkersMachineDeploymentsMachineHealthCheckUnhealthyMachineConditionsStatus,
    /// timeout is the duration that a Machine must be in a given status for,
    /// after which the Machine is considered unhealthy.
    /// For example, with a value of "1h", the Machine must match the status
    /// for at least 1 hour before being considered unhealthy.
...
/// status for at least the timeout value, a machine is considered unhealthy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassWorkersMachineDeploymentsMachineHealthCheckUnhealthyMachineConditionsStatus {
    True,
    False,
    Unknown,
}
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterClassWorkersMachineDeploymentsTaints {
    /// effect is the effect for the taint. Valid values are NoSchedule, PreferNoSchedule and NoExecute.
    pub effect: ClusterClassWorkersMachineDeploymentsTaintsEffect,
    /// key is the taint key to be applied to a node.
    /// Must be a valid qualified name of maximum size 63 characters
    /// with an optional subdomain prefix of maximum size 253 characters,
    /// separated by a `/`.
    ...
    /// Always: The taint will be continuously reconciled. If it is not set for a node, it will be added during reconciliation.
    /// OnInitialization: The taint will be added during node initialization. If it gets removed from the node later on it will not get added again.
    pub propagation: ClusterClassWorkersMachineDeploymentsTaintsPropagation,
    /// value is the taint value corresponding to the taint key.
    /// It must be a valid label value of maximum size 63 characters.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassWorkersMachineDeploymentsTaintsEffect {
    NoSchedule,
    PreferNoSchedule,
    NoExecute,
}
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassWorkersMachineDeploymentsTaintsPropagation {
    Always,
    OnInitialization,
}
...
pub struct ClusterClassWorkersMachinePools {
    ...
    /// NOTE: This list is implemented as a "map" type, meaning that individual elements can be managed by different owners.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub taints: Option<Vec<ClusterClassWorkersMachinePoolsTaints>>,
    /// template is a local struct containing a collection of templates for creation of
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterClassWorkersMachinePoolsTaints {
    /// effect is the effect for the taint. Valid values are NoSchedule, PreferNoSchedule and NoExecute.
    pub effect: ClusterClassWorkersMachinePoolsTaintsEffect,
    /// key is the taint key to be applied to a node.
    /// Must be a valid qualified name of maximum size 63 characters
    /// with an optional subdomain prefix of maximum size 253 characters,
    /// separated by a `/`.
    ...
    /// Always: The taint will be continuously reconciled. If it is not set for a node, it will be added during reconciliation.
    /// OnInitialization: The taint will be added during node initialization. If it gets removed from the node later on it will not get added again.
    pub propagation: ClusterClassWorkersMachinePoolsTaintsPropagation,
    /// value is the taint value corresponding to the taint key.
    /// It must be a valid label value of maximum size 63 characters.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassWorkersMachinePoolsTaintsEffect {
    NoSchedule,
    PreferNoSchedule,
    NoExecute,
}
...
/// MachineTaint defines a taint equivalent to corev1.Taint, but additionally having a propagation field.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterClassWorkersMachinePoolsTaintsPropagation {
    Always,
    OnInitialization,
}
