...
pub struct MachineHealthCheckSpec {
    ...
    pub unhealthy_machine_conditions: Option<Vec<MachineHealthCheckUnhealthyMachineConditions>>,
...
pub struct MachineHealthCheckUnhealthyMachineConditions {
    /// status of the condition, one of True, False, Unknown.
    pub status: MachineHealthCheckUnhealthyMachineConditionsStatus,
...
/// status for at least the timeout value, a machine is considered unhealthy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MachineHealthCheckUnhealthyMachineConditionsStatus {
    True,
    False,
    Unknown,
}
