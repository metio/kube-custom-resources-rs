...
pub struct SelfNodeRemediationConfigSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customDsNodeSelectorRequirements")]
    pub custom_ds_node_selector_requirements: Option<Vec<SelfNodeRemediationConfigCustomDsNodeSelectorRequirements>>,
...
pub struct SelfNodeRemediationConfigCustomDsNodeSelectorRequirements {
