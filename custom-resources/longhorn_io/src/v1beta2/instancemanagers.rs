...
pub struct InstanceManagerStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceEngineFrontends")]
    pub instance_engine_frontends: Option<BTreeMap<String, InstanceManagerStatusInstanceEngineFrontends>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceEngineFrontends {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<InstanceManagerStatusInstanceEngineFrontendsSpec>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<InstanceManagerStatusInstanceEngineFrontendsStatus>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceEngineFrontendsSpec {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataEngine")]
    pub data_engine: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceEngineFrontendsStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub paths: Option<Vec<InstanceManagerStatusInstanceEngineFrontendsStatusPaths>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceEngineFrontendsStatusPaths {
...
pub struct InstanceManagerStatusInstanceEnginesStatus {
    ...
    pub listen: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub paths: Option<Vec<InstanceManagerStatusInstanceEnginesStatusPaths>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portEnd")]
    pub port_end: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portStart")]
    pub port_start: Option<i32>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceEnginesStatusPaths {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "anaState")]
    pub ana_state: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "engineName")]
    pub engine_name: Option<String>,
...
pub struct InstanceManagerStatusInstanceReplicasStatus {
    ...
    pub listen: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub paths: Option<Vec<InstanceManagerStatusInstanceReplicasStatusPaths>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portEnd")]
    pub port_end: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portStart")]
    pub port_start: Option<i32>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceManagerStatusInstanceReplicasStatusPaths {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "anaState")]
    pub ana_state: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "engineName")]
    pub engine_name: Option<String>,
