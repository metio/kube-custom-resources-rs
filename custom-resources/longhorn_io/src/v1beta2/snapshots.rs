...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/longhorn/longhorn/longhorn.io/v1beta2/snapshots.yaml
...
pub struct SnapshotStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checksumCalculatedAt")]
    pub checksum_calculated_at: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestedTime")]
