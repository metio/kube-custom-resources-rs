...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/clusternet/clusternet/apps.clusternet.io/v1alpha1/subscriptions.yaml
...
pub struct SubscriptionStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replicas: Option<BTreeMap<String, Vec<i64>>>,
