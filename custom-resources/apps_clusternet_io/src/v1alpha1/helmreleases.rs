...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/clusternet/clusternet/apps.clusternet.io/v1alpha1/helmreleases.yaml
