...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/hashicorp/vault-secrets-operator/secrets.hashicorp.com/v1beta1/vaultauths.yaml
...
pub struct VaultAuthGcp {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "workloadIdentityServiceAccount"
    )]
