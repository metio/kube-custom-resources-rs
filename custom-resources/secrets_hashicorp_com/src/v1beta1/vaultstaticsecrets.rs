...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/hashicorp/vault-secrets-operator/secrets.hashicorp.com/v1beta1/vaultstaticsecrets.yaml
...
pub struct VaultStaticSecretStatus {
    ...
    pub vault_client_meta: Option<VaultStaticSecretStatusVaultClientMeta>,
}

/// VaultClientMeta contains the status of the Vault client and is used during
/// resource reconciliation.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VaultStaticSecretStatusVaultClientMeta {
