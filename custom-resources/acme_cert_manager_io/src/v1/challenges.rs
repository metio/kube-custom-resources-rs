...
pub struct ChallengeSolverDns01AzureDns {
    ...
    pub zone_type: Option<ChallengeSolverDns01AzureDnsZoneType>,
}
...
/// Use the Microsoft Azure DNS API to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ChallengeSolverDns01AzureDnsZoneType {
    AzurePublicZone,
    AzurePrivateZone,
}
...
pub struct ChallengeSolverDns01Rfc2136 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub protocol: Option<ChallengeSolverDns01Rfc2136Protocol>,
...
/// to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ChallengeSolverDns01Rfc2136Protocol {
    #[serde(rename = "TCP")]
    Tcp,
    #[serde(rename = "UDP")]
    Udp,
...
pub struct ChallengeSolverHttp01IngressPodTemplateSpec {
    ...
    /// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<ChallengeSolverHttp01IngressPodTemplateSpecResources>,
    /// If specified, the pod's security context
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
/// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ChallengeSolverHttp01IngressPodTemplateSpecResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
