...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cert-manager/cert-manager/acme.cert-manager.io/v1/orders.yaml
