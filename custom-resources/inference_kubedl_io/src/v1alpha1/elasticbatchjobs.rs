...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubedl-io/kubedl/inference.kubedl.io/v1alpha1/elasticbatchjobs.yaml
