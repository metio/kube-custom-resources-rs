...
pub struct EnterpriseSearchSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<EnterpriseSearchResources>,
...
pub struct EnterpriseSearchElasticsearchRef {
    ...
    /// client certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientCertificateSecretName")]
    pub client_certificate_secret_name: Option<String>,
...
/// Enterprise Search container. To set resources on other containers, use the PodTemplate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnterpriseSearchResources {
    /// Limits is the shorthand for the main container's CPU and memory limits.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<EnterpriseSearchResourcesLimits>,
    /// Requests is the shorthand for the main container's CPU and memory requests.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<EnterpriseSearchResourcesRequests>,
}

/// Limits is the shorthand for the main container's CPU and memory limits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnterpriseSearchResourcesLimits {
...
/// Requests is the shorthand for the main container's CPU and memory requests.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnterpriseSearchResourcesRequests {
    /// CPU overrides the main container's CPU request/limit when the parent Resources
    /// is merged into a PodTemplate. A nil value means "do not override": any CPU
    /// value already set on the main container in the PodTemplate is passed through
    /// unchanged. Setting this field to nil does not unset a CPU value present in
...
pub struct EnterpriseSearchStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<EnterpriseSearchStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnterpriseSearchStatusConditions {
