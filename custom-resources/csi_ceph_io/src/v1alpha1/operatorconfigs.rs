...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/ceph/ceph-csi-operator/csi.ceph.io/v1alpha1/operatorconfigs.yaml
...
#[kube(group = "csi.ceph.io", version = "v1alpha1", kind = "OperatorConfig", plural = "operatorconfigs")]
#[kube(namespaced)]
