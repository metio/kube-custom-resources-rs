...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/ansible/awx-operator/awx.ansible.com/v1beta1/awxbackups.yaml
...
#[kube(group = "awx.ansible.com", version = "v1beta1", kind = "AWXBackup", root = "AwxBackup", plural = "awxbackups")]
#[kube(namespaced)]
...
pub struct AwxBackupSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub create_backup_pvc: Option<bool>,
    ...
    /// Enable compression for database dumps using pg_dump built-in compression.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub use_db_compression: Option<bool>,
}
