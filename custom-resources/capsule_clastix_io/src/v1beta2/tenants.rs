...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/projectcapsule/capsule/capsule.clastix.io/v1beta2/tenants.yaml
...
pub struct TenantNamespaceOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "additionalMetadataList")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requiredMetadata")]
...
pub struct TenantNamespaceOptionsAdditionalMetadataListNamespaceSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<TenantNamespaceOptionsAdditionalMetadataListNamespaceSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
pub struct TenantPermissions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowOwnerPromotion")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchOwners")]
...
pub struct TenantRulesPermissions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<TenantRulesPermissionsRules>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantRulesPermissionsRules {
    /// ClusterRoles granted to the promoted ServiceAccounts across the Tenant
    /// kubebuilder:validation:Minimum=1
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterRoles")]
    pub cluster_roles: Option<Vec<String>>,
    ...
    /// across the Tenant
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<TenantRulesPermissionsRulesSelector>,
}

/// Match ServiceAccounts which are promoted which are granted these additional ClusterRoles
/// across the Tenant
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantRulesPermissionsRulesSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<TenantRulesPermissionsRulesSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantRulesPermissionsRulesSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
