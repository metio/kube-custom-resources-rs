...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/clastix/capsule/capsule.clastix.io/v1beta2/tenants.yaml
