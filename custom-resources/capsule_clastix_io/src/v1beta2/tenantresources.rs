...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/projectcapsule/capsule/capsule.clastix.io/v1beta2/tenantresources.yaml
...
#[kube(group = "capsule.clastix.io", version = "v1beta2", kind = "TenantResource", plural = "tenantresources")]
#[kube(namespaced)]
#[kube(status = "TenantResourceStatus")]
...
pub struct TenantResourceSpec {
    ...
    pub depends_on: Option<Vec<TenantResourceDependsOn>>,
    ...
    pub resources: Vec<TenantResourceResources>,
    ...
    pub service_account: Option<TenantResourceServiceAccount>,
    /// Provide additional settings
    pub settings: TenantResourceSettings,
}

/// LocalObjectReference contains enough information to locate the referenced Kubernetes resource object.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceDependsOn {
    /// Name of the referent.
    pub name: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResources {
    ...
    pub additional_metadata: Option<TenantResourceResourcesAdditionalMetadata>,
    /// Provide additional template context, which can be used throughout all
    /// the declared items for the replication
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub context: Option<TenantResourceResourcesContext>,
    /// Templates for advanced use cases
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub generators: Option<Vec<TenantResourceResourcesGenerators>>,
    ...
    pub namespace_selector: Option<TenantResourceResourcesNamespaceSelector>,
    ...
    pub namespaced_items: Option<Vec<TenantResourceResourcesNamespacedItems>>,
...
/// added to the replicated resources.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesAdditionalMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// the declared items for the replication
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesContext {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<Vec<TenantResourceResourcesContextResources>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesContextResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<TenantResourceResourcesContextResourcesSelector>,
}

/// Selector which allows to get any amount of these resources based on labels
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesContextResourcesSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<TenantResourceResourcesContextResourcesSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesContextResourcesSelectorMatchExpressions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesGenerators {
    /// Missing Key Option for templating
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "missingKey")]
    pub missing_key: Option<TenantResourceResourcesGeneratorsMissingKey>,
...
pub enum TenantResourceResourcesGeneratorsMissingKey {
...
/// In case of nil value, all the Tenant Namespaces are targeted.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesNamespaceSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<TenantResourceResourcesNamespaceSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesNamespaceSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// Reference
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesNamespacedItems {
    /// API version of the referent.
    #[serde(rename = "apiVersion")]
    pub api_version: String,
    /// Kind of the referent.
    ...
    /// Selector which allows to get any amount of these resources based on labels
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<TenantResourceResourcesNamespacedItemsSelector>,
}

/// Selector which allows to get any amount of these resources based on labels
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesNamespacedItemsSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<TenantResourceResourcesNamespacedItemsSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceResourcesNamespacedItemsSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// You must provide permissions accordingly to that ServiceAccount
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceServiceAccount {
    /// Name of the referent.
    pub name: String,
}
...
/// Provide additional settings
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceSettings {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceStatus {
    ...
    pub processed_items: Option<Vec<TenantResourceStatusProcessedItems>>,
    /// Serviceaccount used for impersonation
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccount")]
    pub service_account: Option<TenantResourceStatusServiceAccount>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceStatusProcessedItems {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<TenantResourceStatusProcessedItemsStatus>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TenantResourceStatusProcessedItemsStatus {
    ...
    pub status: TenantResourceStatusProcessedItemsStatusStatus,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TenantResourceStatusProcessedItemsStatusStatus {
    True,
    False,
    Unknown,
}
...
/// Serviceaccount used for impersonation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantResourceStatusServiceAccount {
    /// Name of the referent.
    pub name: String,
