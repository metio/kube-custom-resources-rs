...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/elastic/cloud-on-k8s/apm.k8s.elastic.co/v1/apmservers.yaml
...
#[kube(group = "apm.k8s.elastic.co", version = "v1", kind = "ApmServer", plural = "apmservers")]
#[kube(namespaced)]
...
pub struct ApmServerSpec {
    ...
    pub kibana_ref: Option<ApmServerKibanaRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<ApmServerResources>,
...
/// container. To set resources on other containers, use the PodTemplate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApmServerResources {
    /// Limits is the shorthand for the main container's CPU and memory limits.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<ApmServerResourcesLimits>,
    /// Requests is the shorthand for the main container's CPU and memory requests.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<ApmServerResourcesRequests>,
}

/// Limits is the shorthand for the main container's CPU and memory limits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApmServerResourcesLimits {
...
/// Requests is the shorthand for the main container's CPU and memory requests.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApmServerResourcesRequests {
    /// CPU overrides the main container's CPU request/limit when the parent Resources
    /// is merged into a PodTemplate. A nil value means "do not override": any CPU
    /// value already set on the main container in the PodTemplate is passed through
    /// unchanged. Setting this field to nil does not unset a CPU value present in
...
pub struct ApmServerStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<ApmServerStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApmServerStatusConditions {
