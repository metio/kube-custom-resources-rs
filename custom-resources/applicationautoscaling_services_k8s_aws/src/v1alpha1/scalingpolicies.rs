...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/applicationautoscaling-controller/applicationautoscaling.services.k8s.aws/v1alpha1/scalingpolicies.yaml
...
pub struct ScalingPolicySpec {
    ...
    pub target_tracking_scaling_policy_configuration:
        Option<ScalingPolicyTargetTrackingScalingPolicyConfiguration>,
}
...
pub struct ScalingPolicyTargetTrackingScalingPolicyConfiguration {
    ...
    pub customized_metric_specification:
        Option<ScalingPolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub predefined_metric_specification:
        Option<ScalingPolicyTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
