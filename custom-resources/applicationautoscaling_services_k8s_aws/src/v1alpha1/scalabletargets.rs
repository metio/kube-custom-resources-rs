...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/applicationautoscaling-controller/applicationautoscaling.services.k8s.aws/v1alpha1/scalabletargets.yaml
...
pub struct ScalableTargetSuspendedState {
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dynamicScalingInSuspended"
    )]
    pub dynamic_scaling_in_suspended: Option<bool>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dynamicScalingOutSuspended"
    )]
    pub dynamic_scaling_out_suspended: Option<bool>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "scheduledScalingSuspended"
    )]
