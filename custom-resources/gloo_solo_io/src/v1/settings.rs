...
pub struct SettingsSpec {
    ...
    pub ext_proc_early: Option<SettingsExtProcEarly>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extProcLate")]
    pub ext_proc_late: Option<SettingsExtProcLate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipV4Only")]
    pub ip_v4_only: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarly {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowModeOverride")]
    pub allow_mode_override: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "asyncMode")]
    pub async_mode: Option<bool>,
    ...
    pub filter_metadata: Option<BTreeMap<String, serde_json::Value>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filterStage")]
    pub filter_stage: Option<SettingsExtProcEarlyFilterStage>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forwardRules")]
    pub forward_rules: Option<SettingsExtProcEarlyForwardRules>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcService")]
    pub grpc_service: Option<SettingsExtProcEarlyGrpcService>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxMessageTimeout")]
    pub max_message_timeout: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "messageTimeout")]
    pub message_timeout: Option<String>,
    ...
    pub metadata_context_namespaces: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mutationRules")]
    pub mutation_rules: Option<SettingsExtProcEarlyMutationRules>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "processingMode")]
    pub processing_mode: Option<SettingsExtProcEarlyProcessingMode>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestAttributes")]
    pub request_attributes: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "responseAttributes")]
    pub response_attributes: Option<Vec<String>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyFilterStage {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub predicate: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub stage: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRules {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowedHeaders")]
    pub allowed_headers: Option<SettingsExtProcEarlyForwardRulesAllowedHeaders>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowedHeaders")]
    pub disallowed_headers: Option<SettingsExtProcEarlyForwardRulesDisallowedHeaders>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesAllowedHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<SettingsExtProcEarlyForwardRulesAllowedHeadersPatterns>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesAllowedHeadersPatterns {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exact: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreCase")]
    pub ignore_case: Option<bool>,
    ...
    pub prefix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "safeRegex")]
    pub safe_regex: Option<SettingsExtProcEarlyForwardRulesAllowedHeadersPatternsSafeRegex>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suffix: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesAllowedHeadersPatternsSafeRegex {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcEarlyForwardRulesAllowedHeadersPatternsSafeRegexGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesAllowedHeadersPatternsSafeRegexGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesDisallowedHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<SettingsExtProcEarlyForwardRulesDisallowedHeadersPatterns>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesDisallowedHeadersPatterns {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exact: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreCase")]
    pub ignore_case: Option<bool>,
    ...
    pub prefix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "safeRegex")]
    pub safe_regex: Option<SettingsExtProcEarlyForwardRulesDisallowedHeadersPatternsSafeRegex>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suffix: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesDisallowedHeadersPatternsSafeRegex {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcEarlyForwardRulesDisallowedHeadersPatternsSafeRegexGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyForwardRulesDisallowedHeadersPatternsSafeRegexGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyGrpcService {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authority: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extProcServerRef")]
    pub ext_proc_server_ref: Option<SettingsExtProcEarlyGrpcServiceExtProcServerRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initialMetadata")]
    pub initial_metadata: Option<Vec<SettingsExtProcEarlyGrpcServiceInitialMetadata>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryPolicy")]
    pub retry_policy: Option<SettingsExtProcEarlyGrpcServiceRetryPolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub timeout: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyGrpcServiceExtProcServerRef {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyGrpcServiceInitialMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyGrpcServiceRetryPolicy {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "numRetries")]
    pub num_retries: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryBackOff")]
    pub retry_back_off: Option<SettingsExtProcEarlyGrpcServiceRetryPolicyRetryBackOff>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyGrpcServiceRetryPolicyRetryBackOff {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baseInterval")]
    pub base_interval: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxInterval")]
    pub max_interval: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyMutationRules {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowAllRouting")]
    pub allow_all_routing: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowEnvoy")]
    pub allow_envoy: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowExpression")]
    pub allow_expression: Option<SettingsExtProcEarlyMutationRulesAllowExpression>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowAll")]
    pub disallow_all: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowExpression")]
    pub disallow_expression: Option<SettingsExtProcEarlyMutationRulesDisallowExpression>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowIsError")]
    pub disallow_is_error: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowSystem")]
    pub disallow_system: Option<bool>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyMutationRulesAllowExpression {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcEarlyMutationRulesAllowExpressionGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyMutationRulesAllowExpressionGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyMutationRulesDisallowExpression {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcEarlyMutationRulesDisallowExpressionGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyMutationRulesDisallowExpressionGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcEarlyProcessingMode {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestBodyMode")]
    pub request_body_mode: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestHeaderMode")]
    pub request_header_mode: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLate {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowModeOverride")]
    pub allow_mode_override: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "asyncMode")]
    pub async_mode: Option<bool>,
    ...
    pub filter_metadata: Option<BTreeMap<String, serde_json::Value>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filterStage")]
    pub filter_stage: Option<SettingsExtProcLateFilterStage>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forwardRules")]
    pub forward_rules: Option<SettingsExtProcLateForwardRules>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcService")]
    pub grpc_service: Option<SettingsExtProcLateGrpcService>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxMessageTimeout")]
    pub max_message_timeout: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "messageTimeout")]
    pub message_timeout: Option<String>,
    ...
    pub metadata_context_namespaces: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mutationRules")]
    pub mutation_rules: Option<SettingsExtProcLateMutationRules>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "processingMode")]
    pub processing_mode: Option<SettingsExtProcLateProcessingMode>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestAttributes")]
    pub request_attributes: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "responseAttributes")]
    pub response_attributes: Option<Vec<String>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateFilterStage {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub predicate: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub stage: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRules {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowedHeaders")]
    pub allowed_headers: Option<SettingsExtProcLateForwardRulesAllowedHeaders>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowedHeaders")]
    pub disallowed_headers: Option<SettingsExtProcLateForwardRulesDisallowedHeaders>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesAllowedHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<SettingsExtProcLateForwardRulesAllowedHeadersPatterns>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesAllowedHeadersPatterns {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exact: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreCase")]
    pub ignore_case: Option<bool>,
    ...
    pub prefix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "safeRegex")]
    pub safe_regex: Option<SettingsExtProcLateForwardRulesAllowedHeadersPatternsSafeRegex>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suffix: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesAllowedHeadersPatternsSafeRegex {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcLateForwardRulesAllowedHeadersPatternsSafeRegexGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesAllowedHeadersPatternsSafeRegexGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesDisallowedHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patterns: Option<Vec<SettingsExtProcLateForwardRulesDisallowedHeadersPatterns>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesDisallowedHeadersPatterns {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exact: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreCase")]
    pub ignore_case: Option<bool>,
    ...
    pub prefix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "safeRegex")]
    pub safe_regex: Option<SettingsExtProcLateForwardRulesDisallowedHeadersPatternsSafeRegex>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suffix: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesDisallowedHeadersPatternsSafeRegex {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcLateForwardRulesDisallowedHeadersPatternsSafeRegexGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateForwardRulesDisallowedHeadersPatternsSafeRegexGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateGrpcService {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authority: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extProcServerRef")]
    pub ext_proc_server_ref: Option<SettingsExtProcLateGrpcServiceExtProcServerRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initialMetadata")]
    pub initial_metadata: Option<Vec<SettingsExtProcLateGrpcServiceInitialMetadata>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryPolicy")]
    pub retry_policy: Option<SettingsExtProcLateGrpcServiceRetryPolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub timeout: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateGrpcServiceExtProcServerRef {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateGrpcServiceInitialMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateGrpcServiceRetryPolicy {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "numRetries")]
    pub num_retries: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryBackOff")]
    pub retry_back_off: Option<SettingsExtProcLateGrpcServiceRetryPolicyRetryBackOff>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateGrpcServiceRetryPolicyRetryBackOff {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baseInterval")]
    pub base_interval: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxInterval")]
    pub max_interval: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateMutationRules {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowAllRouting")]
    pub allow_all_routing: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowEnvoy")]
    pub allow_envoy: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowExpression")]
    pub allow_expression: Option<SettingsExtProcLateMutationRulesAllowExpression>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowAll")]
    pub disallow_all: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowExpression")]
    pub disallow_expression: Option<SettingsExtProcLateMutationRulesDisallowExpression>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowIsError")]
    pub disallow_is_error: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disallowSystem")]
    pub disallow_system: Option<bool>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateMutationRulesAllowExpression {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcLateMutationRulesAllowExpressionGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateMutationRulesAllowExpressionGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateMutationRulesDisallowExpression {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "googleRe2")]
    pub google_re2: Option<SettingsExtProcLateMutationRulesDisallowExpressionGoogleRe2>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regex: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateMutationRulesDisallowExpressionGoogleRe2 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxProgramSize")]
    pub max_program_size: Option<i64>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SettingsExtProcLateProcessingMode {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestBodyMode")]
    pub request_body_mode: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requestHeaderMode")]
    pub request_header_mode: Option<String>,
