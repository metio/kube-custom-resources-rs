...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/isindir/sops-secrets-operator/isindir.github.com/v1alpha3/sopssecrets.yaml
...
pub struct SopsSecretSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enforceOwnership")]
