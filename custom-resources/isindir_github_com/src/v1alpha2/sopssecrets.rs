...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/isindir/sops-secrets-operator/isindir.github.com/v1alpha2/sopssecrets.yaml
