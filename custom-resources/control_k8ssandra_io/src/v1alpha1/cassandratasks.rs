...
pub struct CassandraTaskSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxConcurrentPods")]
    pub max_concurrent_pods: Option<i64>,
...
pub struct CassandraTaskStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "podStatuses")]
    pub pod_statuses: Option<BTreeMap<String, CassandraTaskStatusPodStatuses>>,
...
/// Keys are pod names (not including pod UID to handle recreation scenarios).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CassandraTaskStatusPodStatuses {
