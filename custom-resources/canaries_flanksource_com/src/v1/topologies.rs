...
pub struct TopologyPush {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsSigV4")]
    pub aws_sig_v4: Option<TopologyPushAwsSigV4>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<Vec<TopologyPushHeaders>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4 {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessKey")]
    pub access_key: Option<TopologyPushAwsSigV4AccessKey>,
    ...
    pub secret_key: Option<TopologyPushAwsSigV4SecretKey>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sessionToken")]
    pub session_token: Option<TopologyPushAwsSigV4SessionToken>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4AccessKey {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<TopologyPushAwsSigV4AccessKeyValueFrom>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4AccessKeyValueFrom {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<TopologyPushAwsSigV4AccessKeyValueFromConfigMapKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "helmRef")]
    pub helm_ref: Option<TopologyPushAwsSigV4AccessKeyValueFromHelmRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<TopologyPushAwsSigV4AccessKeyValueFromSecretKeyRef>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4AccessKeyValueFromConfigMapKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4AccessKeyValueFromHelmRef {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4AccessKeyValueFromSecretKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SecretKey {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<TopologyPushAwsSigV4SecretKeyValueFrom>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SecretKeyValueFrom {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<TopologyPushAwsSigV4SecretKeyValueFromConfigMapKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "helmRef")]
    pub helm_ref: Option<TopologyPushAwsSigV4SecretKeyValueFromHelmRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<TopologyPushAwsSigV4SecretKeyValueFromSecretKeyRef>,
    /// ServiceAccount specifies the service account whose token should be fetched
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccount")]
    pub service_account: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SecretKeyValueFromConfigMapKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SecretKeyValueFromHelmRef {
    /// Key is a JSONPath expression used to fetch the key from the merged JSON.
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SecretKeyValueFromSecretKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SessionToken {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<TopologyPushAwsSigV4SessionTokenValueFrom>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SessionTokenValueFrom {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<TopologyPushAwsSigV4SessionTokenValueFromConfigMapKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "helmRef")]
    pub helm_ref: Option<TopologyPushAwsSigV4SessionTokenValueFromHelmRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<TopologyPushAwsSigV4SessionTokenValueFromSecretKeyRef>,
    /// ServiceAccount specifies the service account whose token should be fetched
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccount")]
    pub service_account: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SessionTokenValueFromConfigMapKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SessionTokenValueFromHelmRef {
    /// Key is a JSONPath expression used to fetch the key from the merged JSON.
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushAwsSigV4SessionTokenValueFromSecretKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<TopologyPushHeadersValueFrom>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushHeadersValueFrom {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<TopologyPushHeadersValueFromConfigMapKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "helmRef")]
    pub helm_ref: Option<TopologyPushHeadersValueFromHelmRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<TopologyPushHeadersValueFromSecretKeyRef>,
    /// ServiceAccount specifies the service account whose token should be fetched
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccount")]
    pub service_account: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushHeadersValueFromConfigMapKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushHeadersValueFromHelmRef {
    /// Key is a JSONPath expression used to fetch the key from the merged JSON.
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TopologyPushHeadersValueFromSecretKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
