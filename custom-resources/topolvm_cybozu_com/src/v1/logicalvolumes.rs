...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/alauda/nativestor/topolvm.cybozu.com/v1/logicalvolumes.yaml
