...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/storageos/operator/config.storageos.com/v1/operatorconfigs.yaml
