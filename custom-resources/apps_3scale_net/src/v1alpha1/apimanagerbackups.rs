...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/3scale/3scale-operator/apps.3scale.net/v1alpha1/apimanagerbackups.yaml
...
#[kube(group = "apps.3scale.net", version = "v1alpha1", kind = "APIManagerBackup", root = "ApiManagerBackup", plural = "apimanagerbackups")]
#[kube(namespaced)]
