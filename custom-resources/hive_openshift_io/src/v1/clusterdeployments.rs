...
pub struct ClusterDeploymentIngress {
    ...
    pub tuning_options: Option<ClusterDeploymentIngressTuningOptions>,
}
...
/// TuningOptions allows configuring the tuning options of the ingress controller
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentIngressTuningOptions {
...
pub struct ClusterDeploymentPlatformVsphere {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub infrastructure: Option<ClusterDeploymentPlatformVsphereInfrastructure>,
...
/// Infrastructure is the desired state of the vSphere infrastructure provider.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructure {
    ...
    pub default_machine_platform: Option<ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatform>,
    ...
    pub disk_type: Option<ClusterDeploymentPlatformVsphereInfrastructureDiskType>,
    ...
    pub dns_records_type: Option<ClusterDeploymentPlatformVsphereInfrastructureDnsRecordsType>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureDomains")]
    pub failure_domains: Option<Vec<ClusterDeploymentPlatformVsphereInfrastructureFailureDomains>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hosts: Option<Vec<ClusterDeploymentPlatformVsphereInfrastructureHosts>>,
    ...
    pub load_balancer: Option<ClusterDeploymentPlatformVsphereInfrastructureLoadBalancer>,
    /// Network specifies the name of the network to be used by the cluster.
    ...
    pub node_networking: Option<ClusterDeploymentPlatformVsphereInfrastructureNodeNetworking>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub vcenters: Option<Vec<ClusterDeploymentPlatformVsphereInfrastructureVcenters>>,
}
...
/// platform configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatform {
    ...
    pub data_disks: Option<Vec<ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformDataDisks>>,
    ...
    pub os_disk: Option<ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformOsDisk>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformDataDisks {
    ...
    pub provisioning_mode: Option<ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformDataDisksProvisioningMode>,
...
/// DataDisk defines a data disk to add to the VM that is not part of the VM OVA template.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformDataDisksProvisioningMode {
    Thin,
    Thick,
    EagerlyZeroed,
}
...
/// OSDisk defines the storage for instance.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureDefaultMachinePlatformOsDisk {
...
/// Infrastructure is the desired state of the vSphere infrastructure provider.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentPlatformVsphereInfrastructureDiskType {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "thin")]
    Thin,
...
/// Infrastructure is the desired state of the vSphere infrastructure provider.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentPlatformVsphereInfrastructureDnsRecordsType {
    Internal,
    External,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureFailureDomains {
    ...
    pub topology: ClusterDeploymentPlatformVsphereInfrastructureFailureDomainsTopology,
...
/// Topology describes a given failure domain using vSphere constructs
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureFailureDomainsTopology {
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureHosts {
    ...
    pub network_device: ClusterDeploymentPlatformVsphereInfrastructureHostsNetworkDevice,
    /// Role defines the role of the node
    pub role: ClusterDeploymentPlatformVsphereInfrastructureHostsRole,
}

/// NetworkDeviceSpec to be applied to the host
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureHostsNetworkDevice {
...
/// Host defines host VMs to generate as part of the installation.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentPlatformVsphereInfrastructureHostsRole {
    #[serde(rename = "")]
    KopiumEmpty,
...
/// LoadBalancer is available in TechPreview.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureLoadBalancer {
    ...
    pub r#type: Option<ClusterDeploymentPlatformVsphereInfrastructureLoadBalancerType>,
}

/// LoadBalancer defines how the load balancer used by the cluster is configured.
/// LoadBalancer is available in TechPreview.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentPlatformVsphereInfrastructureLoadBalancerType {
...
/// return the first one found.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureNodeNetworking {
    /// external represents the network configuration of the node that is externally routable.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub external: Option<ClusterDeploymentPlatformVsphereInfrastructureNodeNetworkingExternal>,
    /// internal represents the network configuration of the node that is routable only within the cluster.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub internal: Option<ClusterDeploymentPlatformVsphereInfrastructureNodeNetworkingInternal>,
}

/// external represents the network configuration of the node that is externally routable.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureNodeNetworkingExternal {
...
/// internal represents the network configuration of the node that is routable only within the cluster.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureNodeNetworkingInternal {
    /// excludeNetworkSubnetCidr IP addresses in subnet ranges will be excluded when selecting
    /// the IP address from the VirtualMachine's VM for use in the status.addresses fields.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludeNetworkSubnetCidr")]
    pub exclude_network_subnet_cidr: Option<Vec<String>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentPlatformVsphereInfrastructureVcenters {
...
pub struct ClusterDeploymentStatusClusterVersionStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "conditionalUpdateRisks")]
    pub conditional_update_risks: Option<Vec<ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisks>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisks {
    ...
    pub matching_rules: Vec<ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRules>,
...
/// fail to evaluate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRules {
    /// promql represents a cluster condition based on PromQL.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub promql: Option<ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRulesPromql>,
    /// type represents the cluster-condition type. This defines
    /// the members and semantics of any additional properties.
    #[serde(rename = "type")]
    pub r#type: ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRulesType,
}

/// promql represents a cluster condition based on PromQL.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRulesPromql {
...
/// fail to evaluate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterDeploymentStatusClusterVersionStatusConditionalUpdateRisksMatchingRulesType {
    Always,
    #[serde(rename = "PromQL")]
    PromQl,
}
...
pub struct ClusterDeploymentStatusClusterVersionStatusConditionalUpdates {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "riskNames")]
    pub risk_names: Option<Vec<String>>,
