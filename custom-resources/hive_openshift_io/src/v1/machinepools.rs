...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/openshift/hive/hive.openshift.io/v1/machinepools.yaml
...
pub struct MachinePoolPlatformVsphere {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataDisks")]
    pub data_disks: Option<Vec<MachinePoolPlatformVsphereDataDisks>>,
    /// Memory is the size of a VM's memory in MB.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryMB")]
    pub memory_mb: Option<i64>,
    /// OSDisk defines the storage for instance.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osDisk")]
    pub os_disk: Option<MachinePoolPlatformVsphereOsDisk>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MachinePoolPlatformVsphereDataDisks {
    ...
    pub provisioning_mode: Option<MachinePoolPlatformVsphereDataDisksProvisioningMode>,
...
/// DataDisk defines a data disk to add to the VM that is not part of the VM OVA template.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MachinePoolPlatformVsphereDataDisksProvisioningMode {
    Thin,
    Thick,
    EagerlyZeroed,
}
