...
pub struct HiveConfigSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hiveImagePullSecretRef")]
    pub hive_image_pull_secret_ref: Option<HiveConfigHiveImagePullSecretRef>,
...
/// that the Hive operator is deployed in), as well as the namespace of every ClusterDeployment.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct HiveConfigHiveImagePullSecretRef {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
