...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/openshift/hive/hive.openshift.io/v1/hiveconfigs.yaml
...
pub struct HiveConfigSpec {
    ...
    #[serde(
        ...
        rename = "additionalCertificateAuthoritiesSecretRef"
    )]
    pub additional_certificate_authorities_secret_ref:
        Option<Vec<HiveConfigAdditionalCertificateAuthoritiesSecretRef>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "clusterVersionPollInterval"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "machinePoolPollInterval"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "releaseImageVerificationConfigMapRef"
    )]
    pub release_image_verification_config_map_ref:
        Option<HiveConfigReleaseImageVerificationConfigMapRef>,
    /// ServiceProviderCredentialsConfig is used to configure credentials related to being a service provider on
    /// various cloud platforms.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceProviderCredentialsConfig"
    )]
...
pub struct HiveConfigMetricsConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "additionalClusterDeploymentLabels"
    )]
...
pub struct HiveConfigServiceProviderCredentialsConfigAws {
    ...
    pub credentials_secret_ref:
        Option<HiveConfigServiceProviderCredentialsConfigAwsCredentialsSecretRef>,
}
