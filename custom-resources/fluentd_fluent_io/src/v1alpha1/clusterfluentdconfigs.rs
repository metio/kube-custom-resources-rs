...
pub struct ClusterFluentdConfigSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pluginSortOrder")]
    pub plugin_sort_order: Option<ClusterFluentdConfigPluginSortOrder>,
...
/// ClusterFluentdConfigSpec defines the desired state of ClusterFluentdConfig
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterFluentdConfigPluginSortOrder {
