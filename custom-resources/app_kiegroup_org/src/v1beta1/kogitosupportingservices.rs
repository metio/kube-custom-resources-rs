...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kiegroup/kogito-operator/app.kiegroup.org/v1beta1/kogitosupportingservices.yaml
