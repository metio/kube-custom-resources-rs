...
pub struct ModuleDevicePluginContainerEnvValueFrom {
    ...
    pub file_key_ref: Option<ModuleDevicePluginContainerEnvValueFromFileKeyRef>,
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModuleDevicePluginContainerEnvValueFromFileKeyRef {
...
pub struct ModuleDevicePluginInitContainerEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ModuleDevicePluginInitContainerEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModuleDevicePluginInitContainerEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct ModuleDevicePluginVolumesProjectedSources {
    ...
    pub pod_certificate: Option<ModuleDevicePluginVolumesProjectedSourcesPodCertificate>,
...
/// use the certificates it issues.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModuleDevicePluginVolumesProjectedSourcesPodCertificate {
