...
pub struct ElasticsearchSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<ElasticsearchMode>,
    ...
    pub object_store: Option<ElasticsearchObjectStore>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "remoteClusterServer")]
    pub remote_cluster_server: Option<ElasticsearchRemoteClusterServer>,
...
pub struct ElasticsearchHttpTls {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client: Option<ElasticsearchHttpTlsClient>,
...
/// Client holds client configuration options.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchHttpTlsClient {
...
pub struct ElasticsearchNodeSets {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<ElasticsearchNodeSetsResources>,
    ...
    /// Note: stateless mode is under active development and not yet ready for use.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tier: Option<ElasticsearchNodeSetsTier>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "zoneAwareness")]
    pub zone_awareness: Option<ElasticsearchNodeSetsZoneAwareness>,
}

/// Resources specifies the resource requests and limits (CPU and Memory only) for the Elasticsearch nodes in this NodeSet. When set, these override the resource requests and limits set in the PodTemplate for the primary Elasticsearch container. To set the resources for other containers, use the PodTemplate.Spec.Containers[].Resources field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchNodeSetsResources {
    /// Limits is the shorthand for the main container's CPU and memory limits.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<ElasticsearchNodeSetsResourcesLimits>,
    /// Requests is the shorthand for the main container's CPU and memory requests.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<ElasticsearchNodeSetsResourcesRequests>,
}

/// Limits is the shorthand for the main container's CPU and memory limits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchNodeSetsResourcesLimits {
...
/// Requests is the shorthand for the main container's CPU and memory requests.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchNodeSetsResourcesRequests {
    /// CPU overrides the main container's CPU request/limit when the parent Resources
    /// is merged into a PodTemplate. A nil value means "do not override": any CPU
    /// value already set on the main container in the PodTemplate is passed through
    /// unchanged. Setting this field to nil does not unset a CPU value present in
...
/// NodeSet is the specification for a group of Elasticsearch nodes sharing the same configuration and a Pod template.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ElasticsearchNodeSetsTier {
    #[serde(rename = "index")]
    Index,
    #[serde(rename = "search")]
    Search,
...
/// ZoneAwareness enables automatic topology-aware scheduling and shard-awareness configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchNodeSetsZoneAwareness {
...
/// Note: stateless mode is under active development and not yet ready for use.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ElasticsearchObjectStore {
    ...
    #[serde(rename = "type")]
    pub r#type: ElasticsearchObjectStoreType,
}
...
/// Note: stateless mode is under active development and not yet ready for use.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ElasticsearchObjectStoreType {
    #[serde(rename = "s3")]
    S3,
    #[serde(rename = "gcs")]
    Gcs,
...
/// This must be enabled if this cluster is a remote cluster which is expected to be accessed using API key authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServer {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Service defines the template for the remote cluster server Service object.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<ElasticsearchRemoteClusterServerService>,
}

/// Service defines the template for the remote cluster server Service object.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerService {
    /// ObjectMeta is the metadata of the service.
    /// The name and namespace provided here are managed by ECK and will be ignored.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<ElasticsearchRemoteClusterServerServiceMetadata>,
    /// Spec is the specification of the service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<ElasticsearchRemoteClusterServerServiceSpec>,
}

/// ObjectMeta is the metadata of the service.
/// The name and namespace provided here are managed by ECK and will be ignored.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerServiceMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub finalizers: Option<Vec<String>>,
...
/// Spec is the specification of the service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerServiceSpec {
    /// allocateLoadBalancerNodePorts defines if NodePorts will be automatically
    /// allocated for services with type LoadBalancer.  Default is "true". It
    /// may be set to "false" if the cluster load-balancer does not rely on
    /// NodePorts.  If the caller requests specific NodePorts (by specifying a
    ...
    /// More info: <https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<ElasticsearchRemoteClusterServerServiceSpecPorts>>,
    /// publishNotReadyAddresses indicates that any agent which deals with endpoints for this
    /// Service should disregard any indications of ready/not-ready.
    /// The primary use case for setting this field is for a StatefulSet's Headless Service to
    /// propagate SRV DNS records for its Pods for the purpose of peer discovery.
    ...
    /// sessionAffinityConfig contains the configurations of session affinity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sessionAffinityConfig")]
    pub session_affinity_config: Option<ElasticsearchRemoteClusterServerServiceSpecSessionAffinityConfig>,
    /// TrafficDistribution offers a way to express preferences for how traffic
    /// is distributed to Service endpoints. Implementations can use this field
    /// as a hint, but are not required to guarantee strict adherence. If the
    /// field is not set, the implementation will apply its default routing
...
/// ServicePort contains information on service's port.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerServiceSpecPorts {
    /// The application protocol for this port.
    /// This is used as a hint for implementations to offer richer behavior for protocols that they understand.
    /// This field follows standard Kubernetes label syntax.
    /// Valid values are either:
...
/// sessionAffinityConfig contains the configurations of session affinity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerServiceSpecSessionAffinityConfig {
    /// clientIP contains the configurations of Client IP based session affinity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientIP")]
    pub client_ip: Option<ElasticsearchRemoteClusterServerServiceSpecSessionAffinityConfigClientIp>,
}

/// clientIP contains the configurations of Client IP based session affinity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClusterServerServiceSpecSessionAffinityConfigClientIp {
    /// timeoutSeconds specifies the seconds of ClientIP type session sticky time.
    /// The value must be >0 && <=86400(for 1 day) if ServiceAffinity == "ClientIP".
    /// Default value is 10800(for 3 hours).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeoutSeconds")]
...
pub struct ElasticsearchRemoteClusters {
    ...
    pub api_key: Option<ElasticsearchRemoteClustersApiKey>,
...
/// APIKey can be used to enable remote cluster access using Cross-Cluster API keys: <https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-security-create-cross-cluster-api-key>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClustersApiKey {
    /// Access is the name of the API Key. It is automatically generated if not set or empty.
    pub access: ElasticsearchRemoteClustersApiKeyAccess,
}

/// Access is the name of the API Key. It is automatically generated if not set or empty.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClustersApiKeyAccess {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replication: Option<ElasticsearchRemoteClustersApiKeyAccessReplication>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub search: Option<ElasticsearchRemoteClustersApiKeyAccessSearch>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClustersApiKeyAccessReplication {
    pub names: Vec<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClustersApiKeyAccessSearch {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub allow_restricted_indices: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub field_security: Option<ElasticsearchRemoteClustersApiKeyAccessSearchFieldSecurity>,
    pub names: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub query: Option<BTreeMap<String, serde_json::Value>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ElasticsearchRemoteClustersApiKeyAccessSearchFieldSecurity {
