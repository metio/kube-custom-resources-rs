...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/reddec/keycloak-ext-operator/keycloak.k8s.reddec.net/v1alpha1/keycloakclients.yaml
