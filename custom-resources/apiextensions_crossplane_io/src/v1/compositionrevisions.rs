...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/apiextensions.crossplane.io/v1/compositionrevisions.yaml
...
#[kube(group = "apiextensions.crossplane.io", version = "v1", kind = "CompositionRevision", plural = "compositionrevisions")]
...
pub struct CompositionRevisionPipeline {
    ...
    /// request them first.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requirements: Option<CompositionRevisionPipelineRequirements>,
...
/// request them first.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositionRevisionPipelineRequirements {
    ...
    pub required_resources: Option<Vec<CompositionRevisionPipelineRequirementsRequiredResources>>,
    ...
    pub required_schemas: Option<Vec<CompositionRevisionPipelineRequirementsRequiredSchemas>>,
}

/// RequiredResourceSelector selects a required resource.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositionRevisionPipelineRequirementsRequiredResources {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositionRevisionPipelineRequirementsRequiredSchemas {
