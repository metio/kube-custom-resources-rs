...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/apiextensions.crossplane.io/v2alpha1/compositeresourcedefinitions.yaml
...
#[kube(group = "apiextensions.crossplane.io", version = "v2alpha1", kind = "CompositeResourceDefinition", plural = "compositeresourcedefinitions")]
