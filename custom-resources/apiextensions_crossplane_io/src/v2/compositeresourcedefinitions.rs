...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/apiextensions.crossplane.io/v2/compositeresourcedefinitions.yaml
...
#[kube(group = "apiextensions.crossplane.io", version = "v2", kind = "CompositeResourceDefinition", plural = "compositeresourcedefinitions")]
...
pub struct CompositeResourceDefinitionSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultCompositionRevisionSelector")]
    pub default_composition_revision_selector: Option<CompositeResourceDefinitionDefaultCompositionRevisionSelector>,
...
/// in case no compositionRevision selector is given.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositeResourceDefinitionDefaultCompositionRevisionSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<CompositeResourceDefinitionDefaultCompositionRevisionSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositeResourceDefinitionDefaultCompositionRevisionSelectorMatchExpressions {
...
pub struct CompositeResourceDefinitionVersions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subresources: Option<CompositeResourceDefinitionVersionsSubresources>,
}
...
/// The composition authors have responsibility to implement the logic fulfilling the subresources.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositeResourceDefinitionVersionsSubresources {
    /// Scale indicates the CRD should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scale: Option<CompositeResourceDefinitionVersionsSubresourcesScale>,
}

/// Scale indicates the CRD should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CompositeResourceDefinitionVersionsSubresourcesScale {
