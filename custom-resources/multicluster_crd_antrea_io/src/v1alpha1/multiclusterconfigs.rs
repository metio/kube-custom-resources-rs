...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/antrea-io/antrea/multicluster.crd.antrea.io/v1alpha1/multiclusterconfigs.yaml
