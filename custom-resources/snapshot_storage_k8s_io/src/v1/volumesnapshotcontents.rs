...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-csi/external-snapshotter/snapshot.storage.k8s.io/v1/volumesnapshotcontents.yaml
