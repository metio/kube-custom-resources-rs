...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-csi/external-snapshotter/snapshot.storage.k8s.io/v1beta1/volumesnapshotcontents.yaml
...
#[kube(group = "snapshot.storage.k8s.io", version = "v1beta1", kind = "VolumeSnapshotContent", plural = "volumesnapshotcontents")]
