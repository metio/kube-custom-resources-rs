...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/keycloak/keycloak-operator/keycloak.org/v1alpha1/keycloakrealms.yaml
...
pub struct KeycloakRealmRealm {
    ...
    pub client_scope_mappings: Option<BTreeMap<String, Vec<KeycloakRealmRealmClientScopeMappings>>>,
    /// Client scopes
...
pub struct KeycloakRealmRealmClientsAuthorizationSettingsPolicies {
    ...
    pub scopes_data: Option<Vec<serde_json::Value>>,
    /// Type.
...
pub struct KeycloakRealmRealmRoles {
    /// Client Roles
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client: Option<BTreeMap<String, Vec<KeycloakRealmRealmRolesClient>>>,
    /// Realm Roles
    #[serde(default, skip_serializing_if = "Option::is_none")]
