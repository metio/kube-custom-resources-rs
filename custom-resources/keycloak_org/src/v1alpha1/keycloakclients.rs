...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/keycloak/keycloak-operator/keycloak.org/v1alpha1/keycloakclients.yaml
...
pub struct KeycloakClientSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceAccountClientRoles"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceAccountRealmRoles"
    )]
...
pub struct KeycloakClientClientAuthorizationSettingsScopesPolicies {
    ...
    pub resources_data:
        Option<Vec<KeycloakClientClientAuthorizationSettingsScopesPoliciesResourcesData>>,
    /// Scopes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scopes: Option<Vec<String>>,
    /// Scopes Data.
