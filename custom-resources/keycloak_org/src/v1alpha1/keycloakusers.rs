...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/keycloak/keycloak-operator/keycloak.org/v1alpha1/keycloakusers.yaml
