...
pub struct AlertmanagerConfigReceiversEmailConfigs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub threading: Option<AlertmanagerConfigReceiversEmailConfigsThreading>,
...
/// It requires Alertmanager >= v0.30.0.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct AlertmanagerConfigReceiversEmailConfigsThreading {
    ...
    #[serde(rename = "threadByDate")]
    pub thread_by_date: AlertmanagerConfigReceiversEmailConfigsThreadingThreadByDate,
}

/// threading defines the threading configuration for email receiver.
/// It requires Alertmanager >= v0.30.0.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AlertmanagerConfigReceiversEmailConfigsThreadingThreadByDate {
    Daily,
    None,
}
...
pub struct AlertmanagerConfigReceiversSlackConfigs {
    ...
    /// It requires Alertmanager >= v0.31.0.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "messageText")]
