...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/prometheus-operator/prometheus-operator/monitoring.coreos.com/v1/prometheuses.yaml
...
pub struct PrometheusSpec {
    ...
    pub persistent_volume_claim_retention_policy:
        Option<PrometheusPersistentVolumeClaimRetentionPolicy>,
    ...
    pub prometheus_rules_excluded_from_enforce:
...
pub struct PrometheusAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution {
    ...
    pub preference:
        PrometheusAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference,
...
pub struct PrometheusAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecution {
    ...
    pub pod_affinity_term:
        PrometheusAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm,
...
pub struct PrometheusAffinityPodAntiAffinity {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<
        Vec<PrometheusAffinityPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution>,
    >,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<
        Vec<PrometheusAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution>,
    >,
}
...
pub struct PrometheusRemoteReadOauth2 {
    ...
    pub proxy_connect_header:
        Option<BTreeMap<String, PrometheusRemoteReadOauth2ProxyConnectHeader>>,
    /// Whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    ///
    /// It requires Prometheus >= v2.43.0 or Alertmanager >= 0.25.0.
    #[serde(
...
pub struct PrometheusRemoteWriteOauth2 {
    ...
    pub proxy_connect_header:
        Option<BTreeMap<String, PrometheusRemoteWriteOauth2ProxyConnectHeader>>,
    /// Whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    ///
    /// It requires Prometheus >= v2.43.0 or Alertmanager >= 0.25.0.
    #[serde(
...
pub struct PrometheusStorageEphemeralVolumeClaimTemplateSpecSelector {
    ...
    pub match_expressions:
        Option<Vec<PrometheusStorageEphemeralVolumeClaimTemplateSpecSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(
...
pub struct PrometheusStorageVolumeClaimTemplateSpecSelector {
    ...
    pub match_expressions:
        Option<Vec<PrometheusStorageVolumeClaimTemplateSpecSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(
...
pub struct PrometheusThanos {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "objectStorageConfigFile"
    )]
...
pub struct PrometheusTopologySpreadConstraints {
    ...
    pub additional_label_selectors:
        Option<PrometheusTopologySpreadConstraintsAdditionalLabelSelectors>,
...
pub struct PrometheusTopologySpreadConstraintsLabelSelector {
    ...
    pub match_expressions:
        Option<Vec<PrometheusTopologySpreadConstraintsLabelSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(
...
pub struct PrometheusVolumesEphemeralVolumeClaimTemplateSpecSelector {
    ...
    pub match_expressions:
        Option<Vec<PrometheusVolumesEphemeralVolumeClaimTemplateSpecSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(
...
pub struct PrometheusVolumesProjectedSourcesClusterTrustBundleLabelSelector {
    ...
    pub match_expressions: Option<
        Vec<PrometheusVolumesProjectedSourcesClusterTrustBundleLabelSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct PrometheusVolumesProjectedSourcesDownwardApiItems {
    ...
    pub resource_field_ref:
        Option<PrometheusVolumesProjectedSourcesDownwardApiItemsResourceFieldRef>,
}
