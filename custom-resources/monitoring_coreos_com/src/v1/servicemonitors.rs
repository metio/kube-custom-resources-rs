...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/prometheus-operator/prometheus-operator/monitoring.coreos.com/v1/servicemonitors.yaml
...
pub struct ServiceMonitorEndpointsOauth2 {
    ...
    pub proxy_connect_header:
        Option<BTreeMap<String, ServiceMonitorEndpointsOauth2ProxyConnectHeader>>,
