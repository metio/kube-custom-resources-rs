...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/prometheus-operator/prometheus-operator/monitoring.coreos.com/v1/alertmanagers.yaml
...
pub struct AlertmanagerSpec {
    ...
    pub pod_management_policy: Option<AlertmanagerPodManagementPolicy>,
...
pub struct AlertmanagerAlertmanagerConfigurationGlobal {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mattermost: Option<AlertmanagerAlertmanagerConfigurationGlobalMattermost>,
...
/// mattermost defines the default Mattermost Config
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AlertmanagerAlertmanagerConfigurationGlobalMattermost {
    ...
    pub webhook_url: Option<AlertmanagerAlertmanagerConfigurationGlobalMattermostWebhookUrl>,
}
...
/// It requires Alertmanager >= v0.32.0.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AlertmanagerAlertmanagerConfigurationGlobalMattermostWebhookUrl {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct AlertmanagerAlertmanagerConfigurationGlobalSmtp {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceImplicitTLS")]
    pub force_implicit_tls: Option<bool>,
...
/// <https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status>
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AlertmanagerPodManagementPolicy {
    OrderedReady,
    Parallel,
}
