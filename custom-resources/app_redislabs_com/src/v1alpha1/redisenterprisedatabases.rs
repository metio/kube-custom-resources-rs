...
pub struct RedisEnterpriseDatabaseSpec {
    ...
    pub connection_settings: Option<RedisEnterpriseDatabaseConnectionSettings>,
    ...
    pub oss_cluster_settings: Option<RedisEnterpriseDatabaseOssClusterSettings>,
...
/// Connection-related settings such as proxy connections and scheduling policy.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RedisEnterpriseDatabaseConnectionSettings {
    /// Connections limit type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionLimitType")]
    pub connection_limit_type: Option<RedisEnterpriseDatabaseConnectionSettingsConnectionLimitType>,
    ...
    pub connection_scheduling_policy: Option<RedisEnterpriseDatabaseConnectionSettingsConnectionSchedulingPolicy>,
...
pub enum RedisEnterpriseDatabaseConnectionSettingsConnectionLimitType {
...
/// Connection-related settings such as proxy connections and scheduling policy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum RedisEnterpriseDatabaseConnectionSettingsConnectionSchedulingPolicy {
    #[serde(rename = "cmp")]
    Cmp,
    #[serde(rename = "mru")]
    Mru,
...
/// Additional OSS cluster mode settings.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RedisEnterpriseDatabaseOssClusterSettings {
