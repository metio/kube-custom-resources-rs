...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/RedisLabs/redis-enterprise-k8s-docs/app.redislabs.com/v1alpha1/redisenterprisedatabases.yaml
...
pub struct RedisEnterpriseDatabaseSpec {
    ...
    pub upgrade_spec: Option<RedisEnterpriseDatabaseUpgradeSpec>,
}
...
pub struct RedisEnterpriseDatabaseAlertSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bdb_crdt_src_high_syncer_lag:
        Option<RedisEnterpriseDatabaseAlertSettingsBdbCrdtSrcHighSyncerLag>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bdb_crdt_src_syncer_connection_error:
        Option<RedisEnterpriseDatabaseAlertSettingsBdbCrdtSrcSyncerConnectionError>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bdb_crdt_src_syncer_general_error:
        Option<RedisEnterpriseDatabaseAlertSettingsBdbCrdtSrcSyncerGeneralError>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bdb_replica_src_high_syncer_lag:
        Option<RedisEnterpriseDatabaseAlertSettingsBdbReplicaSrcHighSyncerLag>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bdb_replica_src_syncer_connection_error:
        Option<RedisEnterpriseDatabaseAlertSettingsBdbReplicaSrcSyncerConnectionError>,
...
pub struct RedisEnterpriseDatabaseStatusBackupInfo {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "backupProgressPercentage"
    )]
