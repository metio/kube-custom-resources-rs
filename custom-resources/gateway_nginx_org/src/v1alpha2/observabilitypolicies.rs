...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/nginxinc/nginx-kubernetes-gateway/gateway.nginx.org/v1alpha2/observabilitypolicies.yaml
...
#[kube(group = "gateway.nginx.org", version = "v1alpha2", kind = "ObservabilityPolicy", plural = "observabilitypolicies")]
#[kube(namespaced)]
