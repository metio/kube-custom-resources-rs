...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/k8up-io/k8up/k8up.io/v1/prunes.yaml
...
pub struct PrunePodSecurityContext {
    ...
    pub app_armor_profile: Option<PrunePodSecurityContextAppArmorProfile>,
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PrunePodSecurityContextAppArmorProfile {
