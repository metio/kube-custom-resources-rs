...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2alpha1/ciliumbgpnodeconfigoverrides.yaml
...
#[kube(group = "cilium.io", version = "v2alpha1", kind = "CiliumBGPNodeConfigOverride", root = "CiliumBgpNodeConfigOverride", plural = "ciliumbgpnodeconfigoverrides")]
