...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2/ciliumnodeconfigs.yaml
...
#[kube(group = "cilium.io", version = "v2", kind = "CiliumNodeConfig", plural = "ciliumnodeconfigs")]
#[kube(namespaced)]
