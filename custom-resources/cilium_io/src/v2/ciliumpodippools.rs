...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2/ciliumpodippools.yaml
...
#[kube(group = "cilium.io", version = "v2", kind = "CiliumPodIPPool", root = "CiliumPodIpPool", plural = "ciliumpodippools")]
...
pub struct CiliumPodIpPoolIpv4 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pool: Option<Vec<CiliumPodIpPoolIpv4Pool>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CiliumPodIpPoolIpv4Pool {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedRanges")]
    pub reserved_ranges: Option<Vec<CiliumPodIpPoolIpv4PoolReservedRanges>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CiliumPodIpPoolIpv4PoolReservedRanges {
...
pub struct CiliumPodIpPoolIpv6 {
    ...
    /// Each entry must reference a CIDR in CIDRs.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pool: Option<Vec<CiliumPodIpPoolIpv6Pool>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CiliumPodIpPoolIpv6Pool {
    /// CIDR references one of the CIDRs listed in the parent pool spec.
    pub cidr: String,
    /// ReservedRanges is a list of IP ranges within CIDR that must not be allocated.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedRanges")]
    pub reserved_ranges: Option<Vec<CiliumPodIpPoolIpv6PoolReservedRanges>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CiliumPodIpPoolIpv6PoolReservedRanges {
    /// The last IP in the reserved range.
    pub end: String,
    /// The first IP in the reserved range.
    pub start: String,
