...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2/ciliumbgpadvertisements.yaml
...
#[kube(group = "cilium.io", version = "v2", kind = "CiliumBGPAdvertisement", root = "CiliumBgpAdvertisement", plural = "ciliumbgpadvertisements")]
