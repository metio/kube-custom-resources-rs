...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2/ciliumenvoyconfigs.yaml
...
#[kube(group = "cilium.io", version = "v2", kind = "CiliumEnvoyConfig", plural = "ciliumenvoyconfigs")]
#[kube(namespaced)]
...
pub struct CiliumEnvoyConfigSpec {
    ...
    pub node_selector: Option<CiliumEnvoyConfigNodeSelector>,
...
/// If nil, then this config applies to all nodes.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CiliumEnvoyConfigNodeSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<CiliumEnvoyConfigNodeSelectorMatchExpressions>>,
...
pub struct CiliumEnvoyConfigNodeSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator: CiliumEnvoyConfigNodeSelectorMatchExpressionsOperator,
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CiliumEnvoyConfigNodeSelectorMatchExpressionsOperator {
    In,
    NotIn,
    Exists,
    DoesNotExist,
