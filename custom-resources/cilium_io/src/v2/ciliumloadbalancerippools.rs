...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cilium/cilium/cilium.io/v2/ciliumloadbalancerippools.yaml
...
#[kube(group = "cilium.io", version = "v2", kind = "CiliumLoadBalancerIPPool", root = "CiliumLoadBalancerIpPool", plural = "ciliumloadbalancerippools")]
