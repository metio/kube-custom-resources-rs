...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kube-green/kube-green/kube-green.com/v1alpha1/sleepinfos.yaml
