...
pub struct CanarySpec {
    ...
    pub provider: Option<CanaryProvider>,
...
/// CanarySpec defines the desired state of a Canary.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CanaryProvider {
    #[serde(rename = "apisix")]
    Apisix,
    #[serde(rename = "appmesh")]
    Appmesh,
    #[serde(rename = "appmesh:v1beta2")]
    AppmeshV1beta2,
    #[serde(rename = "contour")]
    Contour,
    #[serde(rename = "gatewayapi:v1")]
    GatewayapiV1,
    #[serde(rename = "gatewayapi:v1beta1")]
    GatewayapiV1beta1,
    #[serde(rename = "gloo")]
    Gloo,
    #[serde(rename = "istio")]
    ...
    #[serde(rename = "osm")]
    Osm,
    #[serde(rename = "skipper")]
    Skipper,
    #[serde(rename = "smi:v1alpha1")]
    SmiV1alpha1,
    #[serde(rename = "smi:v1alpha2")]
    SmiV1alpha2,
    #[serde(rename = "smi:v1alpha3")]
    SmiV1alpha3,
...
pub struct CanaryService {
    ...
    /// Backend request timeout (Gateway API only)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "backendTimeout")]
    pub backend_timeout: Option<String>,
