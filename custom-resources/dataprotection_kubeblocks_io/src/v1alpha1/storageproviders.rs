...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/apecloud/kubeblocks/dataprotection.kubeblocks.io/v1alpha1/storageproviders.yaml
...
#[kube(group = "dataprotection.kubeblocks.io", version = "v1alpha1", kind = "StorageProvider", plural = "storageproviders")]
