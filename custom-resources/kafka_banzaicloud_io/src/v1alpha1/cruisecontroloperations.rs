...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/banzaicloud/koperator/kafka.banzaicloud.io/v1alpha1/cruisecontroloperations.yaml
