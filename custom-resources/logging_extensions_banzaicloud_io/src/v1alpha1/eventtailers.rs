...
pub struct EventTailerWorkloadOverridesVolumesProjectedSources {
    ...
    pub pod_certificate: Option<EventTailerWorkloadOverridesVolumesProjectedSourcesPodCertificate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EventTailerWorkloadOverridesVolumesProjectedSourcesPodCertificate {
