...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tungstenfabric/tf-operator/tf.tungsten.io/v1alpha1/rabbitmqs.yaml
...
pub struct RabbitmqCommonConfigurationAuthParameters {
    ...
    pub keystone_auth_parameters:
        Option<RabbitmqCommonConfigurationAuthParametersKeystoneAuthParameters>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
