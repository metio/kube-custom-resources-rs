...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tungstenfabric/tf-operator/tf.tungsten.io/v1alpha1/queryengine.yaml
...
pub struct QueryEngineCommonConfigurationAuthParameters {
    ...
    pub keystone_auth_parameters:
        Option<QueryEngineCommonConfigurationAuthParametersKeystoneAuthParameters>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
