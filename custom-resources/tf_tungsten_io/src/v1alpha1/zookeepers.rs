...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tungstenfabric/tf-operator/tf.tungsten.io/v1alpha1/zookeepers.yaml
...
#[kube(group = "tf.tungsten.io", version = "v1alpha1", kind = "Zookeeper", plural = "zookeepers")]
#[kube(namespaced)]
#[kube(status = "ZookeeperStatus")]
...
pub struct ZookeeperSpec {
    ...
    pub common_configuration: Option<ZookeeperCommonConfiguration>,
    /// ZookeeperConfiguration is the Spec for the zookeeper API.
    #[serde(rename = "serviceConfiguration")]
    pub service_configuration: ZookeeperServiceConfiguration,
}

/// PodConfiguration is the common services struct.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperCommonConfiguration {
    /// AuthParameters auth parameters
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authParameters")]
    pub auth_parameters: Option<ZookeeperCommonConfigurationAuthParameters>,
    /// OS family
    ...
    pub log_level: Option<ZookeeperCommonConfigurationLogLevel>,
    /// NodeSelector is a selector which must be true for the pod to fit on a node. Selector which must match a node's labels for the pod to be scheduled on that node. More info: <https://kubernetes.io/docs/concepts/configuration/assign-pod-node/.>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nodeSelector")]
    pub node_selector: Option<BTreeMap<String, String>>,
    /// If specified, the pod's tolerations.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<ZookeeperCommonConfigurationTolerations>>,
}

/// AuthParameters auth parameters
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperCommonConfigurationAuthParameters {
    /// AuthenticationMode auth mode
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authMode")]
    pub auth_mode: Option<ZookeeperCommonConfigurationAuthParametersAuthMode>,
    /// KeystoneAuthParameters keystone parameters
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "keystoneAuthParameters")]
    pub keystone_auth_parameters: Option<ZookeeperCommonConfigurationAuthParametersKeystoneAuthParameters>,
...
pub enum ZookeeperCommonConfigurationAuthParametersAuthMode {
    #[serde(rename = "noauth")]
    Noauth,
...
/// KeystoneAuthParameters keystone parameters
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperCommonConfigurationAuthParametersKeystoneAuthParameters {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// PodConfiguration is the common services struct.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ZookeeperCommonConfigurationLogLevel {
    #[serde(rename = "info")]
    Info,
    #[serde(rename = "debug")]
    Debug,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperCommonConfigurationTolerations {
...
/// ZookeeperConfiguration is the Spec for the zookeeper API.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperServiceConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub containers: Option<Vec<ZookeeperServiceConfigurationContainers>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperServiceConfigurationContainers {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ZookeeperStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub nodes: Option<BTreeMap<String, ZookeeperStatusNodes>>,
    /// ZookeeperStatusPorts defines the status of the ports of the zookeeper object.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<ZookeeperStatusPorts>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperStatusNodes {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// ZookeeperStatusPorts defines the status of the ports of the zookeeper object.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ZookeeperStatusPorts {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientPort")]
