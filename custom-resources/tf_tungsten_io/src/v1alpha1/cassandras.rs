...
pub struct CassandraCommonConfigurationAuthParameters {
    ...
    pub keystone_auth_parameters:
        Option<CassandraCommonConfigurationAuthParametersKeystoneAuthParameters>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct CassandraServiceConfigurationCassandraParameters {
    ...
    pub memtable_allocation_type:
        Option<CassandraServiceConfigurationCassandraParametersMemtableAllocationType>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
