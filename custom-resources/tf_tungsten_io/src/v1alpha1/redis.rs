...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tungstenfabric/tf-operator/tf.tungsten.io/v1alpha1/redis.yaml
