...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/documentdb-controller/documentdb.services.k8s.aws/v1alpha1/dbinstances.yaml
...
pub struct DBInstanceSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "performanceInsightsKMSKeyRef"
    )]
...
pub struct DBInstanceStatusDbSubnetGroupSubnets {
    ...
    pub subnet_availability_zone:
        Option<DBInstanceStatusDbSubnetGroupSubnetsSubnetAvailabilityZone>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DBInstanceStatusPendingModifiedValues {
    ...
    pub pending_cloudwatch_logs_exports:
        Option<DBInstanceStatusPendingModifiedValuesPendingCloudwatchLogsExports>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<i64>,
    #[serde(
        default,
