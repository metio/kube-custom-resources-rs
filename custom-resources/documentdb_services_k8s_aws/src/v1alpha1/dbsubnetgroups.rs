...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/documentdb-controller/documentdb.services.k8s.aws/v1alpha1/dbsubnetgroups.yaml
...
#[kube(group = "documentdb.services.k8s.aws", version = "v1alpha1", kind = "DBSubnetGroup", root = "DbSubnetGroup", plural = "dbsubnetgroups")]
#[kube(namespaced)]
