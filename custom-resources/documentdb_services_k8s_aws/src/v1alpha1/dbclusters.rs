...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/documentdb-controller/documentdb.services.k8s.aws/v1alpha1/dbclusters.yaml
...
#[kube(group = "documentdb.services.k8s.aws", version = "v1alpha1", kind = "DBCluster", root = "DbCluster", plural = "dbclusters")]
#[kube(namespaced)]
...
pub struct DbClusterStatus {
    ...
    /// storage type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "iOOptimizedNextAllowedModificationTime")]
