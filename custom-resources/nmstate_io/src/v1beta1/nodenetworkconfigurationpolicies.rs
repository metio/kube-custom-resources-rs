...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/nmstate/kubernetes-nmstate/nmstate.io/v1beta1/nodenetworkconfigurationpolicies.yaml
...
#[kube(group = "nmstate.io", version = "v1beta1", kind = "NodeNetworkConfigurationPolicy", plural = "nodenetworkconfigurationpolicies")]
