...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/koordinator-sh/koordinator/scheduling.sigs.k8s.io/v1alpha1/podgroups.yaml
