...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/keycloak/keycloak-k8s-resources/k8s.keycloak.org/v2beta1/keycloakrealmimports.yaml
...
#[kube(group = "k8s.keycloak.org", version = "v2beta1", kind = "KeycloakRealmImport", plural = "keycloakrealmimports")]
#[kube(namespaced)]
