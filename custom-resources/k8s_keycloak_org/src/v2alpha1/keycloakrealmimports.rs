...
pub struct KeycloakRealmImportRealm {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxSecondaryAuthFailures")]
    pub max_secondary_auth_failures: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scimApiEnabled")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webAuthnPolicyPasswordlessMediation")]
    pub web_authn_policy_passwordless_mediation: Option<String>,
...
pub struct KeycloakRealmImportRealmFederatedUsers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "verifiableCredentials")]
    pub verifiable_credentials: Option<Vec<KeycloakRealmImportRealmFederatedUsersVerifiableCredentials>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KeycloakRealmImportRealmFederatedUsersVerifiableCredentials {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createdDate")]
    pub created_date: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialScopeName")]
    pub credential_scope_name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub revision: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userAttributes")]
    pub user_attributes: Option<BTreeMap<String, Vec<String>>>,
}
...
pub struct KeycloakRealmImportRealmOrganizationsMembers {
    ...
    pub username: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "verifiableCredentials")]
    pub verifiable_credentials: Option<Vec<KeycloakRealmImportRealmOrganizationsMembersVerifiableCredentials>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KeycloakRealmImportRealmOrganizationsMembersVerifiableCredentials {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createdDate")]
    pub created_date: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialScopeName")]
    pub credential_scope_name: Option<String>,
...
pub struct KeycloakRealmImportRealmUsers {
    ...
    pub username: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "verifiableCredentials")]
    pub verifiable_credentials: Option<Vec<KeycloakRealmImportRealmUsersVerifiableCredentials>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KeycloakRealmImportRealmUsersVerifiableCredentials {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createdDate")]
    pub created_date: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialScopeName")]
    pub credential_scope_name: Option<String>,
