...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/metacontroller/metacontroller/metacontroller.k8s.io/v1alpha1/decoratorcontrollers.yaml
