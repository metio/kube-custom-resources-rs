...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluxcd/helm-controller/helm.toolkit.fluxcd.io/v2/helmreleases.yaml
...
pub struct HelmReleaseSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "postRenderStrategy")]
