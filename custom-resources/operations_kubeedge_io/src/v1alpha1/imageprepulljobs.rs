...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubeedge/kubeedge/operations.kubeedge.io/v1alpha1/imageprepulljobs.yaml
...
#[kube(group = "operations.kubeedge.io", version = "v1alpha1", kind = "ImagePrePullJob", plural = "imageprepulljobs")]
