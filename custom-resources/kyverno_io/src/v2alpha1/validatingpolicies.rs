...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/kyverno.io/v2alpha1/validatingpolicies.yaml
...
#[kube(group = "kyverno.io", version = "v2alpha1", kind = "ValidatingPolicy", plural = "validatingpolicies")]
...
pub struct ValidatingPolicySpec {
    ...
    pub param_kind: Option<ValidatingPolicyParamKind>,
...
/// If paramKind is specified but paramRef is unset in ValidatingAdmissionPolicyBinding, the params variable will be null.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ValidatingPolicyParamKind {
