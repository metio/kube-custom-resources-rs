...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/kyverno.io/v2beta1/globalcontextentries.yaml
...
#[kube(group = "kyverno.io", version = "v2beta1", kind = "GlobalContextEntry", plural = "globalcontextentries")]
