...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/kyverno.io/v1alpha2/clusterbackgroundscanreports.yaml
...
pub struct ClusterBackgroundScanReportResultsResourceSelector {
    ...
    pub match_expressions:
        Option<Vec<ClusterBackgroundScanReportResultsResourceSelectorMatchExpressions>>,
