...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/mattermost/mattermost-operator/mattermost.com/v1alpha1/clusterinstallations.yaml
