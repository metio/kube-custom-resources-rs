...
pub struct ClusterManagerSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementConfiguration")]
    pub placement_configuration: Option<ClusterManagerPlacementConfiguration>,
...
pub struct ClusterManagerDeployOptionDefault {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addonWebhookConfiguration")]
    pub addon_webhook_configuration: Option<ClusterManagerDeployOptionDefaultAddonWebhookConfiguration>,
...
/// AddonWebhookConfiguration represents the customized webhook-server configuration of addons.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterManagerDeployOptionDefaultAddonWebhookConfiguration {
    ...
    pub bind_configuration: Option<ClusterManagerDeployOptionDefaultAddonWebhookConfigurationBindConfiguration>,
}

/// BindConfiguration represents server bind configuration for the webhook server
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterManagerDeployOptionDefaultAddonWebhookConfigurationBindConfiguration {
...
/// placementConfiguration contains the configuration of placement
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterManagerPlacementConfiguration {
    ...
    ///  	he can set featuregate/Foo=false before upgrading. Let's say the cluster-admin wants featuregate/Foo=false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "featureGates")]
    pub feature_gates: Option<Vec<ClusterManagerPlacementConfigurationFeatureGates>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterManagerPlacementConfigurationFeatureGates {
    /// Feature is the key of feature gate. e.g. featuregate/Foo.
    pub feature: String,
    /// Mode is either Enable, Disable, "" where "" is Disable by default.
    /// In Enable mode, a valid feature gate `featuregate/Foo` will be set to "--featuregate/Foo=true".
    /// In Disable mode, a valid feature gate `featuregate/Foo` will be set to "--featuregate/Foo=false".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<ClusterManagerPlacementConfigurationFeatureGatesMode>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterManagerPlacementConfigurationFeatureGatesMode {
    Enable,
    Disable,
}
