...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/smartxworks/virtink/virt.virtink.smartx.com/v1alpha1/virtualmachinemigrations.yaml
