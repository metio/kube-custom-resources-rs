...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/superedge/superedge/site.superedge.io/v1alpha1/nodegroups.yaml
