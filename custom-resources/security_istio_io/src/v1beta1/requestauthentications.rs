...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/security.istio.io/v1beta1/requestauthentications.yaml
...
pub struct RequestAuthenticationJwtRules {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spaceDelimitedClaims")]
    pub space_delimited_claims: Option<Vec<String>>,
