...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/rds-controller/rds.services.k8s.aws/v1alpha1/dbclusters.yaml
...
#[kube(group = "rds.services.k8s.aws", version = "v1alpha1", kind = "DBCluster", root = "DbCluster", plural = "dbclusters")]
#[kube(namespaced)]
