...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Alvearie/imaging-ingestion/imaging-ingestion.alvearie.org/v1alpha1/dicomeventdriveningestions.yaml
...
pub struct DicomEventDrivenIngestionEventProcessor {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DicomEventDrivenIngestionImagePullSecrets {
