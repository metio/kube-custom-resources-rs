...
pub struct FlowCollectorSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub execution: Option<FlowCollectorExecution>,
...
/// `execution` defines configuration related to the execution of the flow collection process.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorExecution {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<FlowCollectorExecutionMode>,
}

/// `execution` defines configuration related to the execution of the flow collection process.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorExecutionMode {
    #[serde(rename = "")]
    KopiumEmpty,
    Running,
    OnHold,
...
pub struct FlowCollectorExportersKafka {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compression: Option<FlowCollectorExportersKafkaCompression>,
...
/// Kafka configuration, such as the address and topic, to send enriched flows to.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorExportersKafkaCompression {
    #[serde(rename = "none")]
    None,
    #[serde(rename = "gzip")]
    Gzip,
...
pub struct FlowCollectorKafka {
    ...
    /// Accepted values are: `none` (default), `gzip`, `snappy`, `lz4`, `zstd`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compression: Option<FlowCollectorKafkaCompression>,
    /// SASL authentication configuration. [Unsupported (*)].
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Kafka configuration, allowing to use Kafka as a broker as part of the flow collection pipeline. Available when the `spec.deploymentModel` is `Kafka`.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorKafkaCompression {
    #[serde(rename = "none")]
    None,
    #[serde(rename = "gzip")]
    Gzip,
...
pub struct FlowCollectorProcessor {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<FlowCollectorProcessorService>,
...
pub struct FlowCollectorProcessorMetrics {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "additionalIncludeList")]
    pub additional_include_list: Option<Vec<String>>,
...
pub enum FlowCollectorProcessorMetricsHealthRulesTemplate {
    ...
    Ingress5xxErrors,
    #[serde(rename = "IngressHTTPLatencyTrend")]
...
/// Service configuration, only used when `spec.deploymentModel` is `Service`.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorProcessorService {
    /// TLS or mTLS configuration when `type` is set to `Provided`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "providedCertificates")]
    pub provided_certificates: Option<FlowCollectorProcessorServiceProvidedCertificates>,
    /// Select the type of TLS configuration:<br>
    ...
    #[serde(rename = "tlsType")]
    pub tls_type: FlowCollectorProcessorServiceTlsType,
}

/// TLS or mTLS configuration when `type` is set to `Provided`.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorProcessorServiceProvidedCertificates {
    /// Reference to the CA file.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caFile")]
    pub ca_file: Option<FlowCollectorProcessorServiceProvidedCertificatesCaFile>,
    ...
    pub client_cert: Option<FlowCollectorProcessorServiceProvidedCertificatesClientCert>,
    /// TLS server certificate reference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverCert")]
    pub server_cert: Option<FlowCollectorProcessorServiceProvidedCertificatesServerCert>,
}

/// Reference to the CA file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorProcessorServiceProvidedCertificatesCaFile {
    /// File name within the config map or secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub file: Option<String>,
    /// Name of the config map or secret containing the file.
    ...
    /// Type for the file reference: `configmap` or `secret`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<FlowCollectorProcessorServiceProvidedCertificatesCaFileType>,
}

/// Reference to the CA file.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorProcessorServiceProvidedCertificatesCaFileType {
    #[serde(rename = "configmap")]
    Configmap,
    #[serde(rename = "secret")]
    Secret,
...
/// TLS client certificate reference, used for mTLS. Leave unset for simple TLS.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorProcessorServiceProvidedCertificatesClientCert {
    /// `certFile` defines the path to the certificate file name within the config map or secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certFile")]
    pub cert_file: Option<String>,
    /// `certKey` defines the path to the certificate private key file name within the config map or secret. Omit when the key is not necessary.
    ...
    /// Type for the certificate reference: `configmap` or `secret`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<FlowCollectorProcessorServiceProvidedCertificatesClientCertType>,
}

/// TLS client certificate reference, used for mTLS. Leave unset for simple TLS.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorProcessorServiceProvidedCertificatesClientCertType {
    #[serde(rename = "configmap")]
    Configmap,
    #[serde(rename = "secret")]
    Secret,
...
/// TLS server certificate reference.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorProcessorServiceProvidedCertificatesServerCert {
    /// `certFile` defines the path to the certificate file name within the config map or secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certFile")]
    pub cert_file: Option<String>,
    /// `certKey` defines the path to the certificate private key file name within the config map or secret. Omit when the key is not necessary.
    ...
    /// Type for the certificate reference: `configmap` or `secret`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<FlowCollectorProcessorServiceProvidedCertificatesServerCertType>,
}

/// TLS server certificate reference.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorProcessorServiceProvidedCertificatesServerCertType {
    #[serde(rename = "configmap")]
    Configmap,
    #[serde(rename = "secret")]
    Secret,
...
/// Service configuration, only used when `spec.deploymentModel` is `Service`.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorProcessorServiceTlsType {
    Disabled,
    Provided,
    Auto,
    #[serde(rename = "Auto-mTLS")]
    AutoMTls,
}
...
pub struct FlowCollectorStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub components: Option<FlowCollectorStatusComponents>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub integrations: Option<FlowCollectorStatusIntegrations>,
...
/// `components` reports the status of operator-managed components (agent, processor, plugin).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorStatusComponents {
    /// `agent` reports the status of the eBPF agent component.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub agent: Option<FlowCollectorStatusComponentsAgent>,
    /// `plugin` reports the status of the console plugin component.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plugin: Option<FlowCollectorStatusComponentsPlugin>,
    /// `processor` reports the status of the flowlogs-pipeline component.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub processor: Option<FlowCollectorStatusComponentsProcessor>,
}

/// `agent` reports the status of the eBPF agent component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusComponentsAgent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "podIssues")]
    pub pod_issues: Option<String>,
    ...
    pub state: FlowCollectorStatusComponentsAgentState,
    /// `unhealthyPodCount` is the number of pods in a degraded state (CrashLoopBackOff, OOMKilled, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyPodCount")]
    pub unhealthy_pod_count: Option<i32>,
}

/// `agent` reports the status of the eBPF agent component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusComponentsAgentState {
    Ready,
    InProgress,
    Failure,
    Degraded,
...
/// `plugin` reports the status of the console plugin component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusComponentsPlugin {
    /// `desiredReplicas` is the desired number of replicas (for Deployments) or nodes (for DaemonSets).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredReplicas")]
    pub desired_replicas: Option<i32>,
    /// `message` is a human-readable description of the component's current state.
    ...
    pub reason: Option<String>,
    /// `state` reports the overall health of the component.
    pub state: FlowCollectorStatusComponentsPluginState,
    /// `unhealthyPodCount` is the number of pods in a degraded state (CrashLoopBackOff, OOMKilled, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyPodCount")]
    pub unhealthy_pod_count: Option<i32>,
}
...
/// `plugin` reports the status of the console plugin component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusComponentsPluginState {
    Ready,
    InProgress,
    Failure,
    Degraded,
...
/// `processor` reports the status of the flowlogs-pipeline component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusComponentsProcessor {
    /// `desiredReplicas` is the desired number of replicas (for Deployments) or nodes (for DaemonSets).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredReplicas")]
    pub desired_replicas: Option<i32>,
    /// `message` is a human-readable description of the component's current state.
    ...
    pub reason: Option<String>,
    /// `state` reports the overall health of the component.
    pub state: FlowCollectorStatusComponentsProcessorState,
    /// `unhealthyPodCount` is the number of pods in a degraded state (CrashLoopBackOff, OOMKilled, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyPodCount")]
    pub unhealthy_pod_count: Option<i32>,
}
...
/// `processor` reports the status of the flowlogs-pipeline component.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusComponentsProcessorState {
    Ready,
    InProgress,
    Failure,
    Degraded,
...
/// `integrations` reports the status of external integrations (Loki, monitoring, exporters).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FlowCollectorStatusIntegrations {
    /// `exporters` reports the status of configured exporters.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exporters: Option<Vec<FlowCollectorStatusIntegrationsExporters>>,
    /// `loki` reports the status of the Loki integration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub loki: Option<FlowCollectorStatusIntegrationsLoki>,
    /// `monitoring` reports the status of monitoring (dashboards, ServiceMonitor, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub monitoring: Option<FlowCollectorStatusIntegrationsMonitoring>,
}

/// `FlowCollectorExporterStatus` represents the status of a configured exporter.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusIntegrationsExporters {
    ...
    pub state: FlowCollectorStatusIntegrationsExportersState,
    /// `type` is the exporter type (Kafka, IPFIX, OpenTelemetry).
    #[serde(rename = "type")]
    pub r#type: FlowCollectorStatusIntegrationsExportersType,
}

/// `FlowCollectorExporterStatus` represents the status of a configured exporter.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusIntegrationsExportersState {
    Ready,
    InProgress,
    Failure,
    Degraded,
...
/// `FlowCollectorExporterStatus` represents the status of a configured exporter.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusIntegrationsExportersType {
    Kafka,
    #[serde(rename = "IPFIX")]
    Ipfix,
    OpenTelemetry,
...
/// `loki` reports the status of the Loki integration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusIntegrationsLoki {
    /// `desiredReplicas` is the desired number of replicas (for Deployments) or nodes (for DaemonSets).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredReplicas")]
    pub desired_replicas: Option<i32>,
    /// `message` is a human-readable description of the component's current state.
    ...
    pub reason: Option<String>,
    /// `state` reports the overall health of the component.
    pub state: FlowCollectorStatusIntegrationsLokiState,
    /// `unhealthyPodCount` is the number of pods in a degraded state (CrashLoopBackOff, OOMKilled, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyPodCount")]
    pub unhealthy_pod_count: Option<i32>,
}
...
/// `loki` reports the status of the Loki integration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusIntegrationsLokiState {
    Ready,
    InProgress,
    Failure,
    Degraded,
...
/// `monitoring` reports the status of monitoring (dashboards, ServiceMonitor, etc.).
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct FlowCollectorStatusIntegrationsMonitoring {
    /// `desiredReplicas` is the desired number of replicas (for Deployments) or nodes (for DaemonSets).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredReplicas")]
    pub desired_replicas: Option<i32>,
    /// `message` is a human-readable description of the component's current state.
    ...
    pub reason: Option<String>,
    /// `state` reports the overall health of the component.
    pub state: FlowCollectorStatusIntegrationsMonitoringState,
    /// `unhealthyPodCount` is the number of pods in a degraded state (CrashLoopBackOff, OOMKilled, etc.).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unhealthyPodCount")]
    pub unhealthy_pod_count: Option<i32>,
}
...
/// `monitoring` reports the status of monitoring (dashboards, ServiceMonitor, etc.).
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FlowCollectorStatusIntegrationsMonitoringState {
    Ready,
    InProgress,
    Failure,
    Degraded,
