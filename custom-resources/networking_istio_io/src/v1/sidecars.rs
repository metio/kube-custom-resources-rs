...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/networking.istio.io/v1/sidecars.yaml
...
pub struct SidecarInboundConnectionPoolHttp {
    ...
    pub http2_keep_alive: Option<SidecarInboundConnectionPoolHttpHttp2KeepAlive>,
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SidecarInboundConnectionPoolHttpHttp2KeepAlive {
...
pub struct SidecarIngressConnectionPoolHttp {
    ...
    /// Configure HTTP/2 PING frames for upstream connections.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2KeepAlive")]
    pub http2_keep_alive: Option<SidecarIngressConnectionPoolHttpHttp2KeepAlive>,
    /// Maximum number of active requests to a destination.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2MaxRequests")]
    pub http2_max_requests: Option<i32>,
    /// The idle timeout for upstream connection pool connections.
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SidecarIngressConnectionPoolHttpHttp2KeepAlive {
    /// Send HTTP/2 PING frames at this interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
    /// How long to wait for a response to an HTTP/2 PING frame before closing the connection.
