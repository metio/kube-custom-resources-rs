...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/networking.istio.io/v1/virtualservices.yaml
...
#[kube(group = "networking.istio.io", version = "v1", kind = "VirtualService", plural = "virtualservices")]
#[kube(namespaced)]
...
pub struct VirtualServiceHttpRetries {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryIgnorePreviousHosts")]
    pub retry_ignore_previous_hosts: Option<bool>,
...
pub struct VirtualServiceStatus {
    ...
    pub validation_messages: Option<Vec<VirtualServiceStatusValidationMessages>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServiceStatusValidationMessages {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub level: Option<VirtualServiceStatusValidationMessagesLevel>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<VirtualServiceStatusValidationMessagesType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VirtualServiceStatusValidationMessagesLevel {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServiceStatusValidationMessagesType {
