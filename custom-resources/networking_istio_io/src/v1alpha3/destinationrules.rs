...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/networking.istio.io/v1alpha3/destinationrules.yaml
...
pub struct DestinationRuleSubsetsTrafficPolicyConnectionPoolHttp {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2KeepAlive")]
    pub http2_keep_alive: Option<DestinationRuleSubsetsTrafficPolicyConnectionPoolHttpHttp2KeepAlive>,
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyConnectionPoolHttpHttp2KeepAlive {
...
pub struct DestinationRuleSubsetsTrafficPolicyLoadBalancer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub warmup: Option<DestinationRuleSubsetsTrafficPolicyLoadBalancerWarmup>,
...
pub struct DestinationRuleSubsetsTrafficPolicyLoadBalancerConsistentHashHttpCookie {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<DestinationRuleSubsetsTrafficPolicyLoadBalancerConsistentHashHttpCookieAttributes>>,
    /// Name of the cookie.
    pub name: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyLoadBalancerConsistentHashHttpCookieAttributes {
...
/// Represents the warmup configuration of Service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyLoadBalancerWarmup {
    /// This parameter controls the speed of traffic increase over the warmup duration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aggression: Option<f64>,
    pub duration: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "minimumPercent")]
...
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsConnectionPoolHttp {
    ...
    /// Configure HTTP/2 PING frames for upstream connections.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2KeepAlive")]
    pub http2_keep_alive: Option<DestinationRuleSubsetsTrafficPolicyPortLevelSettingsConnectionPoolHttpHttp2KeepAlive>,
    /// Maximum number of active requests to a destination.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2MaxRequests")]
    pub http2_max_requests: Option<i32>,
    /// The idle timeout for upstream connection pool connections.
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsConnectionPoolHttpHttp2KeepAlive {
    /// Send HTTP/2 PING frames at this interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
    /// How long to wait for a response to an HTTP/2 PING frame before closing the connection.
...
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancer {
    ...
    /// Represents the warmup configuration of Service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub warmup: Option<DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancerWarmup>,
    /// Deprecated: use `warmup` instead.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "warmupDurationSecs")]
    pub warmup_duration_secs: Option<String>,
}
...
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookie {
    /// Additional attributes for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookieAttributes>>,
    /// Name of the cookie.
    pub name: String,
    /// Path to set for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookieAttributes {
    /// The name of the cookie attribute.
    pub name: String,
    /// The optional value of the cookie attribute.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Represents the warmup configuration of Service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleSubsetsTrafficPolicyPortLevelSettingsLoadBalancerWarmup {
    /// This parameter controls the speed of traffic increase over the warmup duration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aggression: Option<f64>,
    pub duration: String,
...
pub struct DestinationRuleTrafficPolicyConnectionPoolHttp {
    ...
    /// Configure HTTP/2 PING frames for upstream connections.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2KeepAlive")]
    pub http2_keep_alive: Option<DestinationRuleTrafficPolicyConnectionPoolHttpHttp2KeepAlive>,
    /// Maximum number of active requests to a destination.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2MaxRequests")]
    pub http2_max_requests: Option<i32>,
    /// The idle timeout for upstream connection pool connections.
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyConnectionPoolHttpHttp2KeepAlive {
    /// Send HTTP/2 PING frames at this interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
    /// How long to wait for a response to an HTTP/2 PING frame before closing the connection.
...
pub struct DestinationRuleTrafficPolicyLoadBalancer {
    ...
    /// Represents the warmup configuration of Service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub warmup: Option<DestinationRuleTrafficPolicyLoadBalancerWarmup>,
    /// Deprecated: use `warmup` instead.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "warmupDurationSecs")]
    pub warmup_duration_secs: Option<String>,
}
...
pub struct DestinationRuleTrafficPolicyLoadBalancerConsistentHashHttpCookie {
    /// Additional attributes for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<DestinationRuleTrafficPolicyLoadBalancerConsistentHashHttpCookieAttributes>>,
    /// Name of the cookie.
    pub name: String,
    /// Path to set for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyLoadBalancerConsistentHashHttpCookieAttributes {
    /// The name of the cookie attribute.
    pub name: String,
    /// The optional value of the cookie attribute.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Represents the warmup configuration of Service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyLoadBalancerWarmup {
    /// This parameter controls the speed of traffic increase over the warmup duration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aggression: Option<f64>,
    pub duration: String,
...
pub struct DestinationRuleTrafficPolicyPortLevelSettingsConnectionPoolHttp {
    ...
    /// Configure HTTP/2 PING frames for upstream connections.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2KeepAlive")]
    pub http2_keep_alive: Option<DestinationRuleTrafficPolicyPortLevelSettingsConnectionPoolHttpHttp2KeepAlive>,
    /// Maximum number of active requests to a destination.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2MaxRequests")]
    pub http2_max_requests: Option<i32>,
    /// The idle timeout for upstream connection pool connections.
...
/// Configure HTTP/2 PING frames for upstream connections.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyPortLevelSettingsConnectionPoolHttpHttp2KeepAlive {
    /// Send HTTP/2 PING frames at this interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
    /// How long to wait for a response to an HTTP/2 PING frame before closing the connection.
...
pub struct DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancer {
    ...
    /// Represents the warmup configuration of Service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub warmup: Option<DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancerWarmup>,
    /// Deprecated: use `warmup` instead.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "warmupDurationSecs")]
    pub warmup_duration_secs: Option<String>,
}
...
pub struct DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookie {
    /// Additional attributes for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attributes: Option<Vec<DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookieAttributes>>,
    /// Name of the cookie.
    pub name: String,
    /// Path to set for the cookie.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancerConsistentHashHttpCookieAttributes {
    /// The name of the cookie attribute.
    pub name: String,
    /// The optional value of the cookie attribute.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Represents the warmup configuration of Service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DestinationRuleTrafficPolicyPortLevelSettingsLoadBalancerWarmup {
    /// This parameter controls the speed of traffic increase over the warmup duration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aggression: Option<f64>,
    pub duration: String,
