...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/networking.istio.io/v1alpha3/envoyfilters.yaml
...
pub struct EnvoyFilterConfigPatchesMatchWaypoint {
    /// The name of a specific filter to apply the patch to.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub filter: Option<EnvoyFilterConfigPatchesMatchWaypointFilter>,
    /// The service port to match on.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portNumber")]
    pub port_number: Option<i64>,
    /// Match a specific route.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub route: Option<EnvoyFilterConfigPatchesMatchWaypointRoute>,
}

/// The name of a specific filter to apply the patch to.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnvoyFilterConfigPatchesMatchWaypointFilter {
    /// The filter name to match on.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// The next level filter within this filter to match on.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subFilter")]
    pub sub_filter: Option<EnvoyFilterConfigPatchesMatchWaypointFilterSubFilter>,
}

/// The next level filter within this filter to match on.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnvoyFilterConfigPatchesMatchWaypointFilterSubFilter {
    /// The filter name to match on.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
/// Match a specific route.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EnvoyFilterConfigPatchesMatchWaypointRoute {
    /// The Route objects generated by default are named as default.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
