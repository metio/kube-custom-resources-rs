...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/networking.istio.io/v1alpha3/gateways.yaml
...
pub struct GatewayServersTls {
    ...
    pub tls_certificates: Option<Vec<GatewayServersTlsTlsCertificates>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GatewayServersTlsTlsCertificates {
    /// REQUIRED if mode is `MUTUAL` or `OPTIONAL_MUTUAL`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCertificates")]
    pub ca_certificates: Option<String>,
    /// REQUIRED if mode is `SIMPLE` or `MUTUAL`.
