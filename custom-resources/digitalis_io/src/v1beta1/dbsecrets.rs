...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/digitalis-io/vals-operator/digitalis.io/v1beta1/dbsecrets.yaml
