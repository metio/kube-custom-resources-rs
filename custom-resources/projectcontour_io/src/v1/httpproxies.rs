...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/projectcontour/contour/projectcontour.io/v1/httpproxies.yaml
...
#[kube(group = "projectcontour.io", version = "v1", kind = "HTTPProxy", root = "HttpProxy", plural = "httpproxies")]
#[kube(namespaced)]
