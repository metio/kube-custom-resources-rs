...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/projectcontour/contour/projectcontour.io/v1alpha1/contourconfigurations.yaml
