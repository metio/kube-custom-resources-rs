...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/projectcontour/contour/projectcontour.io/v1alpha1/contourdeployments.yaml
...
pub struct ContourDeploymentEnvoyExtraVolumesProjectedSources {
    ...
    pub pod_certificate: Option<ContourDeploymentEnvoyExtraVolumesProjectedSourcesPodCertificate>,
...
/// use the certificates it issues.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ContourDeploymentEnvoyExtraVolumesProjectedSourcesPodCertificate {
