...
pub struct ApplicationSourceHydratorDrySource {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub directory: Option<ApplicationSourceHydratorDrySourceDirectory>,
    /// Helm specifies helm specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub helm: Option<ApplicationSourceHydratorDrySourceHelm>,
    /// Kustomize specifies kustomize specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kustomize: Option<ApplicationSourceHydratorDrySourceKustomize>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plugin: Option<ApplicationSourceHydratorDrySourcePlugin>,
...
/// Directory specifies path/directory specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceDirectory {
    /// Exclude contains a glob pattern to match paths against that should be explicitly excluded from being used during manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exclude: Option<String>,
    /// Include contains a glob pattern to match paths against that should be explicitly included during manifest generation
    ...
    /// Jsonnet holds options specific to Jsonnet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub jsonnet: Option<ApplicationSourceHydratorDrySourceDirectoryJsonnet>,
    /// Recurse specifies whether to scan a directory recursively for manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recurse: Option<bool>,
}
...
/// Jsonnet holds options specific to Jsonnet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceDirectoryJsonnet {
    /// ExtVars is a list of Jsonnet External Variables
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extVars")]
    pub ext_vars: Option<Vec<ApplicationSourceHydratorDrySourceDirectoryJsonnetExtVars>>,
    /// Additional library search dirs
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub libs: Option<Vec<String>>,
    /// TLAS is a list of Jsonnet Top-level Arguments
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tlas: Option<Vec<ApplicationSourceHydratorDrySourceDirectoryJsonnetTlas>>,
}

/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceDirectoryJsonnetExtVars {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceDirectoryJsonnetTlas {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// Helm specifies helm specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceHelm {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    /// FileParameters are file parameters to the helm template
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileParameters")]
    pub file_parameters: Option<Vec<ApplicationSourceHydratorDrySourceHelmFileParameters>>,
    /// IgnoreMissingValueFiles prevents helm template from failing when valueFiles do not exist locally by not appending them to helm template --values
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreMissingValueFiles")]
    pub ignore_missing_value_files: Option<bool>,
    /// KubeVersion specifies the Kubernetes API version to pass to Helm when templating manifests. By default, Argo CD
    ...
    /// Parameters is a list of Helm parameters which are passed to the helm template command upon manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationSourceHydratorDrySourceHelmParameters>>,
    /// PassCredentials pass credentials to all domains (Helm's --pass-credentials)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passCredentials")]
    pub pass_credentials: Option<bool>,
    /// ReleaseName is the Helm release name to use. If omitted it will use the application name
...
/// HelmFileParameter is a file parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceHelmFileParameters {
    /// Name is the name of the Helm parameter
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Path is the path to the file containing the values for the Helm parameter
...
/// HelmParameter is a parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceHelmParameters {
    /// ForceString determines whether to tell Helm to interpret booleans and numbers as strings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceString")]
    pub force_string: Option<bool>,
    /// Name is the name of the Helm parameter
...
/// Kustomize specifies kustomize specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceKustomize {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    ...
    /// Patches is a list of Kustomize patches
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patches: Option<Vec<ApplicationSourceHydratorDrySourceKustomizePatches>>,
    /// Replicas is a list of Kustomize Replicas override specifications
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replicas: Option<Vec<ApplicationSourceHydratorDrySourceKustomizeReplicas>>,
    /// Version controls which version of Kustomize to use for rendering manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceKustomizePatches {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<BTreeMap<String, bool>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patch: Option<String>,
    ...
    pub path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ApplicationSourceHydratorDrySourceKustomizePatchesTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceKustomizePatchesTarget {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "annotationSelector")]
    pub annotation_selector: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub group: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourceKustomizeReplicas {
    /// Number of replicas
    pub count: IntOrString,
    /// Name of Deployment or StatefulSet
    pub name: String,
...
/// Plugin specifies config management plugin specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourcePlugin {
    /// Env is a list of environment variable entries
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub env: Option<Vec<ApplicationSourceHydratorDrySourcePluginEnv>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationSourceHydratorDrySourcePluginParameters>>,
}

/// EnvEntry represents an entry in the application's environment
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourcePluginEnv {
    /// Name is the name of the variable, usually expressed in uppercase
    pub name: String,
    /// Value is the value of the variable
    pub value: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationSourceHydratorDrySourcePluginParameters {
    /// Array is the value of an array type parameter.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub array: Option<Vec<String>>,
    /// Map is the value of a map type parameter.
...
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySource {
    /// Directory specifies path/directory specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub directory: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectory>,
    /// Helm specifies helm specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub helm: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelm>,
    /// Kustomize specifies kustomize specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kustomize: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomize>,
    /// Path is a directory path within the Git repository where the manifests are located
    pub path: String,
    /// Plugin specifies config management plugin specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plugin: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePlugin>,
    /// RepoURL is the URL to the git repository that contains the application manifests
    #[serde(rename = "repoURL")]
    pub repo_url: String,
    /// TargetRevision defines the revision of the source to hydrate
...
/// Directory specifies path/directory specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectory {
    /// Exclude contains a glob pattern to match paths against that should be explicitly excluded from being used during manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exclude: Option<String>,
    /// Include contains a glob pattern to match paths against that should be explicitly included during manifest generation
    ...
    /// Jsonnet holds options specific to Jsonnet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub jsonnet: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnet>,
    /// Recurse specifies whether to scan a directory recursively for manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recurse: Option<bool>,
}
...
/// Jsonnet holds options specific to Jsonnet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnet {
    /// ExtVars is a list of Jsonnet External Variables
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extVars")]
    pub ext_vars: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnetExtVars>>,
    /// Additional library search dirs
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub libs: Option<Vec<String>>,
    /// TLAS is a list of Jsonnet Top-level Arguments
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tlas: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnetTlas>>,
}

/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnetExtVars {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceDirectoryJsonnetTlas {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// Helm specifies helm specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelm {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    /// FileParameters are file parameters to the helm template
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileParameters")]
    pub file_parameters: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelmFileParameters>>,
    /// IgnoreMissingValueFiles prevents helm template from failing when valueFiles do not exist locally by not appending them to helm template --values
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreMissingValueFiles")]
    pub ignore_missing_value_files: Option<bool>,
    /// KubeVersion specifies the Kubernetes API version to pass to Helm when templating manifests. By default, Argo CD
    ...
    /// Parameters is a list of Helm parameters which are passed to the helm template command upon manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelmParameters>>,
    /// PassCredentials pass credentials to all domains (Helm's --pass-credentials)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passCredentials")]
    pub pass_credentials: Option<bool>,
    /// ReleaseName is the Helm release name to use. If omitted it will use the application name
...
/// HelmFileParameter is a file parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelmFileParameters {
    /// Name is the name of the Helm parameter
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Path is the path to the file containing the values for the Helm parameter
...
/// HelmParameter is a parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceHelmParameters {
    /// ForceString determines whether to tell Helm to interpret booleans and numbers as strings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceString")]
    pub force_string: Option<bool>,
    /// Name is the name of the Helm parameter
...
/// Kustomize specifies kustomize specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomize {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    ...
    /// Patches is a list of Kustomize patches
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patches: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizePatches>>,
    /// Replicas is a list of Kustomize Replicas override specifications
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replicas: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizeReplicas>>,
    /// Version controls which version of Kustomize to use for rendering manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizePatches {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<BTreeMap<String, bool>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patch: Option<String>,
    ...
    pub path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizePatchesTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizePatchesTarget {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "annotationSelector")]
    pub annotation_selector: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub group: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourceKustomizeReplicas {
    /// Number of replicas
    pub count: IntOrString,
    /// Name of Deployment or StatefulSet
    pub name: String,
...
/// Plugin specifies config management plugin specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePlugin {
    /// Env is a list of environment variable entries
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub env: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePluginEnv>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePluginParameters>>,
}

/// EnvEntry represents an entry in the application's environment
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePluginEnv {
    /// Name is the name of the variable, usually expressed in uppercase
    pub name: String,
    /// Value is the value of the variable
    pub value: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorCurrentOperationSourceHydratorDrySourcePluginParameters {
    /// Array is the value of an array type parameter.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub array: Option<Vec<String>>,
    /// Map is the value of a map type parameter.
...
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySource {
    /// Directory specifies path/directory specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub directory: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectory>,
    /// Helm specifies helm specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub helm: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelm>,
    /// Kustomize specifies kustomize specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kustomize: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomize>,
    /// Path is a directory path within the Git repository where the manifests are located
    pub path: String,
    /// Plugin specifies config management plugin specific options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plugin: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePlugin>,
    /// RepoURL is the URL to the git repository that contains the application manifests
    #[serde(rename = "repoURL")]
    pub repo_url: String,
    /// TargetRevision defines the revision of the source to hydrate
...
/// Directory specifies path/directory specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectory {
    /// Exclude contains a glob pattern to match paths against that should be explicitly excluded from being used during manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub exclude: Option<String>,
    /// Include contains a glob pattern to match paths against that should be explicitly included during manifest generation
    ...
    /// Jsonnet holds options specific to Jsonnet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub jsonnet: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnet>,
    /// Recurse specifies whether to scan a directory recursively for manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recurse: Option<bool>,
}
...
/// Jsonnet holds options specific to Jsonnet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnet {
    /// ExtVars is a list of Jsonnet External Variables
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extVars")]
    pub ext_vars: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnetExtVars>>,
    /// Additional library search dirs
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub libs: Option<Vec<String>>,
    /// TLAS is a list of Jsonnet Top-level Arguments
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tlas: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnetTlas>>,
}

/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnetExtVars {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// JsonnetVar represents a variable to be passed to jsonnet during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceDirectoryJsonnetTlas {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<bool>,
    pub name: String,
    pub value: String,
...
/// Helm specifies helm specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelm {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    /// FileParameters are file parameters to the helm template
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileParameters")]
    pub file_parameters: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelmFileParameters>>,
    /// IgnoreMissingValueFiles prevents helm template from failing when valueFiles do not exist locally by not appending them to helm template --values
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreMissingValueFiles")]
    pub ignore_missing_value_files: Option<bool>,
    /// KubeVersion specifies the Kubernetes API version to pass to Helm when templating manifests. By default, Argo CD
    ...
    /// Parameters is a list of Helm parameters which are passed to the helm template command upon manifest generation
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelmParameters>>,
    /// PassCredentials pass credentials to all domains (Helm's --pass-credentials)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passCredentials")]
    pub pass_credentials: Option<bool>,
    /// ReleaseName is the Helm release name to use. If omitted it will use the application name
...
/// HelmFileParameter is a file parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelmFileParameters {
    /// Name is the name of the Helm parameter
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Path is the path to the file containing the values for the Helm parameter
...
/// HelmParameter is a parameter that's passed to helm template during manifest generation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceHelmParameters {
    /// ForceString determines whether to tell Helm to interpret booleans and numbers as strings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceString")]
    pub force_string: Option<bool>,
    /// Name is the name of the Helm parameter
...
/// Kustomize specifies kustomize specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomize {
    /// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
    /// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersions")]
    pub api_versions: Option<Vec<String>>,
    ...
    /// Patches is a list of Kustomize patches
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patches: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizePatches>>,
    /// Replicas is a list of Kustomize Replicas override specifications
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replicas: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizeReplicas>>,
    /// Version controls which version of Kustomize to use for rendering manifests
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizePatches {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<BTreeMap<String, bool>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patch: Option<String>,
    ...
    pub path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizePatchesTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizePatchesTarget {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "annotationSelector")]
    pub annotation_selector: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub group: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourceKustomizeReplicas {
    /// Number of replicas
    pub count: IntOrString,
    /// Name of Deployment or StatefulSet
    pub name: String,
...
/// Plugin specifies config management plugin specific options
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePlugin {
    /// Env is a list of environment variable entries
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub env: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePluginEnv>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub parameters: Option<Vec<ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePluginParameters>>,
}

/// EnvEntry represents an entry in the application's environment
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePluginEnv {
    /// Name is the name of the variable, usually expressed in uppercase
    pub name: String,
    /// Value is the value of the variable
    pub value: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationStatusSourceHydratorLastSuccessfulOperationSourceHydratorDrySourcePluginParameters {
    /// Array is the value of an array type parameter.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub array: Option<Vec<String>>,
    /// Map is the value of a map type parameter.
