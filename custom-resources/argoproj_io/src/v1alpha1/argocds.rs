...
#[kube(group = "argoproj.io", version = "v1alpha1", kind = "ArgoCD", root = "ArgoCd", plural = "argocds")]
#[kube(namespaced)]
...
pub struct ArgoCdSpec {
    ...
    pub network_policy: Option<ArgoCdNetworkPolicy>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookSecrets")]
    pub webhook_secrets: Option<ArgoCdWebhookSecrets>,
}
...
pub struct ArgoCdApplicationSetEnvValueFrom {
    ...
    pub file_key_ref: Option<ArgoCdApplicationSetEnvValueFromFileKeyRef>,
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdApplicationSetEnvValueFromFileKeyRef {
...
pub struct ArgoCdArgoCdAgentAgent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdArgoCdAgentAgentMetrics>,
...
pub struct ArgoCdArgoCdAgentAgentEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdArgoCdAgentAgentEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdArgoCdAgentAgentEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Metrics defines the metrics configuration for the Agent ServiceMonitor.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdArgoCdAgentAgentMetrics {
...
pub struct ArgoCdArgoCdAgentPrincipal {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdArgoCdAgentPrincipalMetrics>,
...
pub struct ArgoCdArgoCdAgentPrincipalEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdArgoCdAgentPrincipalEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdArgoCdAgentPrincipalEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Metrics defines the metrics configuration for the Principal ServiceMonitor.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdArgoCdAgentPrincipalMetrics {
    /// Interval specifies the Prometheus scrape interval for this component's ServiceMonitor.
    /// If empty, Prometheus uses its default scrape interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
...
pub struct ArgoCdController {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdControllerMetrics>,
...
pub struct ArgoCdControllerEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdControllerEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdControllerEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Metrics defines the metrics configuration for the Application Controller ServiceMonitor.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdControllerMetrics {
    /// Interval specifies the Prometheus scrape interval for this component's ServiceMonitor.
    /// If empty, Prometheus uses its default scrape interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
...
pub struct ArgoCdControllerSharding {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<ArgoCdControllerShardingAlgorithm>,
...
/// Sharding contains the options for the Application Controller sharding configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ArgoCdControllerShardingAlgorithm {
    #[serde(rename = "legacy")]
    Legacy,
...
/// NetworkPolicy controls whether the operator should create NetworkPolicy resources for this Argo CD instance.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdNetworkPolicy {
...
pub struct ArgoCdNotifications {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logFormat")]
    pub log_format: Option<ArgoCdNotificationsLogFormat>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdNotificationsMetrics>,
...
pub struct ArgoCdNotificationsEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdNotificationsEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdNotificationsEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Metrics defines the metrics configuration for the Notifications ServiceMonitor.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdNotificationsMetrics {
    /// Interval specifies the Prometheus scrape interval for this component's ServiceMonitor.
    /// If empty, Prometheus uses its default scrape interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
...
pub struct ArgoCdRepo {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdRepoMetrics>,
...
pub struct ArgoCdRepoEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdRepoEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct ArgoCdRepoInitContainers {
    ...
    pub restart_policy_rules: Option<Vec<ArgoCdRepoInitContainersRestartPolicyRules>>,
...
pub struct ArgoCdRepoInitContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdRepoInitContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoInitContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoInitContainersRestartPolicyRules {
    ...
    pub exit_codes: Option<ArgoCdRepoInitContainersRestartPolicyRulesExitCodes>,
}

/// Represents the exit codes to check on container exits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoInitContainersRestartPolicyRulesExitCodes {
...
pub struct ArgoCdRepoSidecarContainers {
    ...
    /// even it if matches the Pod's RestartPolicy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "restartPolicyRules")]
    pub restart_policy_rules: Option<Vec<ArgoCdRepoSidecarContainersRestartPolicyRules>>,
    /// SecurityContext defines the security options the container should be run with.
    /// If set, the fields of SecurityContext override the equivalent fields of PodSecurityContext.
    /// More info: <https://kubernetes.io/docs/tasks/configure-pod-container/security-context/>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
pub struct ArgoCdRepoSidecarContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdRepoSidecarContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoSidecarContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// ContainerRestartRule describes how a container exit is handled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoSidecarContainersRestartPolicyRules {
    /// Specifies the action taken on a container exit if the requirements
    /// are satisfied. The only possible value is "Restart" to restart the
    /// container.
    pub action: String,
    /// Represents the exit codes to check on container exits.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<ArgoCdRepoSidecarContainersRestartPolicyRulesExitCodes>,
}

/// Represents the exit codes to check on container exits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoSidecarContainersRestartPolicyRulesExitCodes {
    /// Represents the relationship between the container exit code(s) and the
    /// specified values. Possible values are:
    /// - In: the requirement is satisfied if the container exit code is in the
    ///   set of specified values.
...
pub struct ArgoCdRepoVolumesProjectedSources {
    ...
    pub pod_certificate: Option<ArgoCdRepoVolumesProjectedSourcesPodCertificate>,
...
/// use the certificates it issues.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdRepoVolumesProjectedSourcesPodCertificate {
...
pub struct ArgoCdServer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<ArgoCdServerMetrics>,
...
pub struct ArgoCdServerEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<ArgoCdServerEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdServerEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Metrics defines the metrics configuration for the Server ServiceMonitor.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdServerMetrics {
    /// Interval specifies the Prometheus scrape interval for this component's ServiceMonitor.
    /// If empty, Prometheus uses its default scrape interval.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub interval: Option<String>,
...
/// The operator syncs values into argocd-secret under the keys Argo CD expects.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecrets {
    ...
    pub azure_dev_ops: Option<ArgoCdWebhookSecretsAzureDevOps>,
    /// Bitbucket: Secret key reference for the Bitbucket Cloud webhook UUID.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bitbucket: Option<ArgoCdWebhookSecretsBitbucket>,
    ...
    pub bitbucket_server: Option<ArgoCdWebhookSecretsBitbucketServer>,
    /// GitHub: Secret key reference for the GitHub webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub github: Option<ArgoCdWebhookSecretsGithub>,
    /// GitLab: Secret key reference for the GitLab webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gitlab: Option<ArgoCdWebhookSecretsGitlab>,
    /// Gogs: Secret key reference for the Gogs webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gogs: Option<ArgoCdWebhookSecretsGogs>,
}

/// AzureDevOps: Secret key references for the Azure DevOps webhook username and password (or PAT).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsAzureDevOps {
    ...
    pub password_secret_ref: Option<ArgoCdWebhookSecretsAzureDevOpsPasswordSecretRef>,
    /// UsernameSecretRef points to the key holding the username.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "usernameSecretRef")]
    pub username_secret_ref: Option<ArgoCdWebhookSecretsAzureDevOpsUsernameSecretRef>,
}

/// PasswordSecretRef points to the key holding the password or PAT.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsAzureDevOpsPasswordSecretRef {
...
/// UsernameSecretRef points to the key holding the username.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsAzureDevOpsUsernameSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
...
/// Bitbucket: Secret key reference for the Bitbucket Cloud webhook UUID.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsBitbucket {
    /// WebhookUUIDSecretRef points to the key holding the Bitbucket Cloud webhook UUID.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookUUIDSecretRef")]
    pub webhook_uuid_secret_ref: Option<ArgoCdWebhookSecretsBitbucketWebhookUuidSecretRef>,
}

/// WebhookUUIDSecretRef points to the key holding the Bitbucket Cloud webhook UUID.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsBitbucketWebhookUuidSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
...
/// BitbucketServer: Secret key reference for the Bitbucket Server webhook secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsBitbucketServer {
    /// WebhookSecretRef points to the key holding the Bitbucket Server webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookSecretRef")]
    pub webhook_secret_ref: Option<ArgoCdWebhookSecretsBitbucketServerWebhookSecretRef>,
}

/// WebhookSecretRef points to the key holding the Bitbucket Server webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsBitbucketServerWebhookSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
...
/// GitHub: Secret key reference for the GitHub webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGithub {
    /// WebhookSecretRef points to the key holding the GitHub webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookSecretRef")]
    pub webhook_secret_ref: Option<ArgoCdWebhookSecretsGithubWebhookSecretRef>,
}

/// WebhookSecretRef points to the key holding the GitHub webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGithubWebhookSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
...
/// GitLab: Secret key reference for the GitLab webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGitlab {
    /// WebhookSecretRef points to the key holding the GitLab webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookSecretRef")]
    pub webhook_secret_ref: Option<ArgoCdWebhookSecretsGitlabWebhookSecretRef>,
}

/// WebhookSecretRef points to the key holding the GitLab webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGitlabWebhookSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
...
/// Gogs: Secret key reference for the Gogs webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGogs {
    /// WebhookSecretRef points to the key holding the Gogs webhook shared secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webhookSecretRef")]
    pub webhook_secret_ref: Option<ArgoCdWebhookSecretsGogsWebhookSecretRef>,
}

/// WebhookSecretRef points to the key holding the Gogs webhook shared secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ArgoCdWebhookSecretsGogsWebhookSecretRef {
    /// Key in the Secret whose value should be used.
    pub key: String,
    /// Name of the Secret.
    pub name: String,
