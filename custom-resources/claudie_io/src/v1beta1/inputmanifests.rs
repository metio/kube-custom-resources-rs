...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/berops/claudie/claudie.io/v1beta1/inputmanifests.yaml
...
pub struct InputManifestLoadBalancersRoles {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub settings: Option<InputManifestLoadBalancersRolesSettings>,
...
/// Additional settings for a role.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InputManifestLoadBalancersRolesSettings {
...
pub struct InputManifestNodePoolsDynamicMachineSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nvidiaGpu")]
    pub nvidia_gpu: Option<i64>,
    /// NvidiaGpuCount specifies the number of NVIDIA GPUs the provided instance type will have.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nvidiaGpuCount")]
    pub nvidia_gpu_count: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nvidiaGpuType")]
    pub nvidia_gpu_type: Option<String>,
}
...
pub struct InputManifestStatusClusters {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub previous: Option<Vec<InputManifestStatusClustersPrevious>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InputManifestStatusClustersPrevious {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub stage: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "taskDescription")]
