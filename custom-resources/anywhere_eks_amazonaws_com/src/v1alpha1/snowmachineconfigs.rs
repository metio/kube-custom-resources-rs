...
pub struct SnowMachineConfigSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "physicalNetworkConnector"
    )]
...
pub struct SnowMachineConfigHostOsConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "bottlerocketConfiguration"
    )]
    pub bottlerocket_configuration:
        Option<SnowMachineConfigHostOsConfigurationBottlerocketConfiguration>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "certBundles"
...
pub struct SnowMachineConfigHostOsConfigurationBottlerocketConfigurationKubernetes {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cpuManagerPolicyOptions"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cpuManagerReconcilePeriod"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "shutdownGracePeriodCriticalPods"
    )]
...
pub struct SnowMachineConfigNetwork {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "directNetworkInterfaces"
    )]
