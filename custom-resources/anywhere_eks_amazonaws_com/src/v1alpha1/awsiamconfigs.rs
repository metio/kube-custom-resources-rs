...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws/eks-anywhere/anywhere.eks.amazonaws.com/v1alpha1/awsiamconfigs.yaml
...
#[kube(group = "anywhere.eks.amazonaws.com", version = "v1alpha1", kind = "AWSIamConfig", root = "AwsIamConfig", plural = "awsiamconfigs")]
#[kube(namespaced)]
