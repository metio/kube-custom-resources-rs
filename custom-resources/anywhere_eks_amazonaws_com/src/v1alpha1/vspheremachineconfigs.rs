...
pub struct VSphereMachineConfigHostOsConfiguration {
    ...
    pub bottlerocket_configuration:
        Option<VSphereMachineConfigHostOsConfigurationBottlerocketConfiguration>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "certBundles"
...
pub struct VSphereMachineConfigHostOsConfigurationBottlerocketConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kubernetes:
        Option<VSphereMachineConfigHostOsConfigurationBottlerocketConfigurationKubernetes>,
}
