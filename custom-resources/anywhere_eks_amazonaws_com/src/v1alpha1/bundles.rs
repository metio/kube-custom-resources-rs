...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws/eks-anywhere/anywhere.eks.amazonaws.com/v1alpha1/bundles.yaml
...
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStack {
    ...
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hegel: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackHegel>,
    /// Tinkerbell hook OS.
    pub hook: BundlesVersionsBundlesTinkerbellTinkerbellStackHook,
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rufio: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackRufio>,
    pub stack: BundlesVersionsBundlesTinkerbellTinkerbellStackStack,
    ...
    #[serde(rename = "tinkerbellCrds")]
    pub tinkerbell_crds: BundlesVersionsBundlesTinkerbellTinkerbellStackTinkerbellCrds,
}
...
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackHook {
    ...
    pub iso: BundlesVersionsBundlesTinkerbellTinkerbellStackHookIso,
...
/// HookArch defines the Tinkerbell hook architecture-specific artifacts.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackHookIso {
    /// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
    pub amd: BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoAmd,
    /// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
    pub arm: BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoArm,
}

/// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoAmd {
    /// Architectures of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arch: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Operating system of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub os: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoAmdOs>,
    /// Name of the OS like ubuntu, bottlerocket
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osName")]
    pub os_name: Option<String>,
    /// The sha256 of the asset, only applies for 'file' store
...
/// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoAmdOs {
    #[serde(rename = "linux")]
    Linux,
    #[serde(rename = "darwin")]
    Darwin,
...
/// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoArm {
    /// Architectures of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arch: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Operating system of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub os: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoArmOs>,
    /// Name of the OS like ubuntu, bottlerocket
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osName")]
    pub os_name: Option<String>,
    /// The sha256 of the asset, only applies for 'file' store
...
/// Archive represents an archive asset (e.g. tarball) along with its OS/architecture metadata, and checksums for file integrity.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BundlesVersionsBundlesTinkerbellTinkerbellStackHookIsoArmOs {
    #[serde(rename = "linux")]
    Linux,
    #[serde(rename = "darwin")]
    Darwin,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackStack {
    /// Architectures of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arch: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Operating system of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub os: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackStackOs>,
    /// Name of the OS like ubuntu, bottlerocket
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osName")]
    pub os_name: Option<String>,
    /// The image repository, name, and tag
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BundlesVersionsBundlesTinkerbellTinkerbellStackStackOs {
    #[serde(rename = "linux")]
    Linux,
    #[serde(rename = "darwin")]
    Darwin,
...
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackTink {
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub nginx: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkNginx>,
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tinkController")]
    pub tink_controller: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkTinkController>,
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tinkRelay")]
    pub tink_relay: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkTinkRelay>,
    #[serde(rename = "tinkRelayInit")]
    pub tink_relay_init: BundlesVersionsBundlesTinkerbellTinkerbellStackTinkTinkRelayInit,
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tinkServer")]
    pub tink_server: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkTinkServer>,
    /// This field has been deprecated
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tinkWorker")]
    pub tink_worker: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkTinkWorker>,
}

/// This field has been deprecated
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackTinkNginx {
    /// Architectures of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arch: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Operating system of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub os: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkNginxOs>,
    /// Name of the OS like ubuntu, bottlerocket
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osName")]
    pub os_name: Option<String>,
    /// The image repository, name, and tag
...
/// This field has been deprecated
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BundlesVersionsBundlesTinkerbellTinkerbellStackTinkNginxOs {
    #[serde(rename = "linux")]
    Linux,
    #[serde(rename = "darwin")]
    Darwin,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BundlesVersionsBundlesTinkerbellTinkerbellStackTinkerbellCrds {
    /// Architectures of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arch: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Operating system of the asset
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub os: Option<BundlesVersionsBundlesTinkerbellTinkerbellStackTinkerbellCrdsOs>,
    /// Name of the OS like ubuntu, bottlerocket
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "osName")]
    pub os_name: Option<String>,
    /// The image repository, name, and tag
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BundlesVersionsBundlesTinkerbellTinkerbellStackTinkerbellCrdsOs {
    #[serde(rename = "linux")]
    Linux,
    #[serde(rename = "darwin")]
    Darwin,
