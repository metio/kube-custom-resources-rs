...
pub struct TinkerbellMachineConfigHostOsConfiguration {
    ...
    pub bottlerocket_configuration:
        Option<TinkerbellMachineConfigHostOsConfigurationBottlerocketConfiguration>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "certBundles"
...
pub struct TinkerbellMachineConfigHostOsConfigurationBottlerocketConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kubernetes:
        Option<TinkerbellMachineConfigHostOsConfigurationBottlerocketConfigurationKubernetes>,
}
