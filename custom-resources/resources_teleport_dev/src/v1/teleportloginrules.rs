...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/gravitational/teleport/resources.teleport.dev/v1/teleportloginrules.yaml
...
pub struct TeleportLoginRuleSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub traits_map: Option<BTreeMap<String, Vec<String>>>,
}
