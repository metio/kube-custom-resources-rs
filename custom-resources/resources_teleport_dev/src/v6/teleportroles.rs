...
pub struct TeleportRoleAllow {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub beam_labels: Option<BTreeMap<String, serde_json::Value>>,
    /// BeamLabelsExpression is a predicate expression used to allow/deny access to beams.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub beam_labels_expression: Option<String>,
...
pub struct TeleportRoleAllowReviewRequests {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub roles: Option<Vec<String>>,
    /// SubmitForUsers is used by Teleport plugins to indicate they can submit reviews on behalf of other users. Reviews submitted for a user are evaluated against that user's own RBAC permissions. Supports wildcard (*).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub submit_for_users: Option<Vec<String>>,
...
pub struct TeleportRoleOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub web_terminal_clipboard_mode: Option<IntOrString>,
}
