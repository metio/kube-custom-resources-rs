...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/GoogleCloudPlatform/gke-networking-recipes/networking.gke.io/v1/healthcheckpolicies.yaml
