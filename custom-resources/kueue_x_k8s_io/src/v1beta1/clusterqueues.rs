...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/kueue/kueue.x-k8s.io/v1beta1/clusterqueues.yaml
...
pub struct ClusterQueueSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "admissionChecksStrategy"
    )]
...
pub struct ClusterQueueStatusPendingWorkloadsStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "clusterQueuePendingWorkload"
    )]
    pub cluster_queue_pending_workload:
        Option<Vec<ClusterQueueStatusPendingWorkloadsStatusClusterQueuePendingWorkload>>,
