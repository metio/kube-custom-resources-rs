...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/kueue/kueue.x-k8s.io/v1beta2/provisioningrequestconfigs.yaml
...
#[kube(group = "kueue.x-k8s.io", version = "v1beta2", kind = "ProvisioningRequestConfig", plural = "provisioningrequestconfigs")]
