...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/kueue/kueue.x-k8s.io/v1beta2/cohorts.yaml
...
#[kube(group = "kueue.x-k8s.io", version = "v1beta2", kind = "Cohort", plural = "cohorts")]
