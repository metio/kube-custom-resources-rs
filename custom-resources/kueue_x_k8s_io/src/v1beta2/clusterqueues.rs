...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/kueue/kueue.x-k8s.io/v1beta2/clusterqueues.yaml
...
#[kube(group = "kueue.x-k8s.io", version = "v1beta2", kind = "ClusterQueue", plural = "clusterqueues")]
...
pub struct ClusterQueueSpec {
    ...
    /// object.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cohortName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "concurrentAdmissionPolicy")]
    pub concurrent_admission_policy: Option<ClusterQueueConcurrentAdmissionPolicy>,
...
/// It enables them to migrate to more preferable, whenever capacity appears.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterQueueConcurrentAdmissionPolicy {
    ...
    pub migration: ClusterQueueConcurrentAdmissionPolicyMigration,
}
...
/// Flavor preferences are expressed through the order of flavors in the ClusterQueue.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterQueueConcurrentAdmissionPolicyMigration {
    /// constraints defines the constraints of Workload's migration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub constraints: Option<ClusterQueueConcurrentAdmissionPolicyMigrationConstraints>,
    ...
    pub mode: ClusterQueueConcurrentAdmissionPolicyMigrationMode,
}

/// constraints defines the constraints of Workload's migration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterQueueConcurrentAdmissionPolicyMigrationConstraints {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastAcceptableFlavorName")]
    pub last_acceptable_flavor_name: Option<String>,
}
...
/// Flavor preferences are expressed through the order of flavors in the ClusterQueue.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterQueueConcurrentAdmissionPolicyMigrationMode {
    TryPreferredFlavors,
