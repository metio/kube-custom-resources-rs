...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tinkerbell/rufio/bmc.tinkerbell.org/v1alpha1/tasks.yaml
...
pub struct TaskConnectionProviderOptionsRpcHmac {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secrets: Option<BTreeMap<String, Vec<TaskConnectionProviderOptionsRpcHmacSecrets>>>,
}
