...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tinkerbell/rufio/bmc.tinkerbell.org/v1alpha1/machines.yaml
...
pub enum MachineConnectionProviderOptionsIntelAmtHostScheme {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "https")]
    Https,
...
pub struct MachineConnectionProviderOptionsRpcHmac {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secrets: Option<BTreeMap<String, Vec<MachineConnectionProviderOptionsRpcHmacSecrets>>>,
}
...
pub struct MachineConnectionProviderOptionsRpcRequest {
    ...
    pub static_headers: Option<BTreeMap<String, Vec<String>>>,
