...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/openshift/sriov-network-operator/sriovnetwork.openshift.io/v1/sriovoperatorconfigs.yaml
...
pub struct SriovOperatorConfigSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configDaemonEnvVars")]
    pub config_daemon_env_vars: Option<BTreeMap<String, String>>,
