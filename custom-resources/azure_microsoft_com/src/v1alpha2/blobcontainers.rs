...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha2/blobcontainers.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha2", kind = "BlobContainer", plural = "blobcontainers")]
#[kube(namespaced)]
