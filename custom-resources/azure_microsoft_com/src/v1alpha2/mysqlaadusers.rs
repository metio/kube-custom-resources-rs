...
#[kube(group = "azure.microsoft.com", version = "v1alpha2", kind = "MySQLAADUser", root = "MySqlaadUser", plural = "mysqlaadusers")]
#[kube(namespaced)]
...
pub struct MySqlaadUserSpec {
    ...
    pub database_roles: Option<BTreeMap<String, Vec<String>>>,
