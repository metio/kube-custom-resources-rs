...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/postgresqldatabases.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "PostgreSQLDatabase", root = "PostgreSqlDatabase", plural = "postgresqldatabases")]
#[kube(namespaced)]
#[kube(status = "PostgreSqlDatabaseStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct PostgreSqlDatabaseSpec {
...
pub struct PostgreSqlDatabaseStatus {
    ...
    pub polling_url_kind: Option<PostgreSqlDatabaseStatusPollingUrlKind>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum PostgreSqlDatabaseStatusPollingUrlKind {
    CreateOrUpdate,
    Delete,
}
