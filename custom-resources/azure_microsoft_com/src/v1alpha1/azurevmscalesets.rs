...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/azurevmscalesets.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "AzureVMScaleSet", root = "AzureVmScaleSet", plural = "azurevmscalesets")]
#[kube(namespaced)]
