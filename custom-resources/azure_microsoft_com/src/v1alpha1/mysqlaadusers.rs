...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/mysqlaadusers.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "MySQLAADUser", root = "MySqlaadUser", plural = "mysqlaadusers")]
#[kube(namespaced)]
