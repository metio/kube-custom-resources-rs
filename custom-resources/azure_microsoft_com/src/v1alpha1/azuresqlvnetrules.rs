...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/azuresqlvnetrules.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "AzureSQLVNetRule", root = "AzureSqlvNetRule", plural = "azuresqlvnetrules")]
#[kube(namespaced)]
#[kube(status = "AzureSqlvNetRuleStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct AzureSqlvNetRuleSpec {
    ...
    pub server: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverSubscriptionID")]
...
pub struct AzureSqlvNetRuleStatus {
    ...
    pub polling_url_kind: Option<AzureSqlvNetRuleStatusPollingUrlKind>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum AzureSqlvNetRuleStatusPollingUrlKind {
    CreateOrUpdate,
    Delete,
}
