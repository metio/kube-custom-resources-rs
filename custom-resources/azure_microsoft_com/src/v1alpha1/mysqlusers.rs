...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/mysqlusers.yaml
...
#[kube(group = "azure.microsoft.com", version = "v1alpha1", kind = "MySQLUser", root = "MySqlUser", plural = "mysqlusers")]
#[kube(namespaced)]
