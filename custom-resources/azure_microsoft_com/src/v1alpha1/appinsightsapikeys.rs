...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/appinsightsapikeys.yaml
...
pub struct AppInsightsApiKeySpec {
    ...
    #[serde(
        ...
        rename = "authSDKControlChannel"
    )]
    pub auth_sdk_control_channel: Option<bool>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "readTelemetry"
    )]
