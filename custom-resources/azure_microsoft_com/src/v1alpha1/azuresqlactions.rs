...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Azure/azure-service-operator/azure.microsoft.com/v1alpha1/azuresqlactions.yaml
...
pub enum AzureSqlActionStatusPollingUrlKind {
    CreateOrUpdate,
    Delete,
}
