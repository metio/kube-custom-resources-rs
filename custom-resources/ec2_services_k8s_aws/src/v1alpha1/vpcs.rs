...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/ec2-controller/ec2.services.k8s.aws/v1alpha1/vpcs.yaml
...
pub struct VPCSpec {
    ...
    #[serde(
        ...
        rename = "amazonProvidedIPv6CIDRBlock"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "disallowSecurityGroupDefaultRules"
    )]
...
pub struct VPCStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cidrBlockAssociationSet"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "securityGroupDefaultRulesExist"
    )]
