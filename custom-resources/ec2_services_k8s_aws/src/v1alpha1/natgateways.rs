...
#[kube(group = "ec2.services.k8s.aws", version = "v1alpha1", kind = "NATGateway", root = "NatGateway", plural = "natgateways")]
#[kube(namespaced)]
...
pub struct NatGatewaySpec {
    ...
    /// (<https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateways-regional.html)>
    /// in the Amazon VPC User Guide.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZoneAddresses")]
    pub availability_zone_addresses: Option<Vec<NatGatewayAvailabilityZoneAddresses>>,
    ...
    pub vpc_ref: Option<NatGatewayVpcRef>,
}
...
/// in the Amazon VPC User Guide.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NatGatewayAvailabilityZoneAddresses {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocationIDs")]
    pub allocation_i_ds: Option<Vec<String>>,
...
/// 	  name: my-api
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NatGatewayVpcRef {
    /// AWSResourceReference provides all the values necessary to reference another
    /// k8s resource for finding the identifier(Id/ARN/Name)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub from: Option<NatGatewayVpcRefFrom>,
}

/// AWSResourceReference provides all the values necessary to reference another
/// k8s resource for finding the identifier(Id/ARN/Name)
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NatGatewayVpcRefFrom {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
