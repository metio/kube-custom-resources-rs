...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/grafana/loki/loki.grafana.com/v1/lokistacks.yaml
...
pub struct LokiStackLimitsGlobal {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub otlp: Option<LokiStackLimitsGlobalOtlp>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackLimitsGlobalOtlpStreamLabelsResourceAttributes {
    /// Name contains either a verbatim name of an attribute or a regular expression matching many attributes.
    pub name: String,
    /// If Regex is true, then Name is treated as a regular expression instead of as a verbatim attribute name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct LokiStackNetworkPolicies {
    ...
    pub rule_set: LokiStackNetworkPoliciesRuleSet,
}
...
/// Loki components and related services.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LokiStackNetworkPoliciesRuleSet {
    None,
...
pub struct LokiStackTenants {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gateway: Option<LokiStackTenantsGateway>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub passthrough: Option<LokiStackTenantsPassthrough>,
}
...
/// Gateway defines the configuration specific to Gateway server
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsGateway {
    /// TLS defines the TLS configuration for the Gateway server.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls: Option<LokiStackTenantsGatewayTls>,
}

/// TLS defines the TLS configuration for the Gateway server.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsGatewayTls {
    /// CA can be used to specify a custom list of trusted certificate authorities.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<LokiStackTenantsGatewayTlsCa>,
    /// Certificate points to the server certificate to use.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub certificate: Option<LokiStackTenantsGatewayTlsCertificate>,
    ...
    pub private_key: Option<LokiStackTenantsGatewayTlsPrivateKey>,
}

/// CA can be used to specify a custom list of trusted certificate authorities.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsGatewayTlsCa {
...
/// Certificate points to the server certificate to use.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsGatewayTlsCertificate {
    /// ConfigMapName contains the name of the ConfigMap containing the referenced value.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapName")]
    pub config_map_name: Option<String>,
    /// Name of the key used to get the value in either the referenced ConfigMap or Secret.
...
/// PrivateKey points to the private key of the server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsGatewayTlsPrivateKey {
...
pub struct LokiStackTenantsOpenshift {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub otlp: Option<LokiStackTenantsOpenshiftOtlp>,
}
...
pub struct LokiStackTenantsOpenshiftOtlp {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableConsoleLabels")]
    pub enable_console_labels: Option<bool>,
}

/// Passthrough defines the configuration specific to Passthrough mode.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsPassthrough {
    /// CA can be used to specify a custom list of trusted certificate authorities.
    /// That will be used to validate the certificates of the clients that interact
    /// with the gateway
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca: Option<LokiStackTenantsPassthroughCa>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultTenant")]
...
/// with the gateway
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LokiStackTenantsPassthroughCa {
    /// ConfigMapName contains the name of the ConfigMap containing the referenced value.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapName")]
    pub config_map_name: Option<String>,
    /// Name of the key used to get the value in either the referenced ConfigMap or Secret.
...
pub struct LokiStackStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkPolicyRuleSet")]
    pub network_policy_rule_set: Option<LokiStackStatusNetworkPolicyRuleSet>,
...
/// LokiStack CR spec Status.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LokiStackStatusNetworkPolicyRuleSet {
    None,
    RestrictIngressEgress,
}
