...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/metal3-io/baremetal-operator/metal3.io/v1alpha1/dataimages.yaml
