...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/chainsaw/chainsaw.kyverno.io/v1alpha1/tests.yaml
...
pub struct TestCatchScript {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "shellArgs")]
