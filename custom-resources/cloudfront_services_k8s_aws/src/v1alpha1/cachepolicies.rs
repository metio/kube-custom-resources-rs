...
pub struct CachePolicyCachePolicyConfig {
    ...
    pub parameters_in_cache_key_and_forwarded_to_origin:
        Option<CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOrigin>,
}
...
pub struct CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOrigin {
    ...
    pub cookies_config:
        Option<CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginCookiesConfig>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub headers_config:
        Option<CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginHeadersConfig>,
    ...
    pub query_strings_config: Option<
        CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginQueryStringsConfig,
    >,
}
...
pub struct CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginCookiesConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cookies: Option<
        CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginCookiesConfigCookies,
    >,
}
...
pub struct CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginHeadersConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<
        CachePolicyCachePolicyConfigParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaders,
    >,
}
