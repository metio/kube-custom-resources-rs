...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/cloudfront-controller/cloudfront.services.k8s.aws/v1alpha1/functions.yaml
...
pub struct FunctionStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "liveETag")]
    pub live_e_tag: Option<String>,
