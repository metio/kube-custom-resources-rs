...
pub struct DistributionDistributionConfig {
    ...
    /// API.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cacheTagConfig")]
    pub cache_tag_config: Option<DistributionDistributionConfigCacheTagConfig>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub comment: Option<String>,
    /// A connection function association.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionFunctionAssociation")]
    pub connection_function_association: Option<DistributionDistributionConfigConnectionFunctionAssociation>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionMode")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tenantConfig")]
    pub tenant_config: Option<DistributionDistributionConfigTenantConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "viewerMtlsConfig")]
    pub viewer_mtls_config: Option<DistributionDistributionConfigViewerMtlsConfig>,
...
/// API.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigCacheTagConfig {
...
/// A connection function association.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigConnectionFunctionAssociation {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct DistributionDistributionConfigOriginsItems {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "responseCompletionTimeout")]
...
pub struct DistributionDistributionConfigOriginsItemsCustomOriginConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "originMtlsConfig")]
    pub origin_mtls_config: Option<DistributionDistributionConfigOriginsItemsCustomOriginConfigOriginMtlsConfig>,
...
/// Configures mutual TLS authentication between CloudFront and your origin server.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigOriginsItemsCustomOriginConfigOriginMtlsConfig {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientCertificateARN")]
    pub client_certificate_arn: Option<String>,
}
...
/// The configuration for a distribution tenant.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigTenantConfig {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "parameterDefinitions")]
    pub parameter_definitions: Option<Vec<DistributionDistributionConfigTenantConfigParameterDefinitions>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigTenantConfigParameterDefinitions {
    /// An object that contains information about the parameter definition.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub definition: Option<DistributionDistributionConfigTenantConfigParameterDefinitionsDefinition>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// An object that contains information about the parameter definition.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigTenantConfigParameterDefinitionsDefinition {
    /// The configuration for a string schema.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stringSchema")]
    pub string_schema: Option<DistributionDistributionConfigTenantConfigParameterDefinitionsDefinitionStringSchema>,
}

/// The configuration for a string schema.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigTenantConfigParameterDefinitionsDefinitionStringSchema {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub comment: Option<String>,
...
/// A viewer mTLS configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigViewerMtlsConfig {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<String>,
    /// A trust store configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trustStoreConfig")]
    pub trust_store_config: Option<DistributionDistributionConfigViewerMtlsConfigTrustStoreConfig>,
}

/// A trust store configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistributionDistributionConfigViewerMtlsConfigTrustStoreConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreCertificateExpiry")]
    pub ignore_certificate_expiry: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trustStoreID")]
