...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/litmuschaos/chaos-operator/litmuschaos.io/v1alpha1/chaosexperiments.yaml
