...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/openshift/hive/hiveinternal.openshift.io/v1alpha1/fakeclusterinstalls.yaml
...
pub struct FakeClusterInstallClusterMetadata {
    ...
    pub metadata_json_secret_ref: Option<FakeClusterInstallClusterMetadataMetadataJsonSecretRef>,
...
/// installer, potentially scrubbed for sensitive data.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FakeClusterInstallClusterMetadataMetadataJsonSecretRef {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
