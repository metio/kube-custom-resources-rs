...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/ecr-controller/ecr.services.k8s.aws/v1alpha1/repositories.yaml
...
pub struct RepositorySpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imageTagMutabilityExclusionFilters")]
    pub image_tag_mutability_exclusion_filters: Option<Vec<RepositoryImageTagMutabilityExclusionFilters>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RepositoryImageTagMutabilityExclusionFilters {
    #[serde(default, skip_serializing_if = "Option::is_none")]
