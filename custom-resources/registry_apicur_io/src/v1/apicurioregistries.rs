...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Apicurio/apicurio-registry-operator/registry.apicur.io/v1/apicurioregistries.yaml
