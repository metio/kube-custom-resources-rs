...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cloudnative-pg/cloudnative-pg/postgresql.cnpg.io/v1/poolers.yaml
...
pub struct PoolerTemplateSpecContainers {
    ...
    pub restart_policy_rules: Option<Vec<PoolerTemplateSpecContainersRestartPolicyRules>>,
...
pub struct PoolerTemplateSpecContainersEnvValueFrom {
    ...
    pub file_key_ref: Option<PoolerTemplateSpecContainersEnvValueFromFileKeyRef>,
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecContainersEnvValueFromFileKeyRef {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecContainersRestartPolicyRules {
    ...
    pub exit_codes: Option<PoolerTemplateSpecContainersRestartPolicyRulesExitCodes>,
}

/// Represents the exit codes to check on container exits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecContainersRestartPolicyRulesExitCodes {
...
pub struct PoolerTemplateSpecEphemeralContainers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "restartPolicyRules")]
    pub restart_policy_rules: Option<Vec<PoolerTemplateSpecEphemeralContainersRestartPolicyRules>>,
...
pub struct PoolerTemplateSpecEphemeralContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<PoolerTemplateSpecEphemeralContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecEphemeralContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// ContainerRestartRule describes how a container exit is handled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecEphemeralContainersRestartPolicyRules {
    /// Specifies the action taken on a container exit if the requirements
    /// are satisfied. The only possible value is "Restart" to restart the
    /// container.
    pub action: String,
    /// Represents the exit codes to check on container exits.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<PoolerTemplateSpecEphemeralContainersRestartPolicyRulesExitCodes>,
}

/// Represents the exit codes to check on container exits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecEphemeralContainersRestartPolicyRulesExitCodes {
    /// Represents the relationship between the container exit code(s) and the
    /// specified values. Possible values are:
    /// - In: the requirement is satisfied if the container exit code is in the
    ///   set of specified values.
...
pub struct PoolerTemplateSpecInitContainers {
    ...
    /// even it if matches the Pod's RestartPolicy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "restartPolicyRules")]
    pub restart_policy_rules: Option<Vec<PoolerTemplateSpecInitContainersRestartPolicyRules>>,
    /// SecurityContext defines the security options the container should be run with.
    /// If set, the fields of SecurityContext override the equivalent fields of PodSecurityContext.
    /// More info: <https://kubernetes.io/docs/tasks/configure-pod-container/security-context/>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
pub struct PoolerTemplateSpecInitContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<PoolerTemplateSpecInitContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecInitContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// ContainerRestartRule describes how a container exit is handled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecInitContainersRestartPolicyRules {
    /// Specifies the action taken on a container exit if the requirements
    /// are satisfied. The only possible value is "Restart" to restart the
    /// container.
    pub action: String,
    /// Represents the exit codes to check on container exits.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<PoolerTemplateSpecInitContainersRestartPolicyRulesExitCodes>,
}

/// Represents the exit codes to check on container exits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecInitContainersRestartPolicyRulesExitCodes {
    /// Represents the relationship between the container exit code(s) and the
    /// specified values. Possible values are:
    /// - In: the requirement is satisfied if the container exit code is in the
    ///   set of specified values.
...
pub struct PoolerTemplateSpecVolumesProjectedSources {
    ...
    pub pod_certificate: Option<PoolerTemplateSpecVolumesProjectedSourcesPodCertificate>,
...
/// use the certificates it issues.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PoolerTemplateSpecVolumesProjectedSourcesPodCertificate {
