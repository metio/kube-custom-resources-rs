...
pub struct AuthConfigConfigsApiKeyAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub digest: Option<AuthConfigConfigsApiKeyAuthDigest>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hmac: Option<AuthConfigConfigsApiKeyAuthHmac>,
    ...
    pub r#match: Option<AuthConfigConfigsApiKeyAuthMatch>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsApiKeyAuthDigest {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsApiKeyAuthHmac {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sharedSecretRef")]
    pub shared_secret_ref: Option<AuthConfigConfigsApiKeyAuthHmacSharedSecretRef>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsApiKeyAuthHmacSharedSecretRef {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsApiKeyAuthMatch {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<Vec<AuthConfigConfigsApiKeyAuthMatchHeaders>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsApiKeyAuthMatchHeaders {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
pub struct AuthConfigConfigsPassThroughAuthHttp {
    ...
    pub connection_pool: Option<AuthConfigConfigsPassThroughAuthHttpConnectionPool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionTimeout")]
    pub connection_timeout: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthConfigConfigsPassThroughAuthHttpConnectionPool {
