...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws/karpenter-provider-aws/karpenter.k8s.aws/v1beta1/ec2nodeclasses.yaml
...
#[kube(group = "karpenter.k8s.aws", version = "v1beta1", kind = "EC2NodeClass", root = "Ec2NodeClass", plural = "ec2nodeclasses")]
