...
#[kube(group = "karpenter.k8s.aws", version = "v1", kind = "EC2NodeClass", root = "Ec2NodeClass", plural = "ec2nodeclasses")]
...
pub struct Ec2NodeClassSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionTracking")]
    pub connection_tracking: Option<Ec2NodeClassConnectionTracking>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipPrefixCount")]
    pub ip_prefix_count: Option<i32>,
    ...
    pub network_interfaces: Option<Vec<Ec2NodeClassNetworkInterfaces>>,
    ...
    pub placement_group_selector: Option<Ec2NodeClassPlacementGroupSelector>,
...
/// are excluded. See ConnectionTracking.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Ec2NodeClassConnectionTracking {
    ...
    /// instance types.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tcpEstablishedTimeout")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "udpStreamTimeout")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct Ec2NodeClassNetworkInterfaces {
    ...
    pub interface_type: Ec2NodeClassNetworkInterfacesInterfaceType,
...
/// to provisioned instances.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum Ec2NodeClassNetworkInterfacesInterfaceType {
    #[serde(rename = "interface")]
    Interface,
    #[serde(rename = "efa-only")]
    EfaOnly,
}

/// PlacementGroupSelector defines the name or the id of the placement to resolve with the nodeclass.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Ec2NodeClassPlacementGroupSelector {
