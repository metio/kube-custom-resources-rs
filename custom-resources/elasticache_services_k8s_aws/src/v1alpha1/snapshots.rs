...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/elasticache-controller/elasticache.services.k8s.aws/v1alpha1/snapshots.yaml
...
pub struct SnapshotStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationGroupDescription"
    )]
