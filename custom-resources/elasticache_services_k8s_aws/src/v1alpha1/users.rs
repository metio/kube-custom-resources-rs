...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/elasticache-controller/elasticache.services.k8s.aws/v1alpha1/users.yaml
...
pub struct UserSpec {
    ...
    pub authentication_mode: Option<UserAuthenticationMode>,
