...
pub struct DatadogAgentFeatures {
    ...
    pub data_plane: Option<DatadogAgentFeaturesDataPlane>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "otelAgentGateway")]
    pub otel_agent_gateway: Option<DatadogAgentFeaturesOtelAgentGateway>,
...
pub struct DatadogAgentFeaturesAdmissionController {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub probe: Option<DatadogAgentFeaturesAdmissionControllerProbe>,
...
pub struct DatadogAgentFeaturesAdmissionControllerAgentSidecarInjection {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterAgentTlsVerification")]
    pub cluster_agent_tls_verification: Option<DatadogAgentFeaturesAdmissionControllerAgentSidecarInjectionClusterAgentTlsVerification>,
...
/// ClusterAgentTLSVerification configures TLS verification for Agent sidecar to Cluster Agent communication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesAdmissionControllerAgentSidecarInjectionClusterAgentTlsVerification {
    ...
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "copyCaConfigMap")]
    pub copy_ca_config_map: Option<bool>,
...
pub struct DatadogAgentFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFrom {
    ...
    pub file_key_ref: Option<DatadogAgentFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFromFileKeyRef>,
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFromFileKeyRef {
...
/// Probe holds the admission controller connectivity probe configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesAdmissionControllerProbe {
...
pub struct DatadogAgentFeaturesApmInstrumentation {
    ...
    pub injection_mode: Option<DatadogAgentFeaturesApmInstrumentationInjectionMode>,
...
pub enum DatadogAgentFeaturesApmInstrumentationInjectionMode {
    #[serde(rename = "auto")]
    Auto,
    #[serde(rename = "init_container")]
    InitContainer,
    #[serde(rename = "csi")]
    Csi,
    #[serde(rename = "image_volume")]
    ImageVolume,
}
...
pub struct DatadogAgentFeaturesApmInstrumentationTargetsDdTraceConfigsValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentFeaturesApmInstrumentationTargetsDdTraceConfigsValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesApmInstrumentationTargetsDdTraceConfigsValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentFeaturesCspm {
    ...
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runInSystemProbe")]
    pub run_in_system_probe: Option<bool>,
}
...
pub struct DatadogAgentFeaturesCws {
    ...
    pub enabled: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enforcement: Option<DatadogAgentFeaturesCwsEnforcement>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesCwsEnforcement {
...
/// Agent Data Plane is a high-performance sidecar that handles data ingestion.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesDataPlane {
    /// Dogstatsd configures DogStatsD handling by the Data Plane.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub dogstatsd: Option<DatadogAgentFeaturesDataPlaneDogstatsd>,
...
/// Dogstatsd configures DogStatsD handling by the Data Plane.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesDataPlaneDogstatsd {
...
pub struct DatadogAgentFeaturesNpm {
    ...
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "directSend")]
    pub direct_send: Option<bool>,
...
/// OtelAgentGateway configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesOtelAgentGateway {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conf: Option<DatadogAgentFeaturesOtelAgentGatewayConf>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<DatadogAgentFeaturesOtelAgentGatewayPorts>>,
}
...
/// When passing a configmap, file name *must* be otel-gateway-config.yaml.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesOtelAgentGatewayConf {
    /// ConfigData corresponds to the configuration file content.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configData")]
    pub config_data: Option<String>,
    /// ConfigMap references an existing ConfigMap with the configuration file content.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMap")]
    pub config_map: Option<DatadogAgentFeaturesOtelAgentGatewayConfConfigMap>,
}

/// ConfigMap references an existing ConfigMap with the configuration file content.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesOtelAgentGatewayConfConfigMap {
    /// Items maps a ConfigMap data `key` to a file `path` mount.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<DatadogAgentFeaturesOtelAgentGatewayConfConfigMapItems>>,
    /// Name is the name of the ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
/// Maps a string key to a path within a volume.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesOtelAgentGatewayConfConfigMapItems {
    /// key is the key to project.
    pub key: String,
    /// mode is Optional: mode bits used to set permissions on this file.
    /// Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511.
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentFeaturesOtelAgentGatewayPorts {
...
pub struct DatadogAgentGlobal {
    ...
    /// Default: 'false'
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "useVSock")]
    pub use_v_sock: Option<bool>,
}
...
pub struct DatadogAgentGlobalCsi {
    ...
    /// Default: true
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoManage")]
    ...
    pub node_affinity: Option<DatadogAgentGlobalCsiNodeAffinity>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<DatadogAgentGlobalCsiTolerations>>,
}

/// NodeAffinity specifies node affinity scheduling rules for CSI driver DaemonSet pods.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinity {
    ...
    pub preferred_during_scheduling_ignored_during_execution: Option<Vec<DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution>>,
    ...
    pub required_during_scheduling_ignored_during_execution: Option<DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution>,
}

/// An empty preferred scheduling term matches all objects with implicit weight 0
/// (i.e. it's a no-op). A null preferred scheduling term matches no objects (i.e. is also a no-op).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution {
    /// A node selector term, associated with the corresponding weight.
    pub preference: DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference,
...
/// A node selector term, associated with the corresponding weight.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference {
    /// A list of node selector requirements by node's labels.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions>>,
    /// A list of node selector requirements by node's fields.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchFields")]
    pub match_fields: Option<Vec<DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields>>,
}

/// A node selector requirement is a selector that contains values, a key, and an operator
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions {
...
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
/// may or may not try to eventually evict the pod from its node.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution {
    /// Required. A list of node selector terms. The terms are ORed.
    #[serde(rename = "nodeSelectorTerms")]
    pub node_selector_terms: Vec<DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms {
    /// A list of node selector requirements by node's labels.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions>>,
    /// A list of node selector requirements by node's fields.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchFields")]
    pub match_fields: Option<Vec<DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields>>,
}

/// A node selector requirement is a selector that contains values, a key, and an operator
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalCsiTolerations {
...
pub struct DatadogAgentGlobalEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentGlobalEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentGlobalKubeletHost {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentGlobalKubeletHostFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentGlobalKubeletHostFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentOverride {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "celWorkloadExclude")]
    pub cel_workload_exclude: Option<Vec<DatadogAgentOverrideCelWorkloadExclude>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentOverrideCelWorkloadExclude {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rules: Option<DatadogAgentOverrideCelWorkloadExcludeRules>,
}

/// Rules defines the CEL expressions used to identify workloads to exclude.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentOverrideCelWorkloadExcludeRules {
    /// Containers exclude rule
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub containers: Option<Vec<String>>,
    /// KubeEndpoints exclude rule
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kube_endpoints: Option<Vec<String>>,
    /// KubeServices exclude rule
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kube_services: Option<Vec<String>>,
    /// Pods exclude rule
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct DatadogAgentOverrideContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentOverrideContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentOverrideContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentOverrideEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentOverrideEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentOverrideEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentOverrideVolumesProjectedSources {
    ...
    pub pod_certificate: Option<DatadogAgentOverrideVolumesProjectedSourcesPodCertificate>,
...
/// use the certificates it issues.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentOverrideVolumesProjectedSourcesPodCertificate {
...
pub struct DatadogAgentStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub experiment: Option<DatadogAgentStatusExperiment>,
    /// The actual state of the OTel Agent Gateway as a deployment.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "otelAgentGateway")]
    pub otel_agent_gateway: Option<DatadogAgentStatusOtelAgentGateway>,
...
/// Experiment tracks the state of an active or recent Fleet Automation experiment.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusExperiment {
    /// ID is the unique experiment ID sent by Fleet Automation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// Phase is the current state of the experiment.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub phase: Option<DatadogAgentStatusExperimentPhase>,
}

/// Experiment tracks the state of an active or recent Fleet Automation experiment.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum DatadogAgentStatusExperimentPhase {
...
/// The actual state of the OTel Agent Gateway as a deployment.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusOtelAgentGateway {
    /// Total number of available pods (ready for at least minReadySeconds) targeted by this Deployment.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availableReplicas")]
    pub available_replicas: Option<i32>,
    /// CurrentHash is the stored hash of the Deployment.
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeatures {
    ...
    /// Agent Data Plane is a high-performance sidecar that handles data ingestion.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataPlane")]
    pub data_plane: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesDataPlane>,
    /// Dogstatsd configuration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// OtelAgentGateway configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "otelAgentGateway")]
    pub otel_agent_gateway: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGateway>,
    /// OtelCollector configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "otelCollector")]
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionController {
    ...
    /// Probe holds the admission controller connectivity probe configuration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub probe: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerProbe>,
    /// Registry defines an image registry for the admission controller.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub registry: Option<String>,
    /// ServiceName corresponds to the webhook service name.
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjection {
    ...
    /// ClusterAgentTLSVerification configures TLS verification for Agent sidecar to Cluster Agent communication.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterAgentTlsVerification")]
    pub cluster_agent_tls_verification: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjectionClusterAgentTlsVerification>,
    /// Enabled enables Sidecar injections.
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// ClusterAgentTLSVerification configures TLS verification for Agent sidecar to Cluster Agent communication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjectionClusterAgentTlsVerification {
    /// CopyCaConfigMap enables automatic creation of a ConfigMap containing the Cluster Agent's CA certificate
    /// in namespaces where sidecar injection occurs.
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "copyCaConfigMap")]
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerAgentSidecarInjectionProfilesEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
/// Probe holds the admission controller connectivity probe configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesAdmissionControllerProbe {
    /// Enabled enables the admission controller connectivity probe.
    /// The probe periodically sends dry-run ConfigMap creation requests to verify the
    /// webhook is reachable from the API server. Requires Cluster Agent 7.78.0+.
    /// Default: true
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentation {
    ...
    /// Empty by default so the Cluster Agent can apply its own defaults.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "injectionMode")]
    pub injection_mode: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentationInjectionMode>,
    /// Injector configures the APM Injector.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Enabled Default: false
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentationInjectionMode {
    #[serde(rename = "auto")]
    Auto,
    #[serde(rename = "init_container")]
    InitContainer,
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentationTargetsDdTraceConfigsValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentationTargetsDdTraceConfigsValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesApmInstrumentationTargetsDdTraceConfigsValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesCws {
    ...
    pub enabled: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enforcement: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesCwsEnforcement>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesCwsEnforcement {
    /// Enabled enables Enforcement for Cloud Workload Security.
    /// Default: true
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// Agent Data Plane is a high-performance sidecar that handles data ingestion.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesDataPlane {
    /// Dogstatsd configures DogStatsD handling by the Data Plane.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub dogstatsd: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesDataPlaneDogstatsd>,
    /// Enabled enables the Data Plane.
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// Dogstatsd configures DogStatsD handling by the Data Plane.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesDataPlaneDogstatsd {
    /// Enabled configures the Data Plane to handle DogStatsD traffic.
    /// When enabled, DogStatsD is disabled in the Core Agent.
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// OtelAgentGateway configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGateway {
    /// Conf overrides the configuration for the default OTel Agent Gateway.
    /// This must point to a ConfigMap containing a valid OTel collector configuration.
    /// When passing a configmap, file name *must* be otel-gateway-config.yaml.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conf: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConf>,
    /// Enabled enables the OTel Agent Gateway.
    /// Default: false
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    ...
    /// Defaults: otel-grpc:4317 / otel-http:4318.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayPorts>>,
}
...
/// When passing a configmap, file name *must* be otel-gateway-config.yaml.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConf {
    /// ConfigData corresponds to the configuration file content.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configData")]
    pub config_data: Option<String>,
    /// ConfigMap references an existing ConfigMap with the configuration file content.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMap")]
    pub config_map: Option<DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConfConfigMap>,
}

/// ConfigMap references an existing ConfigMap with the configuration file content.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConfConfigMap {
    /// Items maps a ConfigMap data `key` to a file `path` mount.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConfConfigMapItems>>,
    /// Name is the name of the ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
/// Maps a string key to a path within a volume.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayConfConfigMapItems {
    /// key is the key to project.
    pub key: String,
    /// mode is Optional: mode bits used to set permissions on this file.
    /// Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511.
...
/// ContainerPort represents a network port in a single container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogAgentStatusRemoteConfigConfigurationFeaturesOtelAgentGatewayPorts {
    /// Number of port to expose on the pod's IP address.
    /// This must be a valid port number, 0 < x < 65536.
    #[serde(rename = "containerPort")]
    pub container_port: i32,
