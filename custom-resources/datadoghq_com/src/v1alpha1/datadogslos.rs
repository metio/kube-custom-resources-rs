...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/DataDog/datadog-operator/datadoghq.com/v1alpha1/datadogslos.yaml
...
#[kube(group = "datadoghq.com", version = "v1alpha1", kind = "DatadogSLO", root = "DatadogSlo", plural = "datadogslos")]
#[kube(namespaced)]
...
pub struct DatadogSloSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeSlice")]
    pub time_slice: Option<DatadogSloTimeSlice>,
...
/// It specifies a metric query and a comparator/threshold that determines what counts as good uptime.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DatadogSloTimeSlice {
