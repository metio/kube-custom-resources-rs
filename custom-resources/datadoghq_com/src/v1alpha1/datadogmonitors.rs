...
pub struct DatadogMonitorStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "monitorLastForceSyncTime"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "monitorStateLastTransitionTime"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "monitorStateLastUpdateTime"
    )]
