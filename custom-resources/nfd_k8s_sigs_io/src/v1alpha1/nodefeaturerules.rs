...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/clusternet/clusternet/nfd.k8s-sigs.io/v1alpha1/nodefeaturerules.yaml
