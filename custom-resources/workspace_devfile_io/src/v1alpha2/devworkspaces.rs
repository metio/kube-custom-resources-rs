...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/devfile/api/workspace.devfile.io/v1alpha2/devworkspaces.yaml
...
#[kube(group = "workspace.devfile.io", version = "v1alpha2", kind = "DevWorkspace", plural = "devworkspaces")]
#[kube(namespaced)]
