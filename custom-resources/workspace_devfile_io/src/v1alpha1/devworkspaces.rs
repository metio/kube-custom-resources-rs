...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/devfile/api/workspace.devfile.io/v1alpha1/devworkspaces.yaml
...
#[kube(group = "workspace.devfile.io", version = "v1alpha1", kind = "DevWorkspace", plural = "devworkspaces")]
#[kube(namespaced)]
...
pub struct DevWorkspaceSpec {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingClass")]
...
pub struct DevWorkspaceStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ideUrl")]
