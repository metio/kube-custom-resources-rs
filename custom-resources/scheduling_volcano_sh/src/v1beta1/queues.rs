...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/volcano-sh/volcano/scheduling.volcano.sh/v1beta1/queues.yaml
