...
pub struct ClusterGeneratorGeneratorCloudsmithAccessTokenSpec {
    ...
    pub service_account_ref: ClusterGeneratorGeneratorCloudsmithAccessTokenSpecServiceAccountRef,
    /// ServiceSlug is the service slug in Cloudsmith for OIDC authentication
    #[serde(rename = "serviceSlug")]
    pub service_slug: String,
}

/// Name of the service account you are federating with
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorCloudsmithAccessTokenSpecServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// GCPWorkloadIdentityFederation holds the configurations required for generating federated access tokens.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederation {
    ...
    pub aws_security_credentials: Option<ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationAwsSecurityCredentials>,
    ...
    pub cred_config: Option<ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationCredConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gcpServiceAccountEmail")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccountRef")]
    pub service_account_ref: Option<ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationServiceAccountRef>,
}

/// awsSecurityCredentials is for configuring AWS region and credentials to use for obtaining the access token,
/// when using the AWS metadata server is not an option.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationAwsSecurityCredentials {
    ...
    pub aws_credentials_secret_ref: ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationAwsSecurityCredentialsAwsCredentialsSecretRef,
...
/// - aws_session_token: Session Token, is the short-lived token to authenticate requests made to AWS services.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationAwsSecurityCredentialsAwsCredentialsSecretRef {
    /// name of the secret.
    pub name: String,
...
/// serviceAccountRef must be used by providing operators service account details.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationCredConfig {
...
/// when Kubernetes is configured as provider in workload identity pool.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorGcrAccessTokenSpecAuthWorkloadIdentityFederationServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "getParameters")]
    pub get_parameters: Option<BTreeMap<String, Vec<String>>>,
...
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gcp: Option<ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcp>,
...
/// GCP authentication method
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcp {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretRef")]
    pub secret_ref: Option<ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpSecretRef>,
    /// ServiceAccountRef to a service account for impersonation
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccountRef")]
    pub service_account_ref: Option<ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpServiceAccountRef>,
    /// Specify a service account with Workload Identity
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workloadIdentity")]
    pub workload_identity: Option<ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpWorkloadIdentity>,
}

/// Specify credentials in a Secret object
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpSecretRef {
    /// The SecretAccessKey is used for authentication
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretAccessKeySecretRef")]
    pub secret_access_key_secret_ref: Option<ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpSecretRefSecretAccessKeySecretRef>,
}

/// The SecretAccessKey is used for authentication
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpSecretRefSecretAccessKeySecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// ServiceAccountRef to a service account for impersonation
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Specify a service account with Workload Identity
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpWorkloadIdentity {
    ...
    /// ServiceAccountSelector is a reference to a ServiceAccount resource.
    #[serde(rename = "serviceAccountRef")]
    pub service_account_ref: ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpWorkloadIdentityServiceAccountRef,
}

/// ServiceAccountSelector is a reference to a ServiceAccount resource.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterGeneratorGeneratorVaultDynamicSecretSpecProviderAuthGcpWorkloadIdentityServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
