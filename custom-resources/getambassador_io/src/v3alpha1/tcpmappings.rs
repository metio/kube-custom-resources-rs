...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/emissary-ingress/emissary/getambassador.io/v3alpha1/tcpmappings.yaml
...
#[kube(group = "getambassador.io", version = "v3alpha1", kind = "TCPMapping", root = "TcpMapping", plural = "tcpmappings")]
#[kube(namespaced)]
