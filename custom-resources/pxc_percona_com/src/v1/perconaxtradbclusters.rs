...
#[kube(group = "pxc.percona.com", version = "v1", kind = "PerconaXtraDBCluster", root = "PerconaXtraDbCluster", plural = "perconaxtradbclusters")]
#[kube(namespaced)]
...
pub struct PerconaXtraDbClusterSpec {
    ...
    pub storage_scaling: Option<PerconaXtraDbClusterStorageScaling>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PerconaXtraDbClusterBackupStoragesContainerOptionsEnvValueFrom {
    ...
    pub file_key_ref: Option<PerconaXtraDbClusterBackupStoragesContainerOptionsEnvValueFromFileKeyRef>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterBackupStoragesContainerOptionsEnvValueFromFileKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub optional: Option<bool>,
    pub path: String,
...
pub struct PerconaXtraDbClusterBackupStoragesS3 {
    ...
    pub ca_bundle: Option<PerconaXtraDbClusterBackupStoragesS3CaBundle>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checksumAlgorithm")]
    pub checksum_algorithm: Option<PerconaXtraDbClusterBackupStoragesS3ChecksumAlgorithm>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsSecret")]
    pub credentials_secret: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointUrl")]
    pub endpoint_url: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipBucketExistsCheck")]
    pub skip_bucket_exists_check: Option<bool>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterBackupStoragesS3CaBundle {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaXtraDbClusterBackupStoragesS3ChecksumAlgorithm {
...
pub struct PerconaXtraDbClusterHaproxySidecarVolumesProjectedSources {
    ...
    pub pod_certificate: Option<PerconaXtraDbClusterHaproxySidecarVolumesProjectedSourcesPodCertificate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterHaproxySidecarVolumesProjectedSourcesPodCertificate {
...
pub struct PerconaXtraDbClusterHaproxySidecars {
    ...
    pub restart_policy_rules: Option<Vec<PerconaXtraDbClusterHaproxySidecarsRestartPolicyRules>>,
...
pub struct PerconaXtraDbClusterHaproxySidecarsEnvValueFrom {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<PerconaXtraDbClusterHaproxySidecarsEnvValueFromFileKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterHaproxySidecarsEnvValueFromFileKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub optional: Option<bool>,
    pub path: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterHaproxySidecarsRestartPolicyRules {
    pub action: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<PerconaXtraDbClusterHaproxySidecarsRestartPolicyRulesExitCodes>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterHaproxySidecarsRestartPolicyRulesExitCodes {
    pub operator: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PerconaXtraDbClusterLogcollector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imagePullPolicy")]
    pub image_pull_policy: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logRotate")]
    pub log_rotate: Option<PerconaXtraDbClusterLogcollectorLogRotate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterLogcollectorLogRotate {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub configuration: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extraConfig")]
    pub extra_config: Option<PerconaXtraDbClusterLogcollectorLogRotateExtraConfig>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub schedule: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterLogcollectorLogRotateExtraConfig {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
pub struct PerconaXtraDbClusterProxysqlSidecarVolumesProjectedSources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "podCertificate")]
    pub pod_certificate: Option<PerconaXtraDbClusterProxysqlSidecarVolumesProjectedSourcesPodCertificate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterProxysqlSidecarVolumesProjectedSourcesPodCertificate {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateChainPath")]
    pub certificate_chain_path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialBundlePath")]
    pub credential_bundle_path: Option<String>,
...
pub struct PerconaXtraDbClusterProxysqlSidecars {
    ...
    pub restart_policy: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "restartPolicyRules")]
    pub restart_policy_rules: Option<Vec<PerconaXtraDbClusterProxysqlSidecarsRestartPolicyRules>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
pub struct PerconaXtraDbClusterProxysqlSidecarsEnvValueFrom {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<PerconaXtraDbClusterProxysqlSidecarsEnvValueFromFileKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterProxysqlSidecarsEnvValueFromFileKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub optional: Option<bool>,
    pub path: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterProxysqlSidecarsRestartPolicyRules {
    pub action: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<PerconaXtraDbClusterProxysqlSidecarsRestartPolicyRulesExitCodes>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterProxysqlSidecarsRestartPolicyRulesExitCodes {
    pub operator: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<i64>>,
}
...
pub struct PerconaXtraDbClusterPxc {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslSecretName")]
    pub ssl_secret_name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sstRetryCount")]
    pub sst_retry_count: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PerconaXtraDbClusterPxcSidecarVolumesProjectedSources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "podCertificate")]
    pub pod_certificate: Option<PerconaXtraDbClusterPxcSidecarVolumesProjectedSourcesPodCertificate>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterPxcSidecarVolumesProjectedSourcesPodCertificate {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateChainPath")]
    pub certificate_chain_path: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialBundlePath")]
    pub credential_bundle_path: Option<String>,
...
pub struct PerconaXtraDbClusterPxcSidecars {
    ...
    pub restart_policy: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "restartPolicyRules")]
    pub restart_policy_rules: Option<Vec<PerconaXtraDbClusterPxcSidecarsRestartPolicyRules>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
pub struct PerconaXtraDbClusterPxcSidecarsEnvValueFrom {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<PerconaXtraDbClusterPxcSidecarsEnvValueFromFileKeyRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterPxcSidecarsEnvValueFromFileKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub optional: Option<bool>,
    pub path: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterPxcSidecarsRestartPolicyRules {
    pub action: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exitCodes")]
    pub exit_codes: Option<PerconaXtraDbClusterPxcSidecarsRestartPolicyRulesExitCodes>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterPxcSidecarsRestartPolicyRulesExitCodes {
    pub operator: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<i64>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterStorageScaling {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub autoscaling: Option<PerconaXtraDbClusterStorageScalingAutoscaling>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterStorageScalingAutoscaling {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
pub struct PerconaXtraDbClusterStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recovery: Option<PerconaXtraDbClusterStatusRecovery>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub size: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageAutoscaling")]
    pub storage_autoscaling: Option<BTreeMap<String, PerconaXtraDbClusterStatusStorageAutoscaling>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterStatusRecovery {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterUUID")]
    pub cluster_uuid: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastRecoveryPod")]
    pub last_recovery_pod: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastRecoverySeqNo")]
    pub last_recovery_seq_no: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastRecoveryTime")]
    pub last_recovery_time: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaXtraDbClusterStatusStorageAutoscaling {
