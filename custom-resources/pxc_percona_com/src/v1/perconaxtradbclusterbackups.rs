...
#[kube(group = "pxc.percona.com", version = "v1", kind = "PerconaXtraDBClusterBackup", root = "PerconaXtraDbClusterBackup", plural = "perconaxtradbclusterbackups")]
#[kube(namespaced)]
...
pub struct PerconaXtraDbClusterBackupStatusS3 {
    ...
    pub checksum_algorithm: Option<PerconaXtraDbClusterBackupStatusS3ChecksumAlgorithm>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsSecret")]
    pub credentials_secret: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointUrl")]
    pub endpoint_url: Option<String>,
...
pub enum PerconaXtraDbClusterBackupStatusS3ChecksumAlgorithm {
