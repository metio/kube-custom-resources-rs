...
#[kube(group = "pxc.percona.com", version = "v1", kind = "PerconaXtraDBClusterRestore", root = "PerconaXtraDbClusterRestore", plural = "perconaxtradbclusterrestores")]
#[kube(namespaced)]
...
pub struct PerconaXtraDbClusterRestoreBackupSourceS3 {
    ...
    pub checksum_algorithm: Option<PerconaXtraDbClusterRestoreBackupSourceS3ChecksumAlgorithm>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsSecret")]
    pub credentials_secret: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointUrl")]
    pub endpoint_url: Option<String>,
...
pub enum PerconaXtraDbClusterRestoreBackupSourceS3ChecksumAlgorithm {
...
pub struct PerconaXtraDbClusterRestorePitr {
    ...
    pub r#type: Option<PerconaXtraDbClusterRestorePitrType>,
}
...
pub struct PerconaXtraDbClusterRestorePitrBackupSourceS3 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checksumAlgorithm")]
    pub checksum_algorithm: Option<PerconaXtraDbClusterRestorePitrBackupSourceS3ChecksumAlgorithm>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsSecret")]
    pub credentials_secret: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointUrl")]
    pub endpoint_url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaXtraDbClusterRestorePitrBackupSourceS3ChecksumAlgorithm {
    #[serde(rename = "CRC64NVME")]
    Crc64nvme,
    #[serde(rename = "CRC32")]
    Crc32,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaXtraDbClusterRestorePitrType {
    #[serde(rename = "latest")]
    Latest,
    #[serde(rename = "date")]
    Date,
