...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "PKISecretEngineConfig", root = "PkiSecretEngineConfig", plural = "pkisecretengineconfigs")]
#[kube(namespaced)]
...
pub struct PkiSecretEngineConfigSpec {
    ...
    pub private_key_format: Option<PkiSecretEngineConfigPrivateKeyFormat>,
    ...
    pub private_key_type: PkiSecretEngineConfigPrivateKeyType,
    ...
    #[serde(rename = "type")]
    pub r#type: PkiSecretEngineConfigType,
}
...
/// PKISecretEngineConfigSpec defines the desired state of PKISecretEngineConfig
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PkiSecretEngineConfigPrivateKeyFormat {
    #[serde(rename = "der")]
    Der,
    #[serde(rename = "pkcs8")]
    Pkcs8,
