...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "LDAPAuthEngineConfig", root = "LdapAuthEngineConfig", plural = "ldapauthengineconfigs")]
#[kube(namespaced)]
...
pub struct LdapAuthEngineConfigSpec {
    ...
    pub tls_max_version: Option<LdapAuthEngineConfigTlsMaxVersion>,
    ...
    pub tls_min_version: Option<LdapAuthEngineConfigTlsMinVersion>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caseSensitiveNames")]
    ...
    pub token_type: Option<LdapAuthEngineConfigTokenType>,
...
pub enum LdapAuthEngineConfigTlsMaxVersion {
    #[serde(rename = "tls10")]
    Tls10,
    #[serde(rename = "tls11")]
    Tls11,
...
/// LDAPAuthEngineConfigSpec defines the desired state of LDAPAuthEngineConfig
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LdapAuthEngineConfigTlsMinVersion {
    #[serde(rename = "tls10")]
    Tls10,
    #[serde(rename = "tls11")]
    Tls11,
...
/// LDAPAuthEngineConfigSpec defines the desired state of LDAPAuthEngineConfig
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LdapAuthEngineConfigTokenType {
