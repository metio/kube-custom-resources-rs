...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "GCPAuthEngineRole", root = "GcpAuthEngineRole", plural = "gcpauthengineroles")]
#[kube(namespaced)]
...
pub struct GcpAuthEngineRoleSpec {
    ...
    pub token_type: Option<GcpAuthEngineRoleTokenType>,
    ...
    #[serde(rename = "type")]
    pub r#type: GcpAuthEngineRoleType,
}
...
pub enum GcpAuthEngineRoleTokenType {
...
/// GCPAuthEngineRoleSpec defines the desired state of GCPAuthEngineRole
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum GcpAuthEngineRoleType {
    #[serde(rename = "iam")]
    Iam,
    #[serde(rename = "gce")]
    Gce,
