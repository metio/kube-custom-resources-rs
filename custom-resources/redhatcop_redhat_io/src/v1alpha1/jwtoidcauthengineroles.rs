...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "JWTOIDCAuthEngineRole", root = "JwtoidcAuthEngineRole", plural = "jwtoidcauthengineroles")]
#[kube(namespaced)]
...
pub struct JwtoidcAuthEngineRoleSpec {
    ...
    pub bound_claims_type: Option<JwtoidcAuthEngineRoleBoundClaimsType>,
    ...
    pub role_type: Option<JwtoidcAuthEngineRoleRoleType>,
    ...
    pub token_type: Option<JwtoidcAuthEngineRoleTokenType>,
...
pub enum JwtoidcAuthEngineRoleBoundClaimsType {
    #[serde(rename = "string")]
    String,
    #[serde(rename = "glob")]
    Glob,
...
/// JWTOIDCAuthEngineRoleSpec defines the desired state of JWTOIDCAuthEngineRole
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum JwtoidcAuthEngineRoleRoleType {
    #[serde(rename = "oidc")]
    Oidc,
    #[serde(rename = "jwt")]
    Jwt,
...
/// JWTOIDCAuthEngineRoleSpec defines the desired state of JWTOIDCAuthEngineRole
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum JwtoidcAuthEngineRoleTokenType {
