...
pub struct AzureSecretEngineRoleSpec {
    ...
    pub sign_in_audience: Option<AzureSecretEngineRoleSignInAudience>,
...
pub enum AzureSecretEngineRoleSignInAudience {
    #[serde(rename = "AzureADMyOrg")]
    AzureAdMyOrg,
    #[serde(rename = "AzureADMultipleOrgs")]
    AzureAdMultipleOrgs,
