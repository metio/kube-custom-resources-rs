...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "JWTOIDCAuthEngineConfig", root = "JwtoidcAuthEngineConfig", plural = "jwtoidcauthengineconfigs")]
#[kube(namespaced)]
...
pub struct JwtoidcAuthEngineConfigSpec {
    ...
    pub oidc_response_mode: Option<JwtoidcAuthEngineConfigOidcResponseMode>,
...
pub enum JwtoidcAuthEngineConfigOidcResponseMode {
    #[serde(rename = "query")]
    Query,
