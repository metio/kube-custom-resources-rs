...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "GCPAuthEngineConfig", root = "GcpAuthEngineConfig", plural = "gcpauthengineconfigs")]
#[kube(namespaced)]
...
pub struct GcpAuthEngineConfigSpec {
    ...
    pub gc_ealias: Option<GcpAuthEngineConfigGcEalias>,
...
pub enum GcpAuthEngineConfigGcEalias {
