...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/redhat-cop/vault-config-operator/redhatcop.redhat.io/v1alpha1/quaysecretenginestaticroles.yaml
...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "QuaySecretEngineStaticRole", plural = "quaysecretenginestaticroles")]
#[kube(namespaced)]
#[kube(status = "QuaySecretEngineStaticRoleStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct QuaySecretEngineStaticRoleSpec {
    /// Authentication is the kube auth configuration to be used to execute this request
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authentication: Option<QuaySecretEngineStaticRoleAuthentication>,
    /// Connection represents the information needed to connect to Vault. This operator uses the standard Vault environment variables to connect to Vault. If you need to override those settings and for example connect to a different Vault instance, you can do with this section of the CR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub connection: Option<QuaySecretEngineStaticRoleConnection>,
    ...
    pub default_permission: Option<QuaySecretEngineStaticRoleDefaultPermission>,
...
pub struct QuaySecretEngineStaticRoleAuthentication {
    ...
    pub service_account: Option<QuaySecretEngineStaticRoleAuthenticationServiceAccount>,
}
...
/// Connection represents the information needed to connect to Vault. This operator uses the standard Vault environment variables to connect to Vault. If you need to override those settings and for example connect to a different Vault instance, you can do with this section of the CR.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QuaySecretEngineStaticRoleConnection {
    ...
    pub t_ls_config: Option<QuaySecretEngineStaticRoleConnectionTLsConfig>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QuaySecretEngineStaticRoleConnectionTLsConfig {
    ...
    pub tls_secret: Option<QuaySecretEngineStaticRoleConnectionTLsConfigTlsSecret>,
...
pub enum QuaySecretEngineStaticRoleDefaultPermission {
    #[serde(rename = "admin")]
    Admin,
    #[serde(rename = "read")]
    Read,
...
/// QuaySecretEngineStaticRoleSpec defines the desired state of QuaySecretEngineStaticRole
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum QuaySecretEngineStaticRoleNamespaceType {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QuaySecretEngineStaticRoleStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
