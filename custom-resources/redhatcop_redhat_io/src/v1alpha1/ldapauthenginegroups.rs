...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/redhat-cop/vault-config-operator/redhatcop.redhat.io/v1alpha1/ldapauthenginegroups.yaml
...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "LDAPAuthEngineGroup", root = "LdapAuthEngineGroup", plural = "ldapauthenginegroups")]
#[kube(namespaced)]
#[kube(status = "LdapAuthEngineGroupStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct LdapAuthEngineGroupSpec {
    /// Authentication is the kube auth configuraiton to be used to execute this request
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authentication: Option<LdapAuthEngineGroupAuthentication>,
    /// Connection represents the information needed to connect to Vault. This operator uses the standard Vault environment variables to connect to Vault. If you need to override those settings and for example connect to a different Vault instance, you can do with this section of the CR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub connection: Option<LdapAuthEngineGroupConnection>,
...
pub struct LdapAuthEngineGroupAuthentication {
    ...
    pub service_account: Option<LdapAuthEngineGroupAuthenticationServiceAccount>,
}

/// ServiceAccount is the service account used for the kube auth authentication
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LdapAuthEngineGroupAuthenticationServiceAccount {
...
/// Connection represents the information needed to connect to Vault. This operator uses the standard Vault environment variables to connect to Vault. If you need to override those settings and for example connect to a different Vault instance, you can do with this section of the CR.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LdapAuthEngineGroupConnection {
    ...
    pub t_ls_config: Option<LdapAuthEngineGroupConnectionTLsConfig>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LdapAuthEngineGroupConnectionTLsConfig {
    ...
    pub tls_secret: Option<LdapAuthEngineGroupConnectionTLsConfigTlsSecret>,
...
/// TLSSecret namespace-local secret containing the tls material for the connection. the expected keys for the secret are: ca bundle -> "ca.crt", certificate -> "tls.crt", key -> "tls.key"
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LdapAuthEngineGroupConnectionTLsConfigTlsSecret {
    /// Name of the referent.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names>
    /// TODO: Add other useful fields. apiVersion, kind, uid?
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LdapAuthEngineGroupStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
