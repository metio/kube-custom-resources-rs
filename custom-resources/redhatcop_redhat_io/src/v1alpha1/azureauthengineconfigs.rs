...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/redhat-cop/vault-config-operator/redhatcop.redhat.io/v1alpha1/azureauthengineconfigs.yaml
...
#[kube(group = "redhatcop.redhat.io", version = "v1alpha1", kind = "AzureAuthEngineConfig", plural = "azureauthengineconfigs")]
#[kube(namespaced)]
#[kube(status = "AzureAuthEngineConfigStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct AzureAuthEngineConfigSpec {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authentication: Option<AzureAuthEngineConfigAuthentication>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub environment: Option<AzureAuthEngineConfigEnvironment>,
...
pub struct AzureAuthEngineConfigAuthentication {
    ...
    pub service_account: Option<AzureAuthEngineConfigAuthenticationServiceAccount>,
}
...
/// AzureCredentials consists in ClientID and ClientSecret, which can be created as Kubernetes Secret, VaultSecret or RandomSecret
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AzureAuthEngineConfigAzureCredentials {
...
/// Connection represents the information needed to connect to Vault. This operator uses the standard Vault environment variables to connect to Vault. If you need to override those settings and for example connect to a different Vault instance, you can do with this section of the CR.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AzureAuthEngineConfigConnection {
    ...
    pub t_ls_config: Option<AzureAuthEngineConfigConnectionTLsConfig>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AzureAuthEngineConfigConnectionTLsConfig {
    ...
    pub tls_secret: Option<AzureAuthEngineConfigConnectionTLsConfigTlsSecret>,
...
pub enum AzureAuthEngineConfigEnvironment {
    AzurePublicCloud,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AzureAuthEngineConfigStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
