...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/grafana/grafana-operator/grafana.integreatly.org/v1beta1/grafanalibrarypanels.yaml
...
#[kube(group = "grafana.integreatly.org", version = "v1beta1", kind = "GrafanaLibraryPanel", plural = "grafanalibrarypanels")]
#[kube(namespaced)]
#[kube(status = "GrafanaLibraryPanelStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct GrafanaLibraryPanelSpec {
    ...
    pub config_map_ref: Option<GrafanaLibraryPanelConfigMapRef>,
    ...
    pub datasources: Option<Vec<GrafanaLibraryPanelDatasources>>,
    /// environments variables from secrets or config maps
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "envFrom")]
    pub env_from: Option<Vec<GrafanaLibraryPanelEnvFrom>>,
    /// environments variables as a map
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub envs: Option<Vec<GrafanaLibraryPanelEnvs>>,
    ...
    pub grafana_com: Option<GrafanaLibraryPanelGrafanaCom>,
    ...
    pub instance_selector: GrafanaLibraryPanelInstanceSelector,
    /// model json
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub jsonnet_lib: Option<GrafanaLibraryPanelJsonnetLib>,
    /// plugins
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub plugins: Option<Vec<GrafanaLibraryPanelPlugins>>,
    ...
    pub url_authorization: Option<GrafanaLibraryPanelUrlAuthorization>,
}

/// model from configmap
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelConfigMapRef {
    /// The key to select.
    pub key: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelDatasources {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvFrom {
    /// Selects a key of a ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<GrafanaLibraryPanelEnvFromConfigMapKeyRef>,
    /// Selects a key of a Secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<GrafanaLibraryPanelEnvFromSecretKeyRef>,
}

/// Selects a key of a ConfigMap.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvFromConfigMapKeyRef {
    /// The key to select.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// Selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvFromSecretKeyRef {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvs {
    pub name: String,
    /// Inline env value
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub value_from: Option<GrafanaLibraryPanelEnvsValueFrom>,
}

/// Reference on value source, might be the reference on a secret or config map
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvsValueFrom {
    /// Selects a key of a ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapKeyRef")]
    pub config_map_key_ref: Option<GrafanaLibraryPanelEnvsValueFromConfigMapKeyRef>,
    /// Selects a key of a Secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretKeyRef")]
    pub secret_key_ref: Option<GrafanaLibraryPanelEnvsValueFromSecretKeyRef>,
}

/// Selects a key of a ConfigMap.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvsValueFromConfigMapKeyRef {
    /// The key to select.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// Selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelEnvsValueFromSecretKeyRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// grafana.com/dashboards
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelGrafanaCom {
    pub id: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Selects Grafana instances for import
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelInstanceSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<GrafanaLibraryPanelInstanceSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelInstanceSelectorMatchExpressions {
...
/// Jsonnet project build
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelJsonnetLib {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelPlugins {
    pub name: String,
    pub version: String,
}
...
/// authorization options for model from url
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelUrlAuthorization {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "basicAuth")]
    pub basic_auth: Option<GrafanaLibraryPanelUrlAuthorizationBasicAuth>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelUrlAuthorizationBasicAuth {
    /// SecretKeySelector selects a key of a Secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub password: Option<GrafanaLibraryPanelUrlAuthorizationBasicAuthPassword>,
    /// SecretKeySelector selects a key of a Secret.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub username: Option<GrafanaLibraryPanelUrlAuthorizationBasicAuthUsername>,
}

/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelUrlAuthorizationBasicAuthPassword {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct GrafanaLibraryPanelUrlAuthorizationBasicAuthUsername {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
