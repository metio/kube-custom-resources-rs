...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/karmada-io/karmada/work.karmada.io/v1alpha2/resourcebindings.yaml
...
pub struct ResourceBindingSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub components: Option<Vec<ResourceBindingComponents>>,
...
/// NodeClaim represents the node claim HardNodeAffinity, NodeSelector and Tolerations required by each replica.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaim {
    ...
    pub hard_node_affinity: Option<ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinity>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<ResourceBindingComponentsReplicaRequirementsNodeClaimTolerations>>,
}
...
/// is included here because it has a hard limit on pod scheduling.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinity {
    /// Required. A list of node selector terms. The terms are ORed.
    #[serde(rename = "nodeSelectorTerms")]
    pub node_selector_terms: Vec<ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTerms>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTerms {
    /// A list of node selector requirements by node's labels.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTermsMatchExpressions>>,
    /// A list of node selector requirements by node's fields.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchFields")]
    pub match_fields: Option<Vec<ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTermsMatchFields>>,
}

/// A node selector requirement is a selector that contains values, a key, and an operator
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTermsMatchExpressions {
...
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaimHardNodeAffinityNodeSelectorTermsMatchFields {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingComponentsReplicaRequirementsNodeClaimTolerations {
...
pub struct ResourceBindingFailover {
    ...
    /// by this value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster: Option<ResourceBindingFailoverCluster>,
}
...
/// by this value.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingFailoverCluster {
    /// PurgeMode represents how to deal with the legacy applications on the
    /// cluster from which the application is migrated.
    /// Valid options are "Directly", "Gracefully".
    /// Defaults to "Gracefully".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "purgeMode")]
    pub purge_mode: Option<ResourceBindingFailoverClusterPurgeMode>,
    /// StatePreservation defines the policy for preserving and restoring state data
    /// during failover events for stateful applications.
    /// 
    /// When an application fails over from one cluster to another, this policy enables
    ...
    /// which is alpha.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "statePreservation")]
    pub state_preservation: Option<ResourceBindingFailoverClusterStatePreservation>,
}
...
/// by this value.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ResourceBindingFailoverClusterPurgeMode {
    Directly,
    Gracefully,
}
...
/// which is alpha.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingFailoverClusterStatePreservation {
    /// Rules contains a list of StatePreservationRule configurations.
    /// Each rule specifies a JSONPath expression targeting specific pieces of
    /// state data to be preserved during failover events. An AliasLabelName is associated
    /// with each rule, serving as a label key when the preserved data is passed
    /// to the new cluster.
    pub rules: Vec<ResourceBindingFailoverClusterStatePreservationRules>,
}
...
/// as a label key when passing state information to the new cluster.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingFailoverClusterStatePreservationRules {
    /// AliasLabelName is the name that will be used as a label key when the preserved
    /// data is passed to the new cluster. This facilitates the injection of the
    /// preserved state back into the application resources during recovery.
    #[serde(rename = "aliasLabelName")]
...
pub struct ResourceBindingPlacementClusterAffinities {
    ...
    pub overflow_affinities: Option<Vec<ResourceBindingPlacementClusterAffinitiesOverflowAffinities>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingPlacementClusterAffinitiesOverflowAffinities {
    /// AffinityName is the name of the cluster group.
    #[serde(rename = "affinityName")]
    pub affinity_name: String,
    /// ClusterNames is the list of clusters to be selected.
    ...
    /// If non-nil and non-empty, only the clusters match this filter will be selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fieldSelector")]
    pub field_selector: Option<ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesFieldSelector>,
    /// LabelSelector is a filter to select member clusters by labels.
    /// If non-nil and non-empty, only the clusters match this filter will be selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "labelSelector")]
    pub label_selector: Option<ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesLabelSelector>,
}
...
/// If non-nil and non-empty, only the clusters match this filter will be selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesFieldSelector {
    /// A list of field selector requirements.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesFieldSelectorMatchExpressions>>,
}

/// A node selector requirement is a selector that contains values, a key, and an operator
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesFieldSelectorMatchExpressions {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
/// If non-nil and non-empty, only the clusters match this filter will be selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesLabelSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesLabelSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceBindingPlacementClusterAffinitiesOverflowAffinitiesLabelSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
