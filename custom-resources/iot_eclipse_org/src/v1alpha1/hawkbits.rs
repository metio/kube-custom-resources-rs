...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/ctron/hawkbit-operator/iot.eclipse.org/v1alpha1/hawkbits.yaml
