...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1beta1/functions.yaml
...
#[kube(group = "pkg.crossplane.io", version = "v1beta1", kind = "Function", plural = "functions")]
