...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1beta1/functionrevisions.yaml
...
#[kube(group = "pkg.crossplane.io", version = "v1beta1", kind = "FunctionRevision", plural = "functionrevisions")]
#[kube(status = "FunctionRevisionStatus")]
...
pub struct FunctionRevisionSpec {
    ...
    pub package_pull_secrets: Option<Vec<FunctionRevisionPackagePullSecrets>>,
    ...
    pub runtime_config_ref: Option<FunctionRevisionRuntimeConfigRef>,
...
pub struct FunctionRevisionPackagePullSecrets {
...
/// to configure the package runtime.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FunctionRevisionRuntimeConfigRef {
...
pub struct FunctionRevisionStatus {
    ...
    pub applied_image_config_refs: Option<Vec<FunctionRevisionStatusAppliedImageConfigRefs>>,
    ...
    pub object_refs: Option<Vec<FunctionRevisionStatusObjectRefs>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FunctionRevisionStatusAppliedImageConfigRefs {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FunctionRevisionStatusObjectRefs {
