...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1/functionrevisions.yaml
...
#[kube(group = "pkg.crossplane.io", version = "v1", kind = "FunctionRevision", plural = "functionrevisions")]
