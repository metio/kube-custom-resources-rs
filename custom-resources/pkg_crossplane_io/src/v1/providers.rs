...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/pkg.crossplane.io/v1/providers.yaml
...
pub struct ProviderSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "revisionActivationPolicy"
    )]
