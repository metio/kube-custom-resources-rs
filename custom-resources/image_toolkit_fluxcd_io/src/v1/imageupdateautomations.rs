...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluxcd/image-automation-controller/image.toolkit.fluxcd.io/v1/imageupdateautomations.yaml
...
#[kube(group = "image.toolkit.fluxcd.io", version = "v1", kind = "ImageUpdateAutomation", plural = "imageupdateautomations")]
#[kube(namespaced)]
