...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluxcd/image-reflector-controller/image.toolkit.fluxcd.io/v1/imagepolicies.yaml
...
#[kube(group = "image.toolkit.fluxcd.io", version = "v1", kind = "ImagePolicy", plural = "imagepolicies")]
#[kube(namespaced)]
