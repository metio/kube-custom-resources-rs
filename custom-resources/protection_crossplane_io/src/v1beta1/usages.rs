...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/crossplane/crossplane/protection.crossplane.io/v1beta1/usages.yaml
...
#[kube(group = "protection.crossplane.io", version = "v1beta1", kind = "Usage", plural = "usages")]
#[kube(namespaced)]
