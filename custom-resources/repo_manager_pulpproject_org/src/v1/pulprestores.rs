...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/pulp/pulp-operator/repo-manager.pulpproject.org/v1/pulprestores.yaml
...
#[kube(group = "repo-manager.pulpproject.org", version = "v1", kind = "PulpRestore", plural = "pulprestores")]
#[kube(namespaced)]
