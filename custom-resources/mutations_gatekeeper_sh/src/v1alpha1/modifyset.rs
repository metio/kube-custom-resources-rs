...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/open-policy-agent/gatekeeper/mutations.gatekeeper.sh/v1alpha1/modifyset.yaml
...
#[kube(group = "mutations.gatekeeper.sh", version = "v1alpha1", kind = "ModifySet", plural = "modifyset")]
...
pub struct ModifySetSpec {
    ...
    pub apply_to: Option<Vec<ModifySetApplyTo>>,
...
pub struct ModifySetMatch {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<ModifySetMatchSource>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetMatchKinds {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetMatchLabelSelectorMatchExpressions {
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetMatchNamespaceSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
pub struct ModifySetParameters {
    ...
    pub path_tests: Option<Vec<ModifySetParametersPathTests>>,
...
/// Parameters define the behavior of the mutator.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ModifySetParametersOperation {
    #[serde(rename = "merge")]
    Merge,
    #[serde(rename = "prune")]
    Prune,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetParametersPathTests {
    /// Condition describes whether the path either MustExist or MustNotExist in the original object
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub condition: Option<ModifySetParametersPathTestsCondition>,
...
/// * MustNotExist - the path must not exist or do not mutate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ModifySetParametersPathTestsCondition {
    MustExist,
    MustNotExist,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetStatus {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "byPod")]
    pub by_pod: Option<Vec<ModifySetStatusByPod>>,
}

/// MutatorPodStatusStatus defines the observed state of MutatorPodStatus.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetStatusByPod {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enforced: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<ModifySetStatusByPodErrors>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ModifySetStatusByPodErrors {
    pub message: String,
