...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/open-policy-agent/gatekeeper/mutations.gatekeeper.sh/v1/assignmetadata.yaml
...
#[kube(group = "mutations.gatekeeper.sh", version = "v1", kind = "AssignMetadata", plural = "assignmetadata")]
