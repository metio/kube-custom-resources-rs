...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluent/fluent-operator/fluentbit.fluent.io/v1alpha2/outputs.yaml
...
pub struct OutputAzureBlob {
    ...
    pub compress_blob: Option<OutputAzureBlobCompressBlob>,
...
/// AzureBlob defines AzureBlob Output Configuration
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum OutputAzureBlobCompressBlob {
    #[serde(rename = "on")]
    On,
    #[serde(rename = "off")]
    Off,
...
pub struct OutputFirehose {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compression: Option<OutputFirehoseCompression>,
...
/// Firehose defines Firehose Output configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum OutputFirehoseCompression {
    #[serde(rename = "gzip")]
    Gzip,
    #[serde(rename = "snappy")]
    Snappy,
