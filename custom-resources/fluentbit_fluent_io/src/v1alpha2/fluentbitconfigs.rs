...
pub struct FluentBitConfigService {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hotReloadEnsureThreadSafety")]
    pub hot_reload_ensure_thread_safety: Option<bool>,
    /// Maximum time in seconds to wait for a hot reload to complete before aborting.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hotReloadTimeout")]
    pub hot_reload_timeout: Option<i32>,
    /// Address to listen
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multilineBufferLimit")]
    pub multiline_buffer_limit: Option<String>,
