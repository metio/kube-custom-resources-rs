...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluent/fluent-operator/fluentbit.fluent.io/v1alpha2/clusterfilters.yaml
...
pub struct ClusterFilterFilters {
    ...
    pub log_to_metrics: Option<ClusterFilterFiltersLogToMetrics>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub wasm: Option<ClusterFilterFiltersWasm>,
}
...
pub struct ClusterFilterFiltersKubernetes {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "kubeMetaNamespaceCacheTTL"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "kubeMetaPreloadCacheDir"
    )]
...
/// LogToMetrics defines a Log to Metrics Filter configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterFilterFiltersLogToMetrics {
...
pub struct ClusterFilterFiltersModifyConditions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "matchingKeysDoNotHaveMatchingValues"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "matchingKeysHaveMatchingValues"
    )]
...
/// Wasm defines a Wasm configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterFilterFiltersWasm {
