...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluent/fluent-operator/fluentbit.fluent.io/v1alpha2/clusteroutputs.yaml
...
/// AWSAuthSecret Enable AWS Sigv4 Authentication for Amazon ElasticSearch Service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterOutputEsAwsAuthSecret {
    /// ValueSource defines how to find a value's key.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<ClusterOutputEsAwsAuthSecretValueFrom>,
}
...
/// Selects a key of a secret in the pod's namespace
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterOutputEsAwsAuthSecretValueFromSecretKeyRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// CloudAuthSecret Specify the credentials to use to connect to Elastic's Elasticsearch Service running on Elastic Cloud.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterOutputEsCloudAuthSecret {
    /// ValueSource defines how to find a value's key.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "valueFrom")]
    pub value_from: Option<ClusterOutputEsCloudAuthSecretValueFrom>,
}
...
/// Selects a key of a secret in the pod's namespace
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterOutputEsCloudAuthSecretValueFromSecretKeyRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct ClusterOutputFirehose {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compression: Option<ClusterOutputFirehoseCompression>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleAggregation")]
    pub simple_aggregation: Option<bool>,
...
/// Firehose defines Firehose Output configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterOutputFirehoseCompression {
    #[serde(rename = "gzip")]
    Gzip,
    #[serde(rename = "snappy")]
    Snappy,
...
pub struct ClusterOutputForward {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retainMetadataInForwardMode")]
    pub retain_metadata_in_forward_mode: Option<bool>,
