...
pub struct ClusterInputKubernetesEvents {
    ...
    pub pause_on_chunks_overlimit: Option<ClusterInputKubernetesEventsPauseOnChunksOverlimit>,
    ...
    pub storage_type: Option<ClusterInputKubernetesEventsStorageType>,
    /// Tag name associated to all records coming from this plugin.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tag: Option<String>,
...
/// KubernetesEvents defines the KubernetesEvents input plugin configuration
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterInputKubernetesEventsPauseOnChunksOverlimit {
    #[serde(rename = "on")]
    On,
    #[serde(rename = "off")]
    Off,
...
/// KubernetesEvents defines the KubernetesEvents input plugin configuration
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterInputKubernetesEventsStorageType {
...
pub struct ClusterInputSystemd {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storagePath")]
