...
pub struct MeshFaultInjectionRulesMatches {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sni: Option<MeshFaultInjectionRulesMatchesSni>,
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshFaultInjectionRulesMatchesSni {
    /// Type defines how to match traffic by SNI. Only `Exact` is supported.
    #[serde(rename = "type")]
    pub r#type: MeshFaultInjectionRulesMatchesSniType,
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshFaultInjectionRulesMatchesSniType {
    Exact,
}
