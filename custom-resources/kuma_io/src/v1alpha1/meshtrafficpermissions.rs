...
pub struct MeshTrafficPermissionRulesDefaultAllow {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sni: Option<MeshTrafficPermissionRulesDefaultAllowSni>,
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTrafficPermissionRulesDefaultAllowSni {
    /// Type defines how to match traffic by SNI. Only `Exact` is supported.
    #[serde(rename = "type")]
    pub r#type: MeshTrafficPermissionRulesDefaultAllowSniType,
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTrafficPermissionRulesDefaultAllowSniType {
    Exact,
}
...
pub struct MeshTrafficPermissionRulesDefaultAllowWithShadowDeny {
    /// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sni: Option<MeshTrafficPermissionRulesDefaultAllowWithShadowDenySni>,
    /// SpiffeID defines a matcher configuration for SpiffeID matching
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spiffeID")]
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTrafficPermissionRulesDefaultAllowWithShadowDenySni {
    /// Type defines how to match traffic by SNI. Only `Exact` is supported.
    #[serde(rename = "type")]
    pub r#type: MeshTrafficPermissionRulesDefaultAllowWithShadowDenySniType,
    /// Value is the SNI carried on the TLS connection that needs to match for the configuration to be applied
    pub value: String,
}
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTrafficPermissionRulesDefaultAllowWithShadowDenySniType {
    Exact,
}
...
pub struct MeshTrafficPermissionRulesDefaultDeny {
    /// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sni: Option<MeshTrafficPermissionRulesDefaultDenySni>,
    /// SpiffeID defines a matcher configuration for SpiffeID matching
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spiffeID")]
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTrafficPermissionRulesDefaultDenySni {
    /// Type defines how to match traffic by SNI. Only `Exact` is supported.
    #[serde(rename = "type")]
    pub r#type: MeshTrafficPermissionRulesDefaultDenySniType,
    /// Value is the SNI carried on the TLS connection that needs to match for the configuration to be applied
    pub value: String,
}
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTrafficPermissionRulesDefaultDenySniType {
    Exact,
}
