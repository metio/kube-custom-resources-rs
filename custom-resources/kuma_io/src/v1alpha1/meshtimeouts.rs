...
pub struct MeshTimeoutRules {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub matches: Option<Vec<MeshTimeoutRulesMatches>>,
}
...
pub struct MeshTimeoutRulesMatches {
    ...
    pub spiffe_id: Option<MeshTimeoutRulesMatchesSpiffeId>,
}

/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTimeoutRulesMatchesSni {
    /// Type defines how to match traffic by SNI. Only `Exact` is supported.
    #[serde(rename = "type")]
    pub r#type: MeshTimeoutRulesMatchesSniType,
...
/// SNI defines a matcher configuration for matching by SNI value carried on the TLS connection
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTimeoutRulesMatchesSniType {
    Exact,
}

/// SpiffeID defines a matcher configuration for SpiffeID matching
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTimeoutRulesMatchesSpiffeId {
    /// Type defines how to match incoming traffic by SpiffeID. `Exact` or `Prefix` are allowed.
    #[serde(rename = "type")]
    pub r#type: MeshTimeoutRulesMatchesSpiffeIdType,
...
/// SpiffeID defines a matcher configuration for SpiffeID matching
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTimeoutRulesMatchesSpiffeIdType {
    Exact,
    Prefix,
}
