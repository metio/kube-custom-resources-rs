...
pub struct MeshTraceDefaultBackendsOpenTelemetry {
    ...
    pub backend_ref: Option<MeshTraceDefaultBackendsOpenTelemetryBackendRef>,
...
/// defines the collector endpoint. Mutually exclusive with Endpoint.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTraceDefaultBackendsOpenTelemetryBackendRef {
    /// Kind of the backend resource.
    pub kind: MeshTraceDefaultBackendsOpenTelemetryBackendRefKind,
...
/// defines the collector endpoint. Mutually exclusive with Endpoint.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTraceDefaultBackendsOpenTelemetryBackendRefKind {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MeshTraceStatus {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<MeshTraceStatusConditions>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct MeshTraceStatusConditions {
    ...
    pub status: MeshTraceStatusConditionsStatus,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum MeshTraceStatusConditionsStatus {
    True,
    False,
    Unknown,
}
