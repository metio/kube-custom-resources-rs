...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kumahq/kuma/kuma.io/v1alpha1/meshloadbalancingstrategies.yaml
...
pub struct MeshLoadBalancingStrategySpec {
    ...
    pub target_ref: Option<MeshLoadBalancingStrategyTargetRef>,
