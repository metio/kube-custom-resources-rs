...
pub struct BackupSpec {
    ...
    pub log_level: Option<BackupLogLevel>,
...
pub struct BackupStorageS3 {
    ...
    pub access_key_id_secret_key_ref: Option<BackupStorageS3AccessKeyIdSecretKeyRef>,
    ...
    pub secret_access_key_secret_key_ref: Option<BackupStorageS3SecretAccessKeySecretKeyRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ssec: Option<BackupStorageS3Ssec>,
...
/// This enables server-side encryption where you provide and manage the encryption key.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BackupStorageS3Ssec {
    ...
    pub customer_key_secret_key_ref: BackupStorageS3SsecCustomerKeySecretKeyRef,
}

/// CustomerKeySecretKeyRef is a reference to a Secret key containing the SSE-C customer-provided encryption key.
/// The key must be a 32-byte (256-bit) key encoded in base64.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BackupStorageS3SsecCustomerKeySecretKeyRef {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
