...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/rook/rook/ceph.rook.io/v1/cephfilesystems.yaml
...
pub struct CephFilesystemDataPoolsErasureCoded {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<CephFilesystemDataPoolsErasureCodedAlgorithm>,
...
/// The erasure code settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephFilesystemDataPoolsErasureCodedAlgorithm {
    #[serde(rename = "isa")]
    Isa,
...
pub struct CephFilesystemDataPoolsMirroring {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<CephFilesystemDataPoolsMirroringMode>,
...
/// The mirroring settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephFilesystemDataPoolsMirroringMode {
    #[serde(rename = "pool")]
    Pool,
    #[serde(rename = "image")]
    Image,
...
pub struct CephFilesystemMetadataPoolErasureCoded {
    ...
    /// If absent, defaults to the plugin specified in osd_pool_default_erasure_code_profile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub algorithm: Option<CephFilesystemMetadataPoolErasureCodedAlgorithm>,
    /// Number of coding chunks per object in an erasure coded storage pool (required for erasure-coded pool type).
    /// This is the number of OSDs that can be lost simultaneously before data cannot be recovered.
    #[serde(rename = "codingChunks")]
    pub coding_chunks: i64,
...
/// The erasure code settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephFilesystemMetadataPoolErasureCodedAlgorithm {
    #[serde(rename = "isa")]
    Isa,
    #[serde(rename = "jerasure")]
    Jerasure,
...
pub struct CephFilesystemMetadataPoolMirroring {
    ...
    /// Mode is the mirroring mode: pool, image or init-only.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<CephFilesystemMetadataPoolMirroringMode>,
    /// Peers represents the peers spec
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The mirroring settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephFilesystemMetadataPoolMirroringMode {
    #[serde(rename = "pool")]
    Pool,
    #[serde(rename = "image")]
    Image,
