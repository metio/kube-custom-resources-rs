...
pub struct CephClusterMon {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "floatingMon")]
    pub floating_mon: Option<CephClusterMonFloatingMon>,
...
/// and can be scheduled on either node. Template variables are supplied via a ConfigMap.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CephClusterMonFloatingMon {
