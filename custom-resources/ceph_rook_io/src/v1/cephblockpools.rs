...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/rook/rook/ceph.rook.io/v1/cephblockpools.yaml
...
pub struct CephBlockPoolMirroring {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<CephBlockPoolMirroringMode>,
...
/// The mirroring settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephBlockPoolMirroringMode {
    #[serde(rename = "pool")]
    Pool,
    #[serde(rename = "image")]
    Image,
...
pub struct CephBlockPoolStatusMirroringStatusSummary {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub group_states: Option<CephBlockPoolStatusMirroringStatusSummaryGroupStates>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image_states: Option<CephBlockPoolStatusMirroringStatusSummaryImageStates>,
...
/// GroupStates is the various state for all mirrored image groups
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CephBlockPoolStatusMirroringStatusSummaryGroupStates {
...
/// ImageStates is the various state for all mirrored images
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CephBlockPoolStatusMirroringStatusSummaryImageStates {
    /// Error is when the mirroring state is errored
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<i64>,
    /// Replaying is when the replay of the mirroring journal is on-going
