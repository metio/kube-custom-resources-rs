...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/rook/rook/ceph.rook.io/v1/cephobjectzones.yaml
...
pub struct CephObjectZoneDataPoolErasureCoded {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stripeUnit")]
    pub stripe_unit: Option<IntOrString>,
}
...
pub struct CephObjectZoneDataPoolMirroring {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<CephObjectZoneDataPoolMirroringMode>,
...
/// The mirroring settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephObjectZoneDataPoolMirroringMode {
    #[serde(rename = "pool")]
    Pool,
    #[serde(rename = "image")]
    Image,
...
pub struct CephObjectZoneMetadataPoolMirroring {
    ...
    /// Mode is the mirroring mode: pool, image or init-only.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<CephObjectZoneMetadataPoolMirroringMode>,
    /// Peers represents the peers spec
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The mirroring settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CephObjectZoneMetadataPoolMirroringMode {
    #[serde(rename = "pool")]
    Pool,
    #[serde(rename = "image")]
    Image,
