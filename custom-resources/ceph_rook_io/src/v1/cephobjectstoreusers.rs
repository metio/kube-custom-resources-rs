...
pub struct CephObjectStoreUserSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accountRef")]
    pub account_ref: Option<CephObjectStoreUserAccountRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "opMask")]
    pub op_mask: Option<Vec<String>>,
...
pub struct CephObjectStoreUserAccountRef {
