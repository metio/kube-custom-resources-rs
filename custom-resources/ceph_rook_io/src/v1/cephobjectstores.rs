...
pub struct CephObjectStoreSecurity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslOptions")]
    pub ssl_options: Option<CephObjectStoreSecuritySslOptions>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tlsGroups")]
...
/// See <https://docs.ceph.com/en/latest/radosgw/frontends/#options>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CephObjectStoreSecuritySslOptions {
    /// defaultWorkarounds implements various bug workaround when true, or disables it when false. Default disabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultWorkarounds")]
    pub default_workarounds: Option<bool>,
    /// noCompression disables compression when true, or disables it when false. Default disabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noCompression")]
