...
pub struct EphemeralRunnerSetSpec {
    ...
    pub ephemeral_runner_metadata: Option<EphemeralRunnerSetEphemeralRunnerMetadata>,
...
pub struct EphemeralRunnerSetEphemeralRunnerMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct EphemeralRunnerSetEphemeralRunnerSpec {
    ...
    pub ephemeral_runner_config_secret_metadata: Option<EphemeralRunnerSetEphemeralRunnerSpecEphemeralRunnerConfigSecretMetadata>,
...
/// ResourceMeta carries metadata common to all internal resources
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EphemeralRunnerSetEphemeralRunnerSpecEphemeralRunnerConfigSecretMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub labels: Option<BTreeMap<String, String>>,
...
pub struct EphemeralRunnerSetEphemeralRunnerSpecSpec {
    ...
    pub workload_ref: Option<EphemeralRunnerSetEphemeralRunnerSpecSpecWorkloadRef>,
}
...
/// may result in the placement not conforming to the expected policies.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct EphemeralRunnerSetEphemeralRunnerSpecSpecWorkloadRef {
