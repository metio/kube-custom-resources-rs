...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubevious/workload-operator/kubevious.io/v1alpha1/workloadprofiles.yaml
