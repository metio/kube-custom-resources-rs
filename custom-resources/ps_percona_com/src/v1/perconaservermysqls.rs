...
#[kube(group = "ps.percona.com", version = "v1", kind = "PerconaServerMySQL", root = "PerconaServerMySql", plural = "perconaservermysqls")]
#[kube(namespaced)]
...
pub struct PerconaServerMySqlBackupPitrBinlogServer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub storage: Option<PerconaServerMySqlBackupPitrBinlogServerStorage>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PerconaServerMySqlBackupSchedule {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<PerconaServerMySqlBackupScheduleType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaServerMySqlBackupScheduleType {
    #[serde(rename = "full")]
    Full,
...
pub struct PerconaServerMySqlMysql {
    ...
    pub cluster_type: Option<PerconaServerMySqlMysqlClusterType>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub configuration: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerSecurityContext")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PerconaServerMySqlMysqlClusterType {
    #[serde(rename = "group-replication")]
    GroupReplication,
    #[serde(rename = "async")]
    Async,
}
...
pub struct PerconaServerMySqlUnsafeFlags {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "backupNonReadyCluster")]
    pub backup_non_ready_cluster: Option<bool>,
...
pub struct PerconaServerMySqlStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "binlogServer")]
    pub binlog_server: Option<PerconaServerMySqlStatusBinlogServer>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaServerMySqlStatusBinlogServer {
