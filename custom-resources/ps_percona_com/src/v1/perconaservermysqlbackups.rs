...
#[kube(group = "ps.percona.com", version = "v1", kind = "PerconaServerMySQLBackup", root = "PerconaServerMySqlBackup", plural = "perconaservermysqlbackups")]
#[kube(namespaced)]
...
pub struct PerconaServerMySqlBackupSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "incrementalBaseBackupName")]
    pub incremental_base_backup_name: Option<String>,
    ...
    pub r#type: Option<PerconaServerMySqlBackupType>,
}
...
pub enum PerconaServerMySqlBackupType {
    #[serde(rename = "full")]
    Full,
