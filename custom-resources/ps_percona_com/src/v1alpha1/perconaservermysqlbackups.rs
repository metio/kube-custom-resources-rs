...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/percona/percona-server-mysql-operator/ps.percona.com/v1alpha1/perconaservermysqlbackups.yaml
...
#[kube(group = "ps.percona.com", version = "v1alpha1", kind = "PerconaServerMySQLBackup", root = "PerconaServerMySqlBackup", plural = "perconaservermysqlbackups")]
#[kube(namespaced)]
