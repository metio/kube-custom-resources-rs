...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api/addons.cluster.x-k8s.io/v1beta2/clusterresourcesetbindings.yaml
...
#[kube(group = "addons.cluster.x-k8s.io", version = "v1beta2", kind = "ClusterResourceSetBinding", plural = "clusterresourcesetbindings")]
#[kube(namespaced)]
