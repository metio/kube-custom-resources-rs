...
pub struct DatabaseSpec {
    /// BatchWindow specifies a duration to wait and collect table changes before planning and applying them together in a single migration. This improves performance when deploying many tables at once by reducing the number of database connections and migrations created. When set, tables are queued and processed together after the window expires. Example values: "5s", "10s", "30s"
