...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/application-stacks/runtime-component-operator/rc.app.stacks/v1/runtimeoperations.yaml
