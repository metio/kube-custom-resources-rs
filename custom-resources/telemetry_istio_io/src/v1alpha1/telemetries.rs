...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/telemetry.istio.io/v1alpha1/telemetries.yaml
...
pub struct TelemetryTracing {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableContextPropagation")]
    pub disable_context_propagation: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableIstioTags")]
    pub enable_istio_tags: Option<bool>,
