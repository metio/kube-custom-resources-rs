...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/alexandrevilain/temporal-operator/temporal.io/v1beta1/temporalnamespaces.yaml
...
pub struct TemporalNamespaceSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowSearchAttributeDeletion")]
    pub allow_search_attribute_deletion: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customSearchAttributes")]
    pub custom_search_attributes: Option<BTreeMap<String, String>>,
