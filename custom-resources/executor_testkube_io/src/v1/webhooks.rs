...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubeshop/testkube-operator/executor.testkube.io/v1/webhooks.yaml
