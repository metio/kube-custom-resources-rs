...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/apache/rocketmq-operator/rocketmq.apache.org/v1alpha1/topictransfers.yaml
