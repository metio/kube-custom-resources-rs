...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-csi/external-snapshotter/groupsnapshot.storage.k8s.io/v1beta2/volumegroupsnapshots.yaml
...
#[kube(group = "groupsnapshot.storage.k8s.io", version = "v1beta2", kind = "VolumeGroupSnapshot", plural = "volumegroupsnapshots")]
#[kube(namespaced)]
