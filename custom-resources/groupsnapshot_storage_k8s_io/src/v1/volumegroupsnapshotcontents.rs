...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-csi/external-snapshotter/groupsnapshot.storage.k8s.io/v1/volumegroupsnapshotcontents.yaml
...
#[kube(group = "groupsnapshot.storage.k8s.io", version = "v1", kind = "VolumeGroupSnapshotContent", plural = "volumegroupsnapshotcontents")]
...
pub struct VolumeGroupSnapshotContentStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeSnapshotInfoList")]
    pub volume_snapshot_info_list: Option<Vec<VolumeGroupSnapshotContentStatusVolumeSnapshotInfoList>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VolumeGroupSnapshotContentStatusVolumeSnapshotInfoList {
