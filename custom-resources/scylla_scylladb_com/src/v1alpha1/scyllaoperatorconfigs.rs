...
pub struct ScyllaOperatorConfigSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unsupportedBashToolsImageOverride"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unsupportedGrafanaImageOverride"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unsupportedPrometheusVersionOverride"
    )]
