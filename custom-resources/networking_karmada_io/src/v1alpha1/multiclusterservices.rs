...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/karmada-io/karmada/networking.karmada.io/v1alpha1/multiclusterservices.yaml
