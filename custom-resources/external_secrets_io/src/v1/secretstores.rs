...
pub struct SecretStoreProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub nebiusmysterybox: Option<SecretStoreProviderNebiusmysterybox>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ovh: Option<SecretStoreProviderOvh>,
...
pub struct SecretStoreProviderAws {
    ...
    pub session_tags_policy: Option<SecretStoreProviderAwsSessionTagsPolicy>,
...
/// AWS configures this store to sync secrets using AWS Secret Manager provider
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SecretStoreProviderAwsSessionTagsPolicy {
    None,
    Simple,
    Custom,
}
...
pub struct SecretStoreProviderGithub {
    ...
    pub org_secret_visibility: Option<SecretStoreProviderGithubOrgSecretVisibility>,
...
/// Note: This provider only supports write operations (PushSecret) and cannot fetch secrets from GitHub
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SecretStoreProviderGithubOrgSecretVisibility {
    #[serde(rename = "all")]
    All,
...
/// NebiusMysterybox configures this store to sync secrets using NebiusMysterybox provider
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysterybox {
    /// NebiusMysterybox API endpoint
    #[serde(rename = "apiDomain")]
    pub api_domain: String,
    /// Auth defines parameters to authenticate in MysteryBox
    pub auth: SecretStoreProviderNebiusmysteryboxAuth,
    /// The provider for the CA bundle to use to validate NebiusMysterybox server certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<SecretStoreProviderNebiusmysteryboxCaProvider>,
}

/// Auth defines parameters to authenticate in MysteryBox
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysteryboxAuth {
    ...
    pub service_account_creds_secret_ref: Option<SecretStoreProviderNebiusmysteryboxAuthServiceAccountCredsSecretRef>,
    ...
    pub token_secret_ref: Option<SecretStoreProviderNebiusmysteryboxAuthTokenSecretRef>,
}
...
/// }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysteryboxAuthServiceAccountCredsSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// Token authenticates with Nebius Mysterybox by presenting a token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysteryboxAuthTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// The provider for the CA bundle to use to validate NebiusMysterybox server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysteryboxCaProvider {
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certSecretRef")]
    pub cert_secret_ref: Option<SecretStoreProviderNebiusmysteryboxCaProviderCertSecretRef>,
}

/// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderNebiusmysteryboxCaProviderCertSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OVHcloud configures this store to sync secrets using the OVHcloud provider.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderOvh {
    /// Authentication method (mtls or token).
    pub auth: SecretStoreProviderOvhAuth,
...
pub struct SecretStoreProviderOvhAuthMtls {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<SecretStoreProviderOvhAuthMtlsCaProvider>,
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "certSecretRef")]
    pub cert_secret_ref: SecretStoreProviderOvhAuthMtlsCertSecretRef,
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "keySecretRef")]
    pub key_secret_ref: SecretStoreProviderOvhAuthMtlsKeySecretRef,
}

/// CAProvider provides a custom certificate authority for accessing the provider's store.
/// The CAProvider points to a Secret or ConfigMap resource that contains a PEM-encoded certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SecretStoreProviderOvhAuthMtlsCaProvider {
    /// The key where the CA certificate can be found in the Secret or ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    /// The name of the object located at the provider type.
    ...
    /// The type of provider to use such as "Secret", or "ConfigMap".
    #[serde(rename = "type")]
    pub r#type: SecretStoreProviderOvhAuthMtlsCaProviderType,
}

/// CAProvider provides a custom certificate authority for accessing the provider's store.
/// The CAProvider points to a Secret or ConfigMap resource that contains a PEM-encoded certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SecretStoreProviderOvhAuthMtlsCaProviderType {
    Secret,
    ConfigMap,
}
...
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderOvhAuthMtlsCertSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderOvhAuthMtlsKeySecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OvhClientToken defines the configuration required to authenticate to OVHcloud's Secret Manager using a token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderOvhAuthToken {
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "tokenSecretRef")]
    pub token_secret_ref: SecretStoreProviderOvhAuthTokenTokenSecretRef,
}

/// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderOvhAuthTokenTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
pub struct SecretStoreProviderPassbolt {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<SecretStoreProviderPassboltCaProvider>,
...
/// The provider for the CA bundle to use to validate Passbolt server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct SecretStoreProviderPassboltCaProvider {
    /// The key where the CA certificate can be found in the Secret or ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    /// The name of the object located at the provider type.
    ...
    /// The type of provider to use such as "Secret", or "ConfigMap".
    #[serde(rename = "type")]
    pub r#type: SecretStoreProviderPassboltCaProviderType,
}

/// The provider for the CA bundle to use to validate Passbolt server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum SecretStoreProviderPassboltCaProviderType {
    Secret,
    ConfigMap,
}
...
pub struct SecretStoreProviderPulumi {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessToken")]
    pub access_token: Option<SecretStoreProviderPulumiAccessToken>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub auth: Option<SecretStoreProviderPulumiAuth>,
...
/// Either auth or the deprecated accessToken field must be specified.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderPulumiAuth {
    /// AccessToken authenticates using a Pulumi access token stored in a Kubernetes Secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessToken")]
    pub access_token: Option<SecretStoreProviderPulumiAuthAccessToken>,
    /// OIDCConfig authenticates using Kubernetes ServiceAccount tokens via OIDC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "oidcConfig")]
    pub oidc_config: Option<SecretStoreProviderPulumiAuthOidcConfig>,
}

/// AccessToken authenticates using a Pulumi access token stored in a Kubernetes Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderPulumiAuthAccessToken {
    /// SecretRef is a reference to a secret containing the Pulumi API token.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretRef")]
    pub secret_ref: Option<SecretStoreProviderPulumiAuthAccessTokenSecretRef>,
}

/// SecretRef is a reference to a secret containing the Pulumi API token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderPulumiAuthAccessTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OIDCConfig authenticates using Kubernetes ServiceAccount tokens via OIDC.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderPulumiAuthOidcConfig {
    ...
    /// ServiceAccountRef specifies the Kubernetes ServiceAccount to use for authentication.
    #[serde(rename = "serviceAccountRef")]
    pub service_account_ref: SecretStoreProviderPulumiAuthOidcConfigServiceAccountRef,
}

/// ServiceAccountRef specifies the Kubernetes ServiceAccount to use for authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecretStoreProviderPulumiAuthOidcConfigServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
