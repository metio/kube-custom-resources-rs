...
pub struct ClusterExternalSecretExternalSecretSpecDataRemoteRef {
    ...
    pub null_byte_policy: Option<ClusterExternalSecretExternalSecretSpecDataRemoteRefNullBytePolicy>,
...
/// which secret (version/property/..) to fetch.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterExternalSecretExternalSecretSpecDataRemoteRefNullBytePolicy {
    Ignore,
    Fail,
}
...
pub struct ClusterExternalSecretExternalSecretSpecDataFromExtract {
    ...
    /// Controls how ESO handles fetched secret data containing NUL bytes for this source.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nullBytePolicy")]
    pub null_byte_policy: Option<ClusterExternalSecretExternalSecretSpecDataFromExtractNullBytePolicy>,
    /// Used to select a specific property of the Provider value (if a map), if supported
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub property: Option<String>,
    /// Used to select a specific version of the Provider value, if supported
...
/// Note: Extract does not support sourceRef.Generator or sourceRef.GeneratorRef.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterExternalSecretExternalSecretSpecDataFromExtractNullBytePolicy {
    Ignore,
    Fail,
}
...
pub struct ClusterExternalSecretExternalSecretSpecDataFromFind {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nullBytePolicy")]
    pub null_byte_policy: Option<ClusterExternalSecretExternalSecretSpecDataFromFindNullBytePolicy>,
...
/// Note: Find does not support sourceRef.Generator or sourceRef.GeneratorRef.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterExternalSecretExternalSecretSpecDataFromFindNullBytePolicy {
    Ignore,
    Fail,
}
