...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/external-secrets/external-secrets/external-secrets.io/v1/clustersecretstores.yaml
...
pub struct ClusterSecretStoreProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub nebiusmysterybox: Option<ClusterSecretStoreProviderNebiusmysterybox>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ovh: Option<ClusterSecretStoreProviderOvh>,
...
pub struct ClusterSecretStoreProviderAws {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customSessionTags")]
    pub custom_session_tags: Option<BTreeMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sessionTagsPolicy")]
    pub session_tags_policy: Option<ClusterSecretStoreProviderAwsSessionTagsPolicy>,
...
/// AWS configures this store to sync secrets using AWS Secret Manager provider
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterSecretStoreProviderAwsSessionTagsPolicy {
    None,
    Simple,
    Custom,
}
...
pub struct ClusterSecretStoreProviderGithub {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "orgSecretVisibility")]
    pub org_secret_visibility: Option<ClusterSecretStoreProviderGithubOrgSecretVisibility>,
...
/// Note: This provider only supports write operations (PushSecret) and cannot fetch secrets from GitHub
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterSecretStoreProviderGithubOrgSecretVisibility {
    #[serde(rename = "all")]
    All,
...
pub struct ClusterSecretStoreProviderKeepersecurity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "getByTitleFallback")]
    pub get_by_title_fallback: Option<bool>,
}
...
/// NebiusMysterybox configures this store to sync secrets using NebiusMysterybox provider
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysterybox {
    /// NebiusMysterybox API endpoint
    #[serde(rename = "apiDomain")]
    pub api_domain: String,
    /// Auth defines parameters to authenticate in MysteryBox
    pub auth: ClusterSecretStoreProviderNebiusmysteryboxAuth,
    /// The provider for the CA bundle to use to validate NebiusMysterybox server certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<ClusterSecretStoreProviderNebiusmysteryboxCaProvider>,
}

/// Auth defines parameters to authenticate in MysteryBox
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysteryboxAuth {
    ...
    ///   }
    /// }
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAccountCredsSecretRef")]
    pub service_account_creds_secret_ref: Option<ClusterSecretStoreProviderNebiusmysteryboxAuthServiceAccountCredsSecretRef>,
    ...
    pub token_secret_ref: Option<ClusterSecretStoreProviderNebiusmysteryboxAuthTokenSecretRef>,
}
...
/// }
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysteryboxAuthServiceAccountCredsSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// Token authenticates with Nebius Mysterybox by presenting a token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysteryboxAuthTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// The provider for the CA bundle to use to validate NebiusMysterybox server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysteryboxCaProvider {
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certSecretRef")]
    pub cert_secret_ref: Option<ClusterSecretStoreProviderNebiusmysteryboxCaProviderCertSecretRef>,
}

/// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderNebiusmysteryboxCaProviderCertSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OVHcloud configures this store to sync secrets using the OVHcloud provider.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderOvh {
    /// Authentication method (mtls or token).
    pub auth: ClusterSecretStoreProviderOvhAuth,
    /// Enables or disables check-and-set (CAS) (default: false).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "casRequired")]
    pub cas_required: Option<bool>,
    /// Setup a timeout in seconds when requests to the KMS are made (default: 30).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "okmsTimeout")]
    pub okms_timeout: Option<i32>,
...
pub struct ClusterSecretStoreProviderOvhAuthMtls {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<ClusterSecretStoreProviderOvhAuthMtlsCaProvider>,
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "certSecretRef")]
    pub cert_secret_ref: ClusterSecretStoreProviderOvhAuthMtlsCertSecretRef,
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "keySecretRef")]
    pub key_secret_ref: ClusterSecretStoreProviderOvhAuthMtlsKeySecretRef,
}

/// CAProvider provides a custom certificate authority for accessing the provider's store.
/// The CAProvider points to a Secret or ConfigMap resource that contains a PEM-encoded certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterSecretStoreProviderOvhAuthMtlsCaProvider {
    /// The key where the CA certificate can be found in the Secret or ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    /// The name of the object located at the provider type.
    ...
    /// The type of provider to use such as "Secret", or "ConfigMap".
    #[serde(rename = "type")]
    pub r#type: ClusterSecretStoreProviderOvhAuthMtlsCaProviderType,
}

/// CAProvider provides a custom certificate authority for accessing the provider's store.
/// The CAProvider points to a Secret or ConfigMap resource that contains a PEM-encoded certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterSecretStoreProviderOvhAuthMtlsCaProviderType {
    Secret,
    ConfigMap,
}
...
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderOvhAuthMtlsCertSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderOvhAuthMtlsKeySecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OvhClientToken defines the configuration required to authenticate to OVHcloud's Secret Manager using a token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderOvhAuthToken {
    /// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
    /// In some instances, `key` is a required field.
    #[serde(rename = "tokenSecretRef")]
    pub token_secret_ref: ClusterSecretStoreProviderOvhAuthTokenTokenSecretRef,
}

/// SecretKeySelector is a reference to a specific 'key' within a Secret resource.
/// In some instances, `key` is a required field.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderOvhAuthTokenTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
pub struct ClusterSecretStoreProviderPassbolt {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caProvider")]
    pub ca_provider: Option<ClusterSecretStoreProviderPassboltCaProvider>,
...
/// The provider for the CA bundle to use to validate Passbolt server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterSecretStoreProviderPassboltCaProvider {
    /// The key where the CA certificate can be found in the Secret or ConfigMap.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    /// The name of the object located at the provider type.
    ...
    /// The type of provider to use such as "Secret", or "ConfigMap".
    #[serde(rename = "type")]
    pub r#type: ClusterSecretStoreProviderPassboltCaProviderType,
}

/// The provider for the CA bundle to use to validate Passbolt server certificate.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterSecretStoreProviderPassboltCaProviderType {
    Secret,
    ConfigMap,
}
...
pub struct ClusterSecretStoreProviderPulumi {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessToken")]
    pub access_token: Option<ClusterSecretStoreProviderPulumiAccessToken>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub auth: Option<ClusterSecretStoreProviderPulumiAuth>,
...
/// Either auth or the deprecated accessToken field must be specified.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderPulumiAuth {
    /// AccessToken authenticates using a Pulumi access token stored in a Kubernetes Secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessToken")]
    pub access_token: Option<ClusterSecretStoreProviderPulumiAuthAccessToken>,
    /// OIDCConfig authenticates using Kubernetes ServiceAccount tokens via OIDC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "oidcConfig")]
    pub oidc_config: Option<ClusterSecretStoreProviderPulumiAuthOidcConfig>,
}

/// AccessToken authenticates using a Pulumi access token stored in a Kubernetes Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderPulumiAuthAccessToken {
    /// SecretRef is a reference to a secret containing the Pulumi API token.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretRef")]
    pub secret_ref: Option<ClusterSecretStoreProviderPulumiAuthAccessTokenSecretRef>,
}

/// SecretRef is a reference to a secret containing the Pulumi API token.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderPulumiAuthAccessTokenSecretRef {
    /// A key in the referenced Secret.
    /// Some instances of this field may be defaulted, in others it may be required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
...
/// OIDCConfig authenticates using Kubernetes ServiceAccount tokens via OIDC.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderPulumiAuthOidcConfig {
    ...
    /// ServiceAccountRef specifies the Kubernetes ServiceAccount to use for authentication.
    #[serde(rename = "serviceAccountRef")]
    pub service_account_ref: ClusterSecretStoreProviderPulumiAuthOidcConfigServiceAccountRef,
}

/// ServiceAccountRef specifies the Kubernetes ServiceAccount to use for authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterSecretStoreProviderPulumiAuthOidcConfigServiceAccountRef {
    /// Audience specifies the `aud` claim for the service account token
    /// If the service account uses a well-known annotation for e.g. IRSA or GCP Workload Identity
    /// then this audiences will be appended to the list
    #[serde(default, skip_serializing_if = "Option::is_none")]
