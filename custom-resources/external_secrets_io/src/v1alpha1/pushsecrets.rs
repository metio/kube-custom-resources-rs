...
pub struct PushSecretSpec {
    ...
    pub data_to: Option<Vec<PushSecretDataTo>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataTo {
    /// Used to define a conversion Strategy for the secret keys
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "conversionStrategy")]
    pub conversion_strategy: Option<PushSecretDataToConversionStrategy>,
    /// Match pattern for selecting keys from the source Secret.
    /// If not specified, all keys are selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "match")]
    pub r#match: Option<PushSecretDataToMatch>,
    /// Metadata is metadata attached to the secret.
    /// The structure of metadata is provider specific, please look it up in the provider documentation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<serde_json::Value>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rewrite: Option<Vec<PushSecretDataToRewrite>>,
    /// StoreRef specifies which SecretStore to push to. Required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storeRef")]
    pub store_ref: Option<PushSecretDataToStoreRef>,
}

/// PushSecretDataTo defines how to bulk-push secrets to providers without explicit per-key mappings.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PushSecretDataToConversionStrategy {
    None,
    ReverseUnicode,
}
...
/// If not specified, all keys are selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToMatch {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToRewrite {
    /// Used to rewrite with regular expressions.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regexp: Option<PushSecretDataToRewriteRegexp>,
    /// Used to apply string transformation on the secrets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub transform: Option<PushSecretDataToRewriteTransform>,
}

/// Used to rewrite with regular expressions.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToRewriteRegexp {
...
/// Used to apply string transformation on the secrets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToRewriteTransform {
...
/// StoreRef specifies which SecretStore to push to. Required.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToStoreRef {
    /// Kind of the SecretStore resource (SecretStore or ClusterSecretStore)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<PushSecretDataToStoreRefKind>,
    /// Optionally, sync to secret stores with label selector
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "labelSelector")]
    pub label_selector: Option<PushSecretDataToStoreRefLabelSelector>,
...
/// StoreRef specifies which SecretStore to push to. Required.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PushSecretDataToStoreRefKind {
    SecretStore,
    ClusterSecretStore,
}
...
/// Optionally, sync to secret stores with label selector
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToStoreRefLabelSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<PushSecretDataToStoreRefLabelSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PushSecretDataToStoreRefLabelSelectorMatchExpressions {
