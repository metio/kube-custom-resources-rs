...
pub struct ClusterPushSecretPushSecretSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataTo")]
    pub data_to: Option<Vec<ClusterPushSecretPushSecretSpecDataTo>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataTo {
    /// Used to define a conversion Strategy for the secret keys
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "conversionStrategy")]
    pub conversion_strategy: Option<ClusterPushSecretPushSecretSpecDataToConversionStrategy>,
    /// Match pattern for selecting keys from the source Secret.
    /// If not specified, all keys are selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "match")]
    pub r#match: Option<ClusterPushSecretPushSecretSpecDataToMatch>,
    /// Metadata is metadata attached to the secret.
    /// The structure of metadata is provider specific, please look it up in the provider documentation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<serde_json::Value>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "remoteKey")]
    pub remote_key: Option<String>,
    /// Rewrite operations to transform keys before pushing to the provider.
    /// Operations are applied sequentially.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rewrite: Option<Vec<ClusterPushSecretPushSecretSpecDataToRewrite>>,
    /// StoreRef specifies which SecretStore to push to. Required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storeRef")]
    pub store_ref: Option<ClusterPushSecretPushSecretSpecDataToStoreRef>,
}

/// PushSecretDataTo defines how to bulk-push secrets to providers without explicit per-key mappings.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterPushSecretPushSecretSpecDataToConversionStrategy {
    None,
    ReverseUnicode,
}
...
/// If not specified, all keys are selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToMatch {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToRewrite {
    /// Used to rewrite with regular expressions.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub regexp: Option<ClusterPushSecretPushSecretSpecDataToRewriteRegexp>,
    /// Used to apply string transformation on the secrets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub transform: Option<ClusterPushSecretPushSecretSpecDataToRewriteTransform>,
}

/// Used to rewrite with regular expressions.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToRewriteRegexp {
...
/// Used to apply string transformation on the secrets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToRewriteTransform {
...
/// StoreRef specifies which SecretStore to push to. Required.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToStoreRef {
    /// Kind of the SecretStore resource (SecretStore or ClusterSecretStore)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<ClusterPushSecretPushSecretSpecDataToStoreRefKind>,
    /// Optionally, sync to secret stores with label selector
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "labelSelector")]
    pub label_selector: Option<ClusterPushSecretPushSecretSpecDataToStoreRefLabelSelector>,
...
/// StoreRef specifies which SecretStore to push to. Required.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterPushSecretPushSecretSpecDataToStoreRefKind {
    SecretStore,
    ClusterSecretStore,
}
...
/// Optionally, sync to secret stores with label selector
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToStoreRefLabelSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<ClusterPushSecretPushSecretSpecDataToStoreRefLabelSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterPushSecretPushSecretSpecDataToStoreRefLabelSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
