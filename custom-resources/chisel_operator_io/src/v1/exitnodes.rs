...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/FyraLabs/chisel-operator/chisel-operator.io/v1/exitnodes.yaml
