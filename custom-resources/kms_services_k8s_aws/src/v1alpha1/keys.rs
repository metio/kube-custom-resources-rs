...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/kms-controller/kms.services.k8s.aws/v1alpha1/keys.yaml
...
pub struct KeyStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multiRegionConfiguration"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "pendingDeletionWindowInDays"
    )]
