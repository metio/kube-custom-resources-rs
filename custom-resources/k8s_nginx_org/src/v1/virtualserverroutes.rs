...
pub struct VirtualServerRouteSubroutes {
    ...
    pub add_header_inherit: Option<VirtualServerRouteSubroutesAddHeaderInherit>,
    ...
    pub route_selector: Option<VirtualServerRouteSubroutesRouteSelector>,
...
pub enum VirtualServerRouteSubroutesAddHeaderInherit {
    #[serde(rename = "on")]
    On,
    #[serde(rename = "off")]
    Off,
...
/// The RouteSelector allows selecting VirtualServerRoute resources using label selectors.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServerRouteSubroutesRouteSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VirtualServerRouteSubroutesRouteSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServerRouteSubroutesRouteSelectorMatchExpressions {
