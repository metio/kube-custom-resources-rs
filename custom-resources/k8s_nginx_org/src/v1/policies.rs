...
pub struct PolicySpec {
    ...
    pub external_auth: Option<PolicyExternalAuth>,
...
pub struct PolicyCache {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowedCodes")]
    pub allowed_codes: Option<Vec<IntOrString>>,
    ...
    /// Default: false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "overrideUpstreamCache")]
    pub override_upstream_cache: Option<bool>,
...
pub struct PolicyExternalAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authServicePorts")]
    pub auth_service_ports: Option<Vec<i64>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authSigninRedirectBasePath")]
    pub auth_signin_redirect_base_path: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authSigninURI")]
    pub auth_signin_uri: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authSnippets")]
    pub auth_snippets: Option<String>,
