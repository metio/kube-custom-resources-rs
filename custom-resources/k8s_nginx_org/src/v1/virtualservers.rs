...
pub struct VirtualServerSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "add-header-inherit")]
    pub add_header_inherit: Option<VirtualServerAddHeaderInherit>,
...
pub enum VirtualServerAddHeaderInherit {
    #[serde(rename = "on")]
    On,
    #[serde(rename = "off")]
    Off,
...
pub struct VirtualServerRoutes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "add-header-inherit")]
    pub add_header_inherit: Option<VirtualServerRoutesAddHeaderInherit>,
    /// A reference to a DosProtectedResource, setting this enables DOS protection of the VirtualServer route.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub dos: Option<String>,
    ...
    pub route_selector: Option<VirtualServerRoutesRouteSelector>,
...
/// Route defines a route.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VirtualServerRoutesAddHeaderInherit {
    #[serde(rename = "on")]
    On,
    #[serde(rename = "off")]
    Off,
...
/// The RouteSelector allows selecting VirtualServerRoute resources using label selectors.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServerRoutesRouteSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VirtualServerRoutesRouteSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VirtualServerRoutesRouteSelectorMatchExpressions {
...
pub struct VirtualServerUpstreams {
    ...
    /// The SessionCookie field configures session persistence which allows requests from the same client to be passed to the same upstream server. The information about the designated upstream server is passed in a session cookie generated by NGINX.
