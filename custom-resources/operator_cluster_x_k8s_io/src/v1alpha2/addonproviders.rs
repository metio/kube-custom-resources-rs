...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-operator/operator.cluster.x-k8s.io/v1alpha2/addonproviders.yaml
...
pub struct AddonProviderSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patches: Option<Vec<AddonProviderPatches>>,
...
pub struct AddonProviderAdditionalDeploymentsDeploymentContainersEnvValueFrom {
    ...
    pub file_key_ref: Option<AddonProviderAdditionalDeploymentsDeploymentContainersEnvValueFromFileKeyRef>,
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AddonProviderAdditionalDeploymentsDeploymentContainersEnvValueFromFileKeyRef {
...
pub struct AddonProviderDeploymentContainersEnvValueFrom {
    ...
    /// Requires the EnvFiles feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileKeyRef")]
    pub file_key_ref: Option<AddonProviderDeploymentContainersEnvValueFromFileKeyRef>,
    /// Selects a resource of the container: only resources limits and requests
    /// (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceFieldRef")]
...
/// Requires the EnvFiles feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AddonProviderDeploymentContainersEnvValueFromFileKeyRef {
    /// The key within the env file. An invalid key will prevent the pod from starting.
    /// The keys defined within a source may consist of any printable ASCII characters except '='.
    /// During Alpha stage of the EnvFiles feature gate, the key size is limited to 128 characters.
    pub key: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AddonProviderPatches {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<AddonProviderPatchesTarget>,
}

/// Target defines the target object to which the patch should be applied.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AddonProviderPatchesTarget {
