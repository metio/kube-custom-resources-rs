...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/CleverCloud/clever-operator/api.clever-cloud.com/v1/mongodbs.yaml
