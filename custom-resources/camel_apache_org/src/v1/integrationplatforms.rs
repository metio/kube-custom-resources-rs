...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/apache/camel-k/camel.apache.org/v1/integrationplatforms.yaml
...
pub struct IntegrationPlatformBuild {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimeCoreVersion")]
    pub runtime_core_version: Option<String>,
...
pub struct IntegrationPlatformTraits {
    ...
    pub init_containers: Option<IntegrationPlatformTraitsInitContainers>,
    /// The configuration of Istio trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub security_context: Option<IntegrationPlatformTraitsSecurityContext>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub telemetry: Option<IntegrationPlatformTraitsTelemetry>,
...
pub struct IntegrationPlatformTraitsBuilder {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "orderStrategy")]
    pub order_strategy: Option<IntegrationPlatformTraitsBuilderOrderStrategy>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub strategy: Option<IntegrationPlatformTraitsBuilderStrategy>,
...
/// The configuration of Builder trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformTraitsBuilderOrderStrategy {
    #[serde(rename = "dependencies")]
    Dependencies,
    #[serde(rename = "fifo")]
    Fifo,
...
/// The configuration of Builder trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformTraitsBuilderStrategy {
    #[serde(rename = "pod")]
    Pod,
    #[serde(rename = "routine")]
    Routine,
...
pub struct IntegrationPlatformTraitsCamel {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimeProvider")]
    pub runtime_provider: Option<IntegrationPlatformTraitsCamelRuntimeProvider>,
...
/// The configuration of Camel trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformTraitsCamelRuntimeProvider {
...
pub struct IntegrationPlatformTraitsContainer {
    ...
    pub seccomp_profile_type: Option<IntegrationPlatformTraitsContainerSeccompProfileType>,
...
/// The configuration of Container trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformTraitsContainerSeccompProfileType {
    Unconfined,
    RuntimeDefault,
}
...
/// The configuration of Istio trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsGateway {
...
/// The configuration of GitOps trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsGitops {
...
/// The configuration of Init Containers trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsInitContainers {
    /// Legacy trait configuration parameters.
    /// 
    /// Deprecated: for backward compatibility.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct IntegrationPlatformTraitsJvm {
    ...
    pub base_truststore: Option<IntegrationPlatformTraitsJvmBaseTruststore>,
    ...
    pub ca_certificates: Option<Vec<IntegrationPlatformTraitsJvmCaCertificates>>,
...
/// Optional base truststore to use as the starting point for adding certificates.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsJvmBaseTruststore {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsJvmCaCertificates {
...
pub struct IntegrationPlatformTraitsKeda {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub triggers: Option<Vec<IntegrationPlatformTraitsKedaTriggers>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsKedaTriggers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secrets: Option<Vec<IntegrationPlatformTraitsKedaTriggersSecrets>>,
    /// The autoscaler type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsKedaTriggersSecrets {
...
/// The configuration of Security Context trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsSecurityContext {
    /// Legacy trait configuration parameters.
    /// 
    /// Deprecated: for backward compatibility.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Security Context SeccompProfileType configuration (default RuntimeDefault).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seccompProfileType")]
    pub seccomp_profile_type: Option<IntegrationPlatformTraitsSecurityContextSeccompProfileType>,
}

/// The configuration of Security Context trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformTraitsSecurityContextSeccompProfileType {
    Unconfined,
    RuntimeDefault,
}
...
/// The configuration of Telemetry trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformTraitsTelemetry {
...
pub struct IntegrationPlatformStatusTraits {
    ...
    /// The configuration of Istio trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gateway: Option<IntegrationPlatformStatusTraitsGateway>,
    /// The configuration of GC trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gc: Option<IntegrationPlatformStatusTraitsGc>,
    /// The configuration of GitOps trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gitops: Option<IntegrationPlatformStatusTraitsGitops>,
    /// The configuration of Health trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// The configuration of Init Containers trait
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "init-containers")]
    pub init_containers: Option<IntegrationPlatformStatusTraitsInitContainers>,
    /// The configuration of Istio trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// The configuration of Security Context trait
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "security-context")]
    pub security_context: Option<IntegrationPlatformStatusTraitsSecurityContext>,
    /// The configuration of Service trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// The configuration of Telemetry trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub telemetry: Option<IntegrationPlatformStatusTraitsTelemetry>,
    /// The configuration of Toleration trait
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct IntegrationPlatformStatusTraitsBuilder {
    ...
    /// The build order strategy to use, either `dependencies`, `fifo` or `sequential` (default is the platform default)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "orderStrategy")]
    pub order_strategy: Option<IntegrationPlatformStatusTraitsBuilderOrderStrategy>,
    /// The list of manifest platforms to use to build a container image (default `linux/amd64`).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub platforms: Option<Vec<String>>,
    /// A list of properties to be provided to the build task
    ...
    /// The strategy to use, either `pod` or `routine` (default `routine`)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub strategy: Option<IntegrationPlatformStatusTraitsBuilderStrategy>,
    /// A list of tasks to be executed (available only when using `pod` strategy) with format `<name>;<container-image>;<container-command>`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tasks: Option<Vec<String>>,
    /// A list of tasks sorted by the order of execution in a csv format, ie, `<taskName1>,<taskName2>,...`.
...
/// The configuration of Builder trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformStatusTraitsBuilderOrderStrategy {
    #[serde(rename = "dependencies")]
    Dependencies,
    #[serde(rename = "fifo")]
    Fifo,
...
/// The configuration of Builder trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformStatusTraitsBuilderStrategy {
    #[serde(rename = "pod")]
    Pod,
    #[serde(rename = "routine")]
    Routine,
...
pub struct IntegrationPlatformStatusTraitsCamel {
    ...
    /// The runtime provider to use for the integration. (Default, Camel K Runtime).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimeProvider")]
    pub runtime_provider: Option<IntegrationPlatformStatusTraitsCamelRuntimeProvider>,
    /// The runtime version to use for the integration. It overrides the default version set in the Integration Platform.
    /// You can use a fixed version (for example "3.2.3") or a semantic version (for example "3.x") which will try to resolve
    /// to the best matching Catalog existing on the cluster (Default, the one provided by the operator version).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimeVersion")]
...
/// The configuration of Camel trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformStatusTraitsCamelRuntimeProvider {
    #[serde(rename = "quarkus")]
    Quarkus,
    #[serde(rename = "plain-quarkus")]
    PlainQuarkus,
...
pub struct IntegrationPlatformStatusTraitsContainer {
    ...
    /// Security Context SeccompProfileType configuration (default RuntimeDefault).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seccompProfileType")]
    pub seccomp_profile_type: Option<IntegrationPlatformStatusTraitsContainerSeccompProfileType>,
    /// To configure under which service port the http container port is to be exposed (default `80`).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "servicePort")]
    pub service_port: Option<i32>,
    /// To configure under which service port name the http container port is to be exposed (default `http`).
...
/// The configuration of Container trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformStatusTraitsContainerSeccompProfileType {
    Unconfined,
    RuntimeDefault,
}
...
/// The configuration of Istio trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsGateway {
    /// The class name to use for the gateway configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "className")]
    pub class_name: Option<String>,
    /// Legacy trait configuration parameters.
...
/// The configuration of GitOps trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsGitops {
    /// the git branch to check out.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub branch: Option<String>,
    /// the git branch to push to. If omitted, the operator will push to a new branch named as `cicd/release-candidate-<datetime>`.
...
/// The configuration of Init Containers trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsInitContainers {
    /// Legacy trait configuration parameters.
    /// 
    /// Deprecated: for backward compatibility.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct IntegrationPlatformStatusTraitsJvm {
    ...
    /// Optional base truststore to use as the starting point for adding certificates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baseTruststore")]
    pub base_truststore: Option<IntegrationPlatformStatusTraitsJvmBaseTruststore>,
    /// Deprecated: Use CACertificates instead. Path to a PEM-encoded CA certificate file.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCert")]
    pub ca_cert: Option<String>,
    /// The path where the generated truststore will be mounted (default `/etc/camel/conf.d/_truststore`).
    ...
    /// A list of CA certificates to import into the truststore. Certificates must be mounted via the mount trait.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCertificates")]
    pub ca_certificates: Option<Vec<IntegrationPlatformStatusTraitsJvmCaCertificates>>,
    /// Additional JVM classpath (use `Linux` classpath separator)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub classpath: Option<String>,
    /// Legacy trait configuration parameters.
...
/// Optional base truststore to use as the starting point for adding certificates.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsJvmBaseTruststore {
    /// Path to a file containing the password for the base truststore.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passwordPath")]
    pub password_path: Option<String>,
    /// Path to the base truststore file.
...
/// CACertConfig specifies a CA certificate to import into the truststore.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsJvmCaCertificates {
    /// Path to the PEM-encoded CA certificate file to import.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certPath")]
    pub cert_path: Option<String>,
}
...
pub struct IntegrationPlatformStatusTraitsKeda {
    ...
    /// and optionally a mapping of secrets, used by Keda operator to poll resources according to the autoscaler type.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub triggers: Option<Vec<IntegrationPlatformStatusTraitsKedaTriggers>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsKedaTriggers {
    /// The trigger metadata (see Keda documentation to learn how to fill for each type).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<BTreeMap<String, String>>,
    /// The secrets mapping to use. Keda allows the possibility to use values coming from different secrets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secrets: Option<Vec<IntegrationPlatformStatusTraitsKedaTriggersSecrets>>,
    /// The autoscaler type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<String>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsKedaTriggersSecrets {
    /// The mapping to use for this secret (eg, `database-secret-key:keda-secret-key`)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mapping: Option<BTreeMap<String, String>>,
    /// The name of the secret to use.
...
/// The configuration of Security Context trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsSecurityContext {
    /// Legacy trait configuration parameters.
    /// 
    /// Deprecated: for backward compatibility.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Security Context SeccompProfileType configuration (default RuntimeDefault).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seccompProfileType")]
    pub seccomp_profile_type: Option<IntegrationPlatformStatusTraitsSecurityContextSeccompProfileType>,
}

/// The configuration of Security Context trait
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IntegrationPlatformStatusTraitsSecurityContextSeccompProfileType {
    Unconfined,
    RuntimeDefault,
}
...
/// The configuration of Telemetry trait
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IntegrationPlatformStatusTraitsTelemetry {
    /// Enables automatic configuration of the trait, including automatic discovery of the telemetry endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub auto: Option<bool>,
    /// Legacy trait configuration parameters.
