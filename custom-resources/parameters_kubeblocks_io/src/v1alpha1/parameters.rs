...
pub struct ParameterStatusComponentReconfiguringStatus {
    ...
    pub parameter_status: Vec<ParameterStatusComponentReconfiguringStatusParameterStatus>,
    /// Indicates the current status of the configuration item.
    /// 
    /// Possible values include "Creating", "Init", "Running", "Pending", "Merged", "MergeFailed", "FailedAndPause",
    /// "Upgrading", "Deleting", "FailedAndRetry", "Finished".
...
pub struct ParameterStatusComponentReconfiguringStatusParameterStatusUpdatedParameters {
    ...
    pub unmanaged_updates: Option<Vec<ParameterStatusComponentReconfiguringStatusParameterStatusUpdatedParametersUnmanagedUpdates>>,
}

/// UnmanagedParameterSectionUpdate describes unmanaged parameter updates scoped to an optional section within a file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ParameterStatusComponentReconfiguringStatusParameterStatusUpdatedParametersUnmanagedUpdates {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ParameterStatusComponentReconfiguringStatusParameterStatusUpdatedParametersUnmanagedUpdatesUpdates>>,
}

/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ParameterStatusComponentReconfiguringStatusParameterStatusUpdatedParametersUnmanagedUpdatesUpdates {
