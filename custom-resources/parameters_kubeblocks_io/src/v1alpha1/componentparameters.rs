...
pub struct ComponentParameterConfigItemDetailsConfigFileParams {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unmanagedUpdates")]
    pub unmanaged_updates: Option<Vec<ComponentParameterConfigItemDetailsConfigFileParamsUnmanagedUpdates>>,
}

/// UnmanagedParameterSectionUpdate describes unmanaged parameter updates scoped to an optional section within a file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterConfigItemDetailsConfigFileParamsUnmanagedUpdates {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterConfigItemDetailsConfigFileParamsUnmanagedUpdatesUpdates>>,
}

/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterConfigItemDetailsConfigFileParamsUnmanagedUpdatesUpdates {
...
pub struct ComponentParameterConfigItemDetailsConfigSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub variables: Option<Vec<ComponentParameterConfigItemDetailsConfigSpecVariables>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterConfigItemDetailsConfigSpecVariables {
...
/// Desired provides the current desired parameter inputs.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesired {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unmanagedUpdates")]
    pub unmanaged_updates: Option<Vec<ComponentParameterDesiredUnmanagedUpdates>>,
    /// Updates is the advanced path for schema-managed parameter changes with explicit update semantics.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterDesiredUpdates>>,
    /// Templates are user-provided template overrides keyed by config template name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userConfigTemplates")]
    pub user_config_templates: Option<BTreeMap<String, ComponentParameterDesiredUserConfigTemplates>>,
}

/// UnmanagedParameterUpdate describes unmanaged parameter updates scoped to a target template and file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesiredUnmanagedUpdates {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterDesiredUnmanagedUpdatesUpdates>>,
}

/// UnmanagedParameterSectionUpdate describes unmanaged parameter updates scoped to an optional section within a file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesiredUnmanagedUpdatesUpdates {
    /// Section optionally identifies a nested scope for formats that support it.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub section: Option<String>,
    /// Updates are the unmanaged parameter changes to apply within the target section scope.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterDesiredUnmanagedUpdatesUpdatesUpdates>>,
}

/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesiredUnmanagedUpdatesUpdatesUpdates {
    /// Key is the logical parameter key defined in ParametersDefinition.
    pub key: String,
    /// Type defines the update type.
    #[serde(rename = "type")]
...
/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesiredUpdates {
    /// Key is the logical parameter key defined in ParametersDefinition.
    pub key: String,
    /// Type defines the update type.
    #[serde(rename = "type")]
...
/// Templates are user-provided template overrides keyed by config template name.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterDesiredUserConfigTemplates {
    /// Specifies the namespace of the referenced configuration template ConfigMap object.
    /// An empty namespace is equivalent to the "default" namespace.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
    /// Defines the strategy for merging externally imported templates into component templates.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ComponentParameterDesiredUserConfigTemplatesPolicy>,
    /// Specifies the name of the referenced configuration template ConfigMap object.
...
/// Templates are user-provided template overrides keyed by config template name.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ComponentParameterDesiredUserConfigTemplatesPolicy {
    #[serde(rename = "patch")]
    Patch,
    #[serde(rename = "replace")]
    Replace,
...
/// Initial provides the initial parameter inputs used when the managed runtime configuration is created.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitial {
    /// Assignments are flat managed parameter key/value assignments.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub assignments: Option<BTreeMap<String, String>>,
    /// UnmanagedUpdates is the advanced path for parameters not defined in ParametersDefinition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "unmanagedUpdates")]
    pub unmanaged_updates: Option<Vec<ComponentParameterInitialUnmanagedUpdates>>,
    /// Updates is the advanced path for schema-managed parameter changes with explicit update semantics.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterInitialUpdates>>,
    /// Templates are user-provided template overrides keyed by config template name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userConfigTemplates")]
    pub user_config_templates: Option<BTreeMap<String, ComponentParameterInitialUserConfigTemplates>>,
}

/// UnmanagedParameterUpdate describes unmanaged parameter updates scoped to a target template and file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitialUnmanagedUpdates {
    /// File is the target config file name under the template.
    pub file: String,
    /// Template is the target config template name.
    pub template: String,
    /// Updates are the unmanaged parameter changes to apply within the target file scope.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterInitialUnmanagedUpdatesUpdates>>,
}

/// UnmanagedParameterSectionUpdate describes unmanaged parameter updates scoped to an optional section within a file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitialUnmanagedUpdatesUpdates {
    /// Section optionally identifies a nested scope for formats that support it.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub section: Option<String>,
    /// Updates are the unmanaged parameter changes to apply within the target section scope.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub updates: Option<Vec<ComponentParameterInitialUnmanagedUpdatesUpdatesUpdates>>,
}

/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitialUnmanagedUpdatesUpdatesUpdates {
    /// Key is the logical parameter key defined in ParametersDefinition.
    pub key: String,
    /// Type defines the update type.
    #[serde(rename = "type")]
...
/// ParameterUpdate is an explicit parameter update.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitialUpdates {
    /// Key is the logical parameter key defined in ParametersDefinition.
    pub key: String,
    /// Type defines the update type.
    #[serde(rename = "type")]
...
/// Templates are user-provided template overrides keyed by config template name.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComponentParameterInitialUserConfigTemplates {
    /// Specifies the namespace of the referenced configuration template ConfigMap object.
    /// An empty namespace is equivalent to the "default" namespace.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
    /// Defines the strategy for merging externally imported templates into component templates.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ComponentParameterInitialUserConfigTemplatesPolicy>,
    /// Specifies the name of the referenced configuration template ConfigMap object.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "templateRef")]
    pub template_ref: Option<String>,
}
...
/// Templates are user-provided template overrides keyed by config template name.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ComponentParameterInitialUserConfigTemplatesPolicy {
    #[serde(rename = "patch")]
    Patch,
    #[serde(rename = "replace")]
    Replace,
