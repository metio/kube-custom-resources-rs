...
pub struct ProcessingJobProcessingInputsDatasetDefinition {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "athenaDatasetDefinition"
    )]
    pub athena_dataset_definition:
        Option<ProcessingJobProcessingInputsDatasetDefinitionAthenaDatasetDefinition>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataDistributionType"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "redshiftDatasetDefinition"
    )]
    pub redshift_dataset_definition:
        Option<ProcessingJobProcessingInputsDatasetDefinitionRedshiftDatasetDefinition>,
}
