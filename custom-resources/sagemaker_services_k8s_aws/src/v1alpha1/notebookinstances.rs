...
pub struct NotebookInstanceSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "additionalCodeRepositories"
    )]
...
pub struct NotebookInstanceStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "stoppedByControllerMetadata"
    )]
