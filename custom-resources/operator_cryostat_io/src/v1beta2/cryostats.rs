...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cryostatio/cryostat-operator/operator.cryostat.io/v1beta2/cryostats.yaml
...
#[kube(group = "operator.cryostat.io", version = "v1beta2", kind = "Cryostat", plural = "cryostats")]
#[kube(namespaced)]
...
pub struct CryostatSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "agentOptions")]
    pub agent_options: Option<CryostatAgentOptions>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableAudit")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loggingOptions")]
    pub logging_options: Option<CryostatLoggingOptions>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetConnectionCacheOptions")]
    pub target_connection_cache_options: Option<CryostatTargetConnectionCacheOptions>,
...
pub struct CryostatAgentOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<CryostatAgentOptionsResources>,
}
...
/// Default resource limits will be added to the init container if neither resource requests or limits are specified.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatAgentOptionsResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<CryostatAgentOptionsResourcesClaims>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatAgentOptionsResourcesClaims {
...
/// Additional configuration options for the authorization proxy.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatAuthorizationOptions {
    ...
    pub basic_auth: Option<CryostatAuthorizationOptionsBasicAuth>,
    /// Configuration for OpenShift RBAC to define which OpenShift user accounts may access the Cryostat application.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "openShiftSSO")]
    pub open_shift_sso: Option<CryostatAuthorizationOptionsOpenShiftSso>,
}
...
/// pass the OpenShift SSO Roles checks. If not on OpenShift then this defines the only user accounts that have access.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatAuthorizationOptionsBasicAuth {
...
/// Configuration for OpenShift RBAC to define which OpenShift user accounts may access the Cryostat application.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatAuthorizationOptionsOpenShiftSso {
    ...
    pub access_review: Option<CryostatAuthorizationOptionsOpenShiftSsoAccessReview>,
...
/// Options to configure the Cryostat application's database.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatDatabaseOptions {
...
/// Options to configure logging for Cryostat components.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatLoggingOptions {
    /// Log level for the core Cryostat application.
    /// Valid values are: "OFF", "ERROR", "WARN", "INFO", "DEBUG", "TRACE", "ALL"
    /// Defaults to "INFO" if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreLogLevel")]
    pub core_log_level: Option<CryostatLoggingOptionsCoreLogLevel>,
}

/// Options to configure logging for Cryostat components.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CryostatLoggingOptionsCoreLogLevel {
    #[serde(rename = "OFF")]
    Off,
    #[serde(rename = "ERROR")]
    Error,
...
/// Options to customize the NetworkPolicy objects created for Cryostat's various Services.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatNetworkPolicies {
    /// NetworkPolicy configuration for the Cryostat application service.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreConfig")]
    pub core_config: Option<CryostatNetworkPoliciesCoreConfig>,
    ...
    pub database_config: Option<CryostatNetworkPoliciesDatabaseConfig>,
    ...
    pub reports_config: Option<CryostatNetworkPoliciesReportsConfig>,
    /// NetworkPolicy configuration for the storage service.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageConfig")]
    pub storage_config: Option<CryostatNetworkPoliciesStorageConfig>,
}
...
pub struct CryostatResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "agentProxyResources")]
    pub agent_proxy_resources: Option<CryostatResourcesAgentProxyResources>,
    /// Resource requirements for the auth proxy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authProxyResources")]
    pub auth_proxy_resources: Option<CryostatResourcesAuthProxyResources>,
    ...
    pub database_resources: Option<CryostatResourcesDatabaseResources>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "objectStorageResources")]
    pub object_storage_resources: Option<CryostatResourcesObjectStorageResources>,
}

/// Resource requirements for the agent proxy container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesAgentProxyResources {
    /// Claims lists the names of resources, defined in spec.resourceClaims,
    /// that are used by this container.
    /// 
    /// This is an alpha field and requires enabling the
    ...
    /// This field is immutable. It can only be set for containers.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<CryostatResourcesAgentProxyResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// ResourceClaim references one entry in PodSpec.ResourceClaims.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesAgentProxyResourcesClaims {
    /// Name must match the name of one entry in pod.spec.resourceClaims of
    /// the Pod where this field is used. It makes that resource available
    /// inside a container.
    pub name: String,
...
/// Resource requirements for the auth proxy.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesAuthProxyResources {
    /// Claims lists the names of resources, defined in spec.resourceClaims,
    /// that are used by this container.
    /// 
    /// This is an alpha field and requires enabling the
    ...
    /// This field is immutable. It can only be set for containers.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<CryostatResourcesAuthProxyResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// ResourceClaim references one entry in PodSpec.ResourceClaims.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesAuthProxyResourcesClaims {
    /// Name must match the name of one entry in pod.spec.resourceClaims of
    /// the Pod where this field is used. It makes that resource available
    /// inside a container.
    pub name: String,
...
/// Resource requirements for the database container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesDatabaseResources {
    /// Claims lists the names of resources, defined in spec.resourceClaims,
    /// that are used by this container.
    /// 
    /// This is an alpha field and requires enabling the
    ...
    /// This field is immutable. It can only be set for containers.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<CryostatResourcesDatabaseResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// ResourceClaim references one entry in PodSpec.ResourceClaims.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesDatabaseResourcesClaims {
    /// Name must match the name of one entry in pod.spec.resourceClaims of
    /// the Pod where this field is used. It makes that resource available
    /// inside a container.
    pub name: String,
...
/// Resource requirements for the object storage container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesObjectStorageResources {
    /// Claims lists the names of resources, defined in spec.resourceClaims,
    /// that are used by this container.
    /// 
    /// This is an alpha field and requires enabling the
    ...
    /// This field is immutable. It can only be set for containers.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<CryostatResourcesObjectStorageResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// ResourceClaim references one entry in PodSpec.ResourceClaims.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatResourcesObjectStorageResourcesClaims {
    /// Name must match the name of one entry in pod.spec.resourceClaims of
    /// the Pod where this field is used. It makes that resource available
    /// inside a container.
    pub name: String,
...
pub struct CryostatSecurityOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "agentProxySecurityContext")]
    pub agent_proxy_security_context: Option<CryostatSecurityOptionsAgentProxySecurityContext>,
    /// Security Context to apply to the auth proxy container.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authProxySecurityContext")]
    pub auth_proxy_security_context: Option<CryostatSecurityOptionsAuthProxySecurityContext>,
...
/// Security Context to apply to the agent proxy container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContext {
    /// AllowPrivilegeEscalation controls whether a process can gain more
    /// privileges than its parent process. This bool directly controls if
    /// the no_new_privs flag will be set on the container process.
    /// AllowPrivilegeEscalation is true always when the container is:
    ...
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appArmorProfile")]
    pub app_armor_profile: Option<CryostatSecurityOptionsAgentProxySecurityContextAppArmorProfile>,
    /// The capabilities to add/drop when running containers.
    /// Defaults to the default set of capabilities granted by the container runtime.
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capabilities: Option<CryostatSecurityOptionsAgentProxySecurityContextCapabilities>,
    /// Run container in privileged mode.
    /// Processes in privileged containers are essentially equivalent to root on the host.
    /// Defaults to false.
    /// Note that this field cannot be set when spec.os.name is windows.
    ...
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seLinuxOptions")]
    pub se_linux_options: Option<CryostatSecurityOptionsAgentProxySecurityContextSeLinuxOptions>,
    /// The seccomp options to use by this container. If seccomp options are
    /// provided at both the pod & container level, the container options
    /// override the pod options.
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seccompProfile")]
    pub seccomp_profile: Option<CryostatSecurityOptionsAgentProxySecurityContextSeccompProfile>,
    /// The Windows specific settings applied to all containers.
    /// If unspecified, the options from the PodSecurityContext will be used.
    /// If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
    /// Note that this field cannot be set when spec.os.name is linux.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "windowsOptions")]
    pub windows_options: Option<CryostatSecurityOptionsAgentProxySecurityContextWindowsOptions>,
}
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContextAppArmorProfile {
    /// localhostProfile indicates a profile loaded on the node that should be used.
    /// The profile must be preconfigured on the node to work.
    /// Must match the loaded name of the profile.
    /// Must be set if and only if type is "Localhost".
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContextCapabilities {
    /// Added capabilities
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub add: Option<Vec<String>>,
    /// Removed capabilities
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContextSeLinuxOptions {
    /// Level is SELinux level label that applies to the container.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub level: Option<String>,
    /// Role is a SELinux role label that applies to the container.
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContextSeccompProfile {
    /// localhostProfile indicates a profile defined in a file on the node should be used.
    /// The profile must be preconfigured on the node to work.
    /// Must be a descending path, relative to the kubelet's configured seccomp profile location.
    /// Must be set if type is "Localhost". Must NOT be set for any other type.
...
/// Note that this field cannot be set when spec.os.name is linux.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAgentProxySecurityContextWindowsOptions {
    /// GMSACredentialSpec is where the GMSA admission webhook
    /// (<https://github.com/kubernetes-sigs/windows-gmsa)> inlines the contents of the
    /// GMSA credential spec named by the GMSACredentialSpecName field.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gmsaCredentialSpec")]
...
/// Security Context to apply to the auth proxy container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContext {
    /// AllowPrivilegeEscalation controls whether a process can gain more
    /// privileges than its parent process. This bool directly controls if
    /// the no_new_privs flag will be set on the container process.
    /// AllowPrivilegeEscalation is true always when the container is:
    ...
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appArmorProfile")]
    pub app_armor_profile: Option<CryostatSecurityOptionsAuthProxySecurityContextAppArmorProfile>,
    /// The capabilities to add/drop when running containers.
    /// Defaults to the default set of capabilities granted by the container runtime.
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capabilities: Option<CryostatSecurityOptionsAuthProxySecurityContextCapabilities>,
    /// Run container in privileged mode.
    /// Processes in privileged containers are essentially equivalent to root on the host.
    /// Defaults to false.
    /// Note that this field cannot be set when spec.os.name is windows.
    ...
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seLinuxOptions")]
    pub se_linux_options: Option<CryostatSecurityOptionsAuthProxySecurityContextSeLinuxOptions>,
    /// The seccomp options to use by this container. If seccomp options are
    /// provided at both the pod & container level, the container options
    /// override the pod options.
    /// Note that this field cannot be set when spec.os.name is windows.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "seccompProfile")]
    pub seccomp_profile: Option<CryostatSecurityOptionsAuthProxySecurityContextSeccompProfile>,
    /// The Windows specific settings applied to all containers.
    /// If unspecified, the options from the PodSecurityContext will be used.
    /// If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
    /// Note that this field cannot be set when spec.os.name is linux.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "windowsOptions")]
    pub windows_options: Option<CryostatSecurityOptionsAuthProxySecurityContextWindowsOptions>,
}
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContextAppArmorProfile {
    /// localhostProfile indicates a profile loaded on the node that should be used.
    /// The profile must be preconfigured on the node to work.
    /// Must match the loaded name of the profile.
    /// Must be set if and only if type is "Localhost".
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContextCapabilities {
    /// Added capabilities
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub add: Option<Vec<String>>,
    /// Removed capabilities
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContextSeLinuxOptions {
    /// Level is SELinux level label that applies to the container.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub level: Option<String>,
    /// Role is a SELinux role label that applies to the container.
...
/// Note that this field cannot be set when spec.os.name is windows.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContextSeccompProfile {
    /// localhostProfile indicates a profile defined in a file on the node should be used.
    /// The profile must be preconfigured on the node to work.
    /// Must be a descending path, relative to the kubelet's configured seccomp profile location.
    /// Must be set if type is "Localhost". Must NOT be set for any other type.
...
/// Note that this field cannot be set when spec.os.name is linux.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatSecurityOptionsAuthProxySecurityContextWindowsOptions {
    /// GMSACredentialSpec is where the GMSA admission webhook
    /// (<https://github.com/kubernetes-sigs/windows-gmsa)> inlines the contents of the
    /// GMSA credential spec named by the GMSACredentialSpecName field.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gmsaCredentialSpec")]
...
pub struct CryostatServiceOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "agentCallbackConfig")]
    pub agent_callback_config: Option<CryostatServiceOptionsAgentCallbackConfig>,
    /// Specification for the service responsible for agents to communicate with Cryostat.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "agentGatewayConfig")]
    pub agent_gateway_config: Option<CryostatServiceOptionsAgentGatewayConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "databaseConfig")]
    pub database_config: Option<CryostatServiceOptionsDatabaseConfig>,
...
/// to communicate with agents in those namespaces.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatServiceOptionsAgentCallbackConfig {
    /// Annotations to add to the object during its creation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    /// Labels to add to the object during its creation.
...
/// Specification for the service responsible for agents to communicate with Cryostat.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatServiceOptionsAgentGatewayConfig {
    /// Annotations to add to the object during its creation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
...
/// Specification for the service responsible for the cryostat application's database.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatServiceOptionsDatabaseConfig {
    /// Annotations to add to the object during its creation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
...
pub struct CryostatStorageOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub database: Option<CryostatStorageOptionsDatabase>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "objectStorage")]
    pub object_storage: Option<CryostatStorageOptionsObjectStorage>,
...
/// Configuration for the Persistent Volume Claim to be created by the operator for the database.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabase {
    /// Configuration for an EmptyDir to be created
    /// by the operator instead of a PVC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emptyDir")]
    pub empty_dir: Option<CryostatStorageOptionsDatabaseEmptyDir>,
    /// Configuration for the Persistent Volume Claim to be created
    /// by the operator.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pvc: Option<CryostatStorageOptionsDatabasePvc>,
}

/// Configuration for an EmptyDir to be created
/// by the operator instead of a PVC.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabaseEmptyDir {
...
/// by the operator.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvc {
    /// Annotations to add to the object during its creation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    /// Labels to add to the object during its creation.
    ...
    /// no effect.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<CryostatStorageOptionsDatabasePvcSpec>,
}
...
/// no effect.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpec {
    ...
    pub data_source: Option<CryostatStorageOptionsDatabasePvcSpecDataSource>,
    ...
    pub data_source_ref: Option<CryostatStorageOptionsDatabasePvcSpecDataSourceRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<CryostatStorageOptionsDatabasePvcSpecResources>,
    /// selector is a label query over volumes to consider for binding.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<CryostatStorageOptionsDatabasePvcSpecSelector>,
...
/// If the namespace is specified, then dataSourceRef will not be copied to dataSource.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpecDataSource {
    /// APIGroup is the group for the resource being referenced.
    /// If APIGroup is not specified, the specified Kind must be in the core API group.
    /// For any other third-party types, APIGroup is required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
...
/// (Alpha) Using the namespace field of dataSourceRef requires the CrossNamespaceVolumeDataSource feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpecDataSourceRef {
    /// APIGroup is the group for the resource being referenced.
    /// If APIGroup is not specified, the specified Kind must be in the core API group.
    /// For any other third-party types, APIGroup is required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
...
/// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpecResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// selector is a label query over volumes to consider for binding.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpecSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<CryostatStorageOptionsDatabasePvcSpecSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsDatabasePvcSpecSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// Configuration for the Persistent Volume Claim to be created by the operator for the object storage.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStorage {
    /// Configuration for an EmptyDir to be created
    /// by the operator instead of a PVC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emptyDir")]
    pub empty_dir: Option<CryostatStorageOptionsObjectStorageEmptyDir>,
    /// Configuration for the Persistent Volume Claim to be created
    /// by the operator.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pvc: Option<CryostatStorageOptionsObjectStoragePvc>,
}

/// Configuration for an EmptyDir to be created
/// by the operator instead of a PVC.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStorageEmptyDir {
    /// When enabled, Cryostat will use EmptyDir volumes instead of a Persistent Volume Claim. Any PVC configurations will be ignored.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Unless specified, the emptyDir volume will be mounted on
...
/// by the operator.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvc {
    /// Annotations to add to the object during its creation.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub annotations: Option<BTreeMap<String, String>>,
    /// Labels to add to the object during its creation.
    ...
    /// no effect.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<CryostatStorageOptionsObjectStoragePvcSpec>,
}
...
/// no effect.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpec {
    /// accessModes contains the desired access modes the volume should have.
    /// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessModes")]
    pub access_modes: Option<Vec<String>>,
    ...
    /// If the namespace is specified, then dataSourceRef will not be copied to dataSource.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataSource")]
    pub data_source: Option<CryostatStorageOptionsObjectStoragePvcSpecDataSource>,
    /// dataSourceRef specifies the object from which to populate the volume with data, if a non-empty
    /// volume is desired. This may be any object from a non-empty API group (non
    /// core object) or a PersistentVolumeClaim object.
    /// When this field is specified, volume binding will only succeed if the type of
    ...
    /// (Alpha) Using the namespace field of dataSourceRef requires the CrossNamespaceVolumeDataSource feature gate to be enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataSourceRef")]
    pub data_source_ref: Option<CryostatStorageOptionsObjectStoragePvcSpecDataSourceRef>,
    /// resources represents the minimum resources the volume should have.
    /// If RecoverVolumeExpansionFailure feature is enabled users are allowed to specify resource requirements
    /// that are lower than previous value but must still be higher than capacity recorded in the
    /// status field of the claim.
    /// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<CryostatStorageOptionsObjectStoragePvcSpecResources>,
    /// selector is a label query over volumes to consider for binding.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<CryostatStorageOptionsObjectStoragePvcSpecSelector>,
    /// storageClassName is the name of the StorageClass required by the claim.
    /// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#class-1>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageClassName")]
    pub storage_class_name: Option<String>,
...
/// If the namespace is specified, then dataSourceRef will not be copied to dataSource.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpecDataSource {
    /// APIGroup is the group for the resource being referenced.
    /// If APIGroup is not specified, the specified Kind must be in the core API group.
    /// For any other third-party types, APIGroup is required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
...
/// (Alpha) Using the namespace field of dataSourceRef requires the CrossNamespaceVolumeDataSource feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpecDataSourceRef {
    /// APIGroup is the group for the resource being referenced.
    /// If APIGroup is not specified, the specified Kind must be in the core API group.
    /// For any other third-party types, APIGroup is required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
...
/// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpecResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// selector is a label query over volumes to consider for binding.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpecSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<CryostatStorageOptionsObjectStoragePvcSpecSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatStorageOptionsObjectStoragePvcSpecSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// Options to customize the target connections cache for the Cryostat application.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CryostatTargetConnectionCacheOptions {
...
pub struct CryostatTargetDiscoveryOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableBuiltInDiscovery")]
    pub disable_built_in_discovery: Option<bool>,
...
pub struct CryostatStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageSecret")]
