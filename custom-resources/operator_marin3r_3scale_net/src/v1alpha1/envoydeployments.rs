...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/3scale-ops/marin3r/operator.marin3r.3scale.net/v1alpha1/envoydeployments.yaml
