...
pub struct ClusterSpec {
    ...
    pub rebalancing: Option<ClusterRebalancing>,
...
pub struct ClusterBrokerNodeGroupInfo {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSubnetRefs")]
    pub client_subnet_refs: Option<Vec<ClusterBrokerNodeGroupInfoClientSubnetRefs>>,
...
/// 	  name: my-api
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterBrokerNodeGroupInfoClientSubnetRefs {
    /// AWSResourceReference provides all the values necessary to reference another
    /// k8s resource for finding the identifier(Id/ARN/Name)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub from: Option<ClusterBrokerNodeGroupInfoClientSubnetRefsFrom>,
}

/// AWSResourceReference provides all the values necessary to reference another
/// k8s resource for finding the identifier(Id/ARN/Name)
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterBrokerNodeGroupInfoClientSubnetRefsFrom {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
