...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/ktsstudio/mirrors/mirrors.kts.studio/v1alpha2/secretmirrors.yaml
