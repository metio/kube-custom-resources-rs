...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubewharf/kubeadmiral/core.kubeadmiral.io/v1alpha1/federatedtypeconfigs.yaml
...
pub struct FederatedTypeConfigSpec {
    ...
    pub controllers: Option<Vec<Vec<String>>>,
