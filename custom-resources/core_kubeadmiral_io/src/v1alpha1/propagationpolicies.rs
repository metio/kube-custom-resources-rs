...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubewharf/kubeadmiral/core.kubeadmiral.io/v1alpha1/propagationpolicies.yaml
...
#[kube(group = "core.kubeadmiral.io", version = "v1alpha1", kind = "PropagationPolicy", plural = "propagationpolicies")]
#[kube(namespaced)]
#[kube(status = "PropagationPolicyStatus")]
...
pub struct PropagationPolicySpec {
    ...
    pub auto_migration: Option<PropagationPolicyAutoMigration>,
    ...
    pub cluster_affinity: Option<Vec<PropagationPolicyClusterAffinity>>,
    ...
    pub scheduling_mode: PropagationPolicySchedulingMode,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<PropagationPolicyTolerations>>,
}

/// Configures behaviors related to auto migration. If absent, auto migration will be disabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyAutoMigration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub when: Option<PropagationPolicyAutoMigrationWhen>,
}

/// When a replica should be subject to auto migration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyAutoMigrationWhen {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyClusterAffinity {
    /// A list of cluster selector requirements by cluster labels.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<PropagationPolicyClusterAffinityMatchExpressions>>,
    /// A list of cluster selector requirements by cluster fields.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchFields")]
    pub match_fields: Option<Vec<PropagationPolicyClusterAffinityMatchFields>>,
}
...
pub struct PropagationPolicyClusterAffinityMatchExpressions {
    pub key: String,
    /// ClusterSelectorOperator is the set of operators that can be used in a cluster selector requirement.
    pub operator: PropagationPolicyClusterAffinityMatchExpressionsOperator,
    pub values: Vec<String>,
}

/// ClusterSelectorRequirement is a selector that contains values, a key, and an operator that relates the values and keys
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicyClusterAffinityMatchExpressionsOperator {
    In,
    NotIn,
    Exists,
    DoesNotExist,
...
/// ClusterSelectorRequirement is a selector that contains values, a key, and an operator that relates the values and keys
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct PropagationPolicyClusterAffinityMatchFields {
    pub key: String,
    /// ClusterSelectorOperator is the set of operators that can be used in a cluster selector requirement.
    pub operator: PropagationPolicyClusterAffinityMatchFieldsOperator,
    pub values: Vec<String>,
}

/// ClusterSelectorRequirement is a selector that contains values, a key, and an operator that relates the values and keys
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicyClusterAffinityMatchFieldsOperator {
    In,
    NotIn,
    Exists,
    DoesNotExist,
...
pub struct PropagationPolicyPlacement {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub preferences: Option<PropagationPolicyPlacementPreferences>,
}

/// Preferences contains the cluster's propagation preferences.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementPreferences {
...
pub struct PropagationPolicyReschedulePolicy {
    ...
    pub replica_rescheduling: Option<PropagationPolicyReschedulePolicyReplicaRescheduling>,
    ...
    pub reschedule_when: Option<PropagationPolicyReschedulePolicyRescheduleWhen>,
}
...
/// See patch file for details.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyReschedulePolicyReplicaRescheduling {
...
/// When the related objects should be subject to reschedule.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyReschedulePolicyRescheduleWhen {
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicySchedulingMode {
    Duplicate,
    Divide,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyTolerations {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyStatus {
    ...
    pub typed_ref_count: Option<Vec<PropagationPolicyStatusTypedRefCount>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyStatusTypedRefCount {
    pub count: i64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
