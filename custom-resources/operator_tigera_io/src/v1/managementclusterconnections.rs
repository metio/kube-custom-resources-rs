...
pub struct ManagementClusterConnectionGuardianDeploymentSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<ManagementClusterConnectionGuardianDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<ManagementClusterConnectionGuardianDeploymentSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ManagementClusterConnectionGuardianDeploymentSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ManagementClusterConnectionGuardianDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
