...
pub struct ManagerManagerDeploymentSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<ManagerManagerDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<ManagerManagerDeploymentSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ManagerManagerDeploymentSpecTemplateSpecContainersLivenessProbe {
...
pub enum ManagerManagerDeploymentSpecTemplateSpecContainersName {
    ...
    CalicoUiApis,
    #[serde(rename = "calico-dashboard-api")]
    CalicoDashboardApi,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ManagerManagerDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
