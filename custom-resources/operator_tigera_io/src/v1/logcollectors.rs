...
pub struct LogCollectorSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "eksLogForwarderDeployment"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multiTenantManagementClusterNamespace"
    )]
...
pub struct LogCollectorEksLogForwarderDeploymentSpecTemplateSpec {
    ...
    pub init_containers:
        Option<Vec<LogCollectorEksLogForwarderDeploymentSpecTemplateSpecInitContainers>>,
}
...
pub struct LogCollectorEksLogForwarderDeploymentSpecTemplateSpecContainersResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims:
        Option<Vec<LogCollectorEksLogForwarderDeploymentSpecTemplateSpecContainersResourcesClaims>>,
...
pub struct LogCollectorEksLogForwarderDeploymentSpecTemplateSpecInitContainers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources:
        Option<LogCollectorEksLogForwarderDeploymentSpecTemplateSpecInitContainersResources>,
}
...
pub struct LogCollectorEksLogForwarderDeploymentSpecTemplateSpecInitContainersResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<
        Vec<LogCollectorEksLogForwarderDeploymentSpecTemplateSpecInitContainersResourcesClaims>,
    >,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct LogCollectorFluentdDaemonSetSpecTemplateSpecInitContainersResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims:
        Option<Vec<LogCollectorFluentdDaemonSetSpecTemplateSpecInitContainersResourcesClaims>>,
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
