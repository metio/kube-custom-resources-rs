...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tigera/operator/operator.tigera.io/v1/installations.yaml
...
pub struct InstallationSpec {
    ...
    pub image_pull_policy: Option<InstallationImagePullPolicy>,
...
pub struct InstallationCalicoKubeControllersDeploymentSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<InstallationCalicoKubeControllersDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<InstallationCalicoKubeControllersDeploymentSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoKubeControllersDeploymentSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoKubeControllersDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationCalicoNetwork {
    ...
    /// Default: Disabled
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfNetworkBootstrap")]
    pub bpf_network_bootstrap: Option<InstallationCalicoNetworkBpfNetworkBootstrap>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterRoutingMode")]
    pub cluster_routing_mode: Option<InstallationCalicoNetworkClusterRoutingMode>,
    ...
    /// Default: Disabled
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kubeProxyManagement")]
    pub kube_proxy_management: Option<InstallationCalicoNetworkKubeProxyManagement>,
    ...
    /// plugin.
    /// Default: Veth
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "linuxPodInterfaceType")]
    pub linux_pod_interface_type: Option<InstallationCalicoNetworkLinuxPodInterfaceType>,
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationCalicoNetworkBpfNetworkBootstrap {
    Disabled,
    Enabled,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationCalicoNetworkClusterRoutingMode {
    #[serde(rename = "BIRD")]
    Bird,
    Felix,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationCalicoNetworkKubeProxyManagement {
    Disabled,
    Enabled,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationCalicoNetworkLinuxPodInterfaceType {
    Veth,
    Netkit,
}
...
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpec {
    ...
    pub dns_config: Option<InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsConfig>,
    /// DNSPolicy is the DNS policy for the calico-node pods.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsPolicy")]
    pub dns_policy: Option<InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsPolicy>,
...
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationCalicoNodeDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationCalicoNodeDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// DNSConfig allows customization of the DNS configuration for the calico-node pods.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsConfigOptions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsConfigOptions {
...
/// Spec is the calico-node DaemonSet's PodSpec.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationCalicoNodeDaemonSetSpecTemplateSpecDnsPolicy {
    #[serde(rename = "")]
    KopiumEmpty,
    Default,
    ClusterFirst,
...
pub struct InstallationCalicoNodeWindowsDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationCsiNodeDriverDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationCsiNodeDriverDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationCsiNodeDriverDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCsiNodeDriverDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationCsiNodeDriverDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// Specification of the desired state for the Calico or Calico Enterprise installation.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationImagePullPolicy {
    Always,
    IfNotPresent,
    Never,
}
...
pub struct InstallationTyphaDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationTyphaDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationTyphaDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationTyphaDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationTyphaDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationStatusComputed {
    ...
    /// must not be re-pulled from a remote registry.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imagePullPolicy")]
    pub image_pull_policy: Option<InstallationStatusComputedImagePullPolicy>,
    /// ImagePullSecrets is an array of references to container registry pull secrets to use. These are
    /// applied to all images to be pulled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imagePullSecrets")]
...
pub struct InstallationStatusComputedCalicoKubeControllersDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedCalicoKubeControllersDeploymentSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the calico-kube-controllers Deployment container by name.
    /// Supported values are: calico-kube-controllers, es-calico-kube-controllers
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedCalicoKubeControllersDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named calico-kube-controllers Deployment container's resources.
    /// If omitted, the calico-kube-controllers Deployment will use its default value for this container's resources.
    /// If used in conjunction with the deprecated ComponentResources, then this value takes precedence.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoKubeControllersDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoKubeControllersDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationStatusComputedCalicoNetwork {
    ...
    /// Default: Disabled
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfNetworkBootstrap")]
    pub bpf_network_bootstrap: Option<InstallationStatusComputedCalicoNetworkBpfNetworkBootstrap>,
    /// ClusterRoutingMode controls how nodes get a route to a workload on another node,
    /// when that workload's IP comes from an IP Pool with vxlanMode: Never. When ClusterRoutingMode is BIRD,
    /// confd and BIRD program that route. When ClusterRoutingMode is Felix, it is expected that Felix will program that route.
    /// Felix always programs such routes for IP Pools with vxlanMode: Always or vxlanMode: CrossSubnet. [Default: BIRD]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterRoutingMode")]
    pub cluster_routing_mode: Option<InstallationStatusComputedCalicoNetworkClusterRoutingMode>,
    /// ContainerIPForwarding configures whether ip forwarding will be enabled for containers in the CNI configuration.
    /// Default: Disabled
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerIPForwarding")]
    ...
    /// Default: Disabled
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kubeProxyManagement")]
    pub kube_proxy_management: Option<InstallationStatusComputedCalicoNetworkKubeProxyManagement>,
    /// LinuxDataplane is used to select the dataplane used for Linux nodes. In particular, it
    /// causes the operator to add required mounts and environment variables for the particular dataplane.
    /// If not specified, iptables mode is used.
    /// Default: Iptables
    ...
    /// Default: Veth
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "linuxPodInterfaceType")]
    pub linux_pod_interface_type: Option<InstallationStatusComputedCalicoNetworkLinuxPodInterfaceType>,
    /// LinuxPolicySetupTimeoutSeconds delays new pods from running containers
    /// until their policy has been programmed in the dataplane.
    /// The specified delay defines the maximum amount of time
    /// that the Calico CNI plugin will wait for policy to be programmed.
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedCalicoNetworkBpfNetworkBootstrap {
    Disabled,
    Enabled,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedCalicoNetworkClusterRoutingMode {
    #[serde(rename = "BIRD")]
    Bird,
    Felix,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedCalicoNetworkKubeProxyManagement {
    Disabled,
    Enabled,
}
...
/// CalicoNetwork specifies networking configuration options for Calico.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedCalicoNetworkLinuxPodInterfaceType {
    Veth,
    Netkit,
}
...
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpec {
    ...
    /// DNSConfig allows customization of the DNS configuration for the calico-node pods.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsConfig")]
    pub dns_config: Option<InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsConfig>,
    /// DNSPolicy is the DNS policy for the calico-node pods.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsPolicy")]
    pub dns_policy: Option<InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsPolicy>,
    /// InitContainers is a list of calico-node init containers.
    /// If specified, this overrides the specified calico-node DaemonSet init containers.
    /// If omitted, the calico-node DaemonSet will use its default values for its init containers.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initContainers")]
...
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the calico-node DaemonSet container by name.
    /// Supported values are: calico-node
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named calico-node DaemonSet container's resources.
    /// If omitted, the calico-node DaemonSet will use its default value for this container's resources.
    /// If used in conjunction with the deprecated ComponentResources, then this value takes precedence.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// DNSConfig allows customization of the DNS configuration for the calico-node pods.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsConfig {
    /// A list of DNS name server IP addresses.
    /// This will be appended to the base nameservers generated from DNSPolicy.
    /// Duplicated nameservers will be removed.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// will override those that appear in the base DNSPolicy.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsConfigOptions>>,
    /// A list of DNS search domains for host-name lookup.
    /// This will be appended to the base search paths generated from DNSPolicy.
    /// Duplicated search paths will be removed.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// PodDNSConfigOption defines DNS resolver options of a pod.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsConfigOptions {
    /// Name is this DNS resolver option's name.
    /// Required.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
/// Spec is the calico-node DaemonSet's PodSpec.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedCalicoNodeDaemonSetSpecTemplateSpecDnsPolicy {
    #[serde(rename = "")]
    KopiumEmpty,
    Default,
    ClusterFirst,
...
pub struct InstallationStatusComputedCalicoNodeWindowsDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the calico-node-windows DaemonSet container by name.
    /// Supported values are: node, felix, confd
    /// calico-node-windows is allowed because it was previously allowed.
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named DaemonSet container's resources.
    /// If omitted, the DaemonSet will use its default value for this container's resources.
    /// If used in conjunction with the deprecated ComponentResources, then this value takes precedence.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoNodeWindowsDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the calico-windows-upgrade DaemonSet container by name.
    pub name: InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersName,
    /// ReadinessProbe allows customization of the readiness probe timing parameters.
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named calico-windows-upgrade DaemonSet container's resources.
    /// If omitted, the calico-windows-upgrade DaemonSet will use its default value for this container's resources.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCalicoWindowsUpgradeDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct InstallationStatusComputedCsiNodeDriverDaemonSetSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedCsiNodeDriverDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the csi-node-driver DaemonSet container by name.
    /// Supported values are: calico-csi, csi-node-driver-registrar.
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedCsiNodeDriverDaemonSetSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named csi-node-driver DaemonSet container's resources.
    /// If omitted, the csi-node-driver DaemonSet will use its default value for this container's resources.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCsiNodeDriverDaemonSetSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedCsiNodeDriverDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// Computed is the final installation including overlaid resources.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstallationStatusComputedImagePullPolicy {
    Always,
    IfNotPresent,
    Never,
}
...
pub struct InstallationStatusComputedTyphaDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<InstallationStatusComputedTyphaDeploymentSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the typha Deployment container by name.
    /// Supported values are: calico-typha
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<InstallationStatusComputedTyphaDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named typha Deployment container's resources.
    /// If omitted, the typha Deployment will use its default value for this container's resources.
    /// If used in conjunction with the deprecated ComponentResources, then this value takes precedence.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedTyphaDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstallationStatusComputedTyphaDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
