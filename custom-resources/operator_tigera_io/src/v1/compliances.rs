...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tigera/operator/operator.tigera.io/v1/compliances.yaml
...
pub struct ComplianceComplianceBenchmarkerDaemonSetSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<ComplianceComplianceBenchmarkerDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<ComplianceComplianceBenchmarkerDaemonSetSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceBenchmarkerDaemonSetSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceBenchmarkerDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct ComplianceComplianceControllerDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<ComplianceComplianceControllerDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<ComplianceComplianceControllerDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceControllerDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceControllerDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct ComplianceComplianceReporterPodTemplateTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<ComplianceComplianceReporterPodTemplateTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<ComplianceComplianceReporterPodTemplateTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceReporterPodTemplateTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceReporterPodTemplateTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct ComplianceComplianceServerDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<ComplianceComplianceServerDeploymentSpecTemplateSpecContainersLivenessProbe>,
    /// Name is an enum which identifies the ComplianceServer Deployment container by name.
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<ComplianceComplianceServerDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
    /// If specified, this overrides the named ComplianceServer Deployment container's resources.
    /// If omitted, the ComplianceServer Deployment will use its default value for this container's resources.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceServerDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceServerDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct ComplianceComplianceSnapshotterDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<ComplianceComplianceSnapshotterDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<ComplianceComplianceSnapshotterDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceSnapshotterDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ComplianceComplianceSnapshotterDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
