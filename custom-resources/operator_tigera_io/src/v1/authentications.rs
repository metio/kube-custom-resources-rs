...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tigera/operator/operator.tigera.io/v1/authentications.yaml
...
pub struct AuthenticationDexDeploymentSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<AuthenticationDexDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<AuthenticationDexDeploymentSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthenticationDexDeploymentSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthenticationDexDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
