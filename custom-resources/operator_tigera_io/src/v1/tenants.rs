...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tigera/operator/operator.tigera.io/v1/tenants.yaml
...
pub struct TenantDashboardsJobSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<TenantDashboardsJobSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<TenantDashboardsJobSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantDashboardsJobSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantDashboardsJobSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct TenantEsKubeControllerDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<TenantEsKubeControllerDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<TenantEsKubeControllerDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantEsKubeControllerDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantEsKubeControllerDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
pub struct TenantLinseedDeploymentSpecTemplateSpecContainers {
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "livenessProbe")]
    pub liveness_probe: Option<TenantLinseedDeploymentSpecTemplateSpecContainersLivenessProbe>,
    ...
    /// The probe handler is set by the operator and cannot be overridden.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readinessProbe")]
    pub readiness_probe: Option<TenantLinseedDeploymentSpecTemplateSpecContainersReadinessProbe>,
    /// Resources allows customization of limits and requests for compute resources such as cpu and memory.
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantLinseedDeploymentSpecTemplateSpecContainersLivenessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TenantLinseedDeploymentSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
