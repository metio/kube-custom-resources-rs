...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/tigera/operator/operator.tigera.io/v1/applicationlayers.yaml
...
pub struct ApplicationLayerL7LogCollectorDaemonSetSpecTemplateSpecContainers {
    ...
    pub liveness_probe: Option<ApplicationLayerL7LogCollectorDaemonSetSpecTemplateSpecContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<ApplicationLayerL7LogCollectorDaemonSetSpecTemplateSpecContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationLayerL7LogCollectorDaemonSetSpecTemplateSpecContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ApplicationLayerL7LogCollectorDaemonSetSpecTemplateSpecContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
