...
pub struct MonitorSpec {
    ...
    pub alertmanager: Option<MonitorAlertmanager>,
...
pub struct MonitorPrometheusSpecCommonPrometheusFieldsContainers {
    ...
    pub liveness_probe: Option<MonitorPrometheusSpecCommonPrometheusFieldsContainersLivenessProbe>,
    ...
    pub readiness_probe: Option<MonitorPrometheusSpecCommonPrometheusFieldsContainersReadinessProbe>,
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MonitorPrometheusSpecCommonPrometheusFieldsContainersLivenessProbe {
...
/// The probe handler is set by the operator and cannot be overridden.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct MonitorPrometheusSpecCommonPrometheusFieldsContainersReadinessProbe {
    /// FailureThreshold is the minimum consecutive failures for the probe
    /// to be considered failed after having succeeded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failureThreshold")]
    pub failure_threshold: Option<i32>,
