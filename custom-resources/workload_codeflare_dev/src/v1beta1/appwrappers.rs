...
pub struct AppWrapperStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "requeueingTimeInSeconds"
    )]
...
pub struct AppWrapperStatusConditions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "lastTransitionMicroTime"
    )]
