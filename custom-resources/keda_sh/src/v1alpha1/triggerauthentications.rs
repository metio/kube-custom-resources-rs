...
pub struct TriggerAuthenticationSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub oauth2: Option<TriggerAuthenticationOauth2>,
...
pub struct TriggerAuthenticationHashiCorpVault {
    ...
    pub authentication: TriggerAuthenticationHashiCorpVaultAuthentication,
...
/// HashiCorpVault is used to authenticate using Hashicorp Vault
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TriggerAuthenticationHashiCorpVaultAuthentication {
    #[serde(rename = "token")]
    Token,
...
pub struct TriggerAuthenticationHashiCorpVaultSecrets {
    ...
    pub r#type: Option<TriggerAuthenticationHashiCorpVaultSecretsType>,
}
...
/// VaultSecret defines the mapping between the path of the secret in Vault to the parameter
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TriggerAuthenticationHashiCorpVaultSecretsType {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "secretV2")]
    SecretV2,
    #[serde(rename = "secret")]
    Secret,
    #[serde(rename = "pki")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct TriggerAuthenticationOauth2 {
    #[serde(rename = "clientId")]
    pub client_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSecret")]
    pub client_secret: Option<TriggerAuthenticationOauth2ClientSecret>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scopes: Option<Vec<String>>,
    #[serde(rename = "tokenUrl")]
    pub token_url: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tokenUrlParams")]
    pub token_url_params: Option<BTreeMap<String, String>>,
    #[serde(rename = "type")]
    pub r#type: TriggerAuthenticationOauth2Type,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TriggerAuthenticationOauth2ClientSecret {
    #[serde(rename = "valueFrom")]
    pub value_from: TriggerAuthenticationOauth2ClientSecretValueFrom,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TriggerAuthenticationOauth2ClientSecretValueFrom {
    #[serde(rename = "secretKeyRef")]
    pub secret_key_ref: TriggerAuthenticationOauth2ClientSecretValueFromSecretKeyRef,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TriggerAuthenticationOauth2ClientSecretValueFromSecretKeyRef {
    pub key: String,
    pub name: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TriggerAuthenticationOauth2Type {
