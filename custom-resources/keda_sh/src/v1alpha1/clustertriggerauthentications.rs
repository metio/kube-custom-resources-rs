...
pub struct ClusterTriggerAuthenticationSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub oauth2: Option<ClusterTriggerAuthenticationOauth2>,
...
pub struct ClusterTriggerAuthenticationHashiCorpVault {
    ...
    pub authentication: ClusterTriggerAuthenticationHashiCorpVaultAuthentication,
...
/// HashiCorpVault is used to authenticate using Hashicorp Vault
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterTriggerAuthenticationHashiCorpVaultAuthentication {
    #[serde(rename = "token")]
    Token,
...
pub struct ClusterTriggerAuthenticationHashiCorpVaultSecrets {
    ...
    pub r#type: Option<ClusterTriggerAuthenticationHashiCorpVaultSecretsType>,
}
...
/// VaultSecret defines the mapping between the path of the secret in Vault to the parameter
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterTriggerAuthenticationHashiCorpVaultSecretsType {
    #[serde(rename = "")]
    KopiumEmpty,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct ClusterTriggerAuthenticationOauth2 {
    #[serde(rename = "clientId")]
    pub client_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientSecret")]
    pub client_secret: Option<ClusterTriggerAuthenticationOauth2ClientSecret>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "type")]
    pub r#type: ClusterTriggerAuthenticationOauth2Type,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterTriggerAuthenticationOauth2ClientSecret {
    #[serde(rename = "valueFrom")]
    pub value_from: ClusterTriggerAuthenticationOauth2ClientSecretValueFrom,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterTriggerAuthenticationOauth2ClientSecretValueFrom {
    #[serde(rename = "secretKeyRef")]
    pub secret_key_ref: ClusterTriggerAuthenticationOauth2ClientSecretValueFromSecretKeyRef,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterTriggerAuthenticationOauth2ClientSecretValueFromSecretKeyRef {
    pub key: String,
    pub name: String,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterTriggerAuthenticationOauth2Type {
