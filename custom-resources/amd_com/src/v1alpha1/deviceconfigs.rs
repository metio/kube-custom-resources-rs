...
pub struct DeviceConfigSpec {
    ...
    /// dra driver
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "draDriver")]
    pub dra_driver: Option<DeviceConfigDraDriver>,
    /// driver
...
pub struct DeviceConfigCommonConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imageRegistrySecrets")]
    pub image_registry_secrets: Option<Vec<DeviceConfigCommonConfigImageRegistrySecrets>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigCommonConfigImageRegistrySecrets {
...
pub struct DeviceConfigDevicePlugin {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableDevicePlugin")]
    pub enable_device_plugin: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kubeletSocketPath")]
    pub kubelet_socket_path: Option<String>,
...
/// dra driver
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigDraDriver {
    /// arguments is used to pass supported flags and their values while starting DRA driver daemonset
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cmdLineArguments")]
    pub cmd_line_arguments: Option<BTreeMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imagePullPolicy")]
    pub image_pull_policy: Option<DeviceConfigDraDriverImagePullPolicy>,
    /// DRA driver image registry secret used to pull/push images
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imageRegistrySecret")]
    pub image_registry_secret: Option<DeviceConfigDraDriverImageRegistrySecret>,
    /// Selector describes on which nodes to enable DRA driver
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<BTreeMap<String, String>>,
    /// tolerations for the DRA driver DaemonSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<DeviceConfigDraDriverTolerations>>,
    /// upgrade policy for DRA driver daemon
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "upgradePolicy")]
    pub upgrade_policy: Option<DeviceConfigDraDriverUpgradePolicy>,
}

/// dra driver
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum DeviceConfigDraDriverImagePullPolicy {
    Always,
    IfNotPresent,
    Never,
}
...
/// DRA driver image registry secret used to pull/push images
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigDraDriverImageRegistrySecret {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
...
/// the triple <key,value,effect> using the matching operator <operator>.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigDraDriverTolerations {
    /// Effect indicates the taint effect to match. Empty means match all taint effects.
    /// When specified, allowed values are NoSchedule, PreferNoSchedule and NoExecute.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub effect: Option<String>,
...
/// upgrade policy for DRA driver daemon
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigDraDriverUpgradePolicy {
    /// MaxUnavailable specifies the maximum number of Pods that can be unavailable during the update process. Applicable for RollingUpdate only. Default value is 1.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxUnavailable")]
    pub max_unavailable: Option<i32>,
    /// UpgradeStrategy specifies the type of the DaemonSet update. Valid values are "RollingUpdate" (default) or "OnDelete".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "upgradeStrategy")]
    pub upgrade_strategy: Option<DeviceConfigDraDriverUpgradePolicyUpgradeStrategy>,
}

/// upgrade policy for DRA driver daemon
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum DeviceConfigDraDriverUpgradePolicyUpgradeStrategy {
    RollingUpdate,
    OnDelete,
}
...
pub struct DeviceConfigDriverImageBuild {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gpgKeyURL")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "packageRepoURL")]
...
pub struct DeviceConfigDriverUpgradePolicyNodeDrainPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreNamespaces")]
...
pub struct DeviceConfigRemediationWorkflow {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoStartWorkflow")]
    pub auto_start_workflow: Option<bool>,
    /// Name of the ConfigMap that holds condition-to-workflow mappings.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub config: Option<DeviceConfigRemediationWorkflowConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapImage")]
    pub config_map_image: Option<String>,
    ...
    pub max_parallel_workflows: Option<i32>,
    /// Node drain policy during remediation workflow execution
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nodeDrainPolicy")]
    pub node_drain_policy: Option<DeviceConfigRemediationWorkflowNodeDrainPolicy>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nodeRemediationLabels")]
    pub node_remediation_labels: Option<BTreeMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nodeRemediationTaints")]
    pub node_remediation_taints: Option<Vec<DeviceConfigRemediationWorkflowNodeRemediationTaints>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rebootTimeout")]
    ...
    pub ttl_for_failed_workflows: Option<String>,
}

/// Name of the ConfigMap that holds condition-to-workflow mappings.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigRemediationWorkflowConfig {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
...
/// Node drain policy during remediation workflow execution
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigRemediationWorkflowNodeDrainPolicy {
    /// Force indicates if force draining is allowed
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub force: Option<bool>,
    /// GracePeriodSeconds indicates the time kubernetes waits for a pod to shut down gracefully after receiving a termination signal
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigRemediationWorkflowNodeRemediationTaints {
...
pub struct DeviceConfigStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "remediationWorkflow")]
    pub remediation_workflow: Option<DeviceConfigStatusRemediationWorkflow>,
}
...
/// RemediationWorkflow contains the status of the RemediationWorkflow deployment
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DeviceConfigStatusRemediationWorkflow {
    /// number of the actually deployed and running pods
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availableNumber")]
    pub available_number: Option<i32>,
    /// number of the pods that should be deployed for daemonset
