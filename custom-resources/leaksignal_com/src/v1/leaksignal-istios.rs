...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/leaksignal/leaksignal-operator/leaksignal.com/v1/leaksignal-istios.yaml
