...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/leaksignal/leaksignal-operator/leaksignal.com/v1/cluster-leaksignal-istios.yaml
...
#[kube(group = "leaksignal.com", version = "v1", kind = "ClusterLeaksignalIstio", plural = "cluster-leaksignal-istios")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct ClusterLeaksignalIstioSpec {
    ...
    pub grpc_mode: Option<ClusterLeaksignalIstioGrpcMode>,
    ...
    pub workload_selector: Option<ClusterLeaksignalIstioWorkloadSelector>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterLeaksignalIstioGrpcMode {
...
pub struct ClusterLeaksignalIstioWorkloadSelector {
