...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/policies.kyverno.io/v1beta1/policyexceptions.yaml
...
#[kube(group = "policies.kyverno.io", version = "v1beta1", kind = "PolicyException", plural = "policyexceptions")]
#[kube(namespaced)]
