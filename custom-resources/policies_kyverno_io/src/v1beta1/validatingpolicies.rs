...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/policies.kyverno.io/v1beta1/validatingpolicies.yaml
...
#[kube(group = "policies.kyverno.io", version = "v1beta1", kind = "ValidatingPolicy", plural = "validatingpolicies")]
#[kube(status = "ValidatingPolicyStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
#[kube(selectable = ".spec.evaluation.mode")]
