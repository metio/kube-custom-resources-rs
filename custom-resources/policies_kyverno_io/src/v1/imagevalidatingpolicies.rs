...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kyverno/kyverno/policies.kyverno.io/v1/imagevalidatingpolicies.yaml
...
#[kube(group = "policies.kyverno.io", version = "v1", kind = "ImageValidatingPolicy", plural = "imagevalidatingpolicies")]
