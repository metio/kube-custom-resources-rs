...
#[kube(group = "data.fluid.io", version = "v1alpha1", kind = "JuiceFSRuntime", root = "JuiceFsRuntime", plural = "juicefsruntimes")]
#[kube(namespaced)]
...
pub struct JuiceFsRuntimeSpec {
    ...
    pub volume_claim_templates: Option<Vec<JuiceFsRuntimeVolumeClaimTemplates>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplates {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiVersion")]
    pub api_version: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<JuiceFsRuntimeVolumeClaimTemplatesMetadata>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<JuiceFsRuntimeVolumeClaimTemplatesSpec>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<JuiceFsRuntimeVolumeClaimTemplatesStatus>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesMetadata {
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpec {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessModes")]
    pub access_modes: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataSource")]
    pub data_source: Option<JuiceFsRuntimeVolumeClaimTemplatesSpecDataSource>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataSourceRef")]
    pub data_source_ref: Option<JuiceFsRuntimeVolumeClaimTemplatesSpecDataSourceRef>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<JuiceFsRuntimeVolumeClaimTemplatesSpecResources>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<JuiceFsRuntimeVolumeClaimTemplatesSpecSelector>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageClassName")]
    pub storage_class_name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeAttributesClassName")]
    pub volume_attributes_class_name: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpecDataSource {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
    pub api_group: Option<String>,
    pub kind: String,
    pub name: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpecDataSourceRef {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
    pub api_group: Option<String>,
    pub kind: String,
    pub name: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpecResources {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<BTreeMap<String, IntOrString>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpecSelector {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<JuiceFsRuntimeVolumeClaimTemplatesSpecSelectorMatchExpressions>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
    pub match_labels: Option<BTreeMap<String, String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesSpecSelectorMatchExpressions {
    pub key: String,
    pub operator: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub values: Option<Vec<String>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesStatus {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessModes")]
    pub access_modes: Option<Vec<String>>,
    ...
    pub modify_volume_status: Option<JuiceFsRuntimeVolumeClaimTemplatesStatusModifyVolumeStatus>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub phase: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct JuiceFsRuntimeVolumeClaimTemplatesStatusModifyVolumeStatus {
    pub status: String,
