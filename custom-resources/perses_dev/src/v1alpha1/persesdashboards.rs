...
pub struct PersesDashboardSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub links: Option<Vec<PersesDashboardLinks>>,
...
pub struct PersesDashboardDatasourcesPlugin {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<PersesDashboardDatasourcesPluginMetadata>,
    pub spec: serde_json::Value,
}

/// Metadata is an optional field that contains additional information such as version and registry of the plugin.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PersesDashboardDatasourcesPluginMetadata {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PersesDashboardLinks {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
...
pub struct PersesDashboardPanelsSpec {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub display: Option<PersesDashboardPanelsSpecDisplay>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PersesDashboardPanelsSpecPlugin {
    ...
    /// Metadata is an optional field that contains additional information such as version and registry of the plugin.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<PersesDashboardPanelsSpecPluginMetadata>,
    pub spec: serde_json::Value,
}

/// Metadata is an optional field that contains additional information such as version and registry of the plugin.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PersesDashboardPanelsSpecPluginMetadata {
    /// Registry is optional. If not provided, it means the default registry: "perses.dev".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub registry: Option<String>,
    /// Version is optional. If not provided, it means the latest version available in the Perses instance.
...
pub struct PersesDashboardPanelsSpecQueriesSpecPlugin {
    ...
    /// Metadata is an optional field that contains additional information such as version and registry of the plugin.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<PersesDashboardPanelsSpecQueriesSpecPluginMetadata>,
    pub spec: serde_json::Value,
}

/// Metadata is an optional field that contains additional information such as version and registry of the plugin.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PersesDashboardPanelsSpecQueriesSpecPluginMetadata {
    /// Registry is optional. If not provided, it means the default registry: "perses.dev".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub registry: Option<String>,
    /// Version is optional. If not provided, it means the latest version available in the Perses instance.
