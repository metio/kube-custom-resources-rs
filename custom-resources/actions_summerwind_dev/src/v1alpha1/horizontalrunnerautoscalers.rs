...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/actions/actions-runner-controller/actions.summerwind.dev/v1alpha1/horizontalrunnerautoscalers.yaml
...
pub struct HorizontalRunnerAutoscalerSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "scaleDownDelaySecondsAfterScaleOut"
    )]
...
pub struct HorizontalRunnerAutoscalerStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "lastSuccessfulScaleOutTime"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "scheduledOverridesSummary"
    )]
