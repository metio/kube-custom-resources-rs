...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluxcd/kustomize-controller/kustomize.toolkit.fluxcd.io/v1/kustomizations.yaml
...
#[kube(group = "kustomize.toolkit.fluxcd.io", version = "v1", kind = "Kustomization", plural = "kustomizations")]
#[kube(namespaced)]
...
pub struct KustomizationSpec {
    ...
    pub build_metadata: Option<Vec<String>>,
    ...
    pub health_check_exprs: Option<Vec<KustomizationHealthCheckExprs>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KustomizationHealthCheckExprs {
...
pub struct KustomizationKubeConfig {
    ...
    pub config_map_ref: Option<KustomizationKubeConfigConfigMapRef>,
...
/// Mutually exclusive with SecretRef.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KustomizationKubeConfigConfigMapRef {
    /// Name of the referent.
    pub name: String,
}
...
pub struct KustomizationStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastAppliedOriginRevision")]
    pub last_applied_origin_revision: Option<String>,
