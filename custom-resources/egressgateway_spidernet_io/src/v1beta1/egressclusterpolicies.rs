...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/spidernet-io/egressgateway/egressgateway.spidernet.io/v1beta1/egressclusterpolicies.yaml
