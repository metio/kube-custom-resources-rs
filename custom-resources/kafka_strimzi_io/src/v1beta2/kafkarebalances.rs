...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1beta2/kafkarebalances.yaml
...
pub struct KafkaRebalanceSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicaMovementStrategies"
    )]
