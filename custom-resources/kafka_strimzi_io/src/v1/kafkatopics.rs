...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkatopics.yaml
...
#[kube(group = "kafka.strimzi.io", version = "v1", kind = "KafkaTopic", plural = "kafkatopics")]
#[kube(namespaced)]
