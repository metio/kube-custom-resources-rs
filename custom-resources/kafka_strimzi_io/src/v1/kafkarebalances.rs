...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkarebalances.yaml
...
#[kube(group = "kafka.strimzi.io", version = "v1", kind = "KafkaRebalance", plural = "kafkarebalances")]
#[kube(namespaced)]
