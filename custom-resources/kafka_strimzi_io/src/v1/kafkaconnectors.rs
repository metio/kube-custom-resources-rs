...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkaconnectors.yaml
...
#[kube(group = "kafka.strimzi.io", version = "v1", kind = "KafkaConnector", plural = "kafkaconnectors")]
#[kube(namespaced)]
