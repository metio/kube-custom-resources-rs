...
pub struct KafkaKafkaListenersConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "advertisedPortTemplate")]
    pub advertised_port_template: Option<String>,
...
pub struct KafkaKafkaRack {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "envVarName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<KafkaKafkaRackType>,
}

/// Configuration of the `broker.rack` broker config.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KafkaKafkaRackType {
    #[serde(rename = "topology-label")]
    TopologyLabel,
