...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkausers.yaml
...
#[kube(group = "kafka.strimzi.io", version = "v1", kind = "KafkaUser", plural = "kafkausers")]
#[kube(namespaced)]
