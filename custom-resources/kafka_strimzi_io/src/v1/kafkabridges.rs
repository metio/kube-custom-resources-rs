...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkabridges.yaml
...
pub struct KafkaBridgeHttp {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls: Option<KafkaBridgeHttpTls>,
}
...
/// TLS configuration for clients connections to the HTTP Bridge.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaBridgeHttpTls {
    /// Reference to the `Secret` which holds the certificate and private key pair.
    #[serde(rename = "certificateAndKey")]
    pub certificate_and_key: KafkaBridgeHttpTlsCertificateAndKey,
...
/// Reference to the `Secret` which holds the certificate and private key pair.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaBridgeHttpTlsCertificateAndKey {
    /// The name of the file certificate in the Secret.
    pub certificate: String,
    /// The name of the private key in the secret. The private key must be in unencrypted PKCS #8 format. For more information, see RFC 5208: <https://datatracker.ietf.org/doc/html/rfc5208.>
    pub key: String,
...
pub struct KafkaBridgeRack {
    ...
    pub r#type: Option<KafkaBridgeRackType>,
}

/// Configuration of the node label which will be used as the client.rack consumer configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KafkaBridgeRackType {
