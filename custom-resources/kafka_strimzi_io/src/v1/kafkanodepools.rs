...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/strimzi/strimzi-kafka-operator/kafka.strimzi.io/v1/kafkanodepools.yaml
...
#[kube(group = "kafka.strimzi.io", version = "v1", kind = "KafkaNodePool", plural = "kafkanodepools")]
#[kube(namespaced)]
...
pub struct KafkaNodePoolTemplatePod {
    ...
    pub dns_config: Option<KafkaNodePoolTemplatePodDnsConfig>,
    ...
    pub dns_policy: Option<KafkaNodePoolTemplatePodDnsPolicy>,
...
/// The pod's DNSConfig. If specified, it will be merged to the generated DNS configuration based on the DNSPolicy.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaNodePoolTemplatePodDnsConfig {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub nameservers: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<KafkaNodePoolTemplatePodDnsConfigOptions>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub searches: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaNodePoolTemplatePodDnsConfigOptions {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
/// Template for Kafka `Pods`.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KafkaNodePoolTemplatePodDnsPolicy {
    ClusterFirst,
...
pub struct KafkaNodePoolTemplatePodVolumes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub csi: Option<KafkaNodePoolTemplatePodVolumesCsi>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<KafkaNodePoolTemplatePodVolumesImage>,
...
/// `CSIVolumeSource` object to use to populate the volume.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaNodePoolTemplatePodVolumesCsi {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub driver: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fsType")]
    pub fs_type: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nodePublishSecretRef")]
    pub node_publish_secret_ref: Option<KafkaNodePoolTemplatePodVolumesCsiNodePublishSecretRef>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readOnly")]
    pub read_only: Option<bool>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaNodePoolTemplatePodVolumesCsiNodePublishSecretRef {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}
...
pub struct KafkaNodePoolTemplatePodVolumesEmptyDir {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub medium: Option<KafkaNodePoolTemplatePodVolumesEmptyDirMedium>,
...
/// `EmptyDir` to use to populate the volume.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KafkaNodePoolTemplatePodVolumesEmptyDirMedium {
    Memory,
}

/// `ImageVolumeSource` object to use to populate the volume.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KafkaNodePoolTemplatePodVolumesImage {
