...
pub struct NifiClusterClusterConfigAuthorization {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "singleUser")]
    pub single_user: Option<NifiClusterClusterConfigAuthorizationSingleUser>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub standard: Option<NifiClusterClusterConfigAuthorizationStandard>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterClusterConfigAuthorizationSingleUser {
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterClusterConfigAuthorizationStandard {
    #[serde(rename = "accessPolicyProvider")]
    pub access_policy_provider: NifiClusterClusterConfigAuthorizationStandardAccessPolicyProvider,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterClusterConfigAuthorizationStandardAccessPolicyProvider {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileBased")]
    pub file_based: Option<NifiClusterClusterConfigAuthorizationStandardAccessPolicyProviderFileBased>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterClusterConfigAuthorizationStandardAccessPolicyProviderFileBased {
    #[serde(rename = "initialAdminUser")]
...
pub struct NifiClusterNodesConfigResourcesStorage {
    ...
    /// Default size: 16MB
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filebasedRepo")]
    pub filebased_repo: Option<NifiClusterNodesConfigResourcesStorageFilebasedRepo>,
...
/// Default size: 16MB
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesConfigResourcesStorageFilebasedRepo {
    /// Quantity is a fixed-point representation of a number. It provides convenient marshaling/unmarshaling in JSON and YAML, in addition to String() and AsInt64() accessors.
    /// 
    /// The serialization format is:
    /// 
    ...
    /// A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selectors: Option<NifiClusterNodesConfigResourcesStorageFilebasedRepoSelectors>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageClass")]
    pub storage_class: Option<String>,
}
...
/// A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesConfigResourcesStorageFilebasedRepoSelectors {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<NifiClusterNodesConfigResourcesStorageFilebasedRepoSelectorsMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
    pub match_labels: Option<BTreeMap<String, String>>,
}
...
/// A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesConfigResourcesStorageFilebasedRepoSelectorsMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values. Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator: String,
...
pub struct NifiClusterNodesRoleGroupsConfigResourcesStorage {
    ...
    /// Default size: 16MB
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filebasedRepo")]
    pub filebased_repo: Option<NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepo>,
    /// [The FlowFile Repository](<https://nifi.apache.org/docs/nifi-docs/html/nifi-in-depth.html#flowfile-repository)>
    /// is where NiFi keeps track of the state and metadata of FlowFiles as they traverse the data flow.
    /// The repository ensures durability, reliability, and recoverability of data in case of system failures or interruptions.
    /// 
...
/// Default size: 16MB
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepo {
    /// Quantity is a fixed-point representation of a number. It provides convenient marshaling/unmarshaling in JSON and YAML, in addition to String() and AsInt64() accessors.
    /// 
    /// The serialization format is:
    /// 
    ...
    /// A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selectors: Option<NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepoSelectors>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "storageClass")]
    pub storage_class: Option<String>,
}
...
/// A label selector is a label query over a set of resources. The result of matchLabels and matchExpressions are ANDed. An empty label selector matches all objects. A null label selector matches no objects.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepoSelectors {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepoSelectorsMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is "key", the operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
    pub match_labels: Option<BTreeMap<String, String>>,
}
...
/// A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct NifiClusterNodesRoleGroupsConfigResourcesStorageFilebasedRepoSelectorsMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values. Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator: String,
