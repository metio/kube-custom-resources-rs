...
#[kube(group = "psmdb.percona.com", version = "v1", kind = "PerconaServerMongoDBRestore", root = "PerconaServerMongoDbRestore", plural = "perconaservermongodbrestores")]
#[kube(namespaced)]
...
pub struct PerconaServerMongoDbRestoreBackupSource {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub snapshots: Option<Vec<PerconaServerMongoDbRestoreBackupSourceSnapshots>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct PerconaServerMongoDbRestoreBackupSourceMinio {
    ...
    pub ca_bundle: Option<PerconaServerMongoDbRestoreBackupSourceMinioCaBundle>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaServerMongoDbRestoreBackupSourceMinioCaBundle {
    pub key: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaServerMongoDbRestoreBackupSourceSnapshots {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replsetName")]
