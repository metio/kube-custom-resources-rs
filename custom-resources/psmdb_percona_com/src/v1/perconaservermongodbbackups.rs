...
#[kube(group = "psmdb.percona.com", version = "v1", kind = "PerconaServerMongoDBBackup", root = "PerconaServerMongoDbBackup", plural = "perconaservermongodbbackups")]
#[kube(namespaced)]
...
pub struct PerconaServerMongoDbBackupStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub minio: Option<PerconaServerMongoDbBackupStatusMinio>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub snapshots: Option<Vec<PerconaServerMongoDbBackupStatusSnapshots>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaServerMongoDbBackupStatusMinioRetryer {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PerconaServerMongoDbBackupStatusSnapshots {
