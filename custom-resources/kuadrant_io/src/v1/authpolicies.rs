...
pub struct AuthPolicyDefaultsRulesAuthenticationX509 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<AuthPolicyDefaultsRulesAuthenticationX509Source>,
}
...
/// Source of the client certificate. Defaults to the certificate from the TLS connection attributes.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthPolicyDefaultsRulesAuthenticationX509Source {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientCertHeader")]
    ...
    /// One of: xfccHeader, clientCertHeader, expression
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "xfccHeader")]
    pub xfcc_header: Option<String>,
}
...
pub struct AuthPolicyOverridesRulesAuthenticationX509 {
    ...
    /// Source of the client certificate. Defaults to the certificate from the TLS connection attributes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<AuthPolicyOverridesRulesAuthenticationX509Source>,
}
...
/// Source of the client certificate. Defaults to the certificate from the TLS connection attributes.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthPolicyOverridesRulesAuthenticationX509Source {
    /// Name of the HTTP header containing the client certificate as defined in RFC 9440.
    /// Use this option when the certificate is forwarded in the Client-Cert header format (<https://datatracker.ietf.org/doc/rfc9440/).>
    /// The certificate must be in DER format, base64-encoded, and delimited by colons (:base64_cert:) as specified in the RFC.
    /// One of: xfccHeader, clientCertHeader, expression
...
pub struct AuthPolicyRulesAuthenticationX509 {
    ...
    /// Source of the client certificate. Defaults to the certificate from the TLS connection attributes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<AuthPolicyRulesAuthenticationX509Source>,
}
...
/// Source of the client certificate. Defaults to the certificate from the TLS connection attributes.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct AuthPolicyRulesAuthenticationX509Source {
    /// Name of the HTTP header containing the client certificate as defined in RFC 9440.
    /// Use this option when the certificate is forwarded in the Client-Cert header format (<https://datatracker.ietf.org/doc/rfc9440/).>
    /// The certificate must be in DER format, base64-encoded, and delimited by colons (:base64_cert:) as specified in the RFC.
    /// One of: xfccHeader, clientCertHeader, expression
