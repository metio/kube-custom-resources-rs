...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Hyperfoil/hyperfoil-operator/hyperfoil.io/v1alpha2/hyperfoils.yaml
