...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/Hyperfoil/horreum-operator/hyperfoil.io/v1alpha1/horreums.yaml
