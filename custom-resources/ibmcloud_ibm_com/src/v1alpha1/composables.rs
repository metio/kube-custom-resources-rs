...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/composable-operator/composable/ibmcloud.ibm.com/v1alpha1/composables.yaml
