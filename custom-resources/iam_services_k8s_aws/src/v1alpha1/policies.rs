...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/iam-controller/iam.services.k8s.aws/v1alpha1/policies.yaml
...
pub struct PolicyStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "permissionsBoundaryUsageCount"
    )]
