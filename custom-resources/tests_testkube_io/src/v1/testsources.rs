...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubeshop/testkube-operator/tests.testkube.io/v1/testsources.yaml
