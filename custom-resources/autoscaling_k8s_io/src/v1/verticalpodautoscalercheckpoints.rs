...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes/autoscaler/autoscaling.k8s.io/v1/verticalpodautoscalercheckpoints.yaml
