...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/submariner-io/submariner-operator/submariner.io/v1alpha1/servicediscoveries.yaml
