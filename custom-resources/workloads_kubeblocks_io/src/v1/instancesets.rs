...
pub struct InstanceSetMembershipReconfigurationSwitchover {
    ...
    /// This field cannot be updated.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grpc: Option<InstanceSetMembershipReconfigurationSwitchoverGrpc>,
    /// Defines the HTTP request to perform.
    /// 
    /// 
    /// This field cannot be updated.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<InstanceSetMembershipReconfigurationSwitchoverHttp>,
    /// Used in conjunction with the `targetPodSelector` field to refine the selection of target pod(s) for Action execution.
    /// The impact of this field depends on the `targetPodSelector` value:
    /// 
    /// 
    ...
    /// This field cannot be updated.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetPodSelector")]
    pub target_pod_selector: Option<InstanceSetMembershipReconfigurationSwitchoverTargetPodSelector>,
    /// Specifies the maximum duration in seconds that the Action is allowed to run.
    /// 
    /// 
    /// If the Action does not complete within this time frame, it will be terminated.
...
/// This field cannot be updated.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceSetMembershipReconfigurationSwitchoverGrpc {
    /// The target host to connect to.
    /// Defaults to "127.0.0.1" if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub host: Option<String>,
    ...
    /// Required response schema for the gRPC method.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub response: Option<InstanceSetMembershipReconfigurationSwitchoverGrpcResponse>,
    /// Fully-qualified name of the gRPC service to call.
    pub service: String,
}
...
/// Required response schema for the gRPC method.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceSetMembershipReconfigurationSwitchoverGrpcResponse {
    /// Name of the field in the response whose value should be output.
    /// Printed to stdout on success, or stderr on failure.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
...
/// This field cannot be updated.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceSetMembershipReconfigurationSwitchoverHttp {
    /// Optional HTTP request body.
    /// 
    /// 
    /// Supports Go text/template syntax; rendered with predefined variables before sending.
    ...
    /// Header values may use Go text/template syntax, rendered with predefined variables.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<Vec<InstanceSetMembershipReconfigurationSwitchoverHttpHeaders>>,
    /// The target host to connect to.
    /// Defaults to "127.0.0.1" if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub host: Option<String>,
    ...
    /// Defaults to "GET".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<InstanceSetMembershipReconfigurationSwitchoverHttpMethod>,
    /// The path to request on the HTTP server.
    /// Defaults to "/" if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub path: Option<String>,
    ...
    /// Defaults to "HTTP".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scheme: Option<InstanceSetMembershipReconfigurationSwitchoverHttpScheme>,
}

/// HTTPHeader represents a single HTTP header key/value pair.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstanceSetMembershipReconfigurationSwitchoverHttpHeaders {
    /// Name of the header field.
    pub name: String,
    /// Value of the header field.
    pub value: String,
...
/// This field cannot be updated.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstanceSetMembershipReconfigurationSwitchoverHttpMethod {
    #[serde(rename = "GET")]
    Get,
    #[serde(rename = "POST")]
    Post,
...
/// This field cannot be updated.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstanceSetMembershipReconfigurationSwitchoverHttpScheme {
    #[serde(rename = "HTTP")]
    Http,
    #[serde(rename = "HTTPS")]
    Https,
...
/// Defines the procedure for a controlled transition of a role to a new replica.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum InstanceSetMembershipReconfigurationSwitchoverTargetPodSelector {
    Any,
    All,
    Role,
    Ordinal,
