...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/open-policy-agent/gatekeeper/templates.gatekeeper.sh/v1alpha1/constrainttemplates.yaml
...
#[kube(group = "templates.gatekeeper.sh", version = "v1alpha1", kind = "ConstraintTemplate", plural = "constrainttemplates")]
