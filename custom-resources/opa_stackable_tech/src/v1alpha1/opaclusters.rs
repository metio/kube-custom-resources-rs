...
pub struct OpaClusterClusterConfig {
    ...
    pub tls: Option<OpaClusterClusterConfigTls>,
...
pub struct OpaClusterClusterConfigUserInfoBackend {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "experimentalOpenLdap")]
    pub experimental_open_ldap: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdap>,
...
/// Backend that fetches user information from OpenLDAP
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdap {
    /// Credentials for binding to the LDAP server.
    /// 
    /// The bind account is used to search for users and groups in the LDAP directory.
    #[serde(rename = "bindCredentials")]
    pub bind_credentials: OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapBindCredentials,
    /// Custom attributes, and their LDAP attribute names.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customAttributeMappings")]
    pub custom_attribute_mappings: Option<BTreeMap<String, String>>,
    ...
    /// 
    /// Defaults to `member`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "groupMemberAttribute")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "groupsSearchBase")]
    ...
    /// Use a TLS connection. If not specified no TLS will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTls>,
    /// LDAP attribute used for the user's unique identifier. Defaults to `entryUUID`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userIdAttribute")]
    pub user_id_attribute: Option<String>,
    /// LDAP attribute used for the username. Defaults to `uid`.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userNameAttribute")]
...
/// The bind account is used to search for users and groups in the LDAP directory.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapBindCredentials {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub scope: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapBindCredentialsScope>,
...
/// [SecretClass](<https://docs.stackable.tech/home/nightly/secret-operator/secretclass).>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapBindCredentialsScope {
...
/// Use a TLS connection. If not specified no TLS will be used.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTls {
    /// The verification method used to verify the certificates of the server and/or the client.
    pub verification: OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerification,
}

/// The verification method used to verify the certificates of the server and/or the client.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerification {
    /// Use TLS but don't verify certificates.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub none: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationNone>,
    /// Use TLS and a CA certificate to verify the server.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub server: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServer>,
}

/// Use TLS but don't verify certificates.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationNone {
}

/// Use TLS and a CA certificate to verify the server.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServer {
    /// CA cert to verify the server.
    #[serde(rename = "caCert")]
    pub ca_cert: OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServerCaCert,
}

/// CA cert to verify the server.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServerCaCert {
    /// Name of the [SecretClass](<https://docs.stackable.tech/home/nightly/secret-operator/secretclass)> which will provide the CA certificate.
    /// Note that a SecretClass does not need to have a key but can also work with just a CA certificate,
    /// so if you got provided with a CA cert but don't have access to the key you can still use this method.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretClass")]
    ...
    /// This can be useful when you e.g. use public AWS S3 or other public available services.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "webPki")]
    pub web_pki: Option<OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServerCaCertWebPki>,
}

/// Use TLS and the CA certificates trusted by the common web browsers to verify the server.
/// This can be useful when you e.g. use public AWS S3 or other public available services.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct OpaClusterClusterConfigUserInfoBackendExperimentalOpenLdapTlsVerificationServerCaCertWebPki {
}
