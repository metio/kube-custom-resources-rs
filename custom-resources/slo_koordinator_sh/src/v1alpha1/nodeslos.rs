...
#[kube(group = "slo.koordinator.sh", version = "v1alpha1", kind = "NodeSLO", root = "NodeSlo", plural = "nodeslos")]
...
pub struct NodeSloResourceUsedThresholdWithBe {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocatableEvictPriorityThreshold")]
    pub allocatable_evict_priority_threshold: Option<i32>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuAllocatableEvictLowerPercent")]
    pub cpu_allocatable_evict_lower_percent: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuAllocatableEvictThresholdPercent")]
    pub cpu_allocatable_evict_threshold_percent: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryAllocatableEvictLowerPercent")]
    pub memory_allocatable_evict_lower_percent: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryAllocatableEvictThresholdPercent")]
    pub memory_allocatable_evict_threshold_percent: Option<i64>,
