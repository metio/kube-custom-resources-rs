...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/fluxcd/source-controller/source.toolkit.fluxcd.io/v1beta2/ocirepositories.yaml
...
#[kube(group = "source.toolkit.fluxcd.io", version = "v1beta2", kind = "OCIRepository", root = "OciRepository", plural = "ocirepositories")]
#[kube(namespaced)]
