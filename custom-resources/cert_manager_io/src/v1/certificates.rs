...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cert-manager/cert-manager/cert-manager.io/v1/certificates.yaml
...
#[kube(selectable = ".spec.issuerRef.group")]
#[kube(selectable = ".spec.issuerRef.kind")]
#[kube(selectable = ".spec.issuerRef.name")]
pub struct CertificateSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "renewBeforePercentage")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub renewal: Option<CertificateRenewal>,
...
pub struct CertificateKeystoresJks {
    ...
    pub password_secret_ref: Option<CertificateKeystoresJksPasswordSecretRef>,
}
...
pub struct CertificateKeystoresPkcs12 {
    ...
    /// One of password or passwordSecretRef must provide a password with a non-zero length.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passwordSecretRef")]
    pub password_secret_ref: Option<CertificateKeystoresPkcs12PasswordSecretRef>,
...
pub struct CertificateRenewal {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<CertificateRenewalPolicy>,
    /// `windows` mentions the behavior of when the renewal must happen.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub windows: Option<Vec<CertificateRenewalWindows>>,
}

/// `renewal` allows configuration of how your certificate is renewed. If the policy mentioned is
/// `RenewBefore` then the controller respects `renewBefore` and `renewBeforePercentage`.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CertificateRenewalPolicy {
    RenewBefore,
    Disabled,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct CertificateRenewalWindows {
