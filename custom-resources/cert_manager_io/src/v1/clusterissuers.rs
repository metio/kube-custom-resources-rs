...
pub struct ClusterIssuerAcmeSolversDns01AzureDns {
    ...
    pub zone_type: Option<ClusterIssuerAcmeSolversDns01AzureDnsZoneType>,
}
...
/// Use the Microsoft Azure DNS API to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterIssuerAcmeSolversDns01AzureDnsZoneType {
    AzurePublicZone,
    AzurePrivateZone,
}
...
pub struct ClusterIssuerAcmeSolversDns01Rfc2136 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub protocol: Option<ClusterIssuerAcmeSolversDns01Rfc2136Protocol>,
...
/// to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClusterIssuerAcmeSolversDns01Rfc2136Protocol {
    #[serde(rename = "TCP")]
    Tcp,
    #[serde(rename = "UDP")]
    Udp,
...
pub struct ClusterIssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<ClusterIssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpecResources>,
...
/// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpecResources {
...
pub struct ClusterIssuerAcmeSolversHttp01IngressPodTemplateSpec {
    ...
    /// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<ClusterIssuerAcmeSolversHttp01IngressPodTemplateSpecResources>,
    /// If specified, the pod's security context
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
/// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerAcmeSolversHttp01IngressPodTemplateSpecResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
pub struct ClusterIssuerVaultAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aws: Option<ClusterIssuerVaultAuthAws>,
...
/// EKS Pod Identity (PIA), or ambient credentials (EC2 instance profiles, ECS task role).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerVaultAuthAws {
    ...
    pub service_account_ref: Option<ClusterIssuerVaultAuthAwsServiceAccountRef>,
...
/// token for IRSA (IAM Roles for Service Accounts) authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerVaultAuthAwsServiceAccountRef {
...
pub struct ClusterIssuerVenafi {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ngts: Option<ClusterIssuerVenafiNgts>,
...
/// using OAuth 2.0 Client Credentials. Only one of tpp, cloud, or ngts may be specified.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerVenafiNgts {
    ...
    pub credentials_ref: ClusterIssuerVenafiNgtsCredentialsRef,
...
/// 'client-secret'.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClusterIssuerVenafiNgtsCredentialsRef {
    /// Name of the resource being referred to.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names>
    pub name: String,
}
