...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cert-manager/cert-manager/cert-manager.io/v1/issuers.yaml
...
pub struct IssuerAcmeSolversDns01AzureDns {
    ...
    pub zone_type: Option<IssuerAcmeSolversDns01AzureDnsZoneType>,
}
...
/// Use the Microsoft Azure DNS API to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IssuerAcmeSolversDns01AzureDnsZoneType {
    AzurePublicZone,
    AzurePrivateZone,
}
...
pub struct IssuerAcmeSolversDns01Rfc2136 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub protocol: Option<IssuerAcmeSolversDns01Rfc2136Protocol>,
...
/// to manage DNS01 challenge records.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum IssuerAcmeSolversDns01Rfc2136Protocol {
    #[serde(rename = "TCP")]
    Tcp,
    #[serde(rename = "UDP")]
    Udp,
...
pub struct IssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<IssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpecResources>,
...
/// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IssuerAcmeSolversHttp01GatewayHttpRoutePodTemplateSpecResources {
...
pub struct IssuerAcmeSolversHttp01IngressPodTemplateSpec {
    ...
    /// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<IssuerAcmeSolversHttp01IngressPodTemplateSpecResources>,
    /// If specified, the pod's security context
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityContext")]
...
/// Kubernetes will reject pod creation if limits are lower than requests, causing challenge failures.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IssuerAcmeSolversHttp01IngressPodTemplateSpecResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
pub struct IssuerVaultAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aws: Option<IssuerVaultAuthAws>,
...
pub struct IssuerVaultAuthAws {
    ...
    pub service_account_ref: Option<IssuerVaultAuthAwsServiceAccountRef>,
    /// The Vault header value to include in the STS signing request.
    /// This is used to prevent replay attacks.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vaultHeaderValue")]
    pub vault_header_value: Option<String>,
}

/// A reference to a service account that will be used to request a web identity
/// token for IRSA (IAM Roles for Service Accounts) authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IssuerVaultAuthAwsServiceAccountRef {
...
pub struct IssuerVenafi {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ngts: Option<IssuerVenafiNgts>,
...
pub struct IssuerVenafiNgts {
    ...
    pub credentials_ref: IssuerVenafiNgtsCredentialsRef,
...
/// 'client-secret'.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IssuerVenafiNgtsCredentialsRef {
    /// Name of the resource being referred to.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names>
    pub name: String,
}
