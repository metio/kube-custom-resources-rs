...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/mcs-api/multicluster.x-k8s.io/v1beta1/serviceimports.yaml
...
#[kube(group = "multicluster.x-k8s.io", version = "v1beta1", kind = "ServiceImport", plural = "serviceimports")]
#[kube(namespaced)]
