...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/mcs-api/multicluster.x-k8s.io/v1beta1/serviceexports.yaml
...
#[kube(group = "multicluster.x-k8s.io", version = "v1beta1", kind = "ServiceExport", plural = "serviceexports")]
#[kube(namespaced)]
