...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/mittwald/kubernetes-secret-generator/secretgenerator.mittwald.de/v1alpha1/sshkeypairs.yaml
...
#[kube(group = "secretgenerator.mittwald.de", version = "v1alpha1", kind = "SSHKeyPair", root = "SshKeyPair", plural = "sshkeypairs")]
#[kube(namespaced)]
...
pub struct SshKeyPairSpec {
    ...
    /// Field in which to store SSH private key. ssh-privatekey is used if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateKeyField")]
    pub private_key_field: Option<String>,
    /// Field in which to store SSH private key. ssh-publickey is used if not specified.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicKeyField")]
    pub public_key_field: Option<String>,
