...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/traefik/traefik/traefik.io/v1alpha1/ingressroutes.yaml
...
pub struct IngressRouteRoutesServices {
    ...
    pub passive_health_check: Option<IngressRouteRoutesServicesPassiveHealthCheck>,
...
/// PassiveHealthCheck defines passive health checks for ExternalName services.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IngressRouteRoutesServicesPassiveHealthCheck {
