...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/traefik/traefik/traefik.io/v1alpha1/middlewaretcps.yaml
...
#[kube(group = "traefik.io", version = "v1alpha1", kind = "MiddlewareTCP", root = "MiddlewareTcp", plural = "middlewaretcps")]
#[kube(namespaced)]
