...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/traefik/traefik/traefik.io/v1alpha1/ingressrouteudps.yaml
...
#[kube(group = "traefik.io", version = "v1alpha1", kind = "IngressRouteUDP", root = "IngressRouteUdp", plural = "ingressrouteudps")]
#[kube(namespaced)]
