...
pub struct MiddlewareForwardAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxResponseBodySize")]
...
pub struct MiddlewareRetry {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableRetryOnNetworkError")]
    pub disable_retry_on_network_error: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryNonIdempotentMethod")]
    pub retry_non_idempotent_method: Option<bool>,
