...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/karmada-io/karmada/autoscaling.karmada.io/v1alpha1/cronfederatedhpas.yaml
...
#[kube(group = "autoscaling.karmada.io", version = "v1alpha1", kind = "CronFederatedHPA", root = "CronFederatedHpa", plural = "cronfederatedhpas")]
#[kube(namespaced)]
