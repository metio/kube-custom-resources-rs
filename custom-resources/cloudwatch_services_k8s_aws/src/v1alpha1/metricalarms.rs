...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/cloudwatch-controller/cloudwatch.services.k8s.aws/v1alpha1/metricalarms.yaml
...
pub struct MetricAlarmSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "evaluateLowSampleCountPercentile"
    )]
