...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/vmware-tanzu/velero/velero.io/v1/serverstatusrequests.yaml
