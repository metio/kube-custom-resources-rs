...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/emqx/emqx-operator/apps.emqx.io/v1beta3/emqxenterprises.yaml
