...
pub struct CronAnythingSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "resourceTimestampFormat"
    )]
...
pub struct CronAnythingRetention {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "historyTimeLimitSeconds"
    )]
