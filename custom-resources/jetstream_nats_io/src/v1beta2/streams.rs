...
pub struct StreamSpec {
    ...
    /// When true, enables fast-ingest batch publishing (nats-server 2.14+).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowBatched")]
    pub allow_batched: Option<bool>,
...
pub struct StreamMirror {
    /// Reference a durable consumer when sourcing/mirroring (nats-server 2.14+).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub consumer: Option<StreamMirrorConsumer>,
...
/// Reference a durable consumer when sourcing/mirroring (nats-server 2.14+).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct StreamMirrorConsumer {
    /// Deliver subject for the durable push consumer.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliverSubject")]
    pub deliver_subject: Option<String>,
    /// Durable consumer name on the source stream.
    pub name: String,
}
...
pub struct StreamSources {
    /// Reference a durable consumer when sourcing/mirroring (nats-server 2.14+).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub consumer: Option<StreamSourcesConsumer>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalApiPrefix")]
    pub external_api_prefix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalDeliverPrefix")]
    pub external_deliver_prefix: Option<String>,
...
/// Reference a durable consumer when sourcing/mirroring (nats-server 2.14+).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct StreamSourcesConsumer {
    /// Deliver subject for the durable push consumer.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliverSubject")]
    pub deliver_subject: Option<String>,
    /// Durable consumer name on the source stream.
