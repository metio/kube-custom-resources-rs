...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/koordinator-sh/koordinator/scheduling.koordinator.sh/v1alpha1/podmigrationjobs.yaml
...
pub struct PodMigrationJobDeleteOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreStoreReadErrorWithClusterBreakingPotential")]
