...
pub struct ReservationSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "preAllocationPolicy")]
    pub pre_allocation_policy: Option<ReservationPreAllocationPolicy>,
...
/// PreAllocationPolicy defines the policy for pre-allocation.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ReservationPreAllocationPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableMultiple")]
    pub enable_multiple: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mode: Option<ReservationPreAllocationPolicyMode>,
}

/// PreAllocationPolicy defines the policy for pre-allocation.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ReservationPreAllocationPolicyMode {
    Default,
    Cluster,
}
