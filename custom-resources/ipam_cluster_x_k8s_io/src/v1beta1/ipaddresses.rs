...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api/ipam.cluster.x-k8s.io/v1beta1/ipaddresses.yaml
...
#[kube(group = "ipam.cluster.x-k8s.io", version = "v1beta1", kind = "IPAddress", root = "IpAddress", plural = "ipaddresses")]
#[kube(namespaced)]
