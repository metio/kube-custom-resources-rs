...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api/ipam.cluster.x-k8s.io/v1beta1/ipaddressclaims.yaml
...
#[kube(group = "ipam.cluster.x-k8s.io", version = "v1beta1", kind = "IPAddressClaim", root = "IpAddressClaim", plural = "ipaddressclaims")]
#[kube(namespaced)]
