...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/external-dns/externaldns.k8s.io/v1alpha1/dnsendpoints.yaml
...
#[kube(group = "externaldns.k8s.io", version = "v1alpha1", kind = "DNSEndpoint", root = "DnsEndpoint", plural = "dnsendpoints")]
#[kube(namespaced)]
