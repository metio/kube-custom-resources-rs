...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/otterize/helm-charts/k8s.otterize.com/v1alpha3/clientintents.yaml
