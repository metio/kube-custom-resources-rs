...
pub struct ResourceSetSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputStrategy")]
    pub input_strategy: Option<ResourceSetInputStrategy>,
...
pub struct ResourceSetInputStrategy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeEmptyProviders")]
    ...
    pub name: ResourceSetInputStrategyName,
}
...
/// from all providers into a single list of input sets.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ResourceSetInputStrategyName {
    Flatten,
    Permute,
}
...
pub struct ResourceSetInputsFrom {
    ...
    pub api_version: Option<ResourceSetInputsFromApiVersion>,
    /// Kind of the input provider resource.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kind: Option<ResourceSetInputsFromKind>,
...
/// in the same namespace as the ResourceSet.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ResourceSetInputsFromApiVersion {
    #[serde(rename = "fluxcd.controlplane.io/v1")]
    FluxcdControlplaneIoV1,
}
...
pub struct ResourceSetStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalChecksumRefs")]
