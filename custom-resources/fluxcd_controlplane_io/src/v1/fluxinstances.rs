...
pub struct FluxInstanceCluster {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multitenantWorkloadIdentity")]
    pub multitenant_workload_identity: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tenantDefaultDecryptionServiceAccount")]
    pub tenant_default_decryption_service_account: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tenantDefaultKubeConfigServiceAccount")]
    pub tenant_default_kube_config_service_account: Option<String>,
...
pub struct FluxInstanceStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub history: Option<Vec<FluxInstanceStatusHistory>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct FluxInstanceStatusHistory {
