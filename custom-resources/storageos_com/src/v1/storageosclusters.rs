...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/storageos/operator/storageos.com/v1/storageosclusters.yaml
...
#[kube(group = "storageos.com", version = "v1", kind = "StorageOSCluster", root = "StorageOsCluster", plural = "storageosclusters")]
#[kube(namespaced)]
