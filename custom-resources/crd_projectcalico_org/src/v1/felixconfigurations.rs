...
pub struct FelixConfigurationSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfIPFragTimeout")]
    pub bpf_ip_frag_timeout: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfIPFragmentReassemblyEnabled")]
    pub bpf_ip_fragment_reassembly_enabled: Option<bool>,
    ...
    /// 
    /// [Default: 100]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfMaglevMaxEndpointsPerService")]
    pub bpf_maglev_max_endpoints_per_service: Option<i64>,
    /// BPFMaglevMaxServices is the maximum number of expected Maglev-enabled
    /// services that Felix will allocate lookup-tables for.
    /// 
    /// [Default: 100]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bpfMaglevMaxServices")]
    pub bpf_maglev_max_services: Option<i64>,
    ...
    pub iptables_backend: Option<FelixConfigurationIptablesBackend>,
    ...
    /// [Default: 512]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4ElevatedRoutePriority")]
    pub ipv4_elevated_route_priority: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4NormalRoutePriority")]
    pub ipv4_normal_route_priority: Option<i64>,
    ...
    /// [Default: 512]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv6ElevatedRoutePriority")]
    pub ipv6_elevated_route_priority: Option<i64>,
    /// Route Priority value for a normal priority Calico-programmed IPv6 route.  Note, higher
    /// values mean lower priority. [Default: 1024]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv6NormalRoutePriority")]
    pub ipv6_normal_route_priority: Option<i64>,
    ...
    /// [Default: Disabled]
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "istioAmbientMode")]
    pub istio_ambient_mode: Option<FelixConfigurationIstioAmbientMode>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "istioDSCPMark")]
    pub istio_dscp_mark: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "liveMigrationRouteConvergenceTime")]
    pub live_migration_route_convergence_time: Option<String>,
...
/// FelixConfigurationSpec contains the values of the Felix configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FelixConfigurationIptablesBackend {
    Legacy,
    #[serde(rename = "NFT")]
    Nft,
    Auto,
...
/// FelixConfigurationSpec contains the values of the Felix configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum FelixConfigurationIstioAmbientMode {
    Enabled,
    Disabled,
}
