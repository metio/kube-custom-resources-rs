...
#[kube(group = "crd.projectcalico.org", version = "v1", kind = "IPAMBlock", root = "IpamBlock", plural = "ipamblocks")]
...
pub struct IpamBlockAttributes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "alternateOwnerAttrs")]
    pub alternate_owner_attrs: Option<BTreeMap<String, String>>,
