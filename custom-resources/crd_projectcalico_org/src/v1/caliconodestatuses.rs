...
pub struct CalicoNodeStatusStatusAgentBirdV4 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<CalicoNodeStatusStatusAgentBirdV4State>,
...
pub enum CalicoNodeStatusStatusAgentBirdV4State {
    Ready,
    NotReady,
}
...
pub struct CalicoNodeStatusStatusAgentBirdV6 {
    ...
    /// The state of the BGP Daemon.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<CalicoNodeStatusStatusAgentBirdV6State>,
    /// Version of the BGP daemon
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
...
/// BIRDV6 represents the latest observed status of bird6.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusAgentBirdV6State {
    Ready,
    NotReady,
}
...
pub struct CalicoNodeStatusStatusBgpPeersV4 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<CalicoNodeStatusStatusBgpPeersV4State>,
    ...
    pub r#type: Option<CalicoNodeStatusStatusBgpPeersV4Type>,
}

/// CalicoNodePeer contains the status of BGP peers on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusBgpPeersV4State {
    Idle,
    Connect,
    Active,
    OpenSent,
...
/// CalicoNodePeer contains the status of BGP peers on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusBgpPeersV4Type {
    NodeMesh,
    NodePeer,
    GlobalPeer,
}
...
pub struct CalicoNodeStatusStatusBgpPeersV6 {
    ...
    /// State is the BGP session state.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<CalicoNodeStatusStatusBgpPeersV6State>,
    /// Type indicates whether this peer is configured via the node-to-node mesh,
    /// or via an explicit global or per-node BGPPeer object.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<CalicoNodeStatusStatusBgpPeersV6Type>,
}

/// CalicoNodePeer contains the status of BGP peers on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusBgpPeersV6State {
    Idle,
    Connect,
    Active,
    OpenSent,
...
/// CalicoNodePeer contains the status of BGP peers on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusBgpPeersV6Type {
    NodeMesh,
    NodePeer,
    GlobalPeer,
}
...
pub struct CalicoNodeStatusStatusRoutesRoutesV4 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<CalicoNodeStatusStatusRoutesRoutesV4Type>,
}
...
pub struct CalicoNodeStatusStatusRoutesRoutesV4LearnedFrom {
    ...
    pub source_type: Option<CalicoNodeStatusStatusRoutesRoutesV4LearnedFromSourceType>,
}

/// LearnedFrom contains information regarding where this route originated.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusRoutesRoutesV4LearnedFromSourceType {
    Kernel,
    Static,
    Direct,
    NodeMesh,
    #[serde(rename = "BGPPeer")]
    BgpPeer,
}

/// CalicoNodeRoute contains the status of BGP routes on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusRoutesRoutesV4Type {
    #[serde(rename = "FIB")]
    Fib,
    #[serde(rename = "RIB")]
    Rib,
...
pub struct CalicoNodeStatusStatusRoutesRoutesV6 {
    ...
    /// Type indicates if the route is being used for forwarding or not.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    pub r#type: Option<CalicoNodeStatusStatusRoutesRoutesV6Type>,
}
...
pub struct CalicoNodeStatusStatusRoutesRoutesV6LearnedFrom {
    ...
    /// Type of the source where a route is learned from.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceType")]
    pub source_type: Option<CalicoNodeStatusStatusRoutesRoutesV6LearnedFromSourceType>,
}

/// LearnedFrom contains information regarding where this route originated.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusRoutesRoutesV6LearnedFromSourceType {
    Kernel,
    Static,
    Direct,
    NodeMesh,
...
/// CalicoNodeRoute contains the status of BGP routes on the node.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum CalicoNodeStatusStatusRoutesRoutesV6Type {
    #[serde(rename = "FIB")]
    Fib,
    #[serde(rename = "RIB")]
    Rib,
