...
#[kube(group = "crd.projectcalico.org", version = "v1", kind = "BGPConfiguration", root = "BgpConfiguration", plural = "bgpconfigurations")]
...
pub struct BgpConfigurationSpec {
    ...
    pub bind_mode: Option<BgpConfigurationBindMode>,
    ...
    pub program_cluster_routes: Option<BgpConfigurationProgramClusterRoutes>,
...
pub enum BgpConfigurationBindMode {
    None,
    #[serde(rename = "NodeIP")]
    NodeIp,
}
...
/// BGPConfigurationSpec contains the values of the BGP configuration.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BgpConfigurationProgramClusterRoutes {
    Enabled,
    Disabled,
}
