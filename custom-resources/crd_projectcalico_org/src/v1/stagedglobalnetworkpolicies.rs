...
pub struct StagedGlobalNetworkPolicySpec {
    ...
    pub staged_action: Option<StagedGlobalNetworkPolicyStagedAction>,
...
pub struct StagedGlobalNetworkPolicyEgress {
    pub action: StagedGlobalNetworkPolicyEgressAction,
...
/// the positive and negative version of a match and both must be satisfied for the rule to match.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StagedGlobalNetworkPolicyEgressAction {
    Allow,
    Deny,
    Log,
    Pass,
...
/// the positive and negative version of a match and both must be satisfied for the rule to match.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StagedGlobalNetworkPolicyEgressIpVersion {
    #[serde(rename = "4")]
    r#_4,
    #[serde(rename = "6")]
    r#_6,
...
pub struct StagedGlobalNetworkPolicyIngress {
    pub action: StagedGlobalNetworkPolicyIngressAction,
    /// Destination contains the match criteria that apply to destination entity.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// the positive and negative version of a match and both must be satisfied for the rule to match.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StagedGlobalNetworkPolicyIngressAction {
    Allow,
    Deny,
    Log,
    Pass,
...
/// the positive and negative version of a match and both must be satisfied for the rule to match.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StagedGlobalNetworkPolicyIngressIpVersion {
    #[serde(rename = "4")]
    r#_4,
    #[serde(rename = "6")]
    r#_6,
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StagedGlobalNetworkPolicyStagedAction {
    Set,
    Delete,
    Learn,
    Ignore,
