...
#[kube(group = "crd.projectcalico.org", version = "v1", kind = "BGPPeer", root = "BgpPeer", plural = "bgppeers")]
...
pub struct BgpPeerSpec {
    ...
    pub next_hop_mode: Option<BgpPeerNextHopMode>,
    ...
    pub reverse_peering: Option<String>,
    ...
    pub source_address: Option<BgpPeerSourceAddress>,
...
/// BGPPeerSpec contains the specification for a BGPPeer resource.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum BgpPeerSourceAddress {
    #[serde(rename = "UseNodeIP")]
    UseNodeIp,
    None,
}
