...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/cloudnative-pg/plugin-barman-cloud/barmancloud.cnpg.io/v1/objectstores.yaml
