...
pub struct KafkaClusterClusterConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "brokerIdPodConfigMapName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metadataManager")]
    pub metadata_manager: Option<KafkaClusterClusterConfigMetadataManager>,
...
/// The settings in the `clusterConfig` are cluster wide settings that do not need to be configurable at role or role group level.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KafkaClusterClusterConfigMetadataManager {
