...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/minio/operator/sts.min.io/v1beta1/policybindings.yaml
...
#[kube(group = "sts.min.io", version = "v1beta1", kind = "PolicyBinding", plural = "policybindings")]
#[kube(namespaced)]
