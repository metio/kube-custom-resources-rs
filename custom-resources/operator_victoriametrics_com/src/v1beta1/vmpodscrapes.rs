...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMPodScrape", root = "VmPodScrape", plural = "vmpodscrapes")]
#[kube(namespaced)]
...
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfig {
    /// Authorization with http header Authorization
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authorization: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigAuthorization>,
    ...
    /// OAuth2 defines auth configuration
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub oauth2: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2>,
    /// TLSConfig configuration to use when scraping the endpoint
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls_config: Option<serde_json::Value>,
}
...
/// Authorization with http header Authorization
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigAuthorization {
    /// Reference to the secret with value for authorization
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigAuthorizationCredentials>,
    /// File with value for authorization
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsFile")]
    pub credentials_file: Option<String>,
    /// Type of authorization, default to bearer
...
/// Reference to the secret with value for authorization
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigAuthorizationCredentials {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// OAuth2 defines auth configuration
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2 {
    /// The secret or configmap containing the OAuth2 client id
    pub client_id: VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientId,
    /// The secret containing the OAuth2 client secret
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client_secret: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientSecret>,
    /// ClientSecretFile defines path for client secret file.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client_secret_file: Option<String>,
    /// Parameters to append to the token URL
...
/// The secret or configmap containing the OAuth2 client id
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientId {
    /// ConfigMap containing data to use for the targets.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMap")]
    pub config_map: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientIdConfigMap>,
    /// Secret containing data to use for the targets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secret: Option<VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientIdSecret>,
}

/// ConfigMap containing data to use for the targets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientIdConfigMap {
    /// The key to select.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// Secret containing data to use for the targets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientIdSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// The secret containing the OAuth2 client secret
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmPodScrapePodMetricsEndpointsVmScrapeParamsProxyClientConfigOauth2ClientSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
