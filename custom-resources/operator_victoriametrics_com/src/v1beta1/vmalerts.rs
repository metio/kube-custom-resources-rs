...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMAlert", root = "VmAlert", plural = "vmalerts")]
#[kube(namespaced)]
...
pub struct VmAlertPodDisruptionBudget {
    ...
    pub unhealthy_pod_eviction_policy: Option<VmAlertPodDisruptionBudgetUnhealthyPodEvictionPolicy>,
}

/// PodDisruptionBudget created by operator
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmAlertPodDisruptionBudgetUnhealthyPodEvictionPolicy {
    IfHealthyBudget,
    AlwaysAllow,
}
