...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMAgent", root = "VmAgent", plural = "vmagents")]
#[kube(namespaced)]
...
pub struct VmAgentSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "daemonSetRollingUpdateStrategyBehavior")]
    pub daemon_set_rolling_update_strategy_behavior: Option<VmAgentDaemonSetRollingUpdateStrategyBehavior>,
    ...
    pub daemon_set_update_strategy: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "statefulRollingUpdateStrategyBehavior")]
    pub stateful_rolling_update_strategy_behavior: Option<VmAgentStatefulRollingUpdateStrategyBehavior>,
...
/// It applies if the DaemonSetUpdateStrategy is set to RollingUpdate, which is the default.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentDaemonSetRollingUpdateStrategyBehavior {
...
/// Configures horizontal pod autoscaling.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpa {
    /// HorizontalPodAutoscalerBehavior configures the scaling behavior of the target
    /// in both Up and Down directions (scaleUp and scaleDown fields respectively).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub behaviour: Option<VmAgentHpaBehaviour>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxReplicas")]
    pub max_replicas: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metrics: Option<Vec<VmAgentHpaMetrics>>,
...
pub struct VmAgentHpaBehaviour {
    ...
    pub scale_up: Option<VmAgentHpaBehaviourScaleUp>,
}
...
/// the last 300sec is used).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaBehaviourScaleDown {
    /// policies is a list of potential scaling polices which can be used during scaling.
    /// If not set, use the default values:
    /// - For scale up: allow doubling the number of pods, or an absolute change of 4 pods in a 15s window.
    /// - For scale down: allow all pods to be removed in a 15s window.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policies: Option<Vec<VmAgentHpaBehaviourScaleDownPolicies>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaBehaviourScaleDownPolicies {
...
/// No stabilization is used.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaBehaviourScaleUp {
    /// policies is a list of potential scaling polices which can be used during scaling.
    /// If not set, use the default values:
    /// - For scale up: allow doubling the number of pods, or an absolute change of 4 pods in a 15s window.
    /// - For scale down: allow all pods to be removed in a 15s window.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policies: Option<Vec<VmAgentHpaBehaviourScaleUpPolicies>>,
    /// selectPolicy is used to specify which policy should be used.
    /// If not set, the default value Max is used.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectPolicy")]
    pub select_policy: Option<String>,
...
/// HPAScalingPolicy is a single policy which must hold true for a specified past interval.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaBehaviourScaleUpPolicies {
    /// periodSeconds specifies the window of time for which the policy should hold true.
    /// PeriodSeconds must be greater than zero and less than or equal to 1800 (30 min).
    #[serde(rename = "periodSeconds")]
    pub period_seconds: i32,
...
pub struct VmAgentHpaMetrics {
    ...
    pub container_resource: Option<VmAgentHpaMetricsContainerResource>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub external: Option<VmAgentHpaMetricsExternal>,
    /// object refers to a metric describing a single kubernetes object
    /// (for example, hits-per-second on an Ingress object).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub object: Option<VmAgentHpaMetricsObject>,
    /// pods refers to a metric describing each pod in the current scale target
    /// (for example, transactions-processed-per-second).  The values will be
    /// averaged together before being compared to the target value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pods: Option<VmAgentHpaMetricsPods>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resource: Option<VmAgentHpaMetricsResource>,
...
/// available to normal per-pod metrics using the "pods" source.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsContainerResource {
    /// container is the name of the container in the pods of the scaling target
    pub container: String,
    /// name is the name of the resource in question.
    pub name: String,
    /// target specifies the target value for the given metric
    pub target: VmAgentHpaMetricsContainerResourceTarget,
}

/// target specifies the target value for the given metric
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsContainerResourceTarget {
...
/// QPS from loadbalancer running outside of cluster).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsExternal {
    /// metric identifies the target metric by name and selector
    pub metric: VmAgentHpaMetricsExternalMetric,
    /// target specifies the target value for the given metric
    pub target: VmAgentHpaMetricsExternalTarget,
}

/// metric identifies the target metric by name and selector
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsExternalMetric {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<VmAgentHpaMetricsExternalMetricSelector>,
}
...
/// When unset, just the metricName will be used to gather metrics.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsExternalMetricSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmAgentHpaMetricsExternalMetricSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsExternalMetricSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// target specifies the target value for the given metric
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsExternalTarget {
    /// averageUtilization is the target value of the average of the
    /// resource metric across all relevant pods, represented as a percentage of
    /// the requested value of the resource for the pods.
    /// Currently only valid for Resource metric source type
...
/// (for example, hits-per-second on an Ingress object).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObject {
    /// describedObject specifies the descriptions of a object,such as kind,name apiVersion
    #[serde(rename = "describedObject")]
    pub described_object: VmAgentHpaMetricsObjectDescribedObject,
    /// metric identifies the target metric by name and selector
    pub metric: VmAgentHpaMetricsObjectMetric,
    /// target specifies the target value for the given metric
    pub target: VmAgentHpaMetricsObjectTarget,
}

/// describedObject specifies the descriptions of a object,such as kind,name apiVersion
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObjectDescribedObject {
...
/// metric identifies the target metric by name and selector
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObjectMetric {
    /// name is the name of the given metric
    pub name: String,
    /// selector is the string-encoded form of a standard kubernetes label selector for the given metric
    /// When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping.
    /// When unset, just the metricName will be used to gather metrics.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<VmAgentHpaMetricsObjectMetricSelector>,
}
...
/// When unset, just the metricName will be used to gather metrics.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObjectMetricSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmAgentHpaMetricsObjectMetricSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObjectMetricSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// target specifies the target value for the given metric
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsObjectTarget {
    /// averageUtilization is the target value of the average of the
    /// resource metric across all relevant pods, represented as a percentage of
    /// the requested value of the resource for the pods.
    /// Currently only valid for Resource metric source type
...
/// averaged together before being compared to the target value.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsPods {
    /// metric identifies the target metric by name and selector
    pub metric: VmAgentHpaMetricsPodsMetric,
    /// target specifies the target value for the given metric
    pub target: VmAgentHpaMetricsPodsTarget,
}

/// metric identifies the target metric by name and selector
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsPodsMetric {
    /// name is the name of the given metric
    pub name: String,
    /// selector is the string-encoded form of a standard kubernetes label selector for the given metric
    /// When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping.
    /// When unset, just the metricName will be used to gather metrics.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<VmAgentHpaMetricsPodsMetricSelector>,
}
...
/// When unset, just the metricName will be used to gather metrics.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsPodsMetricSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmAgentHpaMetricsPodsMetricSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsPodsMetricSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// target specifies the target value for the given metric
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsPodsTarget {
    /// averageUtilization is the target value of the average of the
    /// resource metric across all relevant pods, represented as a percentage of
    /// the requested value of the resource for the pods.
    /// Currently only valid for Resource metric source type
...
/// to normal per-pod metrics using the "pods" source.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsResource {
    /// name is the name of the resource in question.
    pub name: String,
    /// target specifies the target value for the given metric
    pub target: VmAgentHpaMetricsResourceTarget,
}

/// target specifies the target value for the given metric
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentHpaMetricsResourceTarget {
    /// averageUtilization is the target value of the average of the
    /// resource metric across all relevant pods, represented as a percentage of
    /// the requested value of the resource for the pods.
    /// Currently only valid for Resource metric source type
...
/// It applies if the RollingUpdateStrategy is set to OnDelete, which is the default.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAgentStatefulRollingUpdateStrategyBehavior {
