...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMUser", root = "VmUser", plural = "vmusers")]
#[kube(namespaced)]
...
/// JWT defines JWT based auth for a user
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmUserJwt {
    /// MatchClaims enables claim based routing
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchClaims")]
    pub match_claims: Option<BTreeMap<String, String>>,
    /// OIDC defines OIDC configuration section
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub oidc: Option<VmUserJwtOidc>,
    /// PublicKeyRefs defines a list of Secret selectors that reference public keys
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicKeyRefs")]
    pub public_key_refs: Option<Vec<VmUserJwtPublicKeyRefs>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmUserJwtPublicKeyRefs {
...
pub struct VmUserTargetRefsCrd {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub objects: Option<Vec<VmUserTargetRefsCrdObjects>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmUserTargetRefsCrdObjects {
    /// Name of the target Kubernetes object
    pub name: String,
    /// Namespace of the target Kubernetes object
    pub namespace: String,
