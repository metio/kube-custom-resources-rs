...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMAlertmanagerConfig", root = "VmAlertmanagerConfig", plural = "vmalertmanagerconfigs")]
#[kube(namespaced)]
...
pub struct VmAlertmanagerConfigReceivers {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mattermost_configs: Option<Vec<VmAlertmanagerConfigReceiversMattermostConfigs>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VmAlertmanagerConfigReceiversDiscordConfigsHttpConfig {
    ...
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversDiscordConfigsHttpConfigProxyConnectHeader>>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversDiscordConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigs {
    /// Attachments defines richer formatting options
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub attachments: Option<Vec<VmAlertmanagerConfigReceiversMattermostConfigsAttachments>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub priority: Option<VmAlertmanagerConfigReceiversMattermostConfigsPriority>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub props: Option<VmAlertmanagerConfigReceiversMattermostConfigsProps>,
    /// SendResolved controls notify about resolved alerts.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub send_resolved: Option<bool>,
    ...
    /// one of `urlSecret` and `url` must be defined.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url_secret: Option<VmAlertmanagerConfigReceiversMattermostConfigsUrlSecret>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigsAttachments {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub fields: Option<Vec<VmAlertmanagerConfigReceiversMattermostConfigsAttachmentsFields>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigsAttachmentsFields {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigsPriority {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigsProps {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// one of `urlSecret` and `url` must be defined.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMattermostConfigsUrlSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct VmAlertmanagerConfigReceiversMsteamsConfigsHttpConfig {
    ...
    /// ProxyConnectHeader optionally specifies headers to send to proxies during CONNECT requests.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyConnectHeader")]
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversMsteamsConfigsHttpConfigProxyConnectHeader>>>,
    /// ProxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyFromEnvironment")]
    pub proxy_from_environment: Option<bool>,
    /// ProxyUrl defines the HTTP proxy server to use.
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversMsteamsConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct VmAlertmanagerConfigReceiversSlackConfigs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub update_message: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub username: Option<String>,
}
...
pub struct VmAlertmanagerConfigReceiversSnsConfigsHttpConfig {
    ...
    /// ProxyConnectHeader optionally specifies headers to send to proxies during CONNECT requests.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyConnectHeader")]
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversSnsConfigsHttpConfigProxyConnectHeader>>>,
    /// ProxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyFromEnvironment")]
    pub proxy_from_environment: Option<bool>,
    /// ProxyUrl defines the HTTP proxy server to use.
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversSnsConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct VmAlertmanagerConfigReceiversVictoropsConfigsHttpConfig {
    ...
    /// ProxyConnectHeader optionally specifies headers to send to proxies during CONNECT requests.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyConnectHeader")]
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversVictoropsConfigsHttpConfigProxyConnectHeader>>>,
    /// ProxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyFromEnvironment")]
    pub proxy_from_environment: Option<bool>,
    /// ProxyUrl defines the HTTP proxy server to use.
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversVictoropsConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct VmAlertmanagerConfigReceiversWebexConfigsHttpConfig {
    ...
    /// ProxyConnectHeader optionally specifies headers to send to proxies during CONNECT requests.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyConnectHeader")]
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversWebexConfigsHttpConfigProxyConnectHeader>>>,
    /// ProxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyFromEnvironment")]
    pub proxy_from_environment: Option<bool>,
    /// ProxyUrl defines the HTTP proxy server to use.
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversWebexConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
pub struct VmAlertmanagerConfigReceiversWechatConfigsHttpConfig {
    ...
    /// ProxyConnectHeader optionally specifies headers to send to proxies during CONNECT requests.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyConnectHeader")]
    pub proxy_connect_header: Option<BTreeMap<String, Vec<VmAlertmanagerConfigReceiversWechatConfigsHttpConfigProxyConnectHeader>>>,
    /// ProxyFromEnvironment defines whether to use the proxy configuration defined by environment variables (HTTP_PROXY, HTTPS_PROXY, and NO_PROXY).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "proxyFromEnvironment")]
    pub proxy_from_environment: Option<bool>,
    /// ProxyUrl defines the HTTP proxy server to use.
...
/// SecretKeySelector selects a key of a Secret.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerConfigReceiversWechatConfigsHttpConfigProxyConnectHeader {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
