...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMProbe", root = "VmProbe", plural = "vmprobes")]
#[kube(namespaced)]
...
pub struct VmProbeTargets {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub kubernetes: Option<Vec<VmProbeTargetsKubernetes>>,
    ...
    pub r#static: Option<VmProbeTargetsStatic>,
...
pub struct VmProbeTargetsIngress {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub role: Option<VmProbeTargetsIngressRole>,
...
/// Ingress defines the set of dynamically discovered Ingress objects which hosts are considered for probing.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmProbeTargetsIngressRole {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsKubernetes {
    /// Select k8s objects by namespace.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "namespaceSelector")]
    pub namespace_selector: Option<VmProbeTargetsKubernetesNamespaceSelector>,
    /// RelabelConfigs to apply to samples during service discovery.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "relabelingConfigs")]
    pub relabeling_configs: Option<Vec<VmProbeTargetsKubernetesRelabelingConfigs>>,
    /// Role defines k8s role name
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub role: Option<VmProbeTargetsKubernetesRole>,
    /// Select k8s objects by labels.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<VmProbeTargetsKubernetesSelector>,
}

/// Select k8s objects by namespace.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsKubernetesNamespaceSelector {
    /// Boolean describing whether all namespaces are selected in contrast to a
    /// list restricting them.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub any: Option<bool>,
...
/// More info: <https://docs.victoriametrics.com/victoriametrics/#relabeling>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsKubernetesRelabelingConfigs {
    /// Action to perform based on regex matching. Default is 'replace'
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub action: Option<String>,
    /// If represents metricsQL match expression (or list of expressions): '{__name__=~"foo_.*"}'
...
/// VMProbeTargetKubernetes defines the set of k8s objects considered for probing.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmProbeTargetsKubernetesRole {
    #[serde(rename = "service")]
    Service,
    #[serde(rename = "ingress")]
    Ingress,
...
/// Select k8s objects by labels.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsKubernetesSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmProbeTargetsKubernetesSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsKubernetesSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// Static defines static targets which are considers for probing.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsStatic {
    /// Labels assigned to all metrics scraped from the targets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub labels: Option<BTreeMap<String, String>>,
    /// RelabelConfigs to apply to samples during service discovery.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "relabelingConfigs")]
    pub relabeling_configs: Option<Vec<VmProbeTargetsStaticRelabelingConfigs>>,
...
/// More info: <https://docs.victoriametrics.com/victoriametrics/#relabeling>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeTargetsStaticRelabelingConfigs {
    /// Action to perform based on regex matching. Default is 'replace'
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub action: Option<String>,
    /// If represents metricsQL match expression (or list of expressions): '{__name__=~"foo_.*"}'
...
pub struct VmProbeVmScrapeParamsProxyClientConfig {
    /// Authorization with http header Authorization
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authorization: Option<VmProbeVmScrapeParamsProxyClientConfigAuthorization>,
    ...
    /// OAuth2 defines auth configuration
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub oauth2: Option<VmProbeVmScrapeParamsProxyClientConfigOauth2>,
    /// TLSConfig configuration to use when scraping the endpoint
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls_config: Option<serde_json::Value>,
}
...
/// Authorization with http header Authorization
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigAuthorization {
    /// Reference to the secret with value for authorization
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub credentials: Option<VmProbeVmScrapeParamsProxyClientConfigAuthorizationCredentials>,
    /// File with value for authorization
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsFile")]
    pub credentials_file: Option<String>,
    /// Type of authorization, default to bearer
...
/// Reference to the secret with value for authorization
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigAuthorizationCredentials {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// OAuth2 defines auth configuration
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigOauth2 {
    /// The secret or configmap containing the OAuth2 client id
    pub client_id: VmProbeVmScrapeParamsProxyClientConfigOauth2ClientId,
    /// The secret containing the OAuth2 client secret
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client_secret: Option<VmProbeVmScrapeParamsProxyClientConfigOauth2ClientSecret>,
    /// ClientSecretFile defines path for client secret file.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client_secret_file: Option<String>,
    /// Parameters to append to the token URL
...
/// The secret or configmap containing the OAuth2 client id
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigOauth2ClientId {
    /// ConfigMap containing data to use for the targets.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMap")]
    pub config_map: Option<VmProbeVmScrapeParamsProxyClientConfigOauth2ClientIdConfigMap>,
    /// Secret containing data to use for the targets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub secret: Option<VmProbeVmScrapeParamsProxyClientConfigOauth2ClientIdSecret>,
}

/// ConfigMap containing data to use for the targets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigOauth2ClientIdConfigMap {
    /// The key to select.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// Secret containing data to use for the targets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigOauth2ClientIdSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// The secret containing the OAuth2 client secret
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmProbeVmScrapeParamsProxyClientConfigOauth2ClientSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
