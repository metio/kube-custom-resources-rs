...
#[kube(group = "operator.victoriametrics.com", version = "v1beta1", kind = "VMAlertmanager", root = "VmAlertmanager", plural = "vmalertmanagers")]
#[kube(namespaced)]
...
pub struct VmAlertmanagerSpec {
    ...
    pub arbitrary_fs_access_through_s_ms: Option<VmAlertmanagerArbitraryFsAccessThroughSMs>,
    ...
    pub tracing_config: Option<VmAlertmanagerTracingConfig>,
...
pub struct VmAlertmanagerArbitraryFsAccessThroughSMs {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct VmAlertmanagerPodDisruptionBudget {
    ...
    pub unhealthy_pod_eviction_policy: Option<VmAlertmanagerPodDisruptionBudgetUnhealthyPodEvictionPolicy>,
}

/// PodDisruptionBudget created by operator
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmAlertmanagerPodDisruptionBudgetUnhealthyPodEvictionPolicy {
    IfHealthyBudget,
    AlwaysAllow,
}
...
/// TracingConfig defines tracing configuration for Alertmanager
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerTracingConfig {
    /// ClientType defines tracing client protocol
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub client_type: Option<VmAlertmanagerTracingConfigClientType>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls_config: Option<VmAlertmanagerTracingConfigTlsConfig>,
}

/// TracingConfig defines tracing configuration for Alertmanager
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmAlertmanagerTracingConfigClientType {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "grpc")]
    Grpc,
...
/// TLSConfig defines tracing TLS config
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerTracingConfigTlsConfig {
    /// CAFile defines path to the pre-mounted file with CA
    /// mutually exclusive with CASecretRef
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca_file: Option<String>,
    ...
    /// mutually exclusive with CAFile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ca_secret_ref: Option<VmAlertmanagerTracingConfigTlsConfigCaSecretRef>,
    /// CertFile defines path to the pre-mounted file with certificate
    /// mutually exclusive with CertSecretRef
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cert_file: Option<String>,
    ...
    /// mutually exclusive with CertFile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cert_secret_ref: Option<VmAlertmanagerTracingConfigTlsConfigCertSecretRef>,
    /// Cert defines reference for secret with CA content under given key
    /// mutually exclusive with CertFile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub insecure_skip_verify: Option<bool>,
    ...
    /// mutually exclusive with KeyFile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub key_secret_ref: Option<VmAlertmanagerTracingConfigTlsConfigKeySecretRef>,
    /// ServerName indicates a name of a server
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub server_name: Option<String>,
}
...
/// mutually exclusive with CAFile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerTracingConfigTlsConfigCaSecretRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// mutually exclusive with CertFile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerTracingConfigTlsConfigCertSecretRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// mutually exclusive with KeyFile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAlertmanagerTracingConfigTlsConfigKeySecretRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
