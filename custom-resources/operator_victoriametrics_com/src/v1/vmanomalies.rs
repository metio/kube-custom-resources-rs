...
#[kube(group = "operator.victoriametrics.com", version = "v1", kind = "VMAnomaly", root = "VmAnomaly", plural = "vmanomalies")]
#[kube(namespaced)]
...
pub struct VmAnomalySpec {
    ...
    pub config_namespace_selector: Option<VmAnomalyConfigNamespaceSelector>,
    ...
    pub config_selector: Option<VmAnomalyConfigSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub server: Option<VmAnomalyServer>,
...
/// ConfigNamespaceSelector defines VMAnomalyConfig object namespace selector.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAnomalyConfigNamespaceSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmAnomalyConfigNamespaceSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAnomalyConfigNamespaceSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// ConfigSelector defines VMAnomalyConfig object selector.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAnomalyConfigSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VmAnomalyConfigSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VmAnomalyConfigSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
pub struct VmAnomalyPodDisruptionBudget {
    ...
    pub unhealthy_pod_eviction_policy: Option<VmAnomalyPodDisruptionBudgetUnhealthyPodEvictionPolicy>,
}

/// PodDisruptionBudget created by operator
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VmAnomalyPodDisruptionBudgetUnhealthyPodEvictionPolicy {
    IfHealthyBudget,
    AlwaysAllow,
}
...
pub struct VmAnomalyServer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "uiDefaultState")]
    pub ui_default_state: Option<String>,
}
