...
pub struct VMAnomalySpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub containers: Option<Vec<VMAnomalyContainers>>,
    ...
    pub init_containers: Option<Vec<VMAnomalyInitContainers>>,
    ...
    pub topology_spread_constraints: Option<Vec<VMAnomalyTopologySpreadConstraints>>,
    ...
    /// / +optional
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub volumes: Option<Vec<VMAnomalyVolumes>>,
