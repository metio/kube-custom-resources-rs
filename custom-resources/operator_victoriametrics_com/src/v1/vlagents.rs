...
#[kube(group = "operator.victoriametrics.com", version = "v1", kind = "VLAgent", root = "VlAgent", plural = "vlagents")]
#[kube(namespaced)]
...
pub struct VlAgentSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "k8sCollector")]
    pub k8s_collector: Option<VlAgentK8sCollector>,
    /// License allows to configure license key to be used for enterprise features.
    /// See [here](<https://docs.victoriametrics.com/victoriametrics/enterprise/#victorialogs-enterprise-features)>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub license: Option<VlAgentLicense>,
...
/// K8sCollector configures VLAgent logs collection from K8s pods
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlAgentK8sCollector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checkpointsPath")]
    ...
    pub decolorize_fields: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extraFields")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeNodeAnnotations")]
    pub include_node_annotations: Option<bool>,
    /// IncludeNodeLabels enables attachment of node labels to log entries
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeNodeLabels")]
    pub include_node_labels: Option<bool>,
    /// IncludePodAnnotations enables attachment of pod annotations to log entries
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includePodAnnotations")]
    pub include_pod_annotations: Option<bool>,
    /// IncludePodLabels enables attachment of pod labels to log entries
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includePodLabels")]
    pub include_pod_labels: Option<bool>,
    /// LogsPath configures root for logs path
    /// By default VLAgent collects logs from /var/log/containers
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logsPath")]
    pub logs_path: Option<String>,
    /// MsgField defines fields that may contain the _msg field
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "msgFields")]
    pub msg_fields: Option<Vec<String>>,
    ...
    pub stream_fields: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeFields")]
...
pub struct VlAgentLicense {
    ...
    pub key_ref: Option<VlAgentLicenseKeyRef>,
...
/// KeyRef is reference to secret with license key for enterprise features.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlAgentLicenseKeyRef {
...
pub struct VlAgentPodDisruptionBudget {
    ...
    pub unhealthy_pod_eviction_policy: Option<VlAgentPodDisruptionBudgetUnhealthyPodEvictionPolicy>,
}

/// PodDisruptionBudget created by operator
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VlAgentPodDisruptionBudgetUnhealthyPodEvictionPolicy {
    IfHealthyBudget,
    AlwaysAllow,
}
