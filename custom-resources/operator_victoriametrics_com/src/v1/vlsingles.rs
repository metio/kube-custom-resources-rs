...
pub struct VLSingleSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub containers: Option<Vec<VLSingleContainers>>,
    ...
    pub init_containers: Option<Vec<VLSingleInitContainers>>,
    ...
    pub topology_spread_constraints: Option<Vec<VLSingleTopologySpreadConstraints>>,
    ...
    /// / +optional
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub volumes: Option<Vec<VLSingleVolumes>>,
}
