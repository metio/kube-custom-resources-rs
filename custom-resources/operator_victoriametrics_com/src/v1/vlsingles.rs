...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/VictoriaMetrics/operator/operator.victoriametrics.com/v1/vlsingles.yaml
...
#[kube(group = "operator.victoriametrics.com", version = "v1", kind = "VLSingle", root = "VlSingle", plural = "vlsingles")]
#[kube(namespaced)]
#[kube(status = "VlSingleStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct VlSingleSpec {
    ...
    pub dns_config: Option<VlSingleDnsConfig>,
    ...
    pub extra_envs: Option<Vec<VlSingleExtraEnvs>>,
    ...
    pub extra_envs_from: Option<Vec<VlSingleExtraEnvsFrom>>,
    ...
    pub host_aliases: Option<Vec<VlSingleHostAliases>>,
    ...
    pub host_aliases_x: Option<Vec<VlSingleHostAliases>>,
    /// Image - docker image settings
    /// if no specified operator uses default version from operator config
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<VlSingleImage>,
    /// ImagePullSecrets An optional list of references to secrets in the same namespace
    /// to use for pulling images from registries
    /// see <https://kubernetes.io/docs/concepts/containers/images/#referring-to-an-imagepullsecrets-on-a-pod>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "imagePullSecrets")]
    pub image_pull_secrets: Option<Vec<VlSingleImagePullSecrets>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub license: Option<VlSingleLicense>,
    ...
    pub log_format: Option<VlSingleLogFormat>,
    ...
    pub log_level: Option<VlSingleLogLevel>,
    ...
    pub managed_metadata: Option<VlSingleManagedMetadata>,
    ...
    pub pod_metadata: Option<VlSinglePodMetadata>,
    /// Port listen address
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub readiness_gates: Option<Vec<VlSingleReadinessGates>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<VlSingleResources>,
    ...
    pub service_spec: Option<VlSingleServiceSpec>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub storage: Option<VlSingleStorage>,
    ...
    pub volume_mounts: Option<Vec<VlSingleVolumeMounts>>,
...
pub struct VlSingleDnsConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub options: Option<Vec<VlSingleDnsConfigOptions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleDnsConfigOptions {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleExtraEnvsFrom {
    /// The ConfigMap to select from
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapRef")]
    pub config_map_ref: Option<VlSingleExtraEnvsFromConfigMapRef>,
    ...
    pub secret_ref: Option<VlSingleExtraEnvsFromSecretRef>,
}

/// The ConfigMap to select from
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleExtraEnvsFromConfigMapRef {
...
/// The Secret to select from
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleExtraEnvsFromSecretRef {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
...
/// pod's hosts file.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleHostAliases {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleImagePullSecrets {
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
    /// allowed to be empty. Instances of this type with an empty value here are
    /// almost certainly wrong.
...
pub struct VlSingleLicense {
    ...
    pub key_ref: Option<VlSingleLicenseKeyRef>,
...
/// KeyRef is reference to secret with license key for enterprise features.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleLicenseKeyRef {
...
/// created by operator for the given CustomResource
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleManagedMetadata {
...
/// PodMetadata configures Labels and Annotations which are propagated to the VLSingle pods.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSinglePodMetadata {
    /// Annotations is an unstructured key value map stored with a resource that may be
    /// set by external tools to store and retrieve arbitrary metadata. They are not
    /// queryable and should be preserved when modifying objects.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations>
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleReadinessGates {
...
pub struct VlSingleResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claims: Option<Vec<VlSingleResourcesClaims>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleResourcesClaims {
...
/// ServiceSpec that will be added to vlsingle service spec
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleServiceSpec {
    /// EmbeddedObjectMetadata defines objectMeta for additional service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<VlSingleServiceSpecMetadata>,
...
/// EmbeddedObjectMetadata defines objectMeta for additional service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleServiceSpecMetadata {
    /// Annotations is an unstructured key value map stored with a resource that may be
    /// set by external tools to store and retrieve arbitrary metadata. They are not
    /// queryable and should be preserved when modifying objects.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations>
...
pub struct VlSingleStorage {
    ...
    pub data_source: Option<VlSingleStorageDataSource>,
    ...
    pub data_source_ref: Option<VlSingleStorageDataSourceRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<VlSingleStorageResources>,
    /// selector is a label query over volumes to consider for binding.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<VlSingleStorageSelector>,
...
/// If the namespace is specified, then dataSourceRef will not be copied to dataSource.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageDataSource {
...
/// (Alpha) Using the namespace field of dataSourceRef requires the CrossNamespaceVolumeDataSource feature gate to be enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageDataSourceRef {
    /// APIGroup is the group for the resource being referenced.
    /// If APIGroup is not specified, the specified Kind must be in the core API group.
    /// For any other third-party types, APIGroup is required.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiGroup")]
...
/// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources>
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageResources {
    /// Limits describes the maximum amount of compute resources allowed.
    /// More info: <https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<BTreeMap<String, IntOrString>>,
...
/// selector is a label query over volumes to consider for binding.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VlSingleStorageSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageSelectorMatchExpressions {
...
/// StorageMeta defines annotations and labels attached to PVC for given vlsingle CR
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleStorageMetadata {
    /// Annotations is an unstructured key value map stored with a resource that may be
    /// set by external tools to store and retrieve arbitrary metadata. They are not
    /// queryable and should be preserved when modifying objects.
    /// More info: <https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations>
...
pub struct VlSingleSyslogSpec {
    ...
    pub tcp_listeners: Option<Vec<VlSingleSyslogSpecTcpListeners>>,
    ...
    pub udp_listeners: Option<Vec<VlSingleSyslogSpecUdpListeners>>,
}

/// SyslogTCPListener defines configuration for TCP syslog server listen
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleSyslogSpecTcpListeners {
    ...
    pub tls_config: Option<VlSingleSyslogSpecTcpListenersTlsConfig>,
}

/// TLSServerConfig defines VictoriaMetrics TLS configuration for the application's server
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleSyslogSpecTcpListenersTlsConfig {
    ...
    pub cert_secret: Option<VlSingleSyslogSpecTcpListenersTlsConfigCertSecret>,
    ...
    pub key_secret: Option<VlSingleSyslogSpecTcpListenersTlsConfigKeySecret>,
}

/// CertSecretRef defines reference for secret with certificate content under given key
/// mutually exclusive with CertFile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleSyslogSpecTcpListenersTlsConfigCertSecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
/// mutually exclusive with KeyFile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleSyslogSpecTcpListenersTlsConfigKeySecret {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleSyslogSpecUdpListeners {
    /// CompressMethod for syslog messages
    /// see <https://docs.victoriametrics.com/victorialogs/data-ingestion/syslog/#compression>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "compressMethod")]
    pub compress_method: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleTolerations {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VlSingleVolumeMounts {
