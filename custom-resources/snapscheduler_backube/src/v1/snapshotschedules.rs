...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/backube/snapscheduler/snapscheduler.backube/v1/snapshotschedules.yaml
