...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/furiko-io/furiko/execution.furiko.io/v1alpha1/jobs.yaml
...
pub struct JobStatusConditionFinished {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "latestCreationTimestamp"
    )]
