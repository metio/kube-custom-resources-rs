...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/furiko-io/furiko/execution.furiko.io/v1alpha1/jobconfigs.yaml
...
pub struct JobConfigTemplateSpecParallelism {
    ...
    pub with_matrix: Option<BTreeMap<String, Vec<String>>>,
}
