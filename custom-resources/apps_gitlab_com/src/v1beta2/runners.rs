...
pub struct RunnerSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deploymentSpec")]
...
/// KubernetesDeploymentSpec represents the structure expected when adding a custom DeploymentSpec to configure
/// the Deployment running the GitLab Runner Manager
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RunnerDeploymentSpec {
    /// Name is the name given to the custom Deployment Spec
    pub name: String,
    /// A JSON or YAML format string that describes the changes which must be applied
    /// to the final DeploymentSpec object before it is generated.
    /// You cannot set the patch_path and patch in the same deployment_spec configuration, otherwise an error occurs.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub patch: Option<String>,
    /// Path to the file that defines the changes to apply to the final DeploymentSpec object before it is generated.
    /// The file must be a JSON or YAML file.
    /// You cannot set the patch_path and patch in the same deployment_spec configuration, otherwise an error occurs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "patchFile")]
    pub patch_file: Option<String>,
    /// The strategy the runner uses to apply the specified changes to the DeploymentSpec object generated by GitLab Runner.
