...
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooks>,
...
/// cluster-level hooks to execute before and after cluster reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooks {
    /// actions to execute after cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPost>>,
    /// actions to execute before cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPost {
    ...
    pub failure_policy: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPre {
    /// Cluster-scope reconcile lifecycle events. Required, non-empty.
    ///   Any              - wildcard match: fires on every cluster reconcile pass
    ///                      and the cluster delete sweep
    ///   ClusterCreate    - all hosts in the cluster are new (no ancestor); fires
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHost {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooks>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// hooks to execute before and after host reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooks {
    /// actions to execute after reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPost>>,
    /// actions to execute before reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPost {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPre {
    /// Reconcile lifecycle events that trigger this hook. Required, must be non-empty.
    /// The hook is skipped on any reconcile whose classifier does not emit at least one
    /// of the listed events. Supported values:
    ///   Any               - wildcard match: fires on every hook-evaluation point,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersReconcileHostHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
pub struct ClickHouseInstallationTemplateConfigurationClustersZookeeper {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keeper: Option<ClickHouseInstallationTemplateConfigurationClustersZookeeperKeeper>,
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationClustersZookeeperKeeper {
    ...
    pub service_type: Option<ClickHouseInstallationTemplateConfigurationClustersZookeeperKeeperServiceType>,
}
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationClustersZookeeperKeeperServiceType {
    #[serde(rename = "")]
    KopiumEmpty,
    Replicas,
...
pub struct ClickHouseInstallationTemplateConfigurationZookeeper {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keeper: Option<ClickHouseInstallationTemplateConfigurationZookeeperKeeper>,
    /// describe every available zookeeper cluster node for interaction
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateConfigurationZookeeperKeeper {
    /// name of the ClickHouseKeeperInstallation custom resource
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// namespace of the CHK resource, defaults to the CHI namespace if omitted
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceType")]
    pub service_type: Option<ClickHouseInstallationTemplateConfigurationZookeeperKeeperServiceType>,
}
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateConfigurationZookeeperKeeperServiceType {
    #[serde(rename = "")]
    KopiumEmpty,
    Replicas,
    #[serde(rename = "replicas")]
...
pub struct ClickHouseInstallationTemplateReconcile {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster: Option<ClickHouseInstallationTemplateReconcileCluster>,
    ...
    pub stateful_set: Option<ClickHouseInstallationTemplateReconcileStatefulSet>,
}
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileCluster {
    /// cluster-level hooks inherited by every cluster
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateReconcileClusterHooks>,
}

/// cluster-level hooks inherited by every cluster
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooks {
    /// actions to execute after each cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateReconcileClusterHooksPost>>,
    /// actions to execute before each cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateReconcileClusterHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPost {
    /// Cluster-scope reconcile lifecycle events. Required, non-empty.
    ///   Any              - wildcard match: fires on every cluster reconcile pass
    ///                      and the cluster delete sweep
    ///   ClusterCreate    - all hosts in the cluster are new (no ancestor); fires
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcileClusterHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcileClusterHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcileClusterHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcileClusterHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcileClusterHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileClusterHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileClusterHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPre {
    /// Cluster-scope reconcile lifecycle events. Required, non-empty.
    ///   Any              - wildcard match: fires on every cluster reconcile pass
    ///                      and the cluster delete sweep
    ///   ClusterCreate    - all hosts in the cluster are new (no ancestor); fires
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcileClusterHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcileClusterHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcileClusterHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcileClusterHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcileClusterHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileClusterHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileClusterHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileClusterHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
pub struct ClickHouseInstallationTemplateReconcileHost {
    ...
    /// hooks to execute before and after host reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateReconcileHostHooks>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// hooks to execute before and after host reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooks {
    /// actions to execute after reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateReconcileHostHooksPost>>,
    /// actions to execute before reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateReconcileHostHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPost {
    /// Reconcile lifecycle events that trigger this hook. Required, must be non-empty.
    /// The hook is skipped on any reconcile whose classifier does not emit at least one
    /// of the listed events. Supported values:
    ///   Any               - wildcard match: fires on every hook-evaluation point,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcileHostHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcileHostHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcileHostHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcileHostHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcileHostHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileHostHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileHostHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPre {
    /// Reconcile lifecycle events that trigger this hook. Required, must be non-empty.
    /// The hook is skipped on any reconcile whose classifier does not emit at least one
    /// of the listed events. Supported values:
    ///   Any               - wildcard match: fires on every hook-evaluation point,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcileHostHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcileHostHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcileHostHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcileHostHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcileHostHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileHostHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileHostHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileHostHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
/// Optional, StatefulSet reconcile behavior tuning
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileStatefulSet {
    /// Behavior during create StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub create: Option<ClickHouseInstallationTemplateReconcileStatefulSetCreate>,
    /// Behavior during recreate StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recreate: Option<ClickHouseInstallationTemplateReconcileStatefulSetRecreate>,
    /// Behavior during update StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub update: Option<ClickHouseInstallationTemplateReconcileStatefulSetUpdate>,
}

/// Behavior during create StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileStatefulSetCreate {
    ...
    pub on_failure: Option<ClickHouseInstallationTemplateReconcileStatefulSetCreateOnFailure>,
}

/// Behavior during create StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileStatefulSetCreateOnFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileStatefulSetRecreate {
    ...
    pub on_data_loss: Option<ClickHouseInstallationTemplateReconcileStatefulSetRecreateOnDataLoss>,
    ...
    pub on_update_failure: Option<ClickHouseInstallationTemplateReconcileStatefulSetRecreateOnUpdateFailure>,
}

/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileStatefulSetRecreateOnDataLoss {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileStatefulSetRecreateOnUpdateFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during update StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcileStatefulSetUpdate {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onFailure")]
    pub on_failure: Option<ClickHouseInstallationTemplateReconcileStatefulSetUpdateOnFailure>,
...
/// Behavior during update StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcileStatefulSetUpdateOnFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
pub struct ClickHouseInstallationTemplateReconciling {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster: Option<ClickHouseInstallationTemplateReconcilingCluster>,
    /// Timeout in seconds for `clickhouse-operator` to wait for modified `ConfigMap` to propagate into the `Pod`
    /// More details: <https://kubernetes.io/docs/concepts/configuration/configmap/#mounted-configmaps-are-updated-automatically>
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configMapPropagationTimeout")]
    ...
    /// Optional, StatefulSet reconcile behavior tuning
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "statefulSet")]
    pub stateful_set: Option<ClickHouseInstallationTemplateReconcilingStatefulSet>,
}
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingCluster {
    /// cluster-level hooks inherited by every cluster
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateReconcilingClusterHooks>,
}

/// cluster-level hooks inherited by every cluster
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooks {
    /// actions to execute after each cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateReconcilingClusterHooksPost>>,
    /// actions to execute before each cluster reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateReconcilingClusterHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPost {
    /// Cluster-scope reconcile lifecycle events. Required, non-empty.
    ///   Any              - wildcard match: fires on every cluster reconcile pass
    ///                      and the cluster delete sweep
    ///   ClusterCreate    - all hosts in the cluster are new (no ancestor); fires
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingClusterHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingClusterHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPre {
    /// Cluster-scope reconcile lifecycle events. Required, non-empty.
    ///   Any              - wildcard match: fires on every cluster reconcile pass
    ///                      and the cluster delete sweep
    ///   ClusterCreate    - all hosts in the cluster are new (no ancestor); fires
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcilingClusterHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingClusterHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingClusterHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingClusterHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
pub struct ClickHouseInstallationTemplateReconcilingHost {
    ...
    /// hooks to execute before and after host reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseInstallationTemplateReconcilingHostHooks>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// hooks to execute before and after host reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooks {
    /// actions to execute after reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseInstallationTemplateReconcilingHostHooksPost>>,
    /// actions to execute before reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseInstallationTemplateReconcilingHostHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPost {
    /// Reconcile lifecycle events that trigger this hook. Required, must be non-empty.
    /// The hook is skipped on any reconcile whose classifier does not emit at least one
    /// of the listed events. Supported values:
    ///   Any               - wildcard match: fires on every hook-evaluation point,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcilingHostHooksPostFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcilingHostHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcilingHostHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcilingHostHooksPostSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcilingHostHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingHostHooksPostFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingHostHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPre {
    /// Reconcile lifecycle events that trigger this hook. Required, must be non-empty.
    /// The hook is skipped on any reconcile whose classifier does not emit at least one
    /// of the listed events. Supported values:
    ///   Any               - wildcard match: fires on every hook-evaluation point,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failurePolicy")]
    pub failure_policy: Option<ClickHouseInstallationTemplateReconcilingHostHooksPreFailurePolicy>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseInstallationTemplateReconcilingHostHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseInstallationTemplateReconcilingHostHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseInstallationTemplateReconcilingHostHooksPreSql>,
    /// where to execute hook for cluster-level hooks: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseInstallationTemplateReconcilingHostHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingHostHooksPreFailurePolicy {
    Fail,
    #[serde(rename = "fail")]
    FailX,
    Ignore,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingHostHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingHostHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
/// Optional, StatefulSet reconcile behavior tuning
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingStatefulSet {
    /// Behavior during create StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub create: Option<ClickHouseInstallationTemplateReconcilingStatefulSetCreate>,
    /// Behavior during recreate StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recreate: Option<ClickHouseInstallationTemplateReconcilingStatefulSetRecreate>,
    /// Behavior during update StatefulSet
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub update: Option<ClickHouseInstallationTemplateReconcilingStatefulSetUpdate>,
}

/// Behavior during create StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingStatefulSetCreate {
    /// What to do in case created StatefulSet is not in 'Ready' after `reconcile.statefulSet.update.timeout` seconds.
    /// Possible options:
    /// 1. abort - abort the process, do nothing with the problematic StatefulSet, leave it as it is.
    /// 2. delete - delete newly created problematic StatefulSet and follow 'abort' path afterwards.
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onFailure")]
    pub on_failure: Option<ClickHouseInstallationTemplateReconcilingStatefulSetCreateOnFailure>,
}

/// Behavior during create StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingStatefulSetCreateOnFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingStatefulSetRecreate {
    /// What to do in case operator needs to recreate StatefulSet due to PVC data loss or missing volumes.
    /// Possible options:
    /// 1. abort - abort the process, do nothing with the problematic StatefulSet.
    /// 2. recreate - proceed and recreate StatefulSet.
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDataLoss")]
    pub on_data_loss: Option<ClickHouseInstallationTemplateReconcilingStatefulSetRecreateOnDataLoss>,
    /// What to do in case operator needs to recreate StatefulSet due to update failure or StatefulSet not ready.
    /// Possible options:
    /// 1. abort - abort the process, do nothing with the problematic StatefulSet.
    /// 2. recreate - proceed and recreate StatefulSet.
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onUpdateFailure")]
    pub on_update_failure: Option<ClickHouseInstallationTemplateReconcilingStatefulSetRecreateOnUpdateFailure>,
}

/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingStatefulSetRecreateOnDataLoss {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingStatefulSetRecreateOnUpdateFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
...
/// Behavior during update StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseInstallationTemplateReconcilingStatefulSetUpdate {
    /// What to do in case updated StatefulSet is not in 'Ready' after `reconcile.statefulSet.update.timeout` seconds.
    /// Possible options:
    /// 1. abort - abort the process, do nothing with the problematic StatefulSet, leave it as it is.
    /// 2. rollback - delete Pod and rollback StatefulSet to previous Generation. Follow 'abort' path afterwards.
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onFailure")]
    pub on_failure: Option<ClickHouseInstallationTemplateReconcilingStatefulSetUpdateOnFailure>,
    /// How many seconds to wait between checks for StatefulSet status during update
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pollInterval")]
    pub poll_interval: Option<i64>,
    /// How many seconds to wait for StatefulSet to be 'Ready' during update
...
/// Behavior during update StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseInstallationTemplateReconcilingStatefulSetUpdateOnFailure {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "abort")]
    Abort,
