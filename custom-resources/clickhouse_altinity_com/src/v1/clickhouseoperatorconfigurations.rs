...
pub struct ClickHouseOperatorConfigurationClickhouseMetrics {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludeRegexp")]
    pub exclude_regexp: Option<Vec<String>>,
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tablesRegexp")]
    pub tables_regexp: Option<String>,
...
pub struct ClickHouseOperatorConfigurationReconcile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub coordination: Option<ClickHouseOperatorConfigurationReconcileCoordination>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recovery: Option<ClickHouseOperatorConfigurationReconcileRecovery>,
...
/// Coordination with external systems during reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileCoordination {
    /// Keeper-related coordination settings
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub keeper: Option<ClickHouseOperatorConfigurationReconcileCoordinationKeeper>,
}

/// Keeper-related coordination settings
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileCoordinationKeeper {
    /// Reaction when a referenced CHK resource changes.
    ///   none (default) — do nothing
    ///   reconcile — trigger CHI reconcile
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onKeeperResourceUpdate")]
    pub on_keeper_resource_update: Option<ClickHouseOperatorConfigurationReconcileCoordinationKeeperOnKeeperResourceUpdate>,
...
/// Keeper-related coordination settings
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileCoordinationKeeperOnKeeperResourceUpdate {
    #[serde(rename = "")]
    KopiumEmpty,
    None,
    #[serde(rename = "none")]
...
pub struct ClickHouseOperatorConfigurationReconcileHost {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub drop: Option<ClickHouseOperatorConfigurationReconcileHostDrop>,
    /// default host-level hooks to execute before and after host reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hooks: Option<ClickHouseOperatorConfigurationReconcileHostHooks>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub wait: Option<ClickHouseOperatorConfigurationReconcileHostWait>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostDrop {
    /// Whether the operator during reconcile procedure should drop replicas when replica is deleted or recreated
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub replicas: Option<ClickHouseOperatorConfigurationReconcileHostDropReplicas>,
}

/// Whether the operator during reconcile procedure should drop replicas when replica is deleted or recreated
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostDropReplicas {
    /// Whether the operator during reconcile procedure should drop active replicas when replica is deleted or recreated
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub active: Option<ClickHouseOperatorConfigurationReconcileHostDropReplicasActive>,
    ...
    pub on_delete: Option<ClickHouseOperatorConfigurationReconcileHostDropReplicasOnDelete>,
    ...
    pub on_lost_volume: Option<ClickHouseOperatorConfigurationReconcileHostDropReplicasOnLostVolume>,
}

/// Whether the operator during reconcile procedure should drop replicas when replica is deleted or recreated
/// 
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileHostDropReplicasActive {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "0")]
    r#_0,
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileHostDropReplicasOnDelete {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "0")]
    r#_0,
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileHostDropReplicasOnLostVolume {
    #[serde(rename = "")]
    KopiumEmpty,
    #[serde(rename = "0")]
    r#_0,
...
/// default host-level hooks to execute before and after host reconcile
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooks {
    /// actions to execute after host reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub post: Option<Vec<ClickHouseOperatorConfigurationReconcileHostHooksPost>>,
    /// actions to execute before host reconcile
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pre: Option<Vec<ClickHouseOperatorConfigurationReconcileHostHooksPre>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPost {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseOperatorConfigurationReconcileHostHooksPostHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseOperatorConfigurationReconcileHostHooksPostShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseOperatorConfigurationReconcileHostHooksPostSql>,
    /// where to execute hook: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseOperatorConfigurationReconcileHostHooksPostTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPostHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPostShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPostSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileHostHooksPostTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
    Firsthost,
    AllHosts,
    #[serde(rename = "allhosts")]
    Allhosts,
    AllShards,
    #[serde(rename = "allshards")]
    Allshards,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPre {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<ClickHouseOperatorConfigurationReconcileHostHooksPreHttp>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shell: Option<ClickHouseOperatorConfigurationReconcileHostHooksPreShell>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sql: Option<ClickHouseOperatorConfigurationReconcileHostHooksPreSql>,
    /// where to execute hook: FirstHost (default), AllHosts, AllShards
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<ClickHouseOperatorConfigurationReconcileHostHooksPreTarget>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPreHttp {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPreShell {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub command: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub container: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileHostHooksPreSql {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub queries: Option<Vec<String>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileHostHooksPreTarget {
    #[serde(rename = "")]
    KopiumEmpty,
    FirstHost,
    #[serde(rename = "firsthost")]
...
/// Auto-recovery from reconcile failures, scoped by CHI state
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileRecovery {
    /// Recovery scopes keyed by CHI state being recovered from
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub from: Option<ClickHouseOperatorConfigurationReconcileRecoveryFrom>,
}

/// Recovery scopes keyed by CHI state being recovered from
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileRecoveryFrom {
    /// Recovery from Status=Aborted
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub aborted: Option<ClickHouseOperatorConfigurationReconcileRecoveryFromAborted>,
}

/// Recovery from Status=Aborted
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileRecoveryFromAborted {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onPodReady")]
    pub on_pod_ready: Option<ClickHouseOperatorConfigurationReconcileRecoveryFromAbortedOnPodReady>,
}

/// Recovery from Status=Aborted
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationReconcileRecoveryFromAbortedOnPodReady {
    #[serde(rename = "")]
    KopiumEmpty,
    None,
    #[serde(rename = "none")]
...
pub struct ClickHouseOperatorConfigurationReconcileStatefulSet {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub recreate: Option<ClickHouseOperatorConfigurationReconcileStatefulSetRecreate>,
...
/// Behavior during recreate StatefulSet
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationReconcileStatefulSetRecreate {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDataLoss")]
    pub on_data_loss: Option<String>,
    /// What to do in case operator needs to recreate StatefulSet due to update failure or StatefulSet not ready.
    /// Possible options:
    /// 1. abort - abort the process, do nothing with the problematic StatefulSet.
    /// 2. recreate (default) - proceed and recreate StatefulSet.
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onUpdateFailure")]
...
pub struct ClickHouseOperatorConfigurationWatch {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub configuration: Option<ClickHouseOperatorConfigurationWatchConfiguration>,
...
/// Behavior when ClickHouseOperatorConfiguration resources change
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ClickHouseOperatorConfigurationWatchConfiguration {
    /// none/ignore — do nothing; restart — exit process so the operator pod restarts
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onChange")]
    pub on_change: Option<ClickHouseOperatorConfigurationWatchConfigurationOnChange>,
}

/// Behavior when ClickHouseOperatorConfiguration resources change
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum ClickHouseOperatorConfigurationWatchConfigurationOnChange {
    #[serde(rename = "none")]
    None,
    #[serde(rename = "None")]
    NoneX,
