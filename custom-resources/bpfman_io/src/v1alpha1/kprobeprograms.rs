...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/bpfman/bpfman/bpfman.io/v1alpha1/kprobeprograms.yaml
...
#[kube(group = "bpfman.io", version = "v1alpha1", kind = "KprobeProgram", plural = "kprobeprograms")]
