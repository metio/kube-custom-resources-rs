...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-kubevirt/infrastructure.cluster.x-k8s.io/v1alpha1/kubevirtmachines.yaml
...
pub struct KubevirtMachineVirtualMachineTemplateSpecDataVolumeTemplatesSpecSourceRegistry {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub platform: Option<KubevirtMachineVirtualMachineTemplateSpecDataVolumeTemplatesSpecSourceRegistryPlatform>,
...
/// Platform describes the minimum runtime requirements of the image
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecDataVolumeTemplatesSpecSourceRegistryPlatform {
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpec {
    ...
    pub resource_claims: Option<Vec<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecResourceClaims>>,
    ...
    pub utility_volumes: Option<Vec<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecUtilityVolumes>>,
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecAccessCredentialsSshPublicKeyPropagationMethod {
    ...
    pub no_cloud: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecAccessCredentialsSshPublicKeyPropagationMethodNoCloud>,
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomain {
    ...
    pub io_threads: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainIoThreads>,
    ...
    pub reboot_policy: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainRebootPolicy>,
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevices {
    ...
    pub panic_devices: Option<Vec<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesPanicDevices>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub video: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesVideo>,
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesInterfaces {
    ...
    pub passt_binding: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesInterfacesPasstBinding>,
...
/// version: 1alphav1
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesInterfacesBinding {
...
/// InterfacePasstBinding connects to a given network using passt usermode networking.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesInterfacesPasstBinding {
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesPanicDevices {
...
/// Video describes the video device configuration for the vmi.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesVideo {
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesWatchdog {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub diag288: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesWatchdogDiag288>,
...
/// diag288 watchdog device (specific to s390x architecture).
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainDevicesWatchdogDiag288 {
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFeaturesHypervTlbflush {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direct: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFeaturesHypervTlbflushDirect>,
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub extended: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFeaturesHypervTlbflushExtended>,
}

/// Direct allows sending the TLB flush command directly to the hypervisor.
/// It can be useful to optimize performance in nested virtualization cases, such as Windows VBS.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFeaturesHypervTlbflushDirect {
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// Extended allows the guest to execute partial TLB flushes. It can be helpful for general purpose workloads.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFeaturesHypervTlbflushExtended {
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// Information that can be set in the ACPI table
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainFirmwareAcpi {
...
/// IOThreads specifies the IOThreads options.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainIoThreads {
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainMemory {
    ...
    pub reserved_overhead: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainMemoryReservedOverhead>,
}
...
/// and its characteristics.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainMemoryReservedOverhead {
    ...
    pub mem_lock: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainMemoryReservedOverheadMemLock>,
}

/// ReservedOverhead configures the memory overhead applied to a VM
/// and its characteristics.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainMemoryReservedOverheadMemLock {
    NotRequired,
    Required,
}
...
/// Specification of the desired behavior of the VirtualMachineInstance on the host.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KubevirtMachineVirtualMachineTemplateSpecTemplateSpecDomainRebootPolicy {
    Reboot,
    Terminate,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecResourceClaims {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecUtilityVolumes {
...
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecVolumes {
    ...
    pub container_path: Option<KubevirtMachineVirtualMachineTemplateSpecTemplateSpecVolumesContainerPath>,
...
/// The path must correspond to an existing volumeMount in the compute container.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KubevirtMachineVirtualMachineTemplateSpecTemplateSpecVolumesContainerPath {
...
pub struct KubevirtMachineStatusAddresses {
    ...
    #[serde(rename = "type")]
    pub r#type: KubevirtMachineStatusAddressesType,
}

/// MachineAddress contains information for the node's address.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KubevirtMachineStatusAddressesType {
    Hostname,
