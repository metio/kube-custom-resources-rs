...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-vsphere/infrastructure.cluster.x-k8s.io/v1beta1/vspherevms.yaml
...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta1", kind = "VSphereVM", root = "VSphereVm", plural = "vspherevms")]
#[kube(namespaced)]
