...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-vsphere/infrastructure.cluster.x-k8s.io/v1beta1/vspheremachinetemplates.yaml
...
pub struct VSphereMachineTemplateTemplateSpec {
    ...
    pub ft_encryption_mode: Option<VSphereMachineTemplateTemplateSpecFtEncryptionMode>,
    ...
    pub migrate_encryption: Option<VSphereMachineTemplateTemplateSpecMigrateEncryption>,
    ...
    pub naming_strategy: Option<VSphereMachineTemplateTemplateSpecNamingStrategy>,
...
/// Spec is the specification of the desired behavior of the machine.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereMachineTemplateTemplateSpecFtEncryptionMode {
...
/// Spec is the specification of the desired behavior of the machine.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereMachineTemplateTemplateSpecMigrateEncryption {
...
/// NamingStrategy allows configuring the naming strategy used when calculating the name of the VSphereVM.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VSphereMachineTemplateTemplateSpecNamingStrategy {
