...
pub struct VSphereMachineTemplateTemplateSpec {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "guestSoftPowerOffTimeout"
    )]
...
pub struct VSphereMachineTemplateTemplateSpecNetworkDevices {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "addressesFromPools"
    )]
    pub addresses_from_pools:
        Option<Vec<VSphereMachineTemplateTemplateSpecNetworkDevicesAddressesFromPools>>,
