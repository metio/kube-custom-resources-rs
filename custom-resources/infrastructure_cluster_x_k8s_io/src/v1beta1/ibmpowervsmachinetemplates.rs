...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta1", kind = "IBMPowerVSMachineTemplate", root = "IbmPowerVsMachineTemplate", plural = "ibmpowervsmachinetemplates")]
#[kube(namespaced)]
