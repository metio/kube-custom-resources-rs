...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta1", kind = "IBMPowerVSClusterTemplate", root = "IbmPowerVsClusterTemplate", plural = "ibmpowervsclustertemplates")]
#[kube(namespaced)]
