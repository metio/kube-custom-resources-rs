...
pub struct VSphereMachineSpec {
    ...
    pub ft_encryption_mode: Option<VSphereMachineFtEncryptionMode>,
    ...
    pub migrate_encryption: Option<VSphereMachineMigrateEncryption>,
...
/// spec is the desired state of VSphereMachine.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereMachineFtEncryptionMode {
...
/// spec is the desired state of VSphereMachine.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereMachineMigrateEncryption {
