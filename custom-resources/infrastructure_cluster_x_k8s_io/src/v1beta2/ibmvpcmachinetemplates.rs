...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta2", kind = "IBMVPCMachineTemplate", root = "IbmvpcMachineTemplate", plural = "ibmvpcmachinetemplates")]
#[kube(namespaced)]
...
pub struct IbmvpcMachineTemplateTemplateSpec {
    ...
    pub additional_volumes: Option<Vec<IbmvpcMachineTemplateTemplateSpecAdditionalVolumes>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmvpcMachineTemplateTemplateSpecAdditionalVolumes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub profile: Option<IbmvpcMachineTemplateTemplateSpecAdditionalVolumesProfile>,
...
pub enum IbmvpcMachineTemplateTemplateSpecAdditionalVolumesProfile {
