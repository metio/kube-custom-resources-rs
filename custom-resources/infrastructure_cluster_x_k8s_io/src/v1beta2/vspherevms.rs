...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-vsphere/infrastructure.cluster.x-k8s.io/v1beta2/vspherevms.yaml
...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta2", kind = "VSphereVM", root = "VSphereVm", plural = "vspherevms")]
#[kube(namespaced)]
...
pub struct VSphereVmSpec {
    ...
    pub clone_mode: Option<VSphereVmCloneMode>,
    ...
    /// Virtual Machine.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cryptoProfile")]
    ...
    pub data_disks: Option<Vec<VSphereVmDataDisks>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ftEncryptionMode")]
    pub ft_encryption_mode: Option<VSphereVmFtEncryptionMode>,
    ...
    /// virtual machine is cloned.
    /// Check the compatibility with the ESXi version before setting the value.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "migrateEncryption")]
    pub migrate_encryption: Option<VSphereVmMigrateEncryption>,
    /// nestedHV controls nested hardware-assisted virtualization.
    /// Defaults to the eponymous property value in the template from which the
    /// virtual machine is cloned.
    /// Check the compatibility with the ESXi version before setting the value.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nestedHV")]
    pub nested_hv: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<VSphereVmResources>,
...
pub struct VSphereVmDataDisks {
    ...
    pub provisioning_mode: Option<VSphereVmDataDisksProvisioningMode>,
...
/// VSphereDisk is an additional disk to add to the VM that is not part of the VM OVA template.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereVmDataDisksProvisioningMode {
    Thin,
    Thick,
    EagerlyZeroed,
}
...
/// spec is the desired state of VSphereVM.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereVmFtEncryptionMode {
...
/// spec is the desired state of VSphereVM.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereVmMigrateEncryption {
...
pub struct VSphereVmResources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<VSphereVmResourcesLimits>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<VSphereVmResourcesRequests>,
    /// shares is the definition of the VM's cpu and memory shares
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub shares: Option<VSphereVmResourcesShares>,
}

/// limits is the definition of the VM's cpu (in hertz, rounded up to the nearest MHz)
/// and memory (in bytes, rounded up to the nearest MiB) limits
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VSphereVmResourcesLimits {
...
/// and memory (in bytes, rounded up to the nearest MiB) reservations
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VSphereVmResourcesRequests {
    /// cpu is the definition of the cpu quantity for the given VM hardware policy
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cpu: Option<IntOrString>,
    /// memory is the definition of the memory quantity for the given VM hardware policy
...
/// shares is the definition of the VM's cpu and memory shares
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct VSphereVmResourcesShares {
...
/// status is the observed state of VSphereVM.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum VSphereVmStatusCloneMode {
    #[serde(rename = "fullClone")]
    FullClone,
    #[serde(rename = "linkedClone")]
    LinkedClone,
