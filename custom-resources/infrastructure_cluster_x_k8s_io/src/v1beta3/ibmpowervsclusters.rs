...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-ibmcloud/infrastructure.cluster.x-k8s.io/v1beta3/ibmpowervsclusters.yaml
...
#[kube(group = "infrastructure.cluster.x-k8s.io", version = "v1beta3", kind = "IBMPowerVSCluster", root = "IbmPowerVsCluster", plural = "ibmpowervsclusters")]
#[kube(namespaced)]
...
pub struct IbmPowerVsClusterLoadBalancersAdditionalListeners {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub selector: Option<IbmPowerVsClusterLoadBalancersAdditionalListenersSelector>,
}
...
/// If the label matches, the machine is then added to the load balancer listener configuration.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmPowerVsClusterLoadBalancersAdditionalListenersSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<IbmPowerVsClusterLoadBalancersAdditionalListenersSelectorMatchExpressions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmPowerVsClusterLoadBalancersAdditionalListenersSelectorMatchExpressions {
...
pub struct IbmPowerVsClusterStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub deprecated: Option<IbmPowerVsClusterStatusDeprecated>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub initialization: Option<IbmPowerVsClusterStatusInitialization>,
...
/// deprecated groups all the status fields that are deprecated and will be removed when all the nested field are removed.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmPowerVsClusterStatusDeprecated {
    /// v1beta2 groups all the status fields that are deprecated and will be removed when support for v1beta2 will be dropped.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub v1beta2: Option<IbmPowerVsClusterStatusDeprecatedV1beta2>,
}

/// v1beta2 groups all the status fields that are deprecated and will be removed when support for v1beta2 will be dropped.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmPowerVsClusterStatusDeprecatedV1beta2 {
...
/// NOTE: Fields in this struct are part of the Cluster API contract and are used to orchestrate initial Cluster provisioning.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct IbmPowerVsClusterStatusInitialization {
