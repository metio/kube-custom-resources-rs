...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-vsphere/infrastructure.cluster.x-k8s.io/v1alpha3/vsphereclusters.yaml
...
pub struct VSphereClusterSpec {
    ...
    #[serde(
        ...
        rename = "cloudProviderConfiguration"
    )]
...
pub struct VSphereClusterCloudProviderConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "virtualCenter"
    )]
    pub virtual_center:
        Option<BTreeMap<String, VSphereClusterCloudProviderConfigurationVirtualCenter>>,
