...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/cluster-api-provider-vsphere/infrastructure.cluster.x-k8s.io/v1alpha4/vsphereclusteridentities.yaml
...
pub struct VSphereClusterIdentityAllowedNamespacesSelector {
    ...
    pub match_expressions:
        Option<Vec<VSphereClusterIdentityAllowedNamespacesSelectorMatchExpressions>>,
