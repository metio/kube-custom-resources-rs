...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/elastic/cloud-on-k8s/packageregistry.k8s.elastic.co/v1alpha1/packageregistries.yaml
...
#[kube(group = "packageregistry.k8s.elastic.co", version = "v1alpha1", kind = "PackageRegistry", plural = "packageregistries")]
#[kube(namespaced)]
#[kube(status = "PackageRegistryStatus")]
#[kube(schema = "disabled")]
#[kube(derive="Default")]
#[kube(derive="PartialEq")]
pub struct PackageRegistrySpec {
    ...
    pub config_ref: Option<PackageRegistryConfigRef>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub http: Option<PackageRegistryHttp>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<PackageRegistryResources>,
...
pub struct PackageRegistryConfigRef {
...
/// HTTP holds the HTTP layer configuration for Elastic Package Registry.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttp {
    /// Service defines the template for the associated Kubernetes Service object.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<PackageRegistryHttpService>,
    /// TLS defines options for configuring TLS for HTTP.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tls: Option<PackageRegistryHttpTls>,
}

/// Service defines the template for the associated Kubernetes Service object.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpService {
    /// ObjectMeta is the metadata of the service.
    /// The name and namespace provided here are managed by ECK and will be ignored.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub metadata: Option<PackageRegistryHttpServiceMetadata>,
    /// Spec is the specification of the service.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<PackageRegistryHttpServiceSpec>,
}

/// ObjectMeta is the metadata of the service.
/// The name and namespace provided here are managed by ECK and will be ignored.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpServiceMetadata {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Spec is the specification of the service.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpServiceSpec {
    ...
    /// More info: <https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies>
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<PackageRegistryHttpServiceSpecPorts>>,
    ...
    pub session_affinity_config: Option<PackageRegistryHttpServiceSpecSessionAffinityConfig>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpServiceSpecPorts {
...
/// sessionAffinityConfig contains the configurations of session affinity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpServiceSpecSessionAffinityConfig {
    /// clientIP contains the configurations of Client IP based session affinity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientIP")]
    pub client_ip: Option<PackageRegistryHttpServiceSpecSessionAffinityConfigClientIp>,
}

/// clientIP contains the configurations of Client IP based session affinity.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpServiceSpecSessionAffinityConfigClientIp {
...
/// TLS defines options for configuring TLS for HTTP.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpTls {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub certificate: Option<PackageRegistryHttpTlsCertificate>,
    /// SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selfSignedCertificate")]
    pub self_signed_certificate: Option<PackageRegistryHttpTlsSelfSignedCertificate>,
}
...
/// - `tls.key`: The private key to the first certificate in the certificate chain.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpTlsCertificate {
    /// SecretName is the name of the secret.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secretName")]
    pub secret_name: Option<String>,
}
...
/// SelfSignedCertificate allows configuring the self-signed certificate generated by the operator.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpTlsSelfSignedCertificate {
    ...
    pub subject_alt_names: Option<Vec<PackageRegistryHttpTlsSelfSignedCertificateSubjectAltNames>>,
}

/// SubjectAlternativeName represents a SAN entry in a x509 certificate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryHttpTlsSelfSignedCertificateSubjectAltNames {
...
/// primary Elastic Package Registry container. To set resources on other containers, use the PodTemplate.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryResources {
    /// Limits is the shorthand for the main container's CPU and memory limits.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub limits: Option<PackageRegistryResourcesLimits>,
    /// Requests is the shorthand for the main container's CPU and memory requests.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub requests: Option<PackageRegistryResourcesRequests>,
}

/// Limits is the shorthand for the main container's CPU and memory limits.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryResourcesLimits {
...
/// Requests is the shorthand for the main container's CPU and memory requests.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryResourcesRequests {
    /// CPU overrides the main container's CPU request/limit when the parent Resources
    /// is merged into a PodTemplate. A nil value means "do not override": any CPU
    /// value already set on the main container in the PodTemplate is passed through
    /// unchanged. Setting this field to nil does not unset a CPU value present in
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<PackageRegistryStatusConditions>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PackageRegistryStatusConditions {
