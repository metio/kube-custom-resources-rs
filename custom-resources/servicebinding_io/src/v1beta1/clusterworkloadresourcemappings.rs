...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/redhat-developer/service-binding-operator/servicebinding.io/v1beta1/clusterworkloadresourcemappings.yaml
