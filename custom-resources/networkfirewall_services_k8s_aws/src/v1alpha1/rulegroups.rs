...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/networkfirewall-controller/networkfirewall.services.k8s.aws/v1alpha1/rulegroups.yaml
...
pub struct RuleGroupRuleGroupRulesSource {
    ...
    pub stateless_rules_and_custom_actions:
        Option<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActions>,
}
...
pub struct RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActions {
    ...
    pub custom_actions:
        Option<Vec<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActions>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessRules"
    )]
    pub stateless_rules:
        Option<Vec<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRules>>,
}
...
pub struct RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActions {
    ...
    pub action_definition: Option<
        RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionsActionDefinition,
    >,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRules {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ruleDefinition"
    )]
    pub rule_definition: Option<
        RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRulesRuleDefinition,
    >,
}
...
pub struct RuleGroupStatusRuleGroupResponse {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ruleGroupName"
    )]
    pub rule_group_name: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ruleGroupStatus"
    )]
