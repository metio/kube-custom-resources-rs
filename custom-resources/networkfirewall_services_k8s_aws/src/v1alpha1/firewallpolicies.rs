...
pub struct FirewallPolicyFirewallPolicy {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statefulRuleGroupReferences"
    )]
    pub stateful_rule_group_references:
        Option<Vec<FirewallPolicyFirewallPolicyStatefulRuleGroupReferences>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessCustomActions"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessRuleGroupReferences"
    )]
    pub stateless_rule_group_references:
        Option<Vec<FirewallPolicyFirewallPolicyStatelessRuleGroupReferences>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FirewallPolicyFirewallPolicyPolicyVariables {
    ...
    pub rule_variables:
        Option<BTreeMap<String, FirewallPolicyFirewallPolicyPolicyVariablesRuleVariables>>,
}
...
pub struct FirewallPolicyFirewallPolicyStatelessCustomActions {
    ...
    pub action_definition:
        Option<FirewallPolicyFirewallPolicyStatelessCustomActionsActionDefinition>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "actionName"
...
pub struct FirewallPolicyFirewallPolicyStatelessCustomActionsActionDefinition {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "publishMetricAction"
    )]
    pub publish_metric_action: Option<
        FirewallPolicyFirewallPolicyStatelessCustomActionsActionDefinitionPublishMetricAction,
    >,
}
...
pub struct FirewallPolicyStatusFirewallPolicyResponse {
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "consumedStatefulRuleCapacity"
    )]
    pub consumed_stateful_rule_capacity: Option<i64>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "consumedStatelessRuleCapacity"
    )]
    ...
    pub encryption_configuration:
        Option<FirewallPolicyStatusFirewallPolicyResponseEncryptionConfiguration>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "firewallPolicyName"
    )]
    pub firewall_policy_name: Option<String>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "firewallPolicyStatus"
    )]
