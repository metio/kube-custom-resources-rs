...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/clastix/kamaji/kamaji.clastix.io/v1alpha1/datastores.yaml
