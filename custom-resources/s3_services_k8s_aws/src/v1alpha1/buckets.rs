...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/aws-controllers-k8s/s3-controller/s3.services.k8s.aws/v1alpha1/buckets.yaml
...
pub struct BucketCreateBucketConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub bucket: Option<BucketCreateBucketConfigurationBucket>,
    ...
    /// This functionality is only supported by directory buckets.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub location: Option<BucketCreateBucketConfigurationLocation>,
...
/// This functionality is only supported by directory buckets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BucketCreateBucketConfigurationBucket {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataRedundancy")]
...
/// This functionality is only supported by directory buckets.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct BucketCreateBucketConfigurationLocation {
    #[serde(default, skip_serializing_if = "Option::is_none")]
