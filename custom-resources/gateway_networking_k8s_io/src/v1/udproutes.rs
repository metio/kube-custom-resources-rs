...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1/udproutes.yaml
...
#[kube(group = "gateway.networking.k8s.io", version = "v1", kind = "UDPRoute", root = "UdpRoute", plural = "udproutes")]
#[kube(namespaced)]
