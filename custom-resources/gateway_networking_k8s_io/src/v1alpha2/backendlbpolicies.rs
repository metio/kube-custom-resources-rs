...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1alpha2/backendlbpolicies.yaml
...
#[kube(group = "gateway.networking.k8s.io", version = "v1alpha2", kind = "BackendLBPolicy", root = "BackendLbPolicy", plural = "backendlbpolicies")]
#[kube(namespaced)]
