...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/kubernetes-sigs/gateway-api/gateway.networking.k8s.io/v1alpha2/tlsroutes.yaml
...
#[kube(group = "gateway.networking.k8s.io", version = "v1alpha2", kind = "TLSRoute", root = "TlsRoute", plural = "tlsroutes")]
#[kube(namespaced)]
