...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/istio/istio/extensions.istio.io/v1alpha1/wasmplugins.yaml
