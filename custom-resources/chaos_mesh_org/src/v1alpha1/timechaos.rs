...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/chaos-mesh/chaos-mesh/chaos-mesh.org/v1alpha1/timechaos.yaml
...
#[kube(group = "chaos-mesh.org", version = "v1alpha1", kind = "TimeChaos", plural = "timechaos")]
#[kube(namespaced)]
#[kube(status = "TimeChaosStatus")]
...
pub struct TimeChaosSpec {
    ...
    pub selector: TimeChaosSelector,
...
pub struct TimeChaosSelector {
    ...
    pub expression_selectors: Option<Vec<TimeChaosSelectorExpressionSelectors>>,
    /// Map of string keys and values that can be used to select objects.
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosSelectorExpressionSelectors {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosStatus {
    /// Conditions represents the current global condition of the chaos
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conditions: Option<Vec<TimeChaosStatusConditions>>,
    /// Experiment records the last experiment state.
    pub experiment: TimeChaosStatusExperiment,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosStatusConditions {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Experiment records the last experiment state.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosStatusExperiment {
    /// Records are used to track the running status
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerRecords")]
    pub container_records: Option<Vec<TimeChaosStatusExperimentContainerRecords>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredPhase")]
    pub desired_phase: Option<TimeChaosStatusExperimentDesiredPhase>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosStatusExperimentContainerRecords {
    /// Events are the essential details about the injections and recoveries
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<TimeChaosStatusExperimentContainerRecordsEvents>>,
    pub id: String,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TimeChaosStatusExperimentContainerRecordsEvents {
...
/// Experiment records the last experiment state.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum TimeChaosStatusExperimentDesiredPhase {
    Run,
    Stop,
}
