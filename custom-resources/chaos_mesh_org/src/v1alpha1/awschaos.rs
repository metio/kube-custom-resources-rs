...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/chaos-mesh/chaos-mesh/chaos-mesh.org/v1alpha1/awschaos.yaml
...
#[kube(group = "chaos-mesh.org", version = "v1alpha1", kind = "AWSChaos", root = "AwsChaos", plural = "awschaos")]
#[kube(namespaced)]
#[kube(status = "AwsChaosStatus")]
