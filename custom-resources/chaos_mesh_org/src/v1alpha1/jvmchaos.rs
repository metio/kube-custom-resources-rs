...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/chaos-mesh/chaos-mesh/chaos-mesh.org/v1alpha1/jvmchaos.yaml
...
#[kube(group = "chaos-mesh.org", version = "v1alpha1", kind = "JVMChaos", root = "JvmChaos", plural = "jvmchaos")]
#[kube(namespaced)]
#[kube(status = "JvmChaosStatus")]
