...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/karmada-io/karmada/policy.karmada.io/v1alpha1/propagationpolicies.yaml
...
pub struct PropagationPolicySpec {
    ...
    pub schedule_priority: Option<PropagationPolicySchedulePriority>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub suspension: Option<PropagationPolicySuspension>,
}

/// Spec represents the desired behavior of PropagationPolicy.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicyActivationPreference {
    Lazy,
}
...
pub struct PropagationPolicyFailover {
    ...
    /// by this value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cluster: Option<PropagationPolicyFailoverCluster>,
}
...
pub struct PropagationPolicyFailoverApplication {
    ...
    pub purge_mode: Option<PropagationPolicyFailoverApplicationPurgeMode>,
    ...
    pub state_preservation: Option<PropagationPolicyFailoverApplicationStatePreservation>,
}
...
/// be migrated along with the application.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicyFailoverApplicationPurgeMode {
    Directly,
    Gracefully,
    Never,
    Immediately,
...
/// which is alpha.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyFailoverApplicationStatePreservation {
    ...
    /// to the new cluster.
    pub rules: Vec<PropagationPolicyFailoverApplicationStatePreservationRules>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyFailoverApplicationStatePreservationRules {
...
/// by this value.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyFailoverCluster {
    /// PurgeMode represents how to deal with the legacy applications on the
    /// cluster from which the application is migrated.
    /// Valid options are "Directly", "Gracefully".
    /// Defaults to "Gracefully".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "purgeMode")]
    pub purge_mode: Option<PropagationPolicyFailoverClusterPurgeMode>,
    /// StatePreservation defines the policy for preserving and restoring state data
    /// during failover events for stateful applications.
    /// 
    /// When an application fails over from one cluster to another, this policy enables
    ...
    /// which is alpha.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "statePreservation")]
    pub state_preservation: Option<PropagationPolicyFailoverClusterStatePreservation>,
}
...
/// by this value.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicyFailoverClusterPurgeMode {
    Directly,
    Gracefully,
}
...
/// which is alpha.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyFailoverClusterStatePreservation {
    /// Rules contains a list of StatePreservationRule configurations.
    /// Each rule specifies a JSONPath expression targeting specific pieces of
    /// state data to be preserved during failover events. An AliasLabelName is associated
    /// with each rule, serving as a label key when the preserved data is passed
    /// to the new cluster.
    pub rules: Vec<PropagationPolicyFailoverClusterStatePreservationRules>,
}
...
/// as a label key when passing state information to the new cluster.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyFailoverClusterStatePreservationRules {
    /// AliasLabelName is the name that will be used as a label key when the preserved
    /// data is passed to the new cluster. This facilitates the injection of the
    /// preserved state back into the application resources during recovery.
    #[serde(rename = "aliasLabelName")]
...
pub struct PropagationPolicyPlacement {
    ...
    pub workload_affinity: Option<PropagationPolicyPlacementWorkloadAffinity>,
}
...
pub struct PropagationPolicyPlacementClusterAffinities {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "overflowAffinities")]
    pub overflow_affinities: Option<Vec<PropagationPolicyPlacementClusterAffinitiesOverflowAffinities>>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementClusterAffinitiesOverflowAffinities {
    /// AffinityName is the name of the cluster group.
    #[serde(rename = "affinityName")]
    pub affinity_name: String,
    /// ClusterNames is the list of clusters to be selected.
    ...
    /// If non-nil and non-empty, only the clusters match this filter will be selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fieldSelector")]
    pub field_selector: Option<PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesFieldSelector>,
    /// LabelSelector is a filter to select member clusters by labels.
    /// If non-nil and non-empty, only the clusters match this filter will be selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "labelSelector")]
    pub label_selector: Option<PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesLabelSelector>,
}
...
/// If non-nil and non-empty, only the clusters match this filter will be selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesFieldSelector {
    /// A list of field selector requirements.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesFieldSelectorMatchExpressions>>,
}

/// A node selector requirement is a selector that contains values, a key, and an operator
/// that relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesFieldSelectorMatchExpressions {
    /// The label key that the selector applies to.
    pub key: String,
    /// Represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
/// If non-nil and non-empty, only the clusters match this filter will be selected.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesLabelSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesLabelSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
/// relates the key and values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementClusterAffinitiesOverflowAffinitiesLabelSelectorMatchExpressions {
    /// key is the label key that the selector applies to.
    pub key: String,
    /// operator represents a key's relationship to a set of values.
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
...
/// scheduling policies.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementWorkloadAffinity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub affinity: Option<PropagationPolicyPlacementWorkloadAffinityAffinity>,
    ...
    pub anti_affinity: Option<PropagationPolicyPlacementWorkloadAffinityAntiAffinity>,
}
...
/// encountering scheduling deadlocks, providing a better user experience.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementWorkloadAffinityAffinity {
...
/// where matching workloads are already scheduled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicyPlacementWorkloadAffinityAntiAffinity {
    /// GroupByLabelKey declares the label key on the workload resource template that
...
/// releases as the feature matures.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct PropagationPolicySchedulePriority {
    ...
    pub priority_class_source: PropagationPolicySchedulePriorityPriorityClassSource,
}
...
/// releases as the feature matures.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PropagationPolicySchedulePriorityPriorityClassSource {
    KubePriorityClass,
}
...
/// nil means no suspension. no default values.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PropagationPolicySuspension {
