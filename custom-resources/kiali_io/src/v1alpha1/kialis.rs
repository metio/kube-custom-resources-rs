...
pub struct KialiChatAiProviders {
    /// The provider configuration variant. Valid values depend on `type`: `anthropic` requires `default`; `google` requires `gemini`; `openai` supports `default`, `gemini`, or `azure`. Default value is `default`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// The endpoint of the provider. This is only used if a model has no endpoint specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// The type of the AI models provider. Available values are `openai`, `anthropic`, and `google`. Default value is `openai`.
...
pub struct KialiChatAiStoreConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Idle time allowed before the conversation is deleted due to inactivity.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct KialiDeployment {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pod_disruption_budget: Option<KialiDeploymentPodDisruptionBudget>,
    ...
    /// Configures the update strategy for the Kiali deployment. If not specified, a RollingUpdate strategy is used with maxSurge=1 and maxUnavailable=1. See the Kubernetes documentation on Deployment Strategy for details.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub strategy: Option<BTreeMap<String, serde_json::Value>>,
...
/// 
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KialiDeploymentPodDisruptionBudget {
    /// A specific PDB API version that can be specified in case there is some PDB feature you want to use that is only supported in that specific version. If value is an empty string, the default version of 'policy/v1' will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub api_version: Option<String>,
    /// The `spec` specified here will be placed in the created PDB resource's 'spec' section. If `spec` is left empty, no PDB resource will be created. Note that you must not specify the 'selector' section in `spec`; the Kiali Operator will populate that for you.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub spec: Option<BTreeMap<String, serde_json::Value>>,
}
...
pub struct KialiExternalServicesIstio {
    ...
    /// The Kubernetes cluster DNS domain suffix used to construct fully qualified service hostnames (e.g. reviews.bookinfo.svc.cluster.local) and service account identity strings for validation. When empty, it is auto-detected from the Istio mesh trustDomain (as 'svc.' + trustDomain). Set explicitly only if you need to override the auto-detected value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// How often in seconds Kiali will poll istiod(s) for proxy status. Polling is not performed if istio_api_enabled is false.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct KialiExternalServicesPrometheus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub custom_headers: Option<BTreeMap<String, String>>,
    /// When true, Kiali will connect to the Prometheus instance for Istio telemetry metrics. When false, Kiali will run without metrics support - the graph, health based on request rates, and metrics displays will be unavailable.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Used in the Components health feature. This is the url which Kiali will ping to determine whether the component is reachable or not. It defaults to `url` when not provided.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct KialiExternalServicesTracing {
    ...
    /// Set to true in order to look for traces using the waypoint service name and not the actual service. Ex. To find traces for Istio versions earlier than 1.28.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub use_waypoint_name: Option<bool>,
...
pub struct KialiHealthConfig {
    /// Configuration for health pre-computation and caching.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compute: Option<KialiHealthConfigCompute>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Configuration for health pre-computation and caching.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KialiHealthConfigCompute {
    /// The time period over which health is calculated. Used as the rate interval for Prometheus queries.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub duration: Option<KialiHealthConfigComputeDuration>,
    /// The interval between health cache refreshes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Configuration for health pre-computation and caching.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum KialiHealthConfigComputeDuration {
    #[serde(rename = "1m")]
    r#_1m,
    #[serde(rename = "2m")]
    r#_2m,
...
pub struct KialiIstioLabels {
    ...
    /// DEPRECATED AFTER v2.27: This setting is deprecated and will be ignored.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub egress_gateway_label: Option<String>,
    /// DEPRECATED AFTER v2.27: This setting is deprecated and will be ignored.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ingress_gateway_label: Option<String>,
    /// DEPRECATED AFTER v2.27: This setting is deprecated and will be ignored. The injection label name is now hardcoded to the standard value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub injection_label_name: Option<String>,
    /// DEPRECATED AFTER v2.27: This setting is deprecated and will be ignored. The injection label revision is now hardcoded to the standard value.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct KialiKialiFeatureFlags {
    /// Authorization-related feature flags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub authz: Option<KialiKialiFeatureFlagsAuthz>,
...
/// Authorization-related feature flags.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KialiKialiFeatureFlagsAuthz {
    ...
    /// 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub require_namespace_get: Option<bool>,
}
...
pub struct KialiServerObservabilityMetrics {
    /// The metrics HTTP listener is started when either this or health_status.enabled is true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Settings for the kiali_health_status Prometheus gauge (per-entity health from the health cache refresh). Independent of metrics.enabled.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub health_status: Option<KialiServerObservabilityMetricsHealthStatus>,
...
/// Settings for the kiali_health_status Prometheus gauge (per-entity health from the health cache refresh). Independent of metrics.enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct KialiServerObservabilityMetricsHealthStatus {
    /// When true, Kiali exports kiali_health_status metrics during health cache refresh.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Number of consecutive health refresh cycles an entity may report NA or be missing before its kiali_health_status series is removed. Values less than or equal to 0 use the server default (3).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub max_consecutive_na: Option<i64>,
}
