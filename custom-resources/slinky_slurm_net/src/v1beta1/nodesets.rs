...
pub struct NodeSetSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ordinalPadding")]
    pub ordinal_padding: Option<i64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pinToNode")]
    pub pin_to_node: Option<bool>,
    /// PruneSlurmNodeRecords controls when the operator deletes Slurm node records.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pruneSlurmNodeRecords")]
    pub prune_slurm_node_records: Option<NodeSetPruneSlurmNodeRecords>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scalingMode")]
    pub scaling_mode: Option<NodeSetScalingMode>,
...
pub struct NodeSetPersistentVolumeClaimRetentionPolicy {
    ...
    pub when_deleted: Option<NodeSetPersistentVolumeClaimRetentionPolicyWhenDeleted>,
    ...
    pub when_scaled: Option<NodeSetPersistentVolumeClaimRetentionPolicyWhenScaled>,
}
...
pub enum NodeSetPersistentVolumeClaimRetentionPolicyWhenDeleted {
    Retain,
    Delete,
}
...
/// NodeSetAutoDeletePVC feature gate to be enabled, which is alpha.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum NodeSetPersistentVolumeClaimRetentionPolicyWhenScaled {
    Retain,
    Delete,
}
...
/// NodeSetSpec defines the desired state of NodeSet
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum NodeSetPruneSlurmNodeRecords {
    Never,
    NodeNotFound,
}
...
pub struct NodeSetUpdateStrategy {
    ...
    pub r#type: Option<NodeSetUpdateStrategyType>,
}
...
/// Template.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum NodeSetUpdateStrategyType {
    RollingUpdate,
    OnDelete,
}
...
pub struct NodeSetStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ordinalToNode")]
    pub ordinal_to_node: Option<BTreeMap<String, String>>,
