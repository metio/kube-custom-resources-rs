...
pub struct TokenSpec {
    ...
    pub jwt_hs256_key_ref: Option<TokenJwtHs256KeyRef>,
    /// Slurm `auth/jwt` JWT key authentication.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jwtKeyRef")]
    pub jwt_key_ref: Option<TokenJwtKeyRef>,
