...
pub struct ControllerSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inplaceReconfigure")]
    pub inplace_reconfigure: Option<bool>,
    /// Slurm `auth/jwt` JWKS key authentication.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jwksKeyRef")]
    pub jwks_key_ref: Option<ControllerJwksKeyRef>,
    ...
    pub slurm_key_ref: Option<ControllerSlurmKeyRef>,
...
/// Slurm `auth/jwt` JWKS key authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ControllerJwksKeyRef {
    /// The key to select.
    pub key: String,
    /// Name of the referent.
...
/// Slurm `auth/jwt` JWT key authentication.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ControllerJwtKeyRef {
    /// The key of the secret to select from.  Must be a valid secret key.
    pub key: String,
    /// Name of the referent.
    /// This field is effectively required, but due to backwards compatibility is
