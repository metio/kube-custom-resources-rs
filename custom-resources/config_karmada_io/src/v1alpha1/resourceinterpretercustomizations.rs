...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/karmada-io/karmada/config.karmada.io/v1alpha1/resourceinterpretercustomizations.yaml
...
pub struct ResourceInterpreterCustomizationCustomizations {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "componentResource")]
    pub component_resource: Option<ResourceInterpreterCustomizationCustomizationsComponentResource>,
...
/// This will only be used when the feature gate 'MultiplePodTemplatesScheduling' is enabled.
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ResourceInterpreterCustomizationCustomizationsComponentResource {
