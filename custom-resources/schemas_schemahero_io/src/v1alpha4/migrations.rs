...
pub struct MigrationSpec {
    ...
    /// Tables contains references to all tables included in this migration. This is populated for batch migrations that include multiple tables. For single-table migrations, this may be empty (use TableName/TableNamespace).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tables: Option<Vec<MigrationTables>>,
}
