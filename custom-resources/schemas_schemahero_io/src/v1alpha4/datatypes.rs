...
// kopium command: kopium --docs --derive=Default --derive=PartialEq --smart-derive-elision --filename crd-catalog/schemahero/schemahero/schemas.schemahero.io/v1alpha4/datatypes.yaml
