...
pub const CRD_V1_SOURCES: &'static [UpstreamSource] = &[
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixconsumers.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixglobalrules.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixpluginconfigs.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixroutes.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixtlses.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_apisixupstreams.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_backendtrafficpolicies.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_consumers.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_gatewayproxies.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_httproutepolicies.yaml",
            "https://github.com/apache/apisix-ingress-controller/blob/master/config/crd/bases/apisix.apache.org_pluginconfigs.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/aws-controllers-k8s/eks-controller/blob/main/config/crd/common/bases/services.k8s.aws_iamroleselectors.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/acme.cert-manager.io_challenges.yaml",
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/acme.cert-manager.io_orders.yaml",
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/cert-manager.io_certificaterequests.yaml",
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/cert-manager.io_certificates.yaml",
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/cert-manager.io_clusterissuers.yaml",
            "https://github.com/cert-manager/cert-manager/blob/master/deploy/crds/cert-manager.io_issuers.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/cilium/cilium/blob/main/pkg/k8s/apis/cilium.io/client/crds/v2/ciliumcidrgroups.yaml",
            ...
            "https://github.com/cilium/cilium/blob/main/pkg/k8s/apis/cilium.io/client/crds/v2/ciliumloadbalancerippools.yaml",
            ...
            "https://github.com/cilium/cilium/blob/main/pkg/k8s/apis/cilium.io/client/crds/v2alpha1/ciliumdatapathplugins.yaml",
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_compositeresourcedefinitions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_compositionrevisions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_compositions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_environmentconfigs.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_managedresourceactivationpolicies.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_managedresourcedefinitions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/apiextensions.crossplane.io_usages.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/ops.crossplane.io_cronoperations.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/ops.crossplane.io_operations.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/ops.crossplane.io_watchoperations.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_configurationrevisions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_configurations.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_deploymentruntimeconfigs.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_functionrevisions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_functions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_imageconfigs.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_locks.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_providerrevisions.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/pkg.crossplane.io_providers.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/protection.crossplane.io_clusterusages.yaml",
            "https://github.com/crossplane/crossplane/blob/main/cluster/crds/protection.crossplane.io_usages.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/giantswarm/silence-operator/blob/main/config/crd/bases/monitoring.giantswarm.io_silences.yaml",
            "https://github.com/giantswarm/silence-operator/blob/main/config/crd/bases/observability.giantswarm.io_silences.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging-extensions.banzaicloud.io_eventtailers.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging-extensions.banzaicloud.io_hosttailers.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_axosyslogs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_clusterflows.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_clusteroutputs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_flows.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_fluentbitagents.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_fluentdconfigs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_loggingroutes.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_loggings.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_outputs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_syslogngclusterflows.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_syslogngclusteroutputs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_syslogngconfigs.yaml",
            "https://github.com/kube-logging/logging-operator/blob/master/config/crd/bases/logging.banzaicloud.io_syslogngflows.yaml",
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/kubeedge/kubeedge/blob/master/manifests/charts/cloudcore/crds/devices_v1beta1_devicestatus.yaml",
            "https://github.com/kubeedge/kubeedge/blob/master/manifests/charts/cloudcore/crds/objectsync_v1alpha1.yaml",
            "https://github.com/kubeedge/kubeedge/blob/master/manifests/charts/cloudcore/crds/operations_v1alpha2_configupdatejob.yaml",
            "https://github.com/kubeedge/kubeedge/blob/master/manifests/charts/cloudcore/crds/operations_v1alpha2_imageprepulljob.yaml",
            "https://github.com/kubeedge/kubeedge/blob/master/manifests/charts/cloudcore/crds/operations_v1alpha2_nodeupgradejob.yaml",
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/kubernetes-sigs/gateway-api/blob/main/config/crd/standard/gateway.networking.k8s.io_backendtlspolicies.yaml",
            ...
            "https://github.com/kubernetes-sigs/gateway-api/blob/main/config/crd/standard/gateway.networking.k8s.io_listenersets.yaml",
            ...
            "https://github.com/kubernetes-sigs/gateway-api/blob/main/config/crd/standard/gateway.networking.k8s.io_tcproutes.yaml",
            "https://github.com/kubernetes-sigs/gateway-api/blob/main/config/crd/standard/gateway.networking.k8s.io_tlsroutes.yaml",
            "https://github.com/kubernetes-sigs/gateway-api/blob/main/config/crd/standard/gateway.networking.k8s.io_udproutes.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/kubernetes-sigs/network-policy-api/blob/main/config/crd/standard/policy.networking.k8s.io_clusternetworkpolicies.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        license: BSD3,
        urls: &[
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_groups.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_nbgroups.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_nbpolicies.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_nbresources.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_nbroutingpeers.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_nbsetupkeys.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_networkresources.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_networkrouters.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_setupkeys.yaml",
            "https://github.com/netbirdio/kubernetes-operator/blob/main/config/crd/bases/netbird.io_sidecarprofiles.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/solo-io/gloo/blob/main/install/helm/gloo/crds/gateway.gloo.solo.io_directresponses.yaml",
            "https://github.com/solo-io/gloo/blob/main/install/helm/gloo/crds/gateway.gloo.solo.io_gatewayparameters.yaml",
            ...
            "https://github.com/solo-io/gloo/blob/main/install/helm/gloo/crds/gateway.solo.io_v1_MatchableTcpGateway.yaml",
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/strimzi/strimzi-kafka-operator/blob/main/helm-charts/helm3/strimzi-kafka-operator/crds/045-Crd-kafkanodepool.yaml",
    ...
    UpstreamSource {
        ...
        license: APACHE_V2,
        urls: &[
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_apiservers.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_applicationlayers.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_authentications.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_compliances.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_egressgateways.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_gatewayapis.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_goldmanes.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_imagesets.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_installations.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_intrusiondetections.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_istios.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_logcollectors.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_logstorages.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_managementclusterconnections.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_managementclusters.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_managers.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_monitors.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_nonclusterhosts.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_packetcaptureapis.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_policyrecommendations.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_tenants.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_tigerastatuses.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_tlspassthroughroutes.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_tlsterminatedroutes.yaml",
            "https://github.com/tigera/operator/blob/master/pkg/imports/crds/operator/operator.tigera.io_whiskers.yaml",
        ],
        ignores: &[],
    },
    UpstreamSource {
