...
pub const CRD_V1_SOURCES: &'static [UpstreamSource] = &[
    ...
    UpstreamSource {
        ...
        urls: &[
            ...
            "https://github.com/apecloud/kubeblocks/blob/main/config/crd/bases/apps.kubeblocks.io_componentclassdefinitions.yaml",
            "https://github.com/apecloud/kubeblocks/blob/main/config/crd/bases/apps.kubeblocks.io_componentresourceconstraints.yaml",
            ...
            "https://github.com/apecloud/kubeblocks/blob/main/config/crd/bases/workloads.kubeblocks.io_replicatedstatemachines.yaml",
        ],
    },
    UpstreamSource {
